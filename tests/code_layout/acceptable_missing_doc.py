...
ACCEPTABLE_MISSING_DOCS = {
    ...
    "QgsGeometryRubberBand": ["IconType", "QgsGeometryRubberBand(QgsMapCanvas *mapCanvas, QgsWkbTypes::GeometryType geomType=QgsWkbTypes::GeometryType::LineGeometry)"],
    ...
    "QgsMapToolEdit": ["QgsMapToolEdit(QgsMapCanvas *canvas)", "createGeometryRubberBand(QgsWkbTypes::Type geometryType=QgsWkbTypes::GeometryType::LineGeometry, bool alternativeBand=false) const"],
