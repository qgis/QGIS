...
ACCEPTABLE_MISSING_DOCS = {
    ...
    "QgsMessageBar": ["Qgis::MessageLevel", "currentItem()", "QgsMessageBar(QWidget *parent=0)"],
    ...
    "QgsMessageBarItem": ["setLevel(Qgis::MessageLevel level)", "setIcon(const QIcon &icon)", "setText(const QString &text)", "setDuration(int duration)", "setTitle(const QString &title)", "setWidget(QWidget *widget)"],
