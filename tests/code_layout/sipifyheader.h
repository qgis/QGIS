...
class CORE_EXPORT QgsSipifyHeader : public QtClass<QVariant>, private Ui::QgsBaseClass
{
  ...
  public:
    ...
    static const inline QgsSettingsEntryEnumFlag<QgsSnappingConfig::SnappingTypes> settingsDigitizingDefaultSnapType = QgsSettingsEntryEnumFlag( QStringLiteral( "/qgis/digitizing/default_snap_type" ), QgsSettings::NoSection,  QgsSnappingConfig::VertexFlag );
