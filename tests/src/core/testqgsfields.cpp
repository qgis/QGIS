...
void TestQgsFields::copy()
{
  ...
  const QgsField copyfield( u"copyfield"_s );
...
void TestQgsFields::construct()
{
  ...
  QCOMPARE( fields.at( 0 ).name(), u"field1"_s );
  QCOMPARE( fields.at( 0 ).type(), QMetaType::Type::QString );
  QCOMPARE( fields.indexFromName( u"field1"_s ), 0 );
  QCOMPARE( fields.at( 1 ).name(), u"field2"_s );
  QCOMPARE( fields.at( 1 ).type(), QMetaType::Type::Int );
  QCOMPARE( fields.indexFromName( u"field2"_s ), 1 );
  QCOMPARE( fields.at( 2 ).name(), u"field3"_s );
...
void TestQgsFields::count()
{
  ...
  const QgsField field2( u"testfield2"_s );
...
void TestQgsFields::extend()
{
  ...
  QgsFields source;
  const QgsField field3( u"testfield3"_s );
  source.append( field3, Qgis::FieldOrigin::Join, 5 );
  const QgsField field4( u"testfield4"_s );
...
{
  QgsFields fields;
  QgsField field( u"testfield"_s );
  field.setAlias( u"testfieldAlias"_s );
  fields.append( field );
  const QgsField field2( u"testfield2"_s );
  fields.append( field2 );
  QgsField field3( u"testfield3"_s );
  ...
  const QgsField sameNameDifferentCase( u"teStFielD"_s ); //#spellok
...
void TestQgsFields::appendExpressionField()
{
  ...
  const QgsField dupeName( u"testfield"_s );
  QVERIFY( !fields.appendExpressionField( dupeName, 1 ) );

  //good name
  const QgsField exprField( u"expression"_s );
...
{
  QgsField original1;
  original1.setName( u"name"_s );
  original1.setType( QMetaType::Type::Int );
  original1.setLength( 5 );
  original1.setPrecision( 2 );
  original1.setTypeName( u"typename1"_s );
  original1.setComment( u"comment1"_s );

  QgsField original2;
  original2.setName( u"next name"_s );
  original2.setType( QMetaType::Type::Double );
  original2.setLength( 15 );
  original2.setPrecision( 3 );
  original2.setTypeName( u"double"_s );
  original2.setComment( u"comment for field 2"_s );
...
{
  QgsFields fields;
  const QgsField field( u"1"_s );
  fields.append( field );
  const QgsField field2( u"2"_s );
  fields.append( field2 );
...
void TestQgsFields::constIterator()
{
  ...
  const QgsField field( QString( u"1"_s ) );
  fields.append( field );
  const QgsField field2( QString( u"2"_s ) );
  fields.append( field2 );
...
void TestQgsFields::appendList()
{
  ...
  QVERIFY( fields.append(
    QList<QgsField> {
      QgsField( u"field4"_s, QMetaType::Type::QString ),
      QgsField( u"field5"_s, QMetaType::Type::Int ),
      QgsField( u"field6"_s, QMetaType::Type::Double ),
    },
...
void TestQgsFields::appendQgsFields()
{
  ...
  QgsFields fields2;
  fields2.append( QgsField( u"field1"_s, QMetaType::Type::QString ), Qgis::FieldOrigin::Edit, 2 );
  fields2.append( QgsField( u"field2"_s, QMetaType::Type::Int ), Qgis::FieldOrigin::Join, 4 );
  fields2.append( QgsField( u"field3"_s, QMetaType::Type::Double ), Qgis::FieldOrigin::Provider, 6 );
  ...
  QgsFields fields3;
  fields3.append( QgsField( u"field4"_s, QMetaType::Type::QString ), Qgis::FieldOrigin::Expression, 3 );
  fields3.append( QgsField( u"field5"_s, QMetaType::Type::Int ), Qgis::FieldOrigin::Join, 5 );
  fields3.append( QgsField( u"field6"_s, QMetaType::Type::Double ), Qgis::FieldOrigin::Provider, 7 );
