...
void TestQgsLabelingEngine::testRuleBased()
{
  ...
  s2.dataDefinedProperties().setProperty( static_cast<int>( QgsPalLayerSettings::Property::Size ), QgsProperty::fromValue( QStringLiteral( "18" ) ) );
...
void TestQgsLabelingEngine::zOrder()
{
  ...
  pls1.dataDefinedProperties().setProperty( static_cast<int>( QgsPalLayerSettings::Property::Color ), QgsProperty::fromExpression( QStringLiteral( "case when \"Class\"='Jet' then '#ff5500' when \"Class\"='B52' then '#00ffff' else '#ff00ff' end" ) ) );
  pls1.dataDefinedProperties().setProperty( static_cast<int>( QgsPalLayerSettings::Property::Size ), QgsProperty::fromExpression( QStringLiteral( "case when \"Class\"='Jet' then 100 when \"Class\"='B52' then 30 else 50 end" ) ) );
  ...
  pls1.dataDefinedProperties().setProperty( static_cast<int>( QgsPalLayerSettings::Property::ZIndex ), QgsProperty::fromExpression( QStringLiteral( "case when \"Class\"='Jet' then 3 when \"Class\"='B52' then 1 else 2 end" ) ) );
  ...
  engine.removeProvider( provider1 );
  pls1.dataDefinedProperties().setProperty( static_cast<int>( QgsPalLayerSettings::Property::ZIndex ), QgsProperty::fromExpression( QStringLiteral( "if(\"Class\"='Jet',3,0)" ) ) );
  provider1 = new QgsVectorLayerLabelProvider( vl, QString(), true, &pls1 );
  engine.addProvider( provider1 );
...
void TestQgsLabelingEngine::testLabelRotationUnit()
{
  ...
  settings.dataDefinedProperties().setProperty( static_cast<int>( QgsPalLayerSettings::Property::LabelRotation ), QgsProperty::fromExpression( QString::number( 3.14 / 2.0 ) ) );
...
void TestQgsLabelingEngine::labelingResultsWithCallouts()
{
  ...
  labelProps.setProperty( static_cast<int>( QgsPalLayerSettings::Property::PositionX ), QgsProperty::fromField( QStringLiteral( "labelx" ) ) );
  labelProps.setProperty( static_cast<int>( QgsPalLayerSettings::Property::PositionY ), QgsProperty::fromField( QStringLiteral( "labely" ) ) );
  ...
  calloutProps.setProperty( static_cast<int>( QgsCallout::Property::OriginX ), QgsProperty::fromField( QStringLiteral( "calloutoriginx" ) ) );
  calloutProps.setProperty( static_cast<int>( QgsCallout::Property::OriginY ), QgsProperty::fromField( QStringLiteral( "calloutoriginy" ) ) );
  calloutProps.setProperty( static_cast<int>( QgsCallout::Property::DestinationX ), QgsProperty::fromField( QStringLiteral( "calloutdestx" ) ) );
  calloutProps.setProperty( static_cast<int>( QgsCallout::Property::DestinationY ), QgsProperty::fromField( QStringLiteral( "calloutdesty" ) ) );
...
void TestQgsLabelingEngine::testDataDefinedLabelAllParts()
{
  ...
  settings.dataDefinedProperties().setProperty( static_cast<int>( QgsPalLayerSettings::Property::LabelAllParts ), QgsProperty::fromExpression( QStringLiteral( "\"id\" = 2" ) ) );
...
void TestQgsLabelingEngine::testDataDefinedPlacementPositionPoint()
{
  ...
  settings.dataDefinedProperties().setProperty( static_cast<int>( QgsPalLayerSettings::Property::PositionPoint ), QgsProperty::fromExpression( QStringLiteral( "translate($geometry, 1, 0.5)" ) ) );
...
void TestQgsLabelingEngine::testRotationBasedOrientationPoint()
{
  ...
  settings.fieldName = QStringLiteral( "Class" );
  setDefaultLabelParams( settings );
  settings.dataDefinedProperties().setProperty( static_cast<int>( QgsPalLayerSettings::Property::LabelRotation ), QgsProperty::fromExpression( QStringLiteral( "\"Heading\"" ) ) );
  QgsTextFormat format = settings.format();
...
void TestQgsLabelingEngine::testReferencedFields()
{
  ...
  settings.dataDefinedProperties().setProperty( static_cast<int>( QgsPalLayerSettings::Property::Size ), QgsProperty::fromField( QStringLiteral( "my_dd_size" ) ) );
...
void TestQgsLabelingEngine::testLineAnchorDataDefinedType()
{
  ...
  settings.lineSettings().setAnchorType( QgsLabelLineSettings::AnchorType::HintOnly );
  settings.dataDefinedProperties().setProperty( static_cast<int>( QgsPalLayerSettings::Property::LineAnchorType ), QgsProperty::fromExpression( QStringLiteral( "'strict'" ) ) );
  ...
  settings.lineSettings().setAnchorType( QgsLabelLineSettings::AnchorType::Strict );
  settings.dataDefinedProperties().setProperty( static_cast<int>( QgsPalLayerSettings::Property::LineAnchorType ), QgsProperty::fromExpression( QStringLiteral( "'hi' || 'nt'" ) ) );
