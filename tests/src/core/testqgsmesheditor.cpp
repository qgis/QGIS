...
void TestQgsMeshEditor::init()
{
  ...
  uri = QString( mDataDir + "/quad_flower.2dm" );
...
void TestQgsMeshEditor::startEditing()
{
...
{
  QCOMPARE( meshLayerQuadTriangle->meshVerticesCount(), 5 );
  ...
  QCOMPARE( meshLayerQuadTriangle->meshVerticesCount(), 6 );
  ...
  QVERIFY( error == QgsMeshEditingError() );
  QCOMPARE( meshLayerQuadTriangle->meshVerticesCount(), 7 );
  QCOMPARE( meshLayerQuadTriangle->meshFacesCount(), 3 );
  ...
  QVERIFY( error == QgsMeshEditingError() );
  QCOMPARE( meshLayerQuadTriangle->meshVerticesCount(), 7 );
  QCOMPARE( meshLayerQuadTriangle->meshFacesCount(), 4 );
  ...
  QCOMPARE( meshLayerQuadTriangle->meshFacesCount(), 4 ); //removed faces are still present but empty
  ...
  QCOMPARE( meshLayerQuadTriangle->meshVerticesCount(), 9 );
  QCOMPARE( meshLayerQuadTriangle->meshFacesCount(), 8 ); // vertex on a quad face : 4 faces created, 1 removed, removed are still present but void
  ...
  QCOMPARE( meshLayerQuadTriangle->meshVerticesCount(), 9 );
  QCOMPARE( meshLayerQuadTriangle->meshFacesCount(), 8 );
  ...
  QCOMPARE( meshLayerQuadTriangle->meshVerticesCount(), 9 ); //empty vertex still presents
  ...
  QCOMPARE( meshLayerQuadTriangle->meshVerticesCount(), 9 );
  QCOMPARE( meshLayerQuadTriangle->meshFacesCount(), 7 );
...
{
  QCOMPARE( meshLayerQuadFlower->meshVerticesCount(), 8 );
  QCOMPARE( meshLayerQuadFlower->meshFacesCount(), 5 );
  ...
  QCOMPARE( meshLayerQuadFlower->meshFacesCount(), 18 );
  QCOMPARE( meshLayerQuadFlower->meshVerticesCount(), 13 );
  ...
  QCOMPARE( meshLayerQuadFlower->meshFacesCount(), 22 );
  ...
  QCOMPARE( meshLayerQuadFlower->meshFacesCount(), 4 );
  QCOMPARE( meshLayerQuadFlower->meshVerticesCount(), 6 );
}
