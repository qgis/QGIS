...
void TestQgsTemporalProperty::checkSettingTemporalRange()
{
  QgsDateTimeRange dateTimeRange = QgsDateTimeRange();

  temporalProperty->setTemporalRange( dateTimeRange );

  QCOMPARE( temporalProperty->temporalRange(), dateTimeRange );
}
