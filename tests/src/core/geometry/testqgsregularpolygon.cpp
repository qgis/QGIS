...
void TestQgsRegularPolygon::constructors()
{
  ...
  rp2 = QgsRegularPolygon( QgsPoint( 0, 0 ), 5, 0, 2, QgsRegularPolygon::InscribedCircle );
  QVERIFY( rp2.isEmpty() );

  rp2 = QgsRegularPolygon( QgsPoint( 0, 0 ), 5, 0, 5, static_cast<QgsRegularPolygon::ConstructionOption>( 4 ) );
  QVERIFY( rp2.isEmpty() );
  ...
  rp3 = QgsRegularPolygon( QgsPoint( 0, 0 ), rp2.apothem(), 36.0, 5, QgsRegularPolygon::CircumscribedCircle );
...
void TestQgsRegularPolygon::points()
{
  ...
  rp = QgsRegularPolygon( QgsPoint( 0, 0 ), QgsPoint( 0, 5 ), 3, QgsRegularPolygon::InscribedCircle );
  points = rp.points();
...
void TestQgsRegularPolygon::conversions()
{
  ...
  circleExpected = QgsRegularPolygon( QgsPoint( 0, 0 ), rp.apothem(), 36.0, 5, QgsRegularPolygon::InscribedCircle ).circumscribedCircle();
  ...
  QgsRegularPolygon rp2;
  rp2 = QgsRegularPolygon( QgsPoint( 0, 0 ), QgsPoint( 0, 5 ), 1, QgsRegularPolygon::InscribedCircle );
