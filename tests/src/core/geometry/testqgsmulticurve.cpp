...
void TestQgsMultiCurve::addGeometryZM()
{
  ...
  QgsMultiCurve mc;
  QgsCircularString part;
  part.setPoints( QgsPointSequence() << QgsPoint( Qgis::WkbType::PointZ, 10, 11, 1 ) << QgsPoint( Qgis::WkbType::PointZ, 20, 21, 2 ) << QgsPoint( Qgis::WkbType::PointZ, 10, 31, 3 ) );
  mc.addGeometry( part.clone() );
  ...
  mc.clear();
  part.setPoints( QgsPointSequence() << QgsPoint( Qgis::WkbType::PointM, 10, 11, 0, 1 ) << QgsPoint( Qgis::WkbType::PointM, 20, 21, 0, 2 ) << QgsPoint( Qgis::WkbType::PointM, 10, 31, 0, 3 ) );
  mc.addGeometry( part.clone() );
  ...
  mc.clear();
  part.setPoints( QgsPointSequence() << QgsPoint( Qgis::WkbType::PointZM, 10, 11, 2, 1 ) << QgsPoint( Qgis::WkbType::PointZM, 20, 21, 3, 2 ) << QgsPoint( Qgis::WkbType::PointZM, 10, 31, 4, 5 ) );
  mc.addGeometry( part.clone() );
...
void TestQgsMultiCurve::addGeometryDimensionPreservation()
{
  ...
  part.setPoints( QgsPointSequence() << QgsPoint( Qgis::WkbType::PointM, 21, 30, 0, 2 ) << QgsPoint( Qgis::WkbType::PointM, 32, 41, 0, 3 ) << QgsPoint( Qgis::WkbType::PointM, 21, 51, 0, 4 ) );
  mc.addGeometry( part.clone() );
...
void TestQgsMultiCurve::addGeometryDimensionPreservationZ()
{
  ...
  part.setPoints( QgsPointSequence() << QgsPoint( Qgis::WkbType::PointM, 5, 50, 0, 4 ) << QgsPoint( Qgis::WkbType::PointM, 6, 61, 0, 5 ) << QgsPoint( Qgis::WkbType::PointM, 5, 71, 0, 6 ) );
  mc.addGeometry( part.clone() );
...
void TestQgsMultiCurve::addGeometryDimensionPreservationM()
{
  ...
  part.setPoints( QgsPointSequence() << QgsPoint( Qgis::WkbType::PointM, 5, 50, 0, 4 ) << QgsPoint( Qgis::WkbType::PointM, 6, 61, 0, 5 ) << QgsPoint( Qgis::WkbType::PointM, 5, 71, 0, 5 ) );
  mc.addGeometry( part.clone() );
...
void TestQgsMultiCurve::addGeometryDimensionPreservationZM()
{
  QgsMultiCurve mc;
  QgsCircularString part;
  part.setPoints( QgsPointSequence() << QgsPoint( Qgis::WkbType::PointZM, 5, 50, 1, 4 ) << QgsPoint( Qgis::WkbType::PointZM, 6, 61, 3, 5 ) << QgsPoint( Qgis::WkbType::PointZM, 5, 71, 4, 6 ) );
  mc.addGeometry( part.clone() );

  QCOMPARE( mc.wkbType(), Qgis::WkbType::MultiCurveZM );

  part.setPoints( QgsPointSequence() << QgsPoint( Qgis::WkbType::Point, 7, 17 ) << QgsPoint( Qgis::WkbType::Point, 3, 13 ) << QgsPoint( Qgis::WkbType::Point, 7, 11 ) );
  mc.addGeometry( part.clone() );
  ...
  part.setPoints( QgsPointSequence() << QgsPoint( Qgis::WkbType::PointZ, 77, 87, 7 ) << QgsPoint( Qgis::WkbType::PointZ, 83, 83, 8 ) << QgsPoint( Qgis::WkbType::PointZ, 77, 81, 9 ) );
  mc.addGeometry( part.clone() );
  ...
  part.setPoints( QgsPointSequence() << QgsPoint( Qgis::WkbType::PointM, 177, 187, 0, 9 ) << QgsPoint( Qgis::WkbType::PointM, 183, 183, 0, 11 ) << QgsPoint( Qgis::WkbType::PointM, 177, 181, 0, 13 ) );
  mc.addGeometry( part.clone() );
...
void TestQgsMultiCurve::insertGeometry()
{
  ...
  QgsCircularString part;
  part.setPoints( QgsPointSequence() << QgsPoint( Qgis::WkbType::PointZM, 27, 37, 6, 2 ) << QgsPoint( Qgis::WkbType::PointZM, 43, 43, 11, 5 ) << QgsPoint( Qgis::WkbType::PointZM, 27, 53, 21, 52 ) );
...
void TestQgsMultiCurve::curveN()
{
  ...
  QgsCircularString part;
  part.setPoints( QgsPointSequence() << QgsPoint( 7, 17 ) << QgsPoint( 3, 13 ) << QgsPoint( 7, 11 ) );
  mc.addGeometry( part.clone() );
...
void TestQgsMultiCurve::cast()
{
  ...
  QgsMultiCurve mc2;
  mc2.fromWkt( u"MultiCurveZ()"_s );
  QVERIFY( QgsMultiCurve::cast( &mc2 ) );
  QVERIFY( QgsGeometryCollection::cast( &mc2 ) );

  mc2.fromWkt( u"MultiCurveM()"_s );
  QVERIFY( QgsMultiCurve::cast( &mc2 ) );
  QVERIFY( QgsGeometryCollection::cast( &mc2 ) );

  mc2.fromWkt( u"MultiCurveZM()"_s );
  QVERIFY( QgsMultiCurve::cast( &mc2 ) );
  QVERIFY( QgsGeometryCollection::cast( &mc2 ) );
}
...
void TestQgsMultiCurve::boundary()
{
  ...
  cs.setPoints( QgsPointSequence() << QgsPoint( 10, 10 ) << QgsPoint( 11, 10 ) << QgsPoint( 11, 11 ) );
  mc.addGeometry( cs.clone() );
  ...
  cs.setPoints( QgsPointSequence() << QgsPoint( 20, 20 ) << QgsPoint( 21, 20 ) << QgsPoint( 20, 20 ) );
  mc.addGeometry( cs.clone() );
  ...
  cs.setPoints( QgsPointSequence() << QgsPoint( Qgis::WkbType::PointZ, 10, 10, 100 ) << QgsPoint( Qgis::WkbType::PointZ, 10, 20, 150 ) << QgsPoint( Qgis::WkbType::PointZ, 20, 20, 200 ) );
  mc.addGeometry( cs.clone() );
...
void TestQgsMultiCurve::reversed()
{
  ...
  QgsCircularString part;
  part.setPoints( QgsPointSequence() << QgsPoint( Qgis::WkbType::PointZM, 7, 17, 4, 1 ) << QgsPoint( Qgis::WkbType::PointZM, 3, 13, 1, 4 ) << QgsPoint( Qgis::WkbType::PointZM, 7, 11, 2, 8 ) );
  mc.addGeometry( part.clone() );
...
void TestQgsMultiCurve::toFromWKB()
{
  ...
  part.setPoints( QgsPointSequence() << QgsPoint( Qgis::WkbType::Point, 27, 37 ) << QgsPoint( Qgis::WkbType::Point, 43, 43 ) << QgsPoint( Qgis::WkbType::Point, 27, 54 ) );
  mc1.addGeometry( part.clone() );
  ...
  QCOMPARE( mc2.numGeometries(), 2 );
  QCOMPARE( *static_cast<const QgsCircularString *>( mc2.geometryN( 0 ) ), *static_cast<const QgsCircularString *>( mc1.geometryN( 0 ) ) );
  QCOMPARE( *static_cast<const QgsCircularString *>( mc2.geometryN( 1 ) ), *static_cast<const QgsCircularString *>( mc1.geometryN( 1 ) ) );
...
void TestQgsMultiCurve::toFromWKBWithZM()
{
  ...
  QgsCircularString part;
  part.setPoints( QgsPointSequence() << QgsPoint( Qgis::WkbType::PointZ, 7, 17, 1 ) << QgsPoint( Qgis::WkbType::PointZ, 3, 13, 4 ) << QgsPoint( Qgis::WkbType::PointZ, 7, 11, 3 ) );
  mc1.addGeometry( part.clone() );

  part.setPoints( QgsPointSequence() << QgsPoint( Qgis::WkbType::PointZ, 27, 37, 2 ) << QgsPoint( Qgis::WkbType::PointZ, 43, 43, 5 ) << QgsPoint( Qgis::WkbType::PointZ, 27, 53, 6 ) );
  mc1.addGeometry( part.clone() );
  ...
  part.setPoints( QgsPointSequence() << QgsPoint( Qgis::WkbType::PointM, 7, 17, 0, 1 ) << QgsPoint( Qgis::WkbType::PointM, 3, 13, 0, 4 ) << QgsPoint( Qgis::WkbType::PointM, 7, 11, 0, 5 ) );
  mc1.addGeometry( part.clone() );
  ...
  part.setPoints( QgsPointSequence() << QgsPoint( Qgis::WkbType::PointZM, 7, 17, 4, 1 ) << QgsPoint( Qgis::WkbType::PointZM, 3, 13, 1, 4 ) << QgsPoint( Qgis::WkbType::PointZM, 7, 11, 2, 5 ) );
  mc1.addGeometry( part.clone() );

  part.setPoints( QgsPointSequence() << QgsPoint( Qgis::WkbType::PointZM, 27, 37, 6, 2 ) << QgsPoint( Qgis::WkbType::PointZM, 43, 43, 11, 5 ) << QgsPoint( Qgis::WkbType::PointZM, 27, 47, 12, 15 ) );
  mc1.addGeometry( part.clone() );
...
void TestQgsMultiCurve::exportImport()
{
  ...
  part.setPoints( QgsPointSequence() << QgsPoint( Qgis::WkbType::Point, 27, 37 ) << QgsPoint( Qgis::WkbType::Point, 43, 43 ) << QgsPoint( Qgis::WkbType::Point, 27, 47 ) );
  exportC.addGeometry( part.clone() );
  ...
  QString expectedSimpleGML3(
    u"<MultiCurve xmlns=\"gml\"><curveMember xmlns=\"gml\"><Curve xmlns=\"gml\"><segments xmlns=\"gml\"><ArcString xmlns=\"gml\"><posList xmlns=\"gml\" srsDimension=\"2\">7 17 3 13 7 11</posList></ArcString></segments></Curve></curveMember><curveMember xmlns=\"gml\"><Curve xmlns=\"gml\"><segments xmlns=\"gml\"><ArcString xmlns=\"gml\"><posList xmlns=\"gml\" srsDimension=\"2\">27 37 43 43 27 47</posList></ArcString></segments></Curve></curveMember></MultiCurve>"_s
  );
  ...
  QString expectedGML3prec3(
    u"<MultiCurve xmlns=\"gml\"><curveMember xmlns=\"gml\"><Curve xmlns=\"gml\"><segments xmlns=\"gml\"><ArcString xmlns=\"gml\"><posList xmlns=\"gml\" srsDimension=\"2\">2.333 5.667 0.6 4.333 2.333 3.667</posList></ArcString></segments></Curve></curveMember><curveMember xmlns=\"gml\"><Curve xmlns=\"gml\"><segments xmlns=\"gml\"><ArcString xmlns=\"gml\"><posList xmlns=\"gml\" srsDimension=\"2\">9 4.111 1.049 1.024 9 0.333</posList></ArcString></segments></Curve></curveMember></MultiCurve>"_s
  );
