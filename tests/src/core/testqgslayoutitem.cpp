...
void TestQgsLayoutItem::dataDefinedPosition()
{
  ...
  // position x
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::PositionX ), QgsProperty::fromExpression( QStringLiteral( "4+7" ) ) );
  ...
  //position y
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::PositionY ), QgsProperty::fromExpression( QStringLiteral( "2+3" ) ) );
  ...
  item->setPos( 0, 0 );
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::PositionX ), QgsProperty::fromExpression( QStringLiteral( "4+8" ) ) );
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::PositionY ), QgsProperty::fromExpression( QStringLiteral( "2+4" ) ) );
  ...
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::PositionX ), QgsProperty::fromExpression( QStringLiteral( "4+8" ) ) );
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::PositionY ), QgsProperty() );
  ...
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::PositionX ), QgsProperty() );
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::PositionY ), QgsProperty::fromExpression( QStringLiteral( "2+4" ) ) );
  ...
  item->setPos( 0, 0 );
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::PositionX ), QgsProperty::fromExpression( QStringLiteral( "6+10" ) ) );
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::PositionY ), QgsProperty::fromExpression( QStringLiteral( "2+6" ) ) );
  item->refreshItemPosition();
...
void TestQgsLayoutItem::dataDefinedSize()
{
  ...
  //width
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ItemWidth ), QgsProperty::fromExpression( QStringLiteral( "4+7" ) ) );
  ...
  //height
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ItemHeight ), QgsProperty::fromExpression( QStringLiteral( "2+3" ) ) );
  ...
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ItemWidth ), QgsProperty::fromExpression( QStringLiteral( "4+8" ) ) );
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ItemHeight ), QgsProperty::fromExpression( QStringLiteral( "2+4" ) ) );
  ...
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ItemWidth ), QgsProperty::fromExpression( QStringLiteral( "4+8" ) ) );
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ItemHeight ), QgsProperty() );
  item->attemptResize( QgsLayoutSize( 6.0, 1.50, Qgis::LayoutUnit::Centimeters ) );
  QCOMPARE( item->sizeWithUnits().width(), 12.0 );
  ...
  //restriction only for y position
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ItemWidth ), QgsProperty() );
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ItemHeight ), QgsProperty::fromExpression( QStringLiteral( "2+4" ) ) );
  ...
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ItemWidth ), QgsProperty() );
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ItemHeight ), QgsProperty() );
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::PresetPaperSize ), QgsProperty::fromValue( QStringLiteral( "A5" ) ) );
  item->attemptResize( QgsLayoutSize( 7.0, 1.50, Qgis::LayoutUnit::Centimeters ) );
  ...
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ItemWidth ), QgsProperty::fromValue( "13.0" ) );
  item->attemptResize( QgsLayoutSize( 7.0, 1.50, Qgis::LayoutUnit::Centimeters ) );
  ...
  QCOMPARE( item->rect().height(), 210.0 ); //mm
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ItemHeight ), QgsProperty::fromValue( "3.0" ) );
  item->attemptResize( QgsLayoutSize( 7.0, 1.50, Qgis::LayoutUnit::Centimeters ) );
  QCOMPARE( item->sizeWithUnits().width(), 13.0 );
  ...
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::PaperOrientation ), QgsProperty::fromValue( "portrait" ) );
  item->attemptResize( QgsLayoutSize( 7.0, 1.50, Qgis::LayoutUnit::Centimeters ) );
  ...
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ItemWidth ), QgsProperty() );
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ItemHeight ), QgsProperty() );
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::PresetPaperSize ), QgsProperty() );
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::PaperOrientation ), QgsProperty::fromValue( "landscape" ) );
  ...
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::PaperOrientation ), QgsProperty() );
  ...
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ItemWidth ), QgsProperty::fromExpression( QStringLiteral( "5" ) ) );
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ItemHeight ), QgsProperty::fromExpression( QStringLiteral( "6" ) ) );
  item->setReferencePoint( QgsLayoutItem::LowerRight );
  item->refreshItemSize();
  ...
  item->attemptMove( QgsLayoutPoint( 20.0, 10.0, Qgis::LayoutUnit::Millimeters ) );
  item->setReferencePoint( QgsLayoutItem::LowerRight );
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ItemWidth ), QgsProperty::fromExpression( QStringLiteral( "7" ) ) );
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ItemHeight ), QgsProperty::fromExpression( QStringLiteral( "9" ) ) );
  item->refreshItemSize();
...
void TestQgsLayoutItem::combinedDataDefinedPositionAndSize()
{
  ...
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::PositionX ), QgsProperty::fromExpression( QStringLiteral( "4+7" ) ) );
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::PositionY ), QgsProperty::fromExpression( QStringLiteral( "2+3" ) ) );
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ItemWidth ), QgsProperty::fromExpression( QStringLiteral( "4+9" ) ) );
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ItemHeight ), QgsProperty::fromExpression( QStringLiteral( "2+4" ) ) );
  ...
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::PositionX ), QgsProperty::fromExpression( QStringLiteral( "4+8" ) ) );
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::PositionY ), QgsProperty::fromExpression( QStringLiteral( "2+4" ) ) );
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ItemWidth ), QgsProperty::fromExpression( QStringLiteral( "3+7" ) ) );
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ItemHeight ), QgsProperty::fromExpression( QStringLiteral( "1+3" ) ) );
  item->refreshDataDefinedProperty( QgsLayoutObject::DataDefinedProperty::AllProperties );
  QCOMPARE( item->positionWithUnits().x(), 12.0 );
  QCOMPARE( item->positionWithUnits().y(), 6.0 );
  QCOMPARE( item->positionWithUnits().units(), Qgis::LayoutUnit::Centimeters );
...
void TestQgsLayoutItem::rotation()
{
  ...
  item->attemptMove( QgsLayoutPoint( 5.0, 8.0 ) );
  item->attemptResize( QgsLayoutSize( 10.0, 6.0 ) );
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ItemRotation ), QgsProperty::fromExpression( QStringLiteral( "90" ) ) );
  ...
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ItemRotation ), QgsProperty::fromExpression( QStringLiteral( "180" ) ) );
  item->refreshDataDefinedProperty( QgsLayoutObject::DataDefinedProperty::AllProperties );
  QCOMPARE( item->itemRotation(), 0.0 ); // should be unchanged
...
void TestQgsLayoutItem::writeReadXmlProperties()
{
  ...
  original->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::TestProperty ), QgsProperty::fromExpression( QStringLiteral( "10 + 40" ) ) );
  ...
  const QgsProperty dd = copy->dataDefinedProperties().property( static_cast< int >( QgsLayoutObject::DataDefinedProperty::TestProperty ) );
  QVERIFY( dd );
  QVERIFY( dd.isActive() );
...
void TestQgsLayoutItem::blendMode()
{
  ...
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::BlendMode ), QgsProperty::fromExpression( "'lighten'" ) );
...
void TestQgsLayoutItem::opacity()
{
  ...
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::Opacity ), QgsProperty::fromExpression( "35" ) );
  item->refreshDataDefinedProperty();
...
void TestQgsLayoutItem::excludeFromExports()
{
  ...
  item->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ExcludeFromExports ), QgsProperty::fromExpression( "1" ) );
  item->refreshDataDefinedProperty();
