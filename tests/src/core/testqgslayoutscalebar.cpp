...
void TestQgsLayoutScaleBar::dataDefined()
{
  ...
  scalebar->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarFillColor ), QgsProperty::fromExpression( QStringLiteral( "'red'" ) ) );
  scalebar->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarFillColor2 ), QgsProperty::fromExpression( QStringLiteral( "'blue'" ) ) );
  scalebar->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarLineColor ), QgsProperty::fromExpression( QStringLiteral( "'yellow'" ) ) );
  scalebar->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarLineWidth ), QgsProperty::fromExpression( QStringLiteral( "1.2*3" ) ) );
  ...
  scalebar->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarLeftSegments ), QgsProperty::fromExpression( QStringLiteral( "0" ) ) );
  scalebar->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarRightSegments ), QgsProperty::fromExpression( QStringLiteral( "length('Hi')" ) ) ); // basic expression -> 2
  scalebar->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarSegmentWidth ), QgsProperty::fromExpression( QStringLiteral( "1000.0 * 2.0" ) ) );  // basic math expression -> 2
  scalebar->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarMinimumWidth ), QgsProperty::fromExpression( QStringLiteral( "to_real('50.0')" ) ) );   // basic conversion expression -> 50
  scalebar->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarMaximumWidth ), QgsProperty::fromExpression( QStringLiteral( "to_real('50.0') * 3" ) ) ); // basic conversion with math expression -> 150
  scalebar->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarHeight ), QgsProperty::fromExpression( QStringLiteral( "20" ) ) );
  scalebar->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarSubdivisionHeight ), QgsProperty::fromExpression( QStringLiteral( "30" ) ) );
  scalebar->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarRightSegmentSubdivisions ), QgsProperty::fromExpression( QStringLiteral( "40" ) ) );
...
void TestQgsLayoutScaleBar::oldDataDefinedProject()
{
  ...
  QVERIFY( sll->dataDefinedProperties().property( static_cast< int >( QgsSymbolLayer::Property::StrokeWidth ) ).isActive() );
  QCOMPARE( sll->dataDefinedProperties().property( static_cast< int >( QgsSymbolLayer::Property::StrokeWidth ) ).asExpression(), QStringLiteral( "3" ) );
  QVERIFY( sll->dataDefinedProperties().property( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ) ).isActive() );
  QCOMPARE( sll->dataDefinedProperties().property( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ) ).asExpression(), QStringLiteral( "'red'" ) );

  // deprecated properties should be gone
  QVERIFY( !scaleBar->dataDefinedProperties().property( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarLineColor ) ).isActive() );
  QVERIFY( !scaleBar->dataDefinedProperties().property( static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarLineWidth ) ).isActive() );
}
...
void TestQgsLayoutScaleBar::textFormat()
{
  ...
  format.setSize( 16 );
  format.dataDefinedProperties().setProperty( static_cast< int >( QgsPalLayerSettings::Property::Color ), QgsProperty::fromExpression( QStringLiteral( "case when @scale_value = 2000 then '#ff00ff' else '#ffff00' end" ) ) );
  scalebar->setTextFormat( format );
