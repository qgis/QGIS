...
void TestQgsLayerTree::testShowHideAllSymbolNodes()
{
  ...
  renderer->setSourceSymbol( QgsSymbol::defaultSymbol( QgsWkbTypes::GeometryType::PointGeometry ) );
  renderer->addCategory( QgsRendererCategory( "a", QgsSymbol::defaultSymbol( QgsWkbTypes::GeometryType::PointGeometry ), QStringLiteral( "a" ) ) );
  renderer->addCategory( QgsRendererCategory( "b", QgsSymbol::defaultSymbol( QgsWkbTypes::GeometryType::PointGeometry ), QStringLiteral( "b" ) ) );
  renderer->addCategory( QgsRendererCategory( "c", QgsSymbol::defaultSymbol( QgsWkbTypes::GeometryType::PointGeometry ), QStringLiteral( "c" ) ) );
...
void TestQgsLayerTree::testSymbolText()
{
  ...
  renderer->setClassAttribute( QStringLiteral( "col1" ) );
  renderer->setSourceSymbol( QgsSymbol::defaultSymbol( QgsWkbTypes::GeometryType::PointGeometry ) );
  renderer->addCategory( QgsRendererCategory( "a", QgsSymbol::defaultSymbol( QgsWkbTypes::GeometryType::PointGeometry ), QStringLiteral( "a [% 1 + 2 %]" ) ) );
  renderer->addCategory( QgsRendererCategory( "b", QgsSymbol::defaultSymbol( QgsWkbTypes::GeometryType::PointGeometry ), QStringLiteral( "b,c" ) ) );
  renderer->addCategory( QgsRendererCategory( "c", QgsSymbol::defaultSymbol( QgsWkbTypes::GeometryType::PointGeometry ), QStringLiteral( "c" ) ) );
  vl->setRenderer( renderer );
