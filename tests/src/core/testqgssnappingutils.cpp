...
class TestQgsSnappingUtils : public QObject
{
  ...
  private slots:
    ...
    void testSnapModeAdvanced()
    {
      ...
      snappingConfig.setIndividualLayerSettings( mVL, QgsSnappingConfig::IndividualLayerSettings( true, Qgis::SnappingType::Vertex, 10, Qgis::MapUnitType::Pixels, -1.0, -1.0 ) );
      u.setConfig( snappingConfig );
    ...
    void testSnapOnIntersection()
    {
      ...
      snappingConfig.setEnabled( true );
      snappingConfig.setMode( Qgis::SnappingMode::AdvancedConfiguration );
      const QgsSnappingConfig::IndividualLayerSettings layerSettings( true, Qgis::SnappingType::Vertex, 0.1, Qgis::MapUnitType::Project, 0.0, 0.0 );
    ...
    void testSnapOnIntersectionCurveZ()
    {
      ...
      snappingConfig.setEnabled( true );
      snappingConfig.setMode( Qgis::SnappingMode::AdvancedConfiguration );
      const QgsSnappingConfig::IndividualLayerSettings layerSettings( true, Qgis::SnappingType::Vertex, 0.2, Qgis::MapUnitType::Project, 0.0, 0.0 );
      snappingConfig.setIntersectionSnapping( true );
    ...
    void testSnapOnCentroidAndMiddleSegment()
    {
      ...
      snappingConfig.setEnabled( true );
      snappingConfig.setMode( Qgis::SnappingMode::AdvancedConfiguration );
      const QgsSnappingConfig::IndividualLayerSettings layerSettings( true, static_cast<Qgis::SnappingTypes>( Qgis::SnappingType::MiddleOfSegment | Qgis::SnappingType::Centroid ), 0.2, Qgis::MapUnitType::Project, 0.0, 0.0 );
    ...
    void testSnapOnLineEndpoints()
    {
      ...
      snappingConfig.setEnabled( true );
      snappingConfig.setMode( Qgis::SnappingMode::AdvancedConfiguration );
      const QgsSnappingConfig::IndividualLayerSettings layerSettings( true, static_cast<Qgis::SnappingTypes>( Qgis::SnappingType::LineEndpoint ), 0.2, Qgis::MapUnitType::Project, 0.0, 0.0 );
      snappingConfig.setIndividualLayerSettings( vSnapCentroidMiddle.get(), layerSettings );
      u.setConfig( snappingConfig );
    ...
    void testSnapScaleDependency()
    {
      ...
      snappingConfig.setIndividualLayerSettings( mVL, QgsSnappingConfig::IndividualLayerSettings( true, Qgis::SnappingType::Vertex, 10, Qgis::MapUnitType::Pixels, 10000.0, 1000.0 ) );
      u.setConfig( snappingConfig );
      ...
      snappingConfig.setScaleDependencyMode( QgsSnappingConfig::PerLayer );
      snappingConfig.setIndividualLayerSettings( mVL, QgsSnappingConfig::IndividualLayerSettings( true, Qgis::SnappingType::Vertex, 10, Qgis::MapUnitType::Pixels, 100000.0, 1000.0 ) );
      u.setConfig( snappingConfig );
