...
class TestQgsSnappingUtils : public QObject
{
  ...
  private slots:
    ...
    void testSnapModeCurrent()
    {
      ...
      snappingConfig.setTypeV2( QgsSnappingConfig::SnappingTypeV2::VertexV2 );
      u.setConfig( snappingConfig );
    ...
    void testSnapModeAdvanced()
    {
      ...
      snappingConfig.setIndividualLayerSettings( mVL, QgsSnappingConfig::IndividualLayerSettings( true, QgsSnappingConfig::SnappingTypeV2::VertexV2, 10, QgsTolerance::Pixels ) );
      u.setConfig( snappingConfig );
    ...
    void testSnapOnIntersection()
    {
      ...
      snappingConfig.setEnabled( true );
      snappingConfig.setMode( QgsSnappingConfig::AdvancedConfiguration );
      QgsSnappingConfig::IndividualLayerSettings layerSettings( true, QgsSnappingConfig::SnappingTypeV2::VertexV2, 0.1, QgsTolerance::ProjectUnits );
    ...
    void testSnapOnIntersectionCurveZ()
    {
      ...
      snappingConfig.setEnabled( true );
      snappingConfig.setMode( QgsSnappingConfig::AdvancedConfiguration );
      QgsSnappingConfig::IndividualLayerSettings layerSettings( true, QgsSnappingConfig::SnappingTypeV2::VertexV2, 0.2, QgsTolerance::ProjectUnits );
      snappingConfig.setIntersectionSnapping( true );
    ...
    void testSnapOnCentroidAndMiddleSegment()
    {
      ...
      snappingConfig.setEnabled( true );
      snappingConfig.setMode( QgsSnappingConfig::AdvancedConfiguration );
      QgsSnappingConfig::IndividualLayerSettings layerSettings( true, static_cast<QgsSnappingConfig::SnappingTypeV2>( QgsSnappingConfig::SnappingTypeV2::MiddleOfSegment | QgsSnappingConfig::SnappingTypeV2::Centroid ), 0.2, QgsTolerance::ProjectUnits );
