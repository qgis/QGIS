...
void TestQgsImageCache::fillCache()
{
  ...
  QString imagePath = TEST_DATA_DIR + QStringLiteral( "/sample_image.png" );
  ...
  {
    QImage image = cache.pathAsImage( imagePath, QSize( size, size ), true, fitInCache );
...
struct RenderImageWrapper
{
  ...
  {
    bool fitInCache = false;
    QImage im = cache.pathAsImage( imagePath, size, true, fitInCache );
...
void TestQgsImageCache::changeImage()
{
  ...
  QString tempImagePath = QDir::tempPath() + "/test_sample_image.png";
  ...
  QString newImage = TEST_DATA_DIR + QStringLiteral( "/sample_image2.png" );
  QFile::remove( tempImagePath );
  QFile::copy( newImage, tempImagePath );

  //re-render it
  img = cache.pathAsImage( tempImagePath, QSize( 200, 200 ), true, inCache );
...
void TestQgsImageCache::base64()
{
  ...
  QSize size = cache.originalSize( QStringLiteral( "base64:" ) );
