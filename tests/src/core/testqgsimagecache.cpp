...
class TestQgsImageCache : public QgsTest
{
  ...
  public:
    TestQgsImageCache()
      : QgsTest( QStringLiteral( "QgsImageCache Tests" ) ) {}
...
void TestQgsImageCache::htmlDataUrl()
{
  ...
  QVERIFY( !QgsImageCache::parseBase64DataUrl( testDataPath( QStringLiteral( "/cmyk.jpg" ) ) ) );
  QVERIFY( !QgsImageCache::isBase64Data( testDataPath( QStringLiteral( "/cmyk.jpg" ) ) ) );
  QVERIFY( QgsImageCache::isBase64Data( QStringLiteral( "base64:zzzzzzzzzzzzzzz" ) ) );
  QVERIFY( QgsImageCache::isBase64Data( QStringLiteral( "data:image/jpeg;base64,SGVsbG8sIFdvcmxkIQ==" ) ) );

  QString mimeType;
  QString base64Data;
  QVERIFY( QgsImageCache::parseBase64DataUrl( QStringLiteral( "data:image/jpeg;base64,SGVsbG8sIFdvcmxkIQ==" ), &mimeType, &base64Data ) );
  QCOMPARE( mimeType, QStringLiteral( "image/jpeg" ) );
  QCOMPARE( base64Data, QStringLiteral( "SGVsbG8sIFdvcmxkIQ==" ) );

  // "base64" string is optional
  QVERIFY( QgsImageCache::parseBase64DataUrl( QStringLiteral( "data:image/jpeg,SGVsbG8sIFdvcmxkIQ==" ), &mimeType, &base64Data ) );
  QCOMPARE( mimeType, QStringLiteral( "image/jpeg" ) );
  QCOMPARE( base64Data, QStringLiteral( "SGVsbG8sIFdvcmxkIQ==" ) );

  QgsImageCache cache;
  bool inCache = false;
  const QImage img = cache.pathAsImage( QStringLiteral( "data:image/jpeg;base64," ), QSize( 200, 200 ), true, 1.0, inCache );
  QVERIFY( imageCheck( QStringLiteral( "imagecache_base64" ), img, 30 ) );
  const QSize size = cache.originalSize( QStringLiteral( "base64:" ) );
  QCOMPARE( size.width(), 60 );
  QCOMPARE( size.height(), 60 );
