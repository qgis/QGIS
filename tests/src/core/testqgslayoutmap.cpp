...
void TestQgsLayoutMap::dataDefinedLayers()
{
  ...
  map->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapLayers ), QgsProperty::fromExpression( QStringLiteral( "'x'" ) ) );
  ...
  map->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapLayers ), QgsProperty::fromExpression(
  ...
  map->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapLayers ), QgsProperty::fromField( QStringLiteral( "col1" ) ) );
  result = map->layersToRender();
...
void TestQgsLayoutMap::dataDefinedStyles()
{
  ...
  map->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapStylePreset ), QgsProperty::fromExpression( QStringLiteral( "5" ) ) );
  result = qgis::listToSet( map->layersToRender() );
  QCOMPARE( result, qgis::listToSet( layers ) );

  //test valid preset
  map->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapStylePreset ), QgsProperty::fromExpression( QStringLiteral( "'test preset'" ) ) );
  result = qgis::listToSet( map->layersToRender() );
  QCOMPARE( result.count(), 2 );
  QVERIFY( result.contains( mLinesLayer ) );
  QVERIFY( result.contains( mPointsLayer ) );
  ...
  map->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapStylePreset ), QgsProperty::fromExpression( QStringLiteral( "'bad preset'" ) ) );
  result = qgis::listToSet( map->layersToRender() );
  QCOMPARE( result, qgis::listToSet( layers ) );
  ...
  QCOMPARE( result.count(), 1 );
  QVERIFY( result.contains( mPolysLayer ) );
  map->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapLayers ), QgsProperty() );
...
void TestQgsLayoutMap::dataDefinedCrs()
{
  ...
  //test epsg variable
  map->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapCrs ), QgsProperty::fromValue( QStringLiteral( "EPSG:2192" ) ) );
  ...
  map->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapCrs ), QgsProperty::fromValue( QStringLiteral( "PROJ4: +proj=merc +a=6378137 +b=6378137 +lat_ts=0.0 +lon_0=0.0 +x_0=0.0 +y_0=0 +k=1.0 +units=m +nadgrids=@null +wktext  +no_defs" ) ) );
  map->refreshDataDefinedProperty( QgsLayoutObject::DataDefinedProperty::MapCrs );
...
void TestQgsLayoutMap::dataDefinedTemporalRange()
{
  ...
  map->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::StartDateTime ), QgsProperty::fromValue( dt1 ) );
  map->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::EndDateTime ), QgsProperty::fromValue( dt2 ) );
