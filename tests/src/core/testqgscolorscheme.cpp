...
{
  DummyColorScheme* dummyScheme = new DummyColorScheme();
  QList< QPair< QColor, QString > > colors = dummyScheme->fetchColors();
...
void TestQgsColorScheme::colorsWithBase()
{
  ...
  QList< QPair< QColor, QString > > colors = dummyScheme->fetchColors( QString(), testColor );
...
{
  DummyColorScheme* dummyScheme = new DummyColorScheme();
  QList< QPair< QColor, QString > > colors = dummyScheme->fetchColors( QString( "testscheme" ) );
  QCOMPARE( colors.length(), 1 );
...
void TestQgsColorScheme::clone()
{
  ...
  QList< QPair< QColor, QString > > colors2 = dummyScheme2->fetchColors();
