...
void TestQgsLayoutPicture::pictureExpression()
{
  ...
  mPicture->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::PictureSource ), QgsProperty::fromExpression( expr ) );
  ...
  mLayout->removeItem( mPicture );
  mPicture->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::PictureSource ), QgsProperty() );
}
...
void TestQgsLayoutPicture::pictureInvalidExpression()
{
  ...
  mPicture->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::PictureSource ), QgsProperty::fromValue( QString() ) );
  mPicture->refreshPicture();
  QVERIFY( !mPicture->isMissingImage() );
...
void TestQgsLayoutPicture::valid()
{
  ...
  picture->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::PictureSource ), QgsProperty::fromExpression( QStringLiteral( "'%1'" ).arg( mSvgImage ) ) );
  ...
  picture->dataDefinedProperties().setProperty( static_cast< int >( QgsLayoutObject::DataDefinedProperty::PictureSource ), QgsProperty::fromExpression( QStringLiteral( "'bad'" ) ) );
  picture->refreshPicture();
  QVERIFY( picture->isMissingImage() );
  QCOMPARE( picture->evaluatedPath(), QStringLiteral( "bad" ) );
  QCOMPARE( picture->mode(), QgsLayoutItemPicture::FormatUnknown );
