...
void TestQgsGeoNodeConnection::initTestCase()
{
  ...
  QgsOwsConnection::settingsUrl->setValue( mDemoGeoNodeURL, {QgsGeoNodeConnectionUtils::sGeoNodeConnection.toLower(), mDemoGeoNodeName} );
  // Testing real server, staging.geonode.kartoza.com. Need to be changed later.
  QgsOwsConnection::settingsUrl->setValue( mKartozaGeoNodeQGISServerURL, {QgsGeoNodeConnectionUtils::sGeoNodeConnection.toLower(), mKartozaGeoNodeQGISServerName} );
  // Testing real server, staginggs.geonode.kartoza.com. Need to be changed later.
  QgsOwsConnection::settingsUrl->setValue( mKartozaGeoNodeGeoServerURL, {QgsGeoNodeConnectionUtils::sGeoNodeConnection.toLower(), mKartozaGeoNodeGeoServerName} );
}
...
void TestQgsGeoNodeConnection::testCreation()
{
  ...
  QgsOwsConnection::settingsUrl->setValue( mGeoNodeConnectionURL, {QgsGeoNodeConnectionUtils::sGeoNodeConnection.toLower(), mGeoNodeConnectionName} );
