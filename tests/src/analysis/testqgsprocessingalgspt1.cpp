...
void TestQgsProcessingAlgsPt1::exportLayersInformationAlg()
{
  ...
  const std::unique_ptr<QgsVectorLayer> gpkgLayer = std::make_unique<QgsVectorLayer>( gpkgFileInfo.filePath() + QStringLiteral( "|layername=person" ), QStringLiteral( "person" ), QStringLiteral( "ogr" ) );
...
void TestQgsProcessingAlgsPt1::rasterLogicOp()
{
  ...
  std::unique_ptr<QgsRasterDataProvider> dpOr( QgsRasterDataProvider::create( QStringLiteral( "gdal" ), filenameOr, QStringLiteral( "GTiff" ), 1, static_cast<Qgis::DataType>( dataType ), 10, 10, tform, crs ) );
  ...
  std::unique_ptr<QgsRasterDataProvider> dpAnd( QgsRasterDataProvider::create( QStringLiteral( "gdal" ), filenameAnd, QStringLiteral( "GTiff" ), 1, static_cast<Qgis::DataType>( dataType ), 10, 10, tform, crs ) );
  ...
  dpOr.reset( dynamic_cast<QgsRasterDataProvider *>( QgsProviderRegistry::instance()->createProvider( QStringLiteral( "gdal" ), filenameOr ) ) );
  QVERIFY( dpOr );
  ...
  dpAnd.reset( dynamic_cast<QgsRasterDataProvider *>( QgsProviderRegistry::instance()->createProvider( QStringLiteral( "gdal" ), filenameAnd ) ) );
  QVERIFY( dpAnd );
...
{
  QgsVectorLayer *vl = new QgsVectorLayer( QStringLiteral( TEST_DATA_DIR ) + "/shapefile/system_encoding.shp", QStringLiteral( "test" ), QStringLiteral( "ogr" ) );
  QVERIFY( vl->isValid() );
  QgsProject p;
  p.addMapLayers(
