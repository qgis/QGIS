...
void TestQgsProcessingAlgsPt1::polygonsToLines()
{
  ...
  QVERIFY2( result.geometry().isEquals( expectedGeometry ), QStringLiteral( "Result: %1, Expected: %2" ).arg( result.geometry().asWkt(), expectedGeometry.asWkt() ).toUtf8().constData() );
}
