...
{
  QgsZonalStatistics zs( mVectorLayer, mRasterLayer, QString(), 1, QgsZonalStatistics::Statistic::All );
  ...
  QgsZonalStatistics zsl( mVectorLayer, mRasterLayer, QStringLiteral( "myqgis2_" ), 1, QgsZonalStatistics::Statistic::All );
...
void TestQgsZonalStatistics::testReprojection()
{
  ...
  QgsZonalStatistics zs( reprojected.get(), mRasterLayer, QString(), 1, QgsZonalStatistics::Statistic::All );
  zs.calculateStatistics( nullptr );
...
void TestQgsZonalStatistics::testNoData()
{
  ...
  QgsZonalStatistics zs( vectorLayer.get(), rasterLayer.get(), QStringLiteral( "n" ), 1, QgsZonalStatistics::Statistic::All );
  zs.calculateStatistics( nullptr );
  ...
  zs = QgsZonalStatistics( vectorLayer.get(), rasterLayer.get(), QStringLiteral( "un" ), 1, QgsZonalStatistics::Statistic::All );
  zs.calculateStatistics( nullptr );
...
{
  QCOMPARE( QgsZonalStatistics::shortName( QgsZonalStatistics::Statistic::Count ), QStringLiteral( "count" ) );
  QCOMPARE( QgsZonalStatistics::shortName( QgsZonalStatistics::Statistic::Sum ), QStringLiteral( "sum" ) );
  QCOMPARE( QgsZonalStatistics::shortName( QgsZonalStatistics::Statistic::Mean ), QStringLiteral( "mean" ) );
  QCOMPARE( QgsZonalStatistics::shortName( QgsZonalStatistics::Statistic::Median ), QStringLiteral( "median" ) );
  QCOMPARE( QgsZonalStatistics::shortName( QgsZonalStatistics::Statistic::StDev ), QStringLiteral( "stdev" ) );
  QCOMPARE( QgsZonalStatistics::shortName( QgsZonalStatistics::Statistic::Min ), QStringLiteral( "min" ) );
  QCOMPARE( QgsZonalStatistics::shortName( QgsZonalStatistics::Statistic::Max ), QStringLiteral( "max" ) );
  QCOMPARE( QgsZonalStatistics::shortName( QgsZonalStatistics::Statistic::Range ), QStringLiteral( "range" ) );
  QCOMPARE( QgsZonalStatistics::shortName( QgsZonalStatistics::Statistic::Minority ), QStringLiteral( "minority" ) );
  QCOMPARE( QgsZonalStatistics::shortName( QgsZonalStatistics::Statistic::Majority ), QStringLiteral( "majority" ) );
  QCOMPARE( QgsZonalStatistics::shortName( QgsZonalStatistics::Statistic::Variety ), QStringLiteral( "variety" ) );
  QCOMPARE( QgsZonalStatistics::shortName( QgsZonalStatistics::Statistic::Variance ), QStringLiteral( "variance" ) );
}
