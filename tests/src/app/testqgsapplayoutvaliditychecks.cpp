...
void TestQgsLayoutValidityChecks::testPictureValidity()
{
  ...
  l.addItem( picture2 );
  picture2->dataDefinedProperties().setProperty( static_cast<int>( QgsLayoutObject::DataDefinedProperty::PictureSource ), QgsProperty::fromExpression( QStringLiteral( "'d:/bad' || 'robot'" ) ) );
  l.refresh();
  ...
  picture2->dataDefinedProperties().setProperty( static_cast<int>( QgsLayoutObject::DataDefinedProperty::PictureSource ), QgsProperty::fromExpression( QStringLiteral( "''" ) ) );
  l.refresh();
  ...
  picture2->dataDefinedProperties().setProperty( static_cast<int>( QgsLayoutObject::DataDefinedProperty::PictureSource ), QgsProperty::fromExpression( QStringLiteral( "'%1'" ).arg( QStringLiteral( TEST_DATA_DIR ) + "/sam' || 'ple_svg.svg" ) ) );
  l.refresh();
