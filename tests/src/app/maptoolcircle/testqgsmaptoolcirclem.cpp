...
class TestQgsMapToolCircleM : public QObject
{
    Q_OBJECT

  public:
    TestQgsMapToolCircleM();
...
TestQgsMapToolCircleM::TestQgsMapToolCircleM() = default;


//runs before all tests
void TestQgsMapToolCircleM::initTestCase()
{
  QgsApplication::init();
  ...
  // make testing layers
  mLayer = new QgsVectorLayer( QStringLiteral( "LineStringM?crs=EPSG:27700" ), QStringLiteral( "layer line M" ), QStringLiteral( "memory" ) );
...
void TestQgsMapToolCircleM::cleanupTestCase()
{
...
void TestQgsMapToolCircleM::testCircleFrom2Points()
{
  ...
  QString wkt = "CompoundCurveM (CircularStringM (0 2 333, 1 1 333, 0 0 333, -1 1 333, 0 2 333))";
...
void TestQgsMapToolCircleM::testCircleFrom3Points()
{
  ...
  QString wkt = "CompoundCurveM (CircularStringM (0 2 111, 1 1 111, 0 0 111, -1 1 111, 0 2 111))";
  QCOMPARE( f.geometry().asWkt(), wkt );
...
void TestQgsMapToolCircleM::testCircleFromCenterPoint()
{
  ...
  QString wkt = "CompoundCurveM (CircularStringM (0 2 222, 2 0 222, 0 -2 222, -2 0 222, 0 2 222))";
  QCOMPARE( f.geometry().asWkt(), wkt );
...
#include "testqgsmaptoolcirclem.moc"
