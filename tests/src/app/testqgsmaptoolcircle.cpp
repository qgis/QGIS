...
void TestQgsMapToolCircle::initAttributes()
{
  ...
  mExpectedWkts[QStringLiteral(
    "XYZ"
    "3Points"
  )] = QgsCircle::from3Points( QgsPoint( 0, 0, Z, M, Qgis::WkbType::PointZ ), QgsPoint( 0, 2, Z, M, Qgis::WkbType::PointZ ), QgsPoint( 1, 1, Z, M, Qgis::WkbType::PointZ ) )
         .toCircularString( true )
         ->asWkt( WKT_PRECISION );
  mExpectedWkts[QStringLiteral(
    "XYZ"
    "3PointsWithDeletedVertex"
  ...
  mExpectedWkts[QStringLiteral(
    "XYM"
    "3Points"
  )] = QgsCircle::from3Points( QgsPoint( 0, 0, Z, M, Qgis::WkbType::PointM ), QgsPoint( 0, 2, Z, M, Qgis::WkbType::PointM ), QgsPoint( 1, 1, Z, M, Qgis::WkbType::PointM ) )
         .toCircularString( true )
         ->asWkt( WKT_PRECISION );
  mExpectedWkts[QStringLiteral(
    "XYM"
  ...
  mExpectedWkts[QStringLiteral(
    "XYZM"
    "3Points"
  )] = QgsCircle::from3Points( QgsPoint( 0, 0, Z, M, Qgis::WkbType::PointZM ), QgsPoint( 0, 2, Z, M, Qgis::WkbType::PointZM ), QgsPoint( 1, 1, Z, M, Qgis::WkbType::PointZM ) )
         .toCircularString( true )
         ->asWkt( WKT_PRECISION );
  mExpectedWkts[QStringLiteral(
    "XYZM"
