...
void TestQgsMapToolAddFeatureLine::testTracingWithTransform()
{
  ...
  QCOMPARE( lineLayer3857->undoStack()->index(), 1 );
  QCOMPARE( lineLayer3857->getFeature( newFid2 ).geometry().asWkt( -3 ), QStringLiteral( "CompoundCurve ((-841000 6406000, -841000 6406000, -841000 6406000, -841000 6406000, -841000 6406000, -841000 6406000))" ) );
