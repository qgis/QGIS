  ...
  private slots:
    ...
    void initTestCase()
    {
      ...
      */
      ...
      snappingConfig.setTypeV2( static_cast<QgsSnappingConfig::SnappingTypeV2>( QgsSnappingConfig::SnappingTypeV2::VertexV2 | QgsSnappingConfig::SnappingTypeV2::SegmentV2 ) );
