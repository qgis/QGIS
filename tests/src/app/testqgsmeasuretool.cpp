...
void TestQgsMeasureTool::testLengthCalculationCartesian()
{
  ...
  std::unique_ptr< QgsMeasureTool > tool( new QgsMeasureTool( mCanvas, false, false ) );
  ...
  std::unique_ptr< QgsMeasureTool > tool2( new QgsMeasureTool( mCanvas, false, false ) );
...
void TestQgsMeasureTool::testAreaCalculationCartesian()
{
  ...
  // run length calculation
  std::unique_ptr< QgsMeasureTool > tool( new QgsMeasureTool( mCanvas, true, false ) );
  std::unique_ptr< QgsMeasureDialog > dlg( new QgsMeasureDialog( tool.get() ) );
  ...
  std::unique_ptr< QgsMeasureTool > tool2( new QgsMeasureTool( mCanvas, true, false ) );
  std::unique_ptr< QgsMeasureDialog > dlg2( new QgsMeasureDialog( tool2.get() ) );
  dlg2->mCartesian->setChecked( true );
...
void TestQgsMeasureTool::degreeDecimalPlaces()
{
  ...
  const std::unique_ptr< QgsMeasureTool > tool( new QgsMeasureTool( mCanvas, true, false ) );
  std::unique_ptr< QgsMeasureDialog > dlg( new QgsMeasureDialog( tool.get() ) );
