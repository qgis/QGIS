...
void TestQgsVertexTool::testTopologicalEditingMoveVertexZ()
{
  ...
  QCOMPARE( mLayerLineZ->getFeature( mFidLineZF1 ).geometry().asWkt(), "LineStringZ (5 5 1, 5 7 5, 7 5 1)" );
  QCOMPARE( mLayerLineZ->getFeature( mFidLineZF2 ).geometry().asWkt(), "LineStringZ (5 7 5, 7 7 10)" );
...
void TestQgsVertexTool::testTopologicalEditingMoveVertexOnSegmentZ()
{
  ...
  QCOMPARE( mLayerLineZ->getFeature( mFidLineZF1 ).geometry().asWkt(), "LineStringZ (5 5 1, 6 7 1, 7 5 1)" );
  QCOMPARE( mLayerLineZ->getFeature( mFidLineZF2 ).geometry().asWkt(), "LineStringZ (5 7 5, 6 7 333, 7 7 10)" );
