...
void TestQgsDoubleSpinBox::step()
{
  ...
  // with clear value
  spin.setClearValue( -1000, u"NULL"_s );
  spin.setValue( 0 );
  spin.stepBy( 1 );
  QCOMPARE( spin.value(), 1 );
  spin.stepBy( -1 );
