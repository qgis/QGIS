...
void TestQgsMessageBar::pushPop()
{
  ...
  QCOMPARE( qobject_cast< QgsMessageBarItem * >( static_cast< QGridLayout * >( bar.layout() )->itemAt( 3 )->widget() )->text(), QStringLiteral( "1" ) );
  ...
  QCOMPARE( qobject_cast< QgsMessageBarItem * >( static_cast< QGridLayout * >( bar.layout() )->itemAt( 3 )->widget() )->text(), QStringLiteral( "2" ) );
  ...
  QCOMPARE( qobject_cast< QgsMessageBarItem * >( static_cast< QGridLayout * >( bar.layout() )->itemAt( 3 )->widget() )->text(), QStringLiteral( "3" ) );
