...
#define CHECK_OR_CLAUSE(whereClause,expectedValues)                     \
  {                                                                     \
    ...
    QCOMPARE( values, expectedValues );                                 \
      ...
      CHECK_IN_CLAUSE(QgsDamengUtils::whereClause(QgsFeatureIds() << 42 << 43, fields, NULL, QgsDamengPrimaryKeyType::PktInt, pkAttrs, std::shared_ptr<QgsDamengSharedData>(sdata)),
        QStringList() << "42" << "43");
      ...
      CHECK_IN_CLAUSE(QgsDamengUtils::whereClause(QgsFeatureIds() << 1LL << 2LL, fields, NULL, QgsDamengPrimaryKeyType::PktInt64, pkAttrs, std::shared_ptr<QgsDamengSharedData>(sdata)),
      ...
      CHECK_OR_CLAUSE(QgsDamengUtils::whereClause(QgsFeatureIds() << 1LL << 2LL, fields, NULL, QgsDamengPrimaryKeyType::PktFidMap, pkAttrs, std::shared_ptr<QgsDamengSharedData>(sdata)),
      ...
      CHECK_IN_CLAUSE(QgsDamengUtils::whereClause(QgsFeatureIds() << 1LL << 2LL, fields, NULL, QgsDamengPrimaryKeyType::PktFidMap, pkAttrs, std::shared_ptr<QgsDamengSharedData>(sdata)),
        QStringList() << "'Dameng too!'" << "'QGIS ''Rocks''!'");
      ...
      CHECK_OR_CLAUSE(QgsDamengUtils::whereClause(QgsFeatureIds() << 1LL << 2LL, fields, NULL, QgsDamengPrimaryKeyType::PktFidMap, pkAttrs, std::shared_ptr<QgsDamengSharedData>(sdata)),
        QStringList() << "\"fld_int\"=42 AND \"fld\"='QGIS ''Rocks''!'"
