...
class TestQgsMapHitTest(unittest.TestCase):
    ...
    def test_hit_test(self):
        ...
        self.assertCountEqual(map_hit_test.results()[point_layer.id()], [
            one_rule.ruleKey(), three_rule.ruleKey(), else_rule.ruleKey(), root_rule.ruleKey()
        ])
    ...
    def test_hit_test_task(self):
        ...
        self.assertCountEqual(TestQgsMapHitTest.results[point_layer.id()], [
            one_rule.ruleKey(), three_rule.ruleKey(), else_rule.ruleKey(), root_rule.ruleKey()
        ])
