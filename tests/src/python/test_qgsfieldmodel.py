...
class TestQgsFieldModel(QgisTestCase):
    ...
    def testFieldNameRole(self):
        l, m = create_model()
        self.assertEqual(
            m.data(m.indexFromName("fldtxt"), QgsFieldModel.FieldRoles.FieldNameRole),
            "fldtxt",
        )
        self.assertEqual(
            m.data(m.indexFromName("fldint"), QgsFieldModel.FieldRoles.FieldNameRole),
            "fldint",
        )
        self.assertFalse(
            m.data(
                m.indexFromName("an expression"), QgsFieldModel.FieldRoles.FieldNameRole
            )
        )
        self.assertFalse(
            m.data(m.indexFromName(None), QgsFieldModel.FieldRoles.FieldNameRole)
        )
        m.setAllowExpression(True)
    ...
    def testExpressionRole(self):
        l, m = create_model()
        self.assertEqual(
            m.data(m.indexFromName("fldtxt"), QgsFieldModel.FieldRoles.ExpressionRole),
            "fldtxt",
        )
        self.assertEqual(
            m.data(m.indexFromName("fldint"), QgsFieldModel.FieldRoles.ExpressionRole),
            "fldint",
        )
        self.assertFalse(
            m.data(
                m.indexFromName("an expression"),
                QgsFieldModel.FieldRoles.ExpressionRole,
            )
        )
        self.assertFalse(
            m.data(m.indexFromName(None), QgsFieldModel.FieldRoles.ExpressionRole)
        )
        m.setAllowExpression(True)
        m.setExpression("an expression")
        self.assertEqual(
    ...
    def testFieldIndexRole(self):
        l, m = create_model()
        self.assertEqual(
            m.data(m.indexFromName("fldtxt"), QgsFieldModel.FieldRoles.FieldIndexRole),
            0,
        )
        self.assertEqual(
            m.data(m.indexFromName("fldint"), QgsFieldModel.FieldRoles.FieldIndexRole),
            1,
        )
        self.assertFalse(
            m.data(
                m.indexFromName("an expression"),
                QgsFieldModel.FieldRoles.FieldIndexRole,
            )
        )
        self.assertFalse(
            m.data(m.indexFromName(None), QgsFieldModel.FieldRoles.FieldIndexRole)
        )
        m.setAllowExpression(True)
        m.setExpression("an expression")
        self.assertFalse(
    ...
    def testIsExpressionRole(self):
        l, m = create_model()
        self.assertFalse(
            m.data(m.indexFromName("fldtxt"), QgsFieldModel.FieldRoles.IsExpressionRole)
        )
        self.assertFalse(
            m.data(m.indexFromName("fldint"), QgsFieldModel.FieldRoles.IsExpressionRole)
        )
        self.assertFalse(
            m.data(
                m.indexFromName("an expression"),
                QgsFieldModel.FieldRoles.IsExpressionRole,
            )
        )
        self.assertFalse(
            m.data(m.indexFromName(None), QgsFieldModel.FieldRoles.IsExpressionRole)
        )
        m.setAllowExpression(True)
        m.setExpression("an expression")
        self.assertTrue(
    ...
    def testExpressionValidityRole(self):
        ...
        self.assertTrue(
            m.data(
                m.indexFromName("fldtxt"),
                QgsFieldModel.FieldRoles.ExpressionValidityRole,
            )
        )
        self.assertTrue(
            m.data(
                m.indexFromName("fldint"),
                QgsFieldModel.FieldRoles.ExpressionValidityRole,
            )
        )
        self.assertFalse(
        ...
        self.assertFalse(
            m.data(
                m.indexFromName(None), QgsFieldModel.FieldRoles.ExpressionValidityRole
            )
        )
        m.setAllowExpression(True)
        m.setExpression("an expression")
    ...
    def testFieldTypeRole(self):
        l, m = create_model()
        self.assertEqual(
            m.data(m.indexFromName("fldtxt"), QgsFieldModel.FieldRoles.FieldTypeRole),
            QVariant.String,
        )
        self.assertEqual(
            m.data(m.indexFromName("fldint"), QgsFieldModel.FieldRoles.FieldTypeRole),
            QVariant.Int,
        )
        self.assertFalse(
            m.data(
                m.indexFromName("an expression"), QgsFieldModel.FieldRoles.FieldTypeRole
            )
        )
        self.assertFalse(
            m.data(m.indexFromName(None), QgsFieldModel.FieldRoles.FieldTypeRole)
        )
        m.setAllowExpression(True)
        m.setExpression("an expression")
        self.assertFalse(
    ...
    def testFieldOriginRole(self):
        l, m = create_model()
        self.assertEqual(
            m.data(m.indexFromName("fldtxt"), QgsFieldModel.FieldRoles.FieldOriginRole),
            QgsFields.FieldOrigin.OriginProvider,
        )
        self.assertEqual(
            m.data(m.indexFromName("fldint"), QgsFieldModel.FieldRoles.FieldOriginRole),
            QgsFields.FieldOrigin.OriginProvider,
        )
        self.assertFalse(
            m.data(
                m.indexFromName("an expression"),
                QgsFieldModel.FieldRoles.FieldOriginRole,
            )
        )
        self.assertFalse(
            m.data(m.indexFromName(None), QgsFieldModel.FieldRoles.FieldOriginRole)
        )
        m.setAllowExpression(True)
        m.setExpression("an expression")
        self.assertFalse(
    ...
    def testIsEmptyRole(self):
        l, m = create_model()
        self.assertFalse(
            m.data(m.indexFromName("fldtxt"), QgsFieldModel.FieldRoles.IsEmptyRole),
            QgsFields.FieldOrigin.OriginProvider,
        )
        self.assertFalse(
            m.data(m.indexFromName("fldint"), QgsFieldModel.FieldRoles.IsEmptyRole),
            QgsFields.FieldOrigin.OriginProvider,
        )
        self.assertFalse(
            m.data(
                m.indexFromName("an expression"), QgsFieldModel.FieldRoles.IsEmptyRole
            )
        )
        self.assertFalse(
            m.data(m.indexFromName(None), QgsFieldModel.FieldRoles.IsEmptyRole)
        )
        m.setAllowExpression(True)
        m.setExpression("an expression")
        self.assertFalse(
    ...
    def testDisplayRole(self):
        l, m = create_model()
        self.assertEqual(
            m.data(m.indexFromName("fldtxt"), Qt.ItemDataRole.DisplayRole), "fldtxt"
        )
        self.assertEqual(
            m.data(m.indexFromName("fldint"), Qt.ItemDataRole.DisplayRole), "fldint"
        )
        self.assertFalse(
            m.data(m.indexFromName("an expression"), Qt.ItemDataRole.DisplayRole)
        )
    ...
    def testManualFields(self):
        ...
        self.assertEqual(m.rowCount(), 2)
        self.assertEqual(
            m.data(m.index(0, 0, QModelIndex()), Qt.ItemDataRole.DisplayRole), "f1"
        )
        self.assertEqual(
            m.data(m.index(1, 0, QModelIndex()), Qt.ItemDataRole.DisplayRole), "f2"
        )
    ...
    def testEditorWidgetTypeRole(self):
        ...
        self.assertEqual(
            m.data(
                m.indexFromName("fldtxt"), QgsFieldModel.FieldRoles.EditorWidgetType
            ),
            "Hidden",
        )
        self.assertEqual(
            m.data(
                m.indexFromName("fldint"), QgsFieldModel.FieldRoles.EditorWidgetType
            ),
            "ValueMap",
        )
        self.assertIsNone(
            m.data(
                m.indexFromName("an expression"),
                QgsFieldModel.FieldRoles.EditorWidgetType,
            )
        )
        self.assertIsNone(
            m.data(m.indexFromName(None), QgsFieldModel.FieldRoles.EditorWidgetType)
        )
        m.setAllowExpression(True)
        m.setExpression("an expression")
        self.assertIsNone(
    ...
    def testJoinedFieldIsEditableRole(self):
        ...
        layer2 = QgsVectorLayer(
            "Point?field=id_b:integer&field=value_b", "addfeat", "memory"
        )
        ...
        self.assertTrue(
            m.data(
                m.indexFromName("B_value_b"),
                QgsFieldModel.FieldRoles.JoinedFieldIsEditable,
            )
        )
        self.assertIsNone(
            m.data(
        ...
        proxy_m.setFilters(
            QgsFieldProxyModel.Filter.AllTypes | QgsFieldProxyModel.Filter.HideReadOnly
        )
        ...
        # not editable join
        layer3 = QgsVectorLayer("Point?field=id_a:integer", "addfeat", "memory")
        ...
        proxy_m.setFilters(
            QgsFieldProxyModel.Filter.AllTypes
            | QgsFieldProxyModel.Filter.OriginProvider
        )
        proxy_m.sourceFieldModel().setLayer(layer)
        self.assertEqual(proxy_m.rowCount(), 1)
        self.assertEqual(proxy_m.data(proxy_m.index(0, 0)), "id_a")
    ...
    def testFieldIsWidgetEditableRole(self):
        ...
        self.assertTrue(
            m.data(
                m.indexFromName("fldtxt"),
                QgsFieldModel.FieldRoles.FieldIsWidgetEditable,
            )
        )
        self.assertTrue(
            m.data(
        ...
        self.assertFalse(
            m.data(
                m.indexFromName(None), QgsFieldModel.FieldRoles.FieldIsWidgetEditable
            )
        )
        m.setAllowExpression(True)
        m.setExpression("an expression")
    ...
    def testFieldTooltipExtended(self):
        ...
        self.assertEqual(
            QgsFieldModel.fieldToolTipExtended(
                QgsField("my_string", QVariant.String, "string"), layer
            ),
            "",
        )
        self.assertEqual(
