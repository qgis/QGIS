...
class TestPyQgsProviderConnectionSpatialite(
    ...
    def setUpClass(cls):
        ...
        spatialite_original_path = (
            f"{TEST_DATA_DIR}/qgis_server/test_project_wms_grouped_layers.sqlite"
        )
    ...
    def test_spatialite_table_uri(self):
        ...
        self.assertEqual(
            conn.tableUri("", "cdb_lines"), f'{self.uri} table="cdb_lines"'
        )
    ...
    def test_spatialite_fields(self):
        ...
        self.assertEqual(
            fields.names(),
            ["pk", "geom", "fid", "id", "typ", "name", "ortsrat", "id_long"],
        )
