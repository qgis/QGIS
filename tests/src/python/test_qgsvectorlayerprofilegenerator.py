...
class TestQgsVectorLayerProfileGenerator(QgisTestCase):
    ...
    def testPointGenerationAbsolute(self):
        ...
        self.assertCountEqual([f.geometry.asWkt(-2) for f in features],
                              ['Point Z (-347400 6632600 300)', 'Point Z (-347500 6632700 300)', 'Point Z (-346400 6632300 200)'])
        ...
        self.assertCountEqual([f.geometry.asWkt(-1) for f in features],
                              ['Point Z (-347530 6632710 270)', 'Point Z (-347390 6632650 270)', 'Point Z (-346400 6632270 220)'])
    ...
    def testPointGenerationMultiPoint(self):
        ...
        f = QgsFeature()
        f.setGeometry(QgsGeometry.fromWkt('MultiPoint Z(322069 129893 89.1, 322077 129889 90.2, 322093 129888 92.4)'))
