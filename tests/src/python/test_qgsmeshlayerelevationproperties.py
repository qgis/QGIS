...
class TestQgsMeshLayerElevationProperties(QgisTestCase):
    def testBasic(self):
        ...
        self.assertEqual(props2.mode(), Qgis.MeshElevationMode.FromVertices)
    ...
    def test_basic_fixed_range(self):
        ...
        props2 = QgsMeshLayerElevationProperties(None)
        props2.readXml(elem, QgsReadWriteContext())
        self.assertEqual(props2.mode(), Qgis.MeshElevationMode.FixedElevationRange)
    ...
    def test_basic_fixed_range_per_group(self):
        ...
        props2 = QgsMeshLayerElevationProperties(None)
        props2.readXml(elem, QgsReadWriteContext())
        self.assertEqual(props2.mode(), Qgis.MeshElevationMode.FixedRangePerGroup)
        self.assertEqual(
            props2.fixedRangePerGroup(),
            {
                1: QgsDoubleRange(103.1, 106.8),
                2: QgsDoubleRange(106.8, 116.8),
                3: QgsDoubleRange(116.8, 126.8),
