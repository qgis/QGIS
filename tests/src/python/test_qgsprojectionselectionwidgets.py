...
class TestQgsProjectionSelectionWidgets(QgisTestCase):
    ...
    def testShowingHiding(self):
        ...
        self.assertFalse(
            w.optionVisible(QgsProjectionSelectionWidget.CrsOption.LayerCrs)
        )
        ...
        self.assertFalse(
            w.optionVisible(QgsProjectionSelectionWidget.CrsOption.ProjectCrs)
        )
        ...
        self.assertFalse(
            w.optionVisible(QgsProjectionSelectionWidget.CrsOption.DefaultCrs)
        )
        ...
        self.assertFalse(
            w.optionVisible(QgsProjectionSelectionWidget.CrsOption.CurrentCrs)
        )
        ...
        self.assertFalse(
            w.optionVisible(QgsProjectionSelectionWidget.CrsOption.CrsNotSet)
        )
    ...
    def testFilters(self):
        ...
        self.assertEqual(cb.itemText(2), "EPSG:28356 - GDA94 / MGA zone 56")
        ...
        self.assertEqual(cb.itemText(1), "Project CRS: EPSG:3113 - GDA94 / BCSG02")
        self.assertEqual(cb.itemText(2), "Default CRS: EPSG:4326 - WGS 84")
        self.assertEqual(cb.itemText(3), "Layer CRS: ESRI:115851 - SIRGAS-CON_DGF00P01")
        self.assertEqual(cb.itemText(4), "ESRI:115866 - SIRGAS-CON_SIR17P01")
        self.assertEqual(cb.itemText(5), "EPSG:28356 - GDA94 / MGA zone 56")
        ...
        self.assertEqual(cb.count(), 3)
        self.assertEqual(cb.itemText(0), "ESRI:115852 - SIRGAS-CON_DGF01P01")
        self.assertEqual(cb.itemText(1), "Layer CRS: ESRI:115851 - SIRGAS-CON_DGF00P01")
        self.assertEqual(cb.itemText(2), "ESRI:115866 - SIRGAS-CON_SIR17P01")
    ...
    def testTreeWidgetUnknownCrs(self):
        ...
        crs = QgsCoordinateReferenceSystem.fromWkt(
            'GEOGCS["unknown",DATUM["unknown",SPHEROID["unknown",6378237,298.257223563]],PRIMEM["Greenwich",0],UNIT["degree",0.0174532925199433]]'
        )
        ...
        self.assertTrue(w.hasValidSelection())
        self.assertEqual(
            w.crs().toWkt(QgsCoordinateReferenceSystem.WktVariant.WKT2_2018),
            'GEOGCRS["unknown",DATUM["unknown",ELLIPSOID["unknown",6378237,298.257223563,LENGTHUNIT["metre",1,ID["EPSG",9001]]]],PRIMEM["Greenwich",0,ANGLEUNIT["degree",0.0174532925199433]],CS[ellipsoidal,2],AXIS["longitude",east,ORDER[1],ANGLEUNIT["degree",0.0174532925199433]],AXIS["latitude",north,ORDER[2],ANGLEUNIT["degree",0.0174532925199433]]]',
        )
