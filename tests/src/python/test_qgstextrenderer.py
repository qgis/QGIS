...
class PyQgsTextRenderer(QgisTestCase):
    ...
    def testDataDefinedBackgroundSettings(self):
        ...
        f.updateDataDefinedProperties(context)
        self.assertEqual(
            f.background().sizeUnit(), QgsUnitTypes.RenderUnit.RenderPixels
        )
        ...
        f.updateDataDefinedProperties(context)
        self.assertEqual(
            f.background().offsetUnit(), QgsUnitTypes.RenderUnit.RenderPixels
        )
        ...
        f.updateDataDefinedProperties(context)
        self.assertEqual(
            f.background().radiiUnit(), QgsUnitTypes.RenderUnit.RenderPixels
        )
        ...
        f.updateDataDefinedProperties(context)
        self.assertEqual(
            f.background().strokeWidthUnit(), QgsUnitTypes.RenderUnit.RenderPixels
        )
    ...
    def testDataDefinedShadowSettings(self):
        ...
        f.updateDataDefinedProperties(context)
        self.assertEqual(
            f.shadow().blurRadiusUnit(), QgsUnitTypes.RenderUnit.RenderPixels
        )
    ...
    def testDrawShadow(self):
        ...
        self.assertTrue(
            self.checkRender(
                format, "shadow_enabled", QgsTextRenderer.TextPart.Text, text=["test"]
            )
        )
    ...
    def testDrawShadowBlurRadiusMM(self):
        ...
        self.assertTrue(
            self.checkRender(
                format, "shadow_radius_mm", QgsTextRenderer.TextPart.Text, text=["test"]
            )
        )
    ...
    def testDrawShadowOpacity(self):
        ...
        self.assertTrue(
            self.checkRender(
                format, "shadow_opacity", QgsTextRenderer.TextPart.Text, text=["test"]
            )
        )
    ...
    def testDrawShadowColor(self):
        ...
        self.assertTrue(
            self.checkRender(
                format, "shadow_color", QgsTextRenderer.TextPart.Text, text=["test"]
            )
        )
    ...
    def testDrawShadowScale(self):
        ...
        self.assertTrue(
            self.checkRender(
                format, "shadow_scale_50", QgsTextRenderer.TextPart.Text, text=["test"]
            )
        )
    ...
    def testDrawShadowScaleUp(self):
        ...
        self.assertTrue(
            self.checkRender(
                format, "shadow_scale_150", QgsTextRenderer.TextPart.Text, text=["test"]
            )
        )
