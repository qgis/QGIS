...
class QgsServerAPIUtilsTest(QgsServerTestBase):
    ...
    def test_published_crs(self):
        ...
        self.assertIn("http://www.opengis.net/def/crs/EPSG/0/3857", crss)
        self.assertIn("http://www.opengis.net/def/crs/EPSG/0/4326", crss)

    def test_parse_crs(self):
        crs = QgsServerApiUtils.parseCrs("http://www.opengis.net/def/crs/OGC/1.3/CRS84")
        self.assertTrue(crs.isValid())

        crs = QgsServerApiUtils.parseCrs("http://www.opengis.net/def/crs/EPSG/0/4326")
        self.assertEqual(crs.postgisSrid(), 4326)

        crs = QgsServerApiUtils.parseCrs("http://www.opengis.net/def/crs/EPSG/0/3857")
        self.assertTrue(crs.isValid())
    ...
    def test_temporal_extent(self):
        ...
        source_project_path = (
            unitTestDataPath("qgis_server") + "/test_project_api_timefilters.qgs"
        )
        source_data_path = (
            unitTestDataPath("qgis_server") + "/test_project_api_timefilters.gpkg"
        )
        ...
        self.assertTrue(
            layer.serverProperties().addWmsDimension(
        ...
        self.assertEqual(
            QgsServerApiUtils.temporalExtent(layer),
...
class QgsServerAPITestBase(QgsServerTestBase):
    ...
    def compareApi(self, request, project, reference_file, subdir="api"):
        ...
        result = (
            bytes(response.body()).decode("utf8")
        ...
        with open(path.encode("utf8"), encoding="utf8") as f:
            if reference_file.endswith("json"):
                self.assertLinesEqual(
                    self.normalize_json(result),
                    self.normalize_json(f.read()),
                    path.encode("utf8"),
                )
            else:
...
class RestrictedLayerAccessControl(QgsAccessControlFilter):
    ...
    def layerPermissions(self, layer):
        ...
        rights.canRead = (
            layer.id() not in self.excluded_layers
            or self.can_edit
            or self.can_delete
            or self.can_insert
        )
...
class QgsServerAPITest(QgsServerAPITestBase):
    ...
    def test_wfs3_collections_json_excluded_layer(self):
        ...
        # Access control filter to exclude a layer
        acfilter = RestrictedLayerAccessControl(
            server.serverInterface(), ["testlayer_c0988fd7_97ca_451d_adbc_37ad6d10583a"]
        )
        server.serverInterface().registerAccessControl(acfilter, 100)
    ...
    def test_wfs3_collection_shortname_json(self):
        ...
        self.compareApi(
            request, project, "test_wfs3_collection_layer1_with_short_name.json"
        )
    ...
    def test_wfs3_collection_temporal_extent_json(self):
        ...
        self.compareApi(
            request, project, "test_wfs3_collection_points_timefilters.json"
        )
    ...
    def test_wfs3_collection_items(self):
        ...
        self.compareApi(
            request, project, "test_wfs3_collections_items_testlayer_èé.json"
        )
    ...
    def test_wfs3_collection_items_html(self):
        ...
        self.compareApi(
            request, project, "test_wfs3_collections_items_testlayer_èé.html"
        )
    ...
    def test_wfs3_collection_items_html_limit_0(self):
        ...
        self.compareApi(
            request, project, "test_wfs3_collections_items_testlayer_èé_1.html"
        )
    ...
    def test_wfs3_collection_items_crs(self):
        ...
        request = QgsBufferServerRequest(
            f"http://server.qgis.org/wfs3/collections/testlayer%20èé/items?crs={encoded_crs}"
        )
        self.compareApi(
    ...
    def test_wfs3_collection_items_as_areas_crs_4326(self):
        ...
        request = QgsBufferServerRequest(
            f"http://server.qgis.org/wfs3/collections/as-areas-short-name/items?crs={encoded_crs}"
        )
        self.compareApi(
            request,
            project,
            "test_wfs3_collections_items_as-areas-short-name_4326.json",
        )
    ...
    def test_invalid_args(self):
        ...
        request = QgsBufferServerRequest(
            "http://server.qgis.org/wfs3/collections/testlayer%20èé/items?limit="
            + str(1 << 32)
        )
        response = QgsBufferServerResponse()
        self.server.handleRequest(request, response, project)
    ...
    def test_wfs3_collection_items_limit_offset(self):
        ...
        self.compareApi(
            request,
            project,
            "test_wfs3_collections_items_testlayer_èé_limit_1_offset_1.json",
        )
        request = QgsBufferServerRequest(
            "http://server.qgis.org/wfs3/collections/testlayer%20èé/items?limit=1&offset=-1"
        )
        ...
        self.assertEqual(
            response.body(),
            b'[{"code":"Bad request error","description":"Argument \'offset\' is not valid. Offset for features to retrieve [0-3]"}]',
        )  # Bad request
        request = QgsBufferServerRequest(
            "http://server.qgis.org/wfs3/collections/testlayer%20èé/items?limit=-1&offset=1"
        )
    ...
    def test_wfs3_collection_items_limit_offset_2(self):
        ...
        self.compareApi(
            request,
            project,
            "test_wfs3_collections_items_testlayer_èé_limit_1_offset_2.json",
        )
    ...
    def test_wfs3_collection_items_bbox(self):
        ...
        self.compareApi(
            request, project, "test_wfs3_collections_items_testlayer_èé_bbox.json"
        )
    ...
    def test_wfs3_collection_items_bbox_25832(self):
        ...
        project = QgsProject()
        vl = QgsVectorLayer(
            "Point?crs=EPSG:25832&field=fldint:integer", "testlayer25832", "memory"
        )
        ...
        self.compareApi(
            request, project, "test_wfs3_collections_items_testlayer25832_bbox.json"
        )
    ...
    def test_wfs3_collection_items_post(self):
        ...
        shutil.copy(
            unitTestDataPath("qgis_server") + "/test_project_api_editing.qgs",
            tmpDir.path() + "/test_project_api_editing.qgs",
        )
        shutil.copy(
            unitTestDataPath("qgis_server") + "/test_project_api_editing.gpkg",
        ...
        data = b"not json!"
        request = QgsBufferServerRequest(
            f"http://server.qgis.org/wfs3/collections/{insert_layer}/items",
        ...
        self.assertTrue(
            '[{"code":"Bad request error","description":"JSON parse error'
            in bytes(response.body()).decode("utf8")
        )
        ...
        feature = next(
            project.mapLayersByName("test layer èé 3857 published insert")[
                0
            ].getFeatures(req)
        )
        self.assertEqual(
            response.headers()["Location"],
            f"http://server.qgis.org/wfs3/collections/{insert_layer}/items/{feature.id()}",
        )
        ...
        self.assertEqual(
            re.sub(r"\.\d+", "", feature.geometry().asWkt().upper()),
            "MULTIPOINT ((806732 5592286))",
        )
    ...
    def test_wfs3_collection_items_put(self):
        ...
        data = b"not json!"
        request = QgsBufferServerRequest(
            f"http://server.qgis.org/wfs3/collections/{update_layer}/items/1",
        ...
        # Unauthorized layer
        request = QgsBufferServerRequest(
            f"http://server.qgis.org/wfs3/collections/{insert_layer}/items/1",
            QgsBufferServerRequest.PutMethod,
            {"Content-Type": "application/geo+json"},
            data,
        )
        ...
        request = QgsBufferServerRequest(
            f"http://server.qgis.org/wfs3/collections/{hidden_text_2_layer}/items/1",
            QgsBufferServerRequest.PutMethod,
            {"Content-Type": "application/geo+json"},
            data,
        )
    ...
    def test_wfs3_collection_items_delete(self):
        ...
        data = b""
        request = QgsBufferServerRequest(
            f"http://server.qgis.org/wfs3/collections/{delete_layer}/items/1",
            QgsBufferServerRequest.DeleteMethod,
        )
        response = QgsBufferServerResponse()
        self.server.handleRequest(request, response, project)
    ...
    def test_wfs3_sorting(self):
        ...
        self.compareApi(
            request,
            project,
            "test_wfs3_collections_items_layer1_with_short_name_sort_by_name.json",
        )
        request = QgsBufferServerRequest(
        ...
        self.compareApi(
            request,
            project,
            "test_wfs3_collections_items_layer1_with_short_name_sort_by_name_desc.json",
        )
        request = QgsBufferServerRequest(
        ...
        self.compareApi(
            request,
            project,
            "test_wfs3_collections_items_layer1_with_short_name_sort_by_name_asc.json",
        )
    ...
    def test_wfs3_invalid_fids(self):
        ...
        self.assertEqual(
            ...
            '[{"code":"Internal server error","description":"Invalid feature [123456]"}]',
        )
        ...
        self.assertEqual(
            bytes(response.body()).decode("utf-8"),
            '[{"code":"Internal server error","description":"Invalid feature ID [xYz@]"}]',
        )
    ...
    def test_wfs3_field_alias(self):
        ...
        self.assertEqual(
            list(j_response["features"][0]["properties"].keys()),
            ["alias_id", "alias_name", "utf8nameè"],
        )
        ...
        j_response = json.loads(bytes(response.body()).decode("utf8"))
        self.assertEqual(
            list(j_response["features"][0]["properties"].keys()), ["alias_name"]
        )
    ...
    def test_wfs3_time_filters_ranges(self):
        ...
        self.assertEqual(
            len(
                project.mapLayersByName("points")[0].serverProperties().wmsDimensions()
            ),
            0,
        )
        ...
        self.assertEqualBrackets(
            _interval(created_path, "2017-01-01"),
        ...
        self.assertEqualBrackets(
            _interval(created_path, "2017-01-01/2018-01-01"),
            '( "created" IS NULL OR ( to_date( \'2017-01-01\' ) <= "created" AND "created" <= to_date( \'2018-01-01\' ) ) )',
        )

        self.assertEqualBrackets(
            _interval(created_path, "2017-01-01T01:01:01"),
            '( "created" IS NULL OR "created" = to_date( \'2017-01-01\' ) )',
        )
        self.assertEqualBrackets(
            _interval(created_path, "../2017-01-01T01:01:01"),
        ...
        self.assertEqualBrackets(
            _interval(created_path, "2017-01-01T01:01:01/2018-01-01T01:01:01"),
            '( "created" IS NULL OR ( to_date( \'2017-01-01\' ) <= "created" AND "created" <= to_date( \'2018-01-01\' ) ) )',
        )
        ...
        self.assertEqualBrackets(
            _interval(created_string_path, "2017-01-01"),
        ...
        self.assertEqualBrackets(
            _interval(created_string_path, "2017-01-01T01:01:01/2018-01-01T01:01:01"),
            '( "created_string" IS NULL OR ( to_date( \'2017-01-01\' ) <= to_date( "created_string" ) AND to_date( "created_string" ) <= to_date( \'2018-01-01\' ) ) )',
        )
        ...
        self.assertEqualBrackets(
            _interval(updated_string_path, "2017-01-01T01:01:01/2018-01-01T01:01:01"),
        ...
        # Overlap of ranges
        self.assertEqualBrackets(
            _interval(date_range_path, "2010-01-01/2020-09-12"),
        ...
        _date_tester(
            created_path, "2017-01-01T01:01:01", ["bricherasio"], ["luserna", "torre"]
        )
        # Test exact no match
        _date_tester(
        ...
        # Test exact
        _date_tester(
            updated_path, "2019-01-01T01:01:01", ["bricherasio"], ["luserna", "torre"]
        )
        ...
        # Test exact no match
        _date_tester(
            updated_path, "2017-01-01T05:05:05", [], ["luserna", "bricherasio", "torre"]
        )
        ...
        _date_tester(
            ...
            "2010-01-01T01:01:01",
            ["villar"],
            ["torre", "bricherasio", "luserna"],
        )
        # Test date field exact (test that we can use a date on a datetime type field)
        _date_tester(
            both_path, "2010-01-01", ["villar"], ["luserna", "bricherasio", "torre"]
        )
        # Test exact no match
        _date_tester(
            both_path,
        ...
        _date_tester(
            created_path,
            "2016-05-04/..",
            ["bricherasio", "torre", "luserna"],
            ["villar"],
        )
        _date_tester(
            created_path, "2016-05-04/", ["bricherasio", "torre", "luserna"], ["villar"]
        )
        _date_tester(
            created_path,
            "2100-05-04/",
        ...
        _date_tester(
            created_path, "/2018-05-06", ["bricherasio", "torre", "villar"], ["luserna"]
        )
        _date_tester(
            created_path,
            "../2018-05-06",
        ...
        _date_tester(
            created_path,
            "2016-05-04T01:01:01/2018-05-06T01:01:01",
            ["bricherasio", "torre"],
            ["luserna", "villar"],
        )
        _date_tester(
        ...
        _date_tester(
            updated_path, "2020-05-04/", ["torre", "luserna"], ["bricherasio", "villar"]
        )
        _date_tester(
            updated_path, "2019-01-01/", ["torre", "luserna", "bricherasio"], ["villar"]
        )
        _date_tester(
            updated_path,
            "2019-01-01/..",
            ["torre", "luserna", "bricherasio"],
            ["villar"],
        )
        _date_tester(
            updated_path, "/2020-02-02", ["villar", "bricherasio"], ["torre", "luserna"]
        )
        _date_tester(
            updated_path,
            "../2020-02-02",
        ...
        _date_tester(
            updated_path,
            "2020-05-04T01:01:01/2022-12-31T01:01:01",
            ["torre", "luserna"],
            ["bricherasio", "villar"],
        )
        _date_tester(
        ...
        _date_tester(
            both_path, "2010-01-01/2010-01-01", ["villar"], ["luserna", "bricherasio"]
        )
        _date_tester(
            both_path,
        ...
        _date_tester(
            both_path, "../2021-01-01", ["torre", "bricherasio", "villar"], ["luserna"]
        )
        _date_tester(
        ...
        _date_tester(
            none_path, "2016-05-04/..", ["bricherasio", "torre", "luserna"], ["villar"]
        )
        _date_tester(
            none_path, "2016-05-04/", ["bricherasio", "torre", "luserna"], ["villar"]
        )
        _date_tester(
            none_path, "2100-05-04/", [], ["luserna", "bricherasio", "torre", "villar"]
        )
        _date_tester(
            none_path,
            "2100-05-04/..",
        ...
        _date_tester(
            none_path, "/2018-05-06", ["bricherasio", "torre", "villar"], ["luserna"]
        )
        _date_tester(
            none_path, "../2018-05-06", ["bricherasio", "torre", "villar"], ["luserna"]
        )
...
class Handler3(QgsServerOgcApiHandler):
    ...
    def templatePath(self, context):
        if self.templatePathOverride is None:
            return super().templatePath(context)
        else:
...
class QgsServerOgcAPITest(QgsServerAPITestBase):
    ...
    def testOgcApi(self):
        ...
        api = QgsServerOgcApi(
            self.server.serverInterface(), "/api1", "apione", "an api", "1.1"
        )
        ...
        self.assertEqual(
            api.sanitizeUrl(QtCore.QUrl("/path//double//slashes//#fr")).toString(),
    ...
    def testOgcApiHandler(self):
        ...
        api = QgsServerOgcApi(
            self.server.serverInterface(), "/api2", "apitwo", "a second api", "1.2"
        )
        ...
        ctx.request().setUrl(
            QtCore.QUrl("http://www.qgis.org/services/api2/handlerone?value1=1.2345")
        )
        params = h.values(ctx)
    ...
    def testOgcApiHandlerContentType(self):
        ...
        api = QgsServerOgcApi(
            self.server.serverInterface(), "/api3", "apithree", "a third api", "1.2"
        )
        h3 = Handler3()
        ...
        # Call HTML
        ctx.request().setUrl(
            QtCore.QUrl("http://server.qgis.org/api3/handlerthree.html?value1=9.5")
        )
        with self.assertRaises(QgsServerApiBadRequestException) as ex:
            api.executeRequest(ctx)
    ...
    def testOgcApiHandlerException(self):
        ...
        with self.assertRaises(QgsServerApiBadRequestException) as ex:
            api.executeRequest(ctx)
        self.assertEqual(str(ex.exception), "UTF-8 Exception 1 $ù~à^£")

        h.setException(QgsServerApiBadRequestException("UTF-8 Exception 2 $ù~à^£"))
        ctx.request().setUrl(QtCore.QUrl("http://www.qgis.org/handlerexception"))
        with self.assertRaises(QgsServerApiBadRequestException) as ex:
            api.executeRequest(ctx)
        self.assertEqual(str(ex.exception), "UTF-8 Exception 2 $ù~à^£")
    ...
    def test_path_capture(self):
        ...
        api = QgsServerOgcApi(
            self.server.serverInterface(), "/api4", "apifour", "a fourth api", "1.2"
        )
        ...
        self.assertEqual(
            h4.href(ctx), "http://localhost:19876/api4/france_parts?MAP=france_parts"
        )
