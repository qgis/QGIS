...
class TestQgsProviderSublayerModel(QgisTestCase):
    ...
    def test_model(self):
        ...
        self.assertEqual(model.headerData(0, Qt.Orientation.Horizontal, Qt.ItemDataRole.DisplayRole), 'Item')
        self.assertEqual(model.headerData(0, Qt.Orientation.Horizontal, Qt.ItemDataRole.ToolTipRole), 'Item')
        self.assertEqual(model.headerData(1, Qt.Orientation.Horizontal, Qt.ItemDataRole.DisplayRole), 'Description')
        self.assertEqual(model.headerData(1, Qt.Orientation.Horizontal, Qt.ItemDataRole.ToolTipRole), 'Description')
        ...
        self.assertEqual(model.data(model.index(0, 0), Qt.ItemDataRole.DisplayRole), 'layer 1')
        self.assertEqual(model.data(model.index(0, 1), Qt.ItemDataRole.DisplayRole), 'description 1')
        ...
        self.assertEqual(model.data(model.index(1, 0), Qt.ItemDataRole.DisplayRole), 'layer 2')
        self.assertEqual(model.data(model.index(1, 1), Qt.ItemDataRole.DisplayRole), 'description 2 - LineString (Uncounted)')
        ...
        self.assertEqual(model.data(model.index(2, 0), Qt.ItemDataRole.DisplayRole), 'layer 3')
        self.assertEqual(model.data(model.index(2, 1), Qt.ItemDataRole.DisplayRole), 'Polygon (1,001)')
        ...
        self.assertEqual(model.data(model.index(1, 0), Qt.ItemDataRole.DisplayRole), 'layer 3')
        self.assertEqual(model.data(model.index(1, 1), Qt.ItemDataRole.DisplayRole), 'Polygon (1,001)')
        self.assertEqual(model.data(model.index(1, 0), QgsProviderSublayerModel.Role.ProviderKey), 'ogr')
        self.assertEqual(model.data(model.index(1, 0), QgsProviderSublayerModel.Role.LayerType), QgsMapLayerType.VectorLayer)
        ...
        self.assertEqual(model.rowCount(QModelIndex()), 1)
        self.assertEqual(model.data(model.index(0, 0), Qt.ItemDataRole.DisplayRole), 'layer 3')
        self.assertEqual(model.data(model.index(0, 1), Qt.ItemDataRole.DisplayRole), 'Polygon (1,001)')
    ...
    def test_model_with_non_layer_items(self):
        ...
        self.assertEqual(model.data(model.index(1, 0), Qt.ItemDataRole.DisplayRole), 'item name 1')
        self.assertEqual(model.data(model.index(1, 1), Qt.ItemDataRole.DisplayRole), 'item desc 1')
        ...
        self.assertEqual(model.data(model.index(2, 0), Qt.ItemDataRole.DisplayRole), 'item name 2')
        self.assertEqual(model.data(model.index(2, 1), Qt.ItemDataRole.DisplayRole), 'item desc 2')
    ...
    def test_model_with_paths(self):
        ...
        self.assertEqual(model.data(path_group_index, Qt.ItemDataRole.DisplayRole), 'path')
        self.assertEqual(model.rowCount(path_group_index), 1)
        self.assertEqual(model.data(model.index(0, 0, path_group_index), Qt.ItemDataRole.DisplayRole), 'layer 1')
        self.assertEqual(model.data(model.index(0, 1, path_group_index), Qt.ItemDataRole.DisplayRole), 'description 1')
        ...
        self.assertEqual(model.data(layer2_index, Qt.ItemDataRole.DisplayRole), 'layer 2')
        self.assertEqual(model.data(model.index(1, 1, my_group_index), Qt.ItemDataRole.DisplayRole), 'description 2 - LineString (Uncounted)')
        ...
        self.assertEqual(model.data(layer1_index, Qt.ItemDataRole.DisplayRole), 'layer 1')
        self.assertEqual(model.data(model.index(0, 1, path_group_index), Qt.ItemDataRole.DisplayRole), 'description 1')
        ...
        self.assertEqual(model.data(layer3_index, Qt.ItemDataRole.DisplayRole), 'layer 3')
        self.assertEqual(model.data(model.index(1, 1), Qt.ItemDataRole.DisplayRole), 'Polygon (1,001)')
    ...
    def test_proxy(self):
        ...
        self.assertEqual(proxy.headerData(0, Qt.Orientation.Horizontal, Qt.ItemDataRole.DisplayRole), 'Item')
        self.assertEqual(proxy.headerData(0, Qt.Orientation.Horizontal, Qt.ItemDataRole.ToolTipRole), 'Item')
        self.assertEqual(proxy.headerData(1, Qt.Orientation.Horizontal, Qt.ItemDataRole.DisplayRole), 'Description')
        self.assertEqual(proxy.headerData(1, Qt.Orientation.Horizontal, Qt.ItemDataRole.ToolTipRole), 'Description')
        ...
        self.assertEqual(proxy.data(proxy.index(0, 0), Qt.ItemDataRole.DisplayRole), 'item name 1')
        self.assertEqual(proxy.data(proxy.index(0, 1), Qt.ItemDataRole.DisplayRole), 'item desc 1')
        ...
        self.assertEqual(proxy.data(proxy.index(1, 0), Qt.ItemDataRole.DisplayRole), 'another layer 2')
        self.assertEqual(proxy.data(proxy.index(1, 1), Qt.ItemDataRole.DisplayRole), 'description 2 - LineString (Uncounted)')
        ...
        self.assertEqual(proxy.data(proxy.index(2, 0), Qt.ItemDataRole.DisplayRole), 'layer 1')
        self.assertEqual(proxy.data(proxy.index(2, 1), Qt.ItemDataRole.DisplayRole), 'description 1')
        ...
        self.assertEqual(proxy.data(proxy.index(3, 0), Qt.ItemDataRole.DisplayRole), 'yet another layer 3')
        self.assertEqual(proxy.data(proxy.index(3, 1), Qt.ItemDataRole.DisplayRole), 'an empty layer - Polygon (0)')
        ...
        self.assertEqual(proxy.data(proxy.index(0, 0), Qt.ItemDataRole.DisplayRole), 'item name 1')
        self.assertEqual(proxy.data(proxy.index(1, 0), Qt.ItemDataRole.DisplayRole), 'layer 1')

        proxy.setFilterString(' 2')
        self.assertEqual(proxy.rowCount(QModelIndex()), 1)
        self.assertEqual(proxy.data(proxy.index(0, 0), Qt.ItemDataRole.DisplayRole), 'another layer 2')
        ...
        self.assertEqual(proxy.rowCount(QModelIndex()), 1)
        self.assertEqual(proxy.data(proxy.index(0, 0), Qt.ItemDataRole.DisplayRole), 'yet another layer 3')
        ...
        self.assertEqual(proxy.data(proxy.index(1, 0), Qt.ItemDataRole.DisplayRole), 'another layer 2')
        self.assertEqual(proxy.data(proxy.index(2, 0), Qt.ItemDataRole.DisplayRole), 'layer 1')
        self.assertEqual(proxy.data(proxy.index(3, 0), Qt.ItemDataRole.DisplayRole), 'system table')
        self.assertEqual(proxy.data(proxy.index(4, 0), Qt.ItemDataRole.DisplayRole), 'yet another layer 3')
