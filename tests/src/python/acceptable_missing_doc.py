...
ACCEPTABLE_MISSING_DOCS = {
    ...
    "QgsStyleV2": ["symbolSaved(const QString &name, QgsSymbol *symbol)"],
    ...
    "QgsEllipseSymbolLayerV2": ["symbolHeight() const ", "setOutlineWidthMapUnitScale(const QgsMapUnitScale &scale)", "setSymbolWidth(double w)", "setOutlineWidth(double w)", "symbolHeightUnit() const ", "outlineWidthUnit() const ", "setSymbolWidthUnit(QgsSymbol::OutputUnit unit)", "setSymbolHeightUnit(QgsSymbol::OutputUnit unit)", "symbolHeightMapUnitScale() const ", "symbolWidthMapUnitScale() const ", "setOutlineStyle(Qt::PenStyle outlineStyle)", "outlineStyle() const ", "setSymbolHeight(double h)", "setSymbolName(const QString &name)", "createFromSld(QDomElement &element)", "outlineWidthMapUnitScale() const ", "setOutlineWidthUnit(QgsSymbol::OutputUnit unit)", "symbolName() const ", "setSymbolWidthMapUnitScale(const QgsMapUnitScale &scale)", "setSymbolHeightMapUnitScale(const QgsMapUnitScale &scale)", "symbolWidthUnit() const ", "create(const QgsStringMap &properties=QgsStringMap())", "symbolWidth() const ", "outlineWidth() const "],
