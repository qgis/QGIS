...
ACCEPTABLE_MISSING_DOCS = {
    ...
    "QgsLegendModel": ["QgsLegendModel(QgsLayerTreeGroup *rootNode, QObject *parent=nullptr)"],
    ...
    "QgsSimpleFillSymbolLayerWidget": ["setBrushStyle()", "create(const QgsVectorLayer *vl)", "offsetChanged()", "QgsSimpleFillSymbolLayerWidget(const QgsVectorLayer *vl, QWidget *parent=nullptr)", "borderWidthChanged()", "setBorderColor(const QColor &color)", "setColor(const QColor &color)", "borderStyleChanged()"],
    ...
    "QgsSimpleMarkerSymbolLayerWidget": ["setName()", "setAngle()", "create(const QgsVectorLayer *vl)", "setColorBorder(const QColor &color)", "setColorFill(const QColor &color)", "QgsSimpleMarkerSymbolLayerWidget(const QgsVectorLayer *vl, QWidget *parent=nullptr)", "setSize()", "setOffset()"],
