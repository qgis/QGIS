...
ACCEPTABLE_MISSING_DOCS = {
    ...
    "QgsSvgSelectorDialog": ["QgsSvgSelectorDialog(QWidget *parent=nullptr, Qt::WindowFlags fl=QgisGui::ModalDialogFlags, const QDialogButtonBox::StandardButtons &buttons=QDialogButtonBox::Close|QDialogButtonBox::Ok, Qt::Orientation orientation=Qt::Horizontal)"],
    ...
    "QgsRendererV2AbstractMetadata": ["icon() const ", "createRendererFromSld(QDomElement &elem, QgsWkbTypes::GeometryType geomType)", "setIcon(const QIcon &icon)", "QgsRendererV2AbstractMetadata(const QString &name, const QString &visibleName, const QIcon &icon=QIcon())", "visibleName() const ", "name() const "],
    ...
    "QgsRendererRulePropsDialog": ["QgsRendererRulePropsDialog(QgsRuleBasedRendererV2::Rule *rule, QgsVectorLayer *layer, QgsStyle *style, QWidget *parent=nullptr, QgsMapCanvas *mapCanvas=nullptr)", "rule()", "buildExpression()", "testFilter()"],
    ...
    "QgsSingleSymbolRendererV2Widget": ["changeSingleSymbol()", "scaleMethodChanged(QgsSymbol::ScaleMethod scaleMethod)", "QgsSingleSymbolRendererV2Widget(QgsVectorLayer *layer, QgsStyle *style, QgsFeatureRendererV2 *renderer)", "create(QgsVectorLayer *layer, QgsStyle *style, QgsFeatureRendererV2 *renderer)", "sizeScaleFieldChanged(const QString &fldName)", "showSymbolLevels()"],
    ...
    "QgsRendererV2PropertiesDialog": ["apply()", "onOK()", "QgsRendererV2PropertiesDialog(QgsVectorLayer *layer, QgsStyle *style, bool embedded=false)"],
    ...
    "QgsNewMemoryLayerDialog": ["QgsNewMemoryLayerDialog(QWidget *parent=nullptr, Qt::WindowFlags fl=QgisGui::ModalDialogFlags)"],
    ...
    "QgsMarkerSymbolLayerV2": ["setAngle(double angle)", "sizeMapUnitScale() const ", "scaleMethod() const ", "VerticalAnchorPoint", "offsetMapUnitScale() const ", "renderPoint(QPointF point, QgsSymbolRenderContext &context)=0", "setOffsetUnit(QgsSymbol::OutputUnit unit)", "setSizeUnit(QgsSymbol::OutputUnit unit)", "setVerticalAnchorPoint(VerticalAnchorPoint v)", "setHorizontalAnchorPoint(HorizontalAnchorPoint h)", "_rotatedOffset(QPointF offset, double angle)", "writeSldMarker(QDomDocument &doc, QDomElement &element, const QgsStringMap &props) const ", "offsetUnit() const ", "offset() const ", "sizeUnit() const ", "QgsMarkerSymbolLayerV2(bool locked=false)", "setSize(double size)", "setSizeMapUnitScale(const QgsMapUnitScale &scale)", "size() const ", "horizontalAnchorPoint() const ", "setScaleMethod(QgsSymbol::ScaleMethod scaleMethod)", "setOffset(QPointF offset)", "markerOffset(QgsSymbolRenderContext &context, double &offsetX, double &offsetY) const ", "verticalAnchorPoint() const ", "HorizontalAnchorPoint", "setOffsetMapUnitScale(const QgsMapUnitScale &scale)", "angle() const "],
    ...
    "QgsFillSymbolV2": ["setAngle(double angle)", "QgsFillSymbolV2(const QgsSymbolLayerList &layers=QgsSymbolLayerList())", "renderPolygon(const QPolygonF &points, QList< QPolygonF > *rings, const QgsFeature *f, QgsRenderContext &context, int layer=-1, bool selected=false)"],
    ...
    "QgsRuleBasedRendererV2": ["createFromSld(QDomElement &element, QgsWkbTypes::GeometryType geomType)", "FeatureFlags", "None", "create(QDomElement &element)", "rootRule()"],
    ...
    "QgsCharacterSelectorDialog": ["QgsCharacterSelectorDialog(QWidget *parent=nullptr, Qt::WindowFlags fl=QgisGui::ModalDialogFlags)", "selectCharacter(bool *gotChar, const QFont &font, const QString &style)"],
    ...
    "QgsCredentialDialog": ["QgsCredentialDialog(QWidget *parent=nullptr, Qt::WindowFlags fl=QgisGui::ModalDialogFlags)"],
    "QgsRuleBasedLabeling": ["rootRule()", "None", "rootRule() const "],
    "QgsLUDialog": ["QgsLUDialog(QWidget *parent=nullptr, Qt::WindowFlags fl=QgisGui::ModalDialogFlags)", "lowerValue() const ", "setLowerValue(const QString &val)", "upperValue() const ", "setUpperValue(const QString &val)"],
    ...
    "QgsMessageLogViewer": ["QgsMessageLogViewer(QStatusBar *statusBar=nullptr, QWidget *parent=nullptr, Qt::WindowFlags fl=QgisGui::ModalDialogFlags)", "logMessage(QString message, QString tag, QgsMessageLog::MessageLevel level)"],
    ...
    "QgsFillSymbolLayerV2": ["setAngle(double angle)", "renderPolygon(const QPolygonF &points, QList< QPolygonF > *rings, QgsSymbolRenderContext &context)=0", "QgsFillSymbolLayerV2(bool locked=false)", "angle() const "],
    ...
    "QgsPointDisplacementRendererWidget": ["create(QgsVectorLayer *layer, QgsStyle *style, QgsFeatureRendererV2 *renderer)", "QgsPointDisplacementRendererWidget(QgsVectorLayer *layer, QgsStyle *style, QgsFeatureRendererV2 *renderer)"],
    ...
    "QgsNewVectorLayerDialog": ["QgsNewVectorLayerDialog(QWidget *parent=nullptr, Qt::WindowFlags fl=QgisGui::ModalDialogFlags)", "nameChanged(const QString &)", "selectionChanged()", "runAndCreateLayer(QWidget *parent=nullptr, QString *enc=nullptr)"],
    ...
    "QgsErrorDialog": ["QgsErrorDialog(const QgsError &theError, const QString &theTitle, QWidget *parent=nullptr, Qt::WindowFlags fl=QgisGui::ModalDialogFlags)"],
    ...
    "QgsDialog": ["QgsDialog(QWidget *parent=nullptr, Qt::WindowFlags fl=QgisGui::ModalDialogFlags, const QDialogButtonBox::StandardButtons &buttons=QDialogButtonBox::Close, Qt::Orientation orientation=Qt::Horizontal)"],
    ...
    "QgsRendererCategoryV2": ["label() const ", "swap(QgsRendererCategoryV2 &other)", "symbol() const ", "setValue(const QVariant &value)", "renderState() const ", "toSld(QDomDocument &doc, QDomElement &element, QgsStringMap props) const ", "setRenderState(bool render)", "value() const ", "setSymbol(QgsSymbol *s)", "dump() const ", "setLabel(const QString &label)"],
    ...
    "QgsSublayersDialog": ["selectionIndexes()", "ProviderType", "exec()", "QgsSublayersDialog(ProviderType providerType, const QString &name, QWidget *parent=nullptr, Qt::WindowFlags fl=0)", "populateLayerTable(const QStringList &theList, const QString &delim=\":\")", "selectionNames()"],
    ...
    "QgsRendererV2Widget": ["refreshSymbolView()", "QgsRendererV2Widget(QgsVectorLayer *layer, QgsStyle *style)", "copy()", "contextMenuViewCategories(QPoint p)", "paste()"],
    ...
    "QgsSymbolLegendNode": ["QgsSymbolLegendNode(QgsLayerTreeLayer *nodeLayer, const QgsLegendSymbolItemV2 &item, QObject *parent=nullptr)"],
