...
ACCEPTABLE_MISSING_DOCS = {
    ...
    "QgsSvgSelectorDialog": ["QgsSvgSelectorDialog(QWidget *parent=0, Qt::WindowFlags fl=QgisGui::ModalDialogFlags, const QDialogButtonBox::StandardButtons &buttons=QDialogButtonBox::Close|QDialogButtonBox::Ok, Qt::Orientation orientation=Qt::Horizontal)"],
    ...
    "QgsVectorRandomColorRampDialog": ["setSat1(int val)", "QgsVectorRandomColorRampDialog(QgsVectorRandomColorRamp *ramp, QWidget *parent=0)", "setVal1(int val)", "setCount(int val)", "setSat2(int val)", "setVal2(int val)", "setHue2(int val)", "setHue1(int val)", "updatePreview()"],
    ...
    "QgsShapeburstFillSymbolLayerWidget": ["applyColorRamp()", "create(const QgsVectorLayer *vl)", "offsetChanged()", "setColor(const QColor &color)", "setColor2(const QColor &color)", "QgsShapeburstFillSymbolLayerWidget(const QgsVectorLayer *vl, QWidget *parent=0)", "colorModeChanged()"],
    ...
    "QgsGroupBoxCollapseButton": ["QgsGroupBoxCollapseButton(QWidget *parent=0)", "shiftDown() const ", "setAltDown(bool updown)", "setShiftDown(bool shiftdown)", "altDown() const "],
    ...
    "QgsHiddenWidgetWrapper": ["QgsHiddenWidgetWrapper(QgsVectorLayer *vl, int fieldIdx, QWidget *editor=0, QWidget *parent=0)"],
    ...
    "QgsCheckBoxConfigDlg": ["QgsCheckBoxConfigDlg(QgsVectorLayer *vl, int fieldIdx, QWidget *parent=0)"],
    ...
    "QgsFontMarkerSymbolLayerWidget": ["setAngle(double angle)", "create(const QgsVectorLayer *vl)", "setFontFamily(const QFont &font)", "QgsFontMarkerSymbolLayerWidget(const QgsVectorLayer *vl, QWidget *parent=0)", "setColor(const QColor &color)", "setOffset()", "setCharacter(QChar chr)", "setSize(double size)"],
    "QgsStyleManagerDialog": ["removeItem()", "importItems()", "removeSymbol()", "addColorRamp(QAction *action)", "exportItemsSVG()", "editItem()", "exportSelectedItemsImages(const QString &dir, const QString &format, QSize size)", "editSymbol()", "editColorRamp()", "currentItemType()", "addGroup()", "groupSelectedSymbols()", "groupChanged(const QModelIndex &)", "addItem()", "itemChanged(QStandardItem *item)", "removeGroup()", "QgsStyleManagerDialog(QgsStyle *style, QWidget *parent=0)", "groupRenamed(QStandardItem *)", "removeColorRamp()", "exportItemsPNG()", "exportItems()", "currentItemName()"],
    "QgsVectorColorBrewerColorRampDialog": ["setSchemeName()", "populateVariants()", "QgsVectorColorBrewerColorRampDialog(QgsVectorColorBrewerColorRamp *ramp, QWidget *parent=0)", "setColors()", "updatePreview()"],
    ...
    "QgsFeatureListViewDelegate": ["editButtonClicked(QModelIndex &index)", "positionToElement(QPoint pos)", "QgsFeatureListViewDelegate(QgsFeatureListModel *listModel, QObject *parent=0)", "setCurrentFeatureEdited(bool state)", "setFeatureSelectionModel(QgsFeatureSelectionModel *featureSelectionModel)", "Element", "setEditSelectionModel(QItemSelectionModel *editSelectionModel)"],
    ...
    "QgsTransformWidget": ["QgsTransformWidget(QWidget *parent=0)", "create()"],
    ...
    "QgsPenCapStyleComboBox": ["QgsPenCapStyleComboBox(QWidget *parent=0)", "penCapStyle() const ", "setPenCapStyle(Qt::PenCapStyle style)"],
    ...
    "QgsVectorGradientColorRampDialog": ["setItemStopColor(const QColor &newColor)", "setColor1(const QColor &color)", "stopDoubleClicked(QTreeWidgetItem *item, int column)", "setStopColor(QTreeWidgetItem *item, const QColor &color)", "QgsVectorGradientColorRampDialog(QgsVectorGradientColorRamp *ramp, QWidget *parent=0)", "setColor2(const QColor &color)", "addStop()", "toggledStops(bool on)", "removeStop()", "updateStops()", "updatePreview()"],
    "QgsCptCityColorRampDialog": ["clearCopyingInfo()", "showAll()", "saveAsGradientRamp() const ", "updatePreview(bool clear=false)", "setTreeModel(QgsCptCityBrowserModel *model)", "updateCopyingInfo(const QMap< QString, QString > &copyingMap)", "QgsCptCityColorRampDialog(QgsCptCityColorRamp *ramp, QWidget *parent=0)", "updateTreeView(QgsCptCityDataItem *item, bool resetRamp=true)", "onFinished()", "updateRamp()", "populateVariants()", "updateListWidget(QgsCptCityDataItem *item)", "selectedName() const "],
    ...
    "QgsExpressionBuilderDialog": ["QgsExpressionBuilderDialog(QgsVectorLayer *layer, const QString &startText=QString(), QWidget *parent=0, const QString &key=\"generic\", const QgsExpressionContext &context=QgsExpressionContext())", "expressionText()", "setExpressionText(const QString &text)"],
    ...
    "QgsEffectDrawModeComboBox": ["QgsEffectDrawModeComboBox(QWidget *parent=0)"],
    ...
    "QgsRasterResampleFilter": ["setMaxOversampling(double os)", "QgsRasterResampleFilter(QgsRasterInterface *input=0)", "zoomedInResampler() const ", "zoomedOutResampler() const ", "maxOversampling() const "],
    ...
    "QgsHtmlAnnotationItem": ["QgsHtmlAnnotationItem(QgsMapCanvas *canvas, QgsVectorLayer *vlayer=0, bool hasFeature=false, int feature=0)", "htmlPage() const ", "vectorLayer() const ", "setHTMLPage(const QString &htmlFile)"],
    "QgsWkbException": ["QgsWkbException(QString const &what)"],
    "QgsSmartGroupEditorDialog": ["QgsSmartGroupEditorDialog(QgsStyle *style, QWidget *parent=0)"],
    ...
    "QgsBrushStyleComboBox": ["setBrushStyle(Qt::BrushStyle style)", "QgsBrushStyleComboBox(QWidget *parent=0)", "iconForBrush(Qt::BrushStyle style)", "brushStyle() const "],
    ...
    "QgsRasterRenderer": ["opacity() const ", "MinMaxOrigin", "QgsRasterRenderer(QgsRasterInterface *input=0, const QString &type=\"\")", "rasterTransparency() const ", "type() const ", "minMaxOriginLabel(int origin)", "setAlphaBand(int band)", "minMaxOriginFromName(const QString &name)", "setOpacity(double opacity)", "usesTransparency() const ", "alphaBand() const ", "setRasterTransparency(QgsRasterTransparency *t)", "minMaxOriginName(int origin)"],
    ...
    "QgsBrightnessContrastFilter": ["contrast() const ", "setContrast(int contrast)", "brightness() const ", "setBrightness(int brightness)", "QgsBrightnessContrastFilter(QgsRasterInterface *input=0)"],
    ...
    "QgsRendererRulePropsDialog": ["QgsRendererRulePropsDialog(QgsRuleBasedRenderer::Rule *rule, QgsVectorLayer *layer, QgsStyle *style, QWidget *parent=0, QgsMapCanvas *mapCanvas=0)", "rule()", "buildExpression()", "testFilter()"],
    ...
    "QgsMultiBandColorRenderer": ["greenContrastEnhancement() const ", "blueBand() const ", "setGreenBand(int band)", "setRedBand(int band)", "QgsMultiBandColorRenderer(QgsRasterInterface *input, int redBand, int greenBand, int blueBand, QgsContrastEnhancement *redEnhancement=0, QgsContrastEnhancement *greenEnhancement=0, QgsContrastEnhancement *blueEnhancement=0)", "redBand() const ", "create(const QDomElement &elem, QgsRasterInterface *input)", "greenBand() const ", "setBlueBand(int band)", "redContrastEnhancement() const ", "blueContrastEnhancement() const "],
    ...
    "QgsWMSLegendNode": ["QgsWMSLegendNode(QgsLayerTreeLayer *nodeLayer, QObject *parent=0)"],
    ...
    "QgsClassificationWidgetWrapper": ["QgsClassificationWidgetWrapper(QgsVectorLayer *vl, int fieldIdx, QWidget *editor=0, QWidget *parent=0)"],
    ...
    "QgsLayerTreeViewDefaultActions": ["actionShowFeatureCount(QObject *parent=0)", "actionShowInOverview(QObject *parent=0)", "showFeatureCount()", "uniqueGroupName(QgsLayerTreeGroup *parentGroup)", "actionZoomToLayer(QgsMapCanvas *canvas, QObject *parent=0)", "zoomToGroup()", "zoomToLayers(QgsMapCanvas *canvas, const QList< QgsMapLayer * > &layers)", "zoomToLayer(QgsMapCanvas *canvas)", "zoomToLayer()", "makeTopLevel()", "renameGroupOrLayer()", "actionAddGroup(QObject *parent=0)", "addGroup()", "actionGroupSelected(QObject *parent=0)", "groupSelected()", "actionRemoveGroupOrLayer(QObject *parent=0)", "zoomToGroup(QgsMapCanvas *canvas)", "actionZoomToGroup(QgsMapCanvas *canvas, QObject *parent=0)", "QgsLayerTreeViewDefaultActions(QgsLayerTreeView *view)", "removeGroupOrLayer()", "actionRenameGroupOrLayer(QObject *parent=0)", "actionMakeTopLevel(QObject *parent=0)", "showInOverview()"],
    ...
    "QgsMapOverviewCanvas": ["destinationSrsChanged()", "QgsMapOverviewCanvas(QWidget *parent=0, QgsMapCanvas *mapCanvas=0)", "layerRepaintRequested()", "hasCrsTransformEnabled(bool flag)", "enableAntiAliasing(bool flag)", "layerSet() const ", "updateFullExtent()", "mapRenderingFinished()"],
    "QgsMapCanvasSnappingUtils": ["QgsMapCanvasSnappingUtils(QgsMapCanvas *canvas, QObject *parent=0)"],
    ...
    "QgsStyleGroupSelectionDialog": ["QgsStyleGroupSelectionDialog(QgsStyle *style, QWidget *parent=0)"],
    "QgsCheckboxWidgetWrapper": ["QgsCheckboxWidgetWrapper(QgsVectorLayer *vl, int fieldIdx, QWidget *editor=0, QWidget *parent=0)"],
    ...
    "QgsDateTimeEditWrapper": ["QgsDateTimeEditWrapper(QgsVectorLayer *vl, int fieldIdx, QWidget *editor, QWidget *parent=0)"],
    ...
    "QgsScaleComboBox": ["QgsScaleComboBox(QWidget *parent=0)", "updateScales(const QStringList &scales=QStringList())"],
    ...
    "QgsSymbolLayerWidget": ["setSymbolLayer(QgsSymbolLayer *layer)=0", "updateDataDefinedProperty()", "QgsSymbolLayerWidget(QWidget *parent, const QgsVectorLayer *vl=0)", "symbolLayer()=0"],
    ...
    "QgsNetworkAccessManager": ["QgsNetworkAccessManager(QObject *parent=0)", "requestCreated(QNetworkReply *)", "requestTimedOut(QNetworkReply *)", "requestAboutToBeCreated(QNetworkAccessManager::Operation, const QNetworkRequest &, QIODevice *)"],
    ...
    "QgsGeos": ["asGeos(const QgsAbstractGeometry *geom, double precision=0)", "getGEOSHandler()", "coordSeqPoint(const GEOSCoordSequence *cs, int i, bool hasZ, bool hasM)", "reshapeGeometry(const QgsLineString &reshapeWithLine, int *errorCode, QString *errorMsg=0) const ", "fromGeosPolygon(const GEOSGeometry *geos)"],
    ...
    "QgsMessageViewer": ["setCheckBoxText(const QString &text)", "setMessageAsPlainText(const QString &msg)", "checkBoxState()", "setCheckBoxState(Qt::CheckState state)", "setCheckBoxVisible(bool visible)", "setCheckBoxQgsSettingsLabel(const QString &label)", "setMessageAsHtml(const QString &msg)", "QgsMessageViewer(QWidget *parent=0, Qt::WindowFlags fl=QgisGui::ModalDialogFlags, bool deleteOnClose=true)"],
    ...
    "QgsRangeWidgetWrapper": ["QgsRangeWidgetWrapper(QgsVectorLayer *vl, int fieldIdx, QWidget *editor, QWidget *parent=0)", "valueChanged(const QVariant &)"],
    ...
    "QgsNewMemoryLayerDialog": ["QgsNewMemoryLayerDialog(QWidget *parent=0, Qt::WindowFlags fl=QgisGui::ModalDialogFlags)"],
    "QgsBrowserModel": ["dataItem(const QModelIndex &idx) const ", "endRemoveItems()", "connectItem(QgsDataItem *item)", "beginRemoveItems(QgsDataItem *parent, int first, int last)", "itemStateChanged(QgsDataItem *item, QgsDataItem::State oldState)", "ItemDataRole", "findItem(QgsDataItem *item, QgsDataItem *parent=0) const ", "removeFavourite(const QModelIndex &index)", "addFavouriteDirectory(const QString &favDir)", "beginInsertItems(QgsDataItem *parent, int first, int last)", "QgsBrowserModel(QObject *parent=0)", "itemDataChanged(QgsDataItem *item)", "removeRootItems()", "updateProjectHome()", "endInsertItems()"],
    "QgsExpression::NodeCondition": ["NodeCondition(const WhenThenList &conditions, Node *elseExp=0)", "NodeCondition(WhenThenList *conditions, Node *elseExp=0)"],
    ...
    "QgsColorRampComboBox": ["QgsColorRampComboBox(QWidget *parent=0)", "colorRampChanged(int index)"],
    "QgsSvgSelectorWidget": ["imagesListView()", "svgSelected(const QString &path)", "filePathLineEdit()", "selectorLayout()", "QgsSvgSelectorWidget(QWidget *parent=0)", "relativePathCheckbox()", "currentSvgPathToName() const ", "currentSvgPath() const ", "groupsTreeView()", "filePathButton()", "create(QWidget *parent=0)", "populateList()"],
    "QgsEnumerationWidgetWrapper": ["QgsEnumerationWidgetWrapper(QgsVectorLayer *vl, int fieldIdx, QWidget *editor=0, QWidget *parent=0)"],
    ...
    "QgsPointLocator_VisitorNearestEdge": ["QgsPointLocator_VisitorNearestEdge(QgsPointLocator *pl, QgsPointLocator::Match &m, const QgsPoint &srcPoint, QgsPointLocator::MatchFilter *filter=0)"],
    ...
    "QgsCollapsibleGroupBoxBasic": ["QgsCollapsibleGroupBoxBasic(const QString &title, QWidget *parent=0)", "checkToggled(bool ckd)", "QgsCollapsibleGroupBoxBasic(QWidget *parent=0)", "init()", "clearModifiers()", "titleRect() const ", "checkClicked(bool ckd)", "updateStyle()", "toggleCollapsed()"],
    ...
    "QgsAttributeEditor": ["QgsAttributeEditor(QObject *parent, QgsVectorLayer *vl=0, int idx=-1)", "setValue(QWidget *widget, QgsVectorLayer *vl, int idx, const QVariant &value)", "retrieveValue(QWidget *widget, QgsVectorLayer *vl, int idx, QVariant &value)"],
    ...
    "QgsDashSpaceDialog": ["QgsDashSpaceDialog(const QVector< qreal > &v, QWidget *parent=0, Qt::WindowFlags f=0)", "dashDotVector() const "],
    ...
    "QgsDrawSourceWidget": ["create()", "QgsDrawSourceWidget(QWidget *parent=0)"],
    "QgsRelationWidgetWrapper": ["QgsRelationWidgetWrapper(QgsVectorLayer *vl, const QgsRelation &relation, QWidget *editor=0, QWidget *parent=0)"],
    ...
    "QgsRasterFillSymbolLayerWidget": ["QgsRasterFillSymbolLayerWidget(const QgsVectorLayer *vl, QWidget *parent=0)", "create(const QgsVectorLayer *vl)"],
    ...
    "QgsLayerTreeRegistryBridge": ["groupWillRemoveChildren(QgsLayerTreeNode *node, int indexFrom, int indexTo)", "QgsLayerTreeRegistryBridge(QgsLayerTreeGroup *root, QObject *parent=0)", "removeLayersFromRegistry(const QStringList &layerIds)", "isEnabled() const ", "layersAdded(const QList< QgsMapLayer * > &layers)", "newLayersVisible() const ", "setEnabled(bool enabled)", "layersWillBeRemoved(const QStringList &layerIds)", "setNewLayersVisible(bool enabled)", "groupRemovedChildren()"],
    ...
    "QgsCentroidFillSymbolLayerWidget": ["create(const QgsVectorLayer *vl)", "QgsCentroidFillSymbolLayerWidget(const QgsVectorLayer *vl, QWidget *parent=0)"],
    "QgsLinePatternFillSymbolLayerWidget": ["create(const QgsVectorLayer *vl)", "QgsLinePatternFillSymbolLayerWidget(const QgsVectorLayer *vl, QWidget *parent=0)"],
    ...
    "QgsScaleVisibilityDialog": ["QgsScaleVisibilityDialog(QWidget *parent=0, const QString &title=QString(), QgsMapCanvas *mapCanvas=0)"],
    ...
    "QgsPaintEffectWidget": ["QgsPaintEffectWidget(QWidget *parent=0)"],
    ...
    "QgsEncodingFileDialog": ["saveUsedEncoding()", "QgsEncodingFileDialog(QWidget *parent=0, const QString &caption=QString(), const QString &directory=QString(), const QString &filter=QString(), const QString &encoding=QString())", "pbnCancelAll_clicked()"],
    ...
    "QgsValueMapWidgetWrapper": ["QgsValueMapWidgetWrapper(QgsVectorLayer *vl, int fieldIdx, QWidget *editor=0, QWidget *parent=0)"],
    ...
    "QgsSimpleFillSymbolLayerWidget": ["setBrushStyle()", "create(const QgsVectorLayer *vl)", "offsetChanged()", "QgsSimpleFillSymbolLayerWidget(const QgsVectorLayer *vl, QWidget *parent=0)", "strokeWidthChanged()", "setStrokeColor(const QColor &color)", "setColor(const QColor &color)", "strokeStyleChanged()"],
    "QgsValueRelationWidgetWrapper": ["orderByKeyLessThan(const QgsValueRelationWidgetWrapper::ValueRelationItem &p1, const QgsValueRelationWidgetWrapper::ValueRelationItem &p2)", "orderByValueLessThan(const QgsValueRelationWidgetWrapper::ValueRelationItem &p1, const QgsValueRelationWidgetWrapper::ValueRelationItem &p2)", "QgsValueRelationWidgetWrapper(QgsVectorLayer *vl, int fieldIdx, QWidget *editor=0, QWidget *parent=0)", "createCache(const QVariantMap &config)", "None"],
    ...
    "QgsGenericFeatureSelectionManager": ["QgsGenericFeatureSelectionManager(QObject *parent=0)", "QgsGenericFeatureSelectionManager(const QgsFeatureIds &initialSelection, QObject *parent=0)"],
    ...
    "QgsPenJoinStyleComboBox": ["penJoinStyle() const ", "setPenJoinStyle(Qt::PenJoinStyle style)", "QgsPenJoinStyleComboBox(QWidget *parent=0)"],
    ...
    "QgsAdvancedDigitizingDockWidget::CadConstraint": ["CadConstraint(QLineEdit *lineEdit, QToolButton *lockerButton, QToolButton *relativeButton=0)"],
    "QgsProject": ["readBoolEntry(const QString &scope, const QString &key, bool def=false, bool *ok=0) const ", "readEntry(const QString &scope, const QString &key, const QString &def=QString::null, bool *ok=0) const ", "dirty(bool b)", "write()", "loadingLayer(const QString &)", "writeEntry(const QString &scope, const QString &key, const QString &value)", "snapSettingsChanged()", "readNumEntry(const QString &scope, const QString &key, int def=0, bool *ok=0) const ", "writeEntry(const QString &scope, const QString &key, int value)", "relationManager() const ", "writeEntry(const QString &scope, const QString &key, const QStringList &value)", "readDoubleEntry(const QString &scope, const QString &key, double def=0, bool *ok=0) const "],
    "QgsMapLayerModel": ["removeLayers(const QStringList &layerIds)", "addLayers(const QList< QgsMapLayer * > &layers)"],
    "QgsValueRelationConfigDlg": ["editExpression()", "QgsValueRelationConfigDlg(QgsVectorLayer *vl, int fieldIdx, QWidget *parent=0)"],
    ...
    "QgsCharacterSelectorDialog": ["QgsCharacterSelectorDialog(QWidget *parent=0, Qt::WindowFlags fl=QgisGui::ModalDialogFlags)", "selectCharacter(bool *gotChar, const QFont &font, const QString &style)"],
    ...
    "QgsCredentialDialog": ["QgsCredentialDialog(QWidget *parent=0, Qt::WindowFlags fl=QgisGui::ModalDialogFlags)"],
    "QgsRuleBasedLabeling": ["rootRule()", "None", "rootRule() const "],
    "QgsLUDialog": ["QgsLUDialog(QWidget *parent=0, Qt::WindowFlags fl=QgisGui::ModalDialogFlags)", "lowerValue() const ", "setLowerValue(const QString &val)", "upperValue() const ", "setUpperValue(const QString &val)"],
    "QgsRasterHistogramWidget": ["QgsRasterHistogramWidget(QgsRasterLayer *lyr, QWidget *parent=0)"],
    "QgsUnitSelectionWidget": ["QgsUnitSelectionWidget(QWidget *parent=0)", "changed()"],
    ...
    "QgsProviderRegistry": ["registerGuis(QWidget *widget)", "selectWidget(const QString &providerKey, QWidget *parent=0, Qt::WindowFlags fl=0)", "providerLibrary(const QString &providerKey) const "],
    ...
    "QgsVectorLayerCache": ["QgsVectorLayerCache(QgsVectorLayer *layer, int cacheSize, QObject *parent=0)"],
    ...
    "QgsMarkerLineSymbolLayerWidget": ["create(const QgsVectorLayer *vl)", "setOffsetAlongLine(double val)", "setPlacement()", "setInterval(double val)", "setOffset()", "setRotate()", "QgsMarkerLineSymbolLayerWidget(const QgsVectorLayer *vl, QWidget *parent=0)"],
    ...
    "QgsManageConnectionsDialog": ["doExportImport()", "selectionChanged()", "Mode", "clearSelection()", "QgsManageConnectionsDialog(QWidget *parent=0, Mode mode=Export, Type type=WMS, const QString &fileName=\"\")", "selectAll()", "Type"],
    ...
    "QgsStyleExportImportDialog": ["QgsStyleExportImportDialog(QgsStyle *style, QWidget *parent=0, Mode mode=Export)", "Mode", "doExportImport()", "importTypeChanged(int)", "browse()"],
    ...
    "QgsAttributeForm": ["QgsAttributeForm(QgsVectorLayer *vl, const QgsFeature &feature=QgsFeature(), const QgsAttributeEditorContext &context=QgsAttributeEditorContext(), QWidget *parent=0)", "feature()"],
    ...
    "QgsSnappingUtils": ["QgsSnappingUtils(QObject *parent=0)", "IndexingStrategy", "snapToMap(const QgsPoint &pointMap, QgsPointLocator::MatchFilter *filter=0)", "currentLayer() const ", "mapSettings() const "],
    ...
    "QgsMessageLogViewer": ["QgsMessageLogViewer(QStatusBar *statusBar=0, QWidget *parent=0, Qt::WindowFlags fl=QgisGui::ModalDialogFlags)", "logMessage(QString message, QString tag, QgsMessageLog::MessageLevel level)"],
    ...
    "QgsPalLayerSettings": ["DataDefinedProperties", "ShapeType", "DirectionSymbols", "UpsideDownLabels", "QuadrantPosition", "MultiLineAlign", "writeToLayer(QgsVectorLayer *layer)", "RotationType", "ShadowType", "calculateLabelSize(const QFontMetricsF *fm, QString text, double &labelX, double &labelY, QgsFeature *f=0, QgsRenderContext *context=0)", "QgsPalLayerSettings(const QgsPalLayerSettings &s)", "SizeType", "readFromLayer(QgsVectorLayer *layer)"],
    ...
    "QgsPointLocator_VisitorNearestVertex": ["QgsPointLocator_VisitorNearestVertex(QgsPointLocator *pl, QgsPointLocator::Match &m, const QgsPoint &srcPoint, QgsPointLocator::MatchFilter *filter=0)"],
    "QgsConditionalStyle": ["QgsConditionalStyle(const QgsConditionalStyle &other)", "QgsConditionalStyle(const QString &rule)"],
    "QgsColorEffectWidget": ["QgsColorEffectWidget(QWidget *parent=0)", "create()"],
    ...
    "QgsLayerPropertiesWidget": ["updateSymbolLayerWidget(QgsSymbolLayer *layer)", "changed()", "populateLayerTypes()", "emitSignalChanged()", "QgsLayerPropertiesWidget(QgsSymbolLayer *layer, const QgsSymbol *symbol, const QgsVectorLayer *vl, QWidget *parent=0)", "changeLayer(QgsSymbolLayer *)", "layerTypeChanged()"],
    ...
    "QgsGeometryEngine": ["buffer(double distance, int segments, QString *errorMsg=0) const =0", "contains(const QgsAbstractGeometry &geom, QString *errorMsg=0) const =0", "prepareGeometry()=0", "length(QString *errorMsg=0) const =0", "splitGeometry(const QgsLineString &splitLine, QList< QgsAbstractGeometry * > &newGeometries, bool topological, QgsPointSequence &topologyTestPoints, QString *errorMsg=0) const ", "within(const QgsAbstractGeometry &geom, QString *errorMsg=0) const =0", "geometryChanged()=0", "overlaps(const QgsAbstractGeometry &geom, QString *errorMsg=0) const =0", "interpolate(double distance, QString *errorMsg=0) const =0", "intersection(const QgsAbstractGeometry &geom, QString *errorMsg=0) const =0", "centroid(QgsPointV2 &pt, QString *errorMsg=0) const =0", "simplify(double tolerance, QString *errorMsg=0) const =0", "QgsGeometryEngine(const QgsAbstractGeometry *geometry)", "isValid(QString *errorMsg=0) const =0", "area(QString *errorMsg=0) const =0", "combine(const QgsAbstractGeometry &geom, QString *errorMsg=0) const =0", "combine(const QList< QgsAbstractGeometry * > &, QString *errorMsg=0) const =0", "isEmpty(QString *errorMsg) const =0", "envelope(QString *errorMsg=0) const =0", "touches(const QgsAbstractGeometry &geom, QString *errorMsg=0) const =0", "distance(const QgsAbstractGeometry &geom, QString *errorMsg=0) const =0", "disjoint(const QgsAbstractGeometry &geom, QString *errorMsg=0) const =0", "convexHull(QString *errorMsg=0) const =0", "offsetCurve(double distance, int segments, int joinStyle, double mitreLimit, QString *errorMsg=0) const =0", "buffer(double distance, int segments, int endCapStyle, int joinStyle, double mitreLimit, QString *errorMsg=0) const =0", "pointOnSurface(QgsPointV2 &pt, QString *errorMsg=0) const =0", "intersects(const QgsAbstractGeometry &geom, QString *errorMsg=0) const =0", "difference(const QgsAbstractGeometry &geom, QString *errorMsg=0) const =0", "symDifference(const QgsAbstractGeometry &geom, QString *errorMsg=0) const =0", "isEqual(const QgsAbstractGeometry &geom, QString *errorMsg=0) const =0", "crosses(const QgsAbstractGeometry &geom, QString *errorMsg=0) const =0"],
    "QgsMapToolAdvancedDigitizing": ["cadDockWidget() const "],
    "QgsCptCityBrowserModel": ["findItem(QgsCptCityDataItem *item, QgsCptCityDataItem *parent=0) const ", "QgsCptCityBrowserModel(QObject *parent=0, QgsCptCityArchive *archive=QgsCptCityArchive::defaultArchive(), ViewType Type=Authors)", "endInsertItems()", "reload()", "beginInsertItems(QgsCptCityDataItem *parent, int first, int last)", "addRootItems()", "connectItem(QgsCptCityDataItem *item)", "refresh(const QString &path)", "beginRemoveItems(QgsCptCityDataItem *parent, int first, int last)", "endRemoveItems()", "refresh(const QModelIndex &index=QModelIndex())", "ViewType", "removeRootItems()"],
    ...
    "QgsFilterLineEdit": ["nullValue() const ", "QgsFilterLineEdit(QWidget *parent=0, const QString &nullValue=QString::null)", "cleared()", "setNullValue(const QString &nullValue)"],
    ...
    "QgsGlowWidget": ["QgsGlowWidget(QWidget *parent=0)", "create()"],
    "QgsCollapsibleGroupBox": ["setSettings(QgsSettings *settings)", "QgsCollapsibleGroupBox(QWidget *parent=0, QgsSettings *settings=0)", "QgsCollapsibleGroupBox(const QString &title, QWidget *parent=0, QgsSettings *settings=0)", "init()", "saveCollapsedState()", "saveKey() const ", "saveCheckedState()"],
    "QgsSVGFillSymbolLayerWidget": ["create(const QgsVectorLayer *vl)", "QgsSVGFillSymbolLayerWidget(const QgsVectorLayer *vl, QWidget *parent=0)", "insertIcons()"],
    ...
    "QgsPenStyleComboBox": ["setPenStyle(Qt::PenStyle style)", "iconForPen(Qt::PenStyle style)", "QgsPenStyleComboBox(QWidget *parent=0)", "penStyle() const "],
    ...
    "QgsSpatialIndexData": ["QgsSpatialIndexData(const QgsFeatureIterator &fi)", "QgsSpatialIndexData(const QgsSpatialIndexData &other)", "initTree(IDataStream *inputStream=0)"],
    ...
    "QgsTextEditConfigDlg": ["QgsTextEditConfigDlg(QgsVectorLayer *vl, int fieldIdx, QWidget *parent=0)"],
    ...
    "QgsFormAnnotationItem": ["QgsFormAnnotationItem(QgsMapCanvas *canvas, QgsVectorLayer *vlayer=0, bool hasFeature=false, int feature=0)", "vectorLayer() const ", "designerForm() const ", "setDesignerForm(const QString &uiFile)"],
    ...
    "QgsDatumTransformDialog": ["QgsDatumTransformDialog(const QString &layerName, const QList< QList< int > > &dt, QWidget *parent=0, Qt::WindowFlags f=0)"],
    ...
    "GEOSGeomScopedPtr": ["GEOSGeomScopedPtr(GEOSGeometry *geom=0)", "get() const ", "operator bool() const ", "reset(GEOSGeometry *geom)"],
    "QgsDoubleSpinBox": ["QgsDoubleSpinBox(QWidget *parent=0)", "ClearValueMode", "showClearButton() const "],
    ...
    "QgsVectorLayerSelectionManager": ["QgsVectorLayerSelectionManager(QgsVectorLayer *layer, QObject *parent=0)"],
    ...
    "QgsExpressionHighlighter": ["addFields(const QStringList &fieldList)", "QgsExpressionHighlighter(QTextDocument *parent=0)"],
    "QgsNewVectorLayerDialog": ["QgsNewVectorLayerDialog(QWidget *parent=0, Qt::WindowFlags fl=QgisGui::ModalDialogFlags)", "nameChanged(const QString &)", "selectionChanged()", "runAndCreateLayer(QWidget *parent=0, QString *enc=0)"],
    ...
    "QgsSymbolsListWidget": ["updateDataDefinedMarkerAngle()", "updateDataDefinedMarkerSize()", "changed()", "setSymbolColor(const QColor &color)", "setLineWidth(double width)", "setSymbolFromStyle(const QModelIndex &index)", "updateSymbolColor()", "updateSymbolInfo()", "setMarkerAngle(double angle)", "openStyleManager()", "QgsSymbolsListWidget(QgsSymbol *symbol, QgsStyle *style, QMenu *menu, QWidget *parent, const QgsVectorLayer *layer=0)", "symbolAddedToStyle(const QString &name, QgsSymbol *symbol)", "saveSymbol()", "clipFeaturesToggled(bool checked)", "populateSymbols(const QStringList &symbols)", "populateSymbolView()", "addSymbolToStyle()", "setMarkerSize(double size)", "updateDataDefinedLineWidth()"],
    ...
    "QgsErrorDialog": ["QgsErrorDialog(const QgsError &error, const QString &title, QWidget *parent=0, Qt::WindowFlags fl=QgisGui::ModalDialogFlags)"],
    ...
    "QgsColorWidgetWrapper": ["QgsColorWidgetWrapper(QgsVectorLayer *vl, int fieldIdx, QWidget *editor=0, QWidget *parent=0)"],
    "QgsDialog": ["QgsDialog(QWidget *parent=0, Qt::WindowFlags fl=QgisGui::ModalDialogFlags, const QDialogButtonBox::StandardButtons &buttons=QDialogButtonBox::Close, Qt::Orientation orientation=Qt::Horizontal)"],
    ...
    "QgsDirectoryParamWidget": ["showHideColumn()", "QgsDirectoryParamWidget(const QString &path, QWidget *parent=0)"],
    ...
    "QgsRasterInterface": ["QgsRasterInterface(QgsRasterInterface *input=0)", "dataTypeSize(int bandNo)", "ySize() const ", "srcInput()", "yBlockSize() const "],
    ...
    "QgsRasterFormatSaveOptionsWidget": ["validateOptions(bool gui=true, bool reportOk=true)", "setFormat(const QString &format)", "setRasterLayer(QgsRasterLayer *rasterLayer)", "setPyramidsFormat(QgsRaster::RasterPyramidsFormat format)", "QgsRasterFormatSaveOptionsWidget(QWidget *parent=0, const QString &format=\"GTiff\", QgsRasterFormatSaveOptionsWidget::Type type=Default, const QString &provider=\"gdal\")", "options() const ", "setProvider(const QString &provider)", "setRasterFileName(const QString &file)", "updateProfiles()", "helpOptions()", "apply()", "Type", "setType(QgsRasterFormatSaveOptionsWidget::Type type=Default)", "optionsChanged()"],
    ...
    "QgsPointPatternFillSymbolLayerWidget": ["QgsPointPatternFillSymbolLayerWidget(const QgsVectorLayer *vl, QWidget *parent=0)", "create(const QgsVectorLayer *vl)"],
    ...
    "QgsSmartGroupCondition": ["removed(int)", "QgsSmartGroupCondition(int id, QWidget *parent=0)", "destruct()"],
    ...
    "QgsDial": ["setSingleStep(const QVariant &step)", "variantValue() const ", "valueChanged(int)", "setMinimum(const QVariant &min)", "valueChanged(const QVariant &)", "setValue(const QVariant &value)", "setMaximum(const QVariant &max)", "QgsDial(QWidget *parent=0)"],
    ...
    "QgsSimpleMarkerSymbolLayerWidget": ["setName()", "setAngle()", "create(const QgsVectorLayer *vl)", "setColorStroke(const QColor &color)", "setColorFill(const QColor &color)", "QgsSimpleMarkerSymbolLayerWidget(const QgsVectorLayer *vl, QWidget *parent=0)", "setSize()", "setOffset()"],
    ...
    "QgsDateTimeEditConfig": ["QgsDateTimeEditConfig(QgsVectorLayer *vl, int fieldIdx, QWidget *parent=0)"],
    ...
    "QgsUniqueValuesConfigDlg": ["QgsUniqueValuesConfigDlg(QgsVectorLayer *vl, int fieldIdx, QWidget *parent=0)"],
    ...
    "QgsMapUnitScaleDialog": ["QgsMapUnitScaleDialog(QWidget *parent=0)"],
    ...
    "QgsUuidWidgetWrapper": ["QgsUuidWidgetWrapper(QgsVectorLayer *vl, int fieldIdx, QWidget *editor=0, QWidget *parent=0)"],
    "QgsSimpleLineSymbolLayerWidget": ["penStyleChanged()", "penWidthChanged()", "create(const QgsVectorLayer *vl)", "offsetChanged()", "updatePatternIcon()", "colorChanged(const QColor &color)", "QgsSimpleLineSymbolLayerWidget(const QgsVectorLayer *vl, QWidget *parent=0)"],
    "QgsRasterNuller": ["noData(int bandNo) const ", "setNoData(int bandNo, const QgsRasterRangeList &noData)", "QgsRasterNuller(QgsRasterInterface *input=0)"],
    ...
    "QgsSublayersDialog": ["selectionIndexes()", "ProviderType", "exec()", "QgsSublayersDialog(ProviderType providerType, const QString &name, QWidget *parent=0, Qt::WindowFlags fl=0)", "populateLayerTable(const QStringList &list, const QString &delim=\":\")", "selectionNames()"],
    ...
    "QgsShadowEffectWidget": ["create()", "QgsShadowEffectWidget(QWidget *parent=0)"],
    ...
    "QgsSpinBox": ["ClearValueMode", "showClearButton() const ", "QgsSpinBox(QWidget *parent=0)"],
    ...
    "QgsBlurWidget": ["create()", "QgsBlurWidget(QWidget *parent=0)"],
    ...
    "QgsVectorLayerJoinBuffer": ["vectorJoins() const ", "QgsVectorLayerJoinBuffer(QgsVectorLayer *layer=0)"],
    ...
    "QgsExternalResourceWidgetWrapper": ["QgsExternalResourceWidgetWrapper(QgsVectorLayer *vl, int fieldIdx, QWidget *editor=0, QWidget *parent=0)"],
    ...
    "QgsTextEditWrapper": ["QgsTextEditWrapper(QgsVectorLayer *vl, int fieldIdx, QWidget *editor=0, QWidget *parent=0)"],
    ...
    "QgsUniqueValuesWidgetWrapper": ["QgsUniqueValuesWidgetWrapper(QgsVectorLayer *vl, int fieldIdx, QWidget *editor=0, QWidget *parent=0)"],
    ...
    "QgsGradientFillSymbolLayerWidget": ["applyColorRamp()", "create(const QgsVectorLayer *vl)", "offsetChanged()", "QgsGradientFillSymbolLayerWidget(const QgsVectorLayer *vl, QWidget *parent=0)", "setCoordinateMode(int index)", "setGradientType(int index)", "setGradientSpread(int index)", "setColor(const QColor &color)", "referencePointChanged()", "setColor2(const QColor &color)", "colorModeChanged()"],
    "QgsSvgMarkerSymbolLayerWidget": ["setAngle()", "create(const QgsVectorLayer *vl)", "setGuiForSvg(const QgsSvgMarkerSymbolLayer *layer)", "setSize()", "populateIcons(const QModelIndex &idx)", "setOffset()", "QgsSvgMarkerSymbolLayerWidget(const QgsVectorLayer *vl, QWidget *parent=0)", "populateList()", "setName(const QModelIndex &idx)"],
