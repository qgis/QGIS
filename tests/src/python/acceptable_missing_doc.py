...
ACCEPTABLE_MISSING_DOCS = {
    ...
    "QgsProjectionSelector": ["setSelectedAuthId(const QString &authId)", "setSelectedCrsId(long theCRSID)", "QgsProjectionSelector(QWidget *parent, const char *name=\"\", const Qt::WindowFlags &fl=0)", "selectedProj4String()", "setSelectedCrsName(const QString &theCRSName)", "selectedName()", "sridSelected(const QString &theSRID)"],
    ...
    "QgsDashSpaceDialog": ["QgsDashSpaceDialog(const QVector< qreal > &v, QWidget *parent=nullptr, const Qt::WindowFlags &f=0)", "dashDotVector() const "],
    ...
    "QgsDatumTransformDialog": ["QgsDatumTransformDialog(const QString &layerName, const QList< QList< int > > &dt, QWidget *parent=nullptr, const Qt::WindowFlags &f=0)"],
    ...
    "QgsSublayersDialog": ["selectionIndexes()", "ProviderType", "exec()", "QgsSublayersDialog(ProviderType providerType, const QString &name, QWidget *parent=nullptr, const Qt::WindowFlags &fl=0)", "populateLayerTable(const QStringList &theList, const QString &delim=\":\")", "selectionNames()"],
