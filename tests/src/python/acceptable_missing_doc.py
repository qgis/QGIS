...
ACCEPTABLE_MISSING_DOCS = {
    ...
    "QgsSymbolLayerAbstractMetadata": ["QgsSymbolLayerAbstractMetadata(const QString &name, const QString &visibleName, QgsSymbolV2::SymbolType type)", "type() const ", "name() const ", "visibleName() const "],
    ...
    "QgsLayerPropertiesWidget": ["updateSymbolLayerWidget(QgsSymbolLayer *layer)", "changed()", "populateLayerTypes()", "emitSignalChanged()", "QgsLayerPropertiesWidget(QgsSymbolLayer *layer, const QgsSymbolV2 *symbol, const QgsVectorLayer *vl, QWidget *parent=nullptr)", "changeLayer(QgsSymbolLayer *)", "layerTypeChanged()"],
