...
class TestQgsDistanceArea(QgisTestCase):
    ...
    def testCrs(self):
        ...
        self.assertIn(
            da.ellipsoidCrs().toProj(),
            (
                "+proj=longlat +ellps=GRS80 +no_defs",
                "+proj=longlat +a=6378137 +rf=298.25722210100002 +no_defs",
            ),
        )
    ...
    def testBearing(self):
        ...
        self.assertAlmostEqual(
            da.bearing(QgsPointXY(145.047, -37.578), QgsPointXY(168.38, -16.95)),
            0.84685,
            5,
        )
        self.assertAlmostEqual(
            da.bearing(QgsPointXY(-19.57, 65.12), QgsPointXY(-2.63, 54.97)),
            2.11060792,
            5,
        )
        ...
        self.assertAlmostEqual(
            da.bearing(QgsPointXY(16198544, -4534850), QgsPointXY(18736872, -1877769)),
            0.8723168079,
            5,
        )
        self.assertAlmostEqual(
            da.bearing(QgsPointXY(-2074453, 9559553), QgsPointXY(-55665, 6828252)),
            2.35691008,
            5,
        )
    ...
    def testMeasureLineProjected(self):
        ...
        print(
            "setting [{}] srid [{}] description [{}] isGeographic[{}]".format(
                "Wsg84",
        ...
        print(
            "Testing Position change for[{}] years[{}]".format(
                "Ampelanlage - Potsdamer Platz, Verkehrsinsel", "1924 and 1998"
            )
        )
        ...
        distance_wsg84_mapunits_format = QgsDistanceArea.formatDistance(
            0.000362, 7, QgsUnitTypes.DistanceUnit.DistanceDegrees, True
        )
        ...
        point_soldner_1998_result = point_soldner_1924.project(
            distance_qpoint, azimuth_qpoint
        )
        ...
        length_1998_mapunits, point_soldner_1998_result = da_3068.measureLineProjected(
            point_soldner_1924, distance_soldner_meters, azimuth_qpoint
        )
        self.assertEqual(
            point_soldner_1998_result.toString(6), point_soldner_1998.toString(6)
        )
        ...
        length_meter_mapunits, point_wsg84_meter_result = da_wsg84.measureLineProjected(
            point_wsg84_1924, 1.0, (math.pi / 2)
        )
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                length_meter_mapunits,
                7,
        ...
        self.assertEqual(
            point_wsg84_meter_result.toString(7), point_wsg84_1927_meter.toString(7)
        )

        point_wsg84_1998_result = QgsPointXY(0, 0)
        length_1928_mapunits, point_wsg84_1998_result = da_wsg84.measureLineProjected(
            point_wsg84_1924, distance_wsg84_meters, azimuth_wsg84_1924
        )
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                length_1928_mapunits, 7, QgsUnitTypes.DistanceUnit.DistanceDegrees, True
            ),
    ...
    def testMeasureLineProjectedWorldPoints(self):
        ...
        print(
            "setting [{}] srid [{}] description [{}] isGeographic[{}] lengthUnits[{}] projectionAcronym[{}] ellipsoidAcronym[{}]".format(
                ...
                da_3068.sourceCrs().authid(),
                da_3068.sourceCrs().description(),
                da_3068.sourceCrs().isGeographic(),
                QgsUnitTypes.toString(da_3068.lengthUnits()),
                da_3068.sourceCrs().projectionAcronym(),
                da_3068.sourceCrs().ellipsoidAcronym(),
            )
        )
        da_wsg84 = QgsDistanceArea()
        da_wsg84.setSourceCrs(
        ...
        print(
            "setting [{}] srid [{}] description [{}] isGeographic[{}] lengthUnits[{}] projectionAcronym[{}] ellipsoidAcronym[{}] ellipsoid[{}]".format(
                ...
                da_wsg84.sourceCrs().description(),
                da_wsg84.sourceCrs().isGeographic(),
                QgsUnitTypes.toString(da_wsg84.lengthUnits()),
                da_wsg84.sourceCrs().projectionAcronym(),
                da_wsg84.sourceCrs().ellipsoidAcronym(),
                da_wsg84.ellipsoid(),
            )
        )
        da_4314 = QgsDistanceArea()
        da_4314.setSourceCrs(
            QgsCoordinateReferenceSystem.fromOgcWmsCrs("EPSG:4314"),
            QgsProject.instance().transformContext(),
        )
        ...
        print(
            "setting [{}] srid [{}] description [{}] isGeographic[{}] lengthUnits[{}] projectionAcronym[{}] ellipsoidAcronym[{}]".format(
                "EPSG:4314",
                da_4314.sourceCrs().authid(),
                da_4314.sourceCrs().description(),
                da_4314.sourceCrs().isGeographic(),
                QgsUnitTypes.toString(da_4314.lengthUnits()),
                da_4314.sourceCrs().projectionAcronym(),
                da_4314.sourceCrs().ellipsoidAcronym(),
            )
        )
        da_4805 = QgsDistanceArea()
        da_4805.setSourceCrs(
            QgsCoordinateReferenceSystem.fromOgcWmsCrs("EPSG:4805"),
            QgsProject.instance().transformContext(),
        )
        ...
        print(
            "setting [{}] srid [{}] description [{}] isGeographic[{}] lengthUnits[{}] projectionAcronym[{}] ellipsoidAcronym[{}]".format(
                ...
                da_4805.sourceCrs().description(),
                da_4805.sourceCrs().isGeographic(),
                QgsUnitTypes.toString(da_4805.lengthUnits()),
                da_4805.sourceCrs().projectionAcronym(),
                da_4805.sourceCrs().ellipsoidAcronym(),
            )
        )
        # EPSG:5665 unknown, why?
        da_5665 = QgsDistanceArea()
        da_5665.setSourceCrs(
            QgsCoordinateReferenceSystem.fromOgcWmsCrs("EPSG:5665"),
            QgsProject.instance().transformContext(),
        )
        ...
        print(
            "setting [{}] srid [{}] description [{}] isGeographic[{}] lengthUnits[{}] projectionAcronym[{}] ellipsoidAcronym[{}]".format(
                ...
                da_5665.sourceCrs().description(),
                da_5665.sourceCrs().isGeographic(),
                QgsUnitTypes.toString(da_5665.lengthUnits()),
                da_5665.sourceCrs().projectionAcronym(),
                da_5665.sourceCrs().ellipsoidAcronym(),
            )
        )
        # self.assertEqual(da_5665.sourceCrs().authid(), 'EPSG:5665')
        da_25833 = QgsDistanceArea()
        da_25833.setSourceCrs(
            QgsCoordinateReferenceSystem.fromOgcWmsCrs("EPSG:25833"),
            QgsProject.instance().transformContext(),
        )
        ...
        print(
            "setting [{}] srid [{}] description [{}] isGeographic[{}] lengthUnits[{}] projectionAcronym[{}] ellipsoidAcronym[{}]".format(
                ...
                da_25833.sourceCrs().description(),
                da_25833.sourceCrs().isGeographic(),
                QgsUnitTypes.toString(da_25833.lengthUnits()),
                da_25833.sourceCrs().projectionAcronym(),
        ...
        length_meter_mapunits, point_meter_result = da_3068.measureLineProjected(
            point_berlin_3068, 1.0, (math.pi / 2)
        )
        pprint(point_meter_result)
        print(
            "-I-> Berlin 3068 length_meter_mapunits[{}] point_meter_result[{}]".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_3068.lengthUnits(), True
                ),
        ...
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                length_meter_mapunits, 1, da_3068.lengthUnits(), True
            ),
            "1.0 m",
        )
        self.assertEqual(
            point_meter_result.toString(7), point_berlin_3068_project.toString(7)
        )
        ...
        print(
            "-I-> Berlin Wsg84 length_meter_mapunits[{}] point_meter_result[{}] ellipsoid[{}]".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 20, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
                da_wsg84.ellipsoid(),
            )
        ...
        self.assertEqual(
            point_meter_result.toString(7), point_berlin_wsg84_project.toString(7)
        )
        ...
        length_meter_mapunits, point_meter_result = da_4314.measureLineProjected(
            point_berlin_4314, 1.0, (math.pi / 2)
        )
        print(
            "-I-> Berlin 4314 length_meter_mapunits[{}] point_meter_result[{}]".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_4314.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
            )
        )
        ...
        self.assertEqual(
            point_meter_result.toString(7), point_berlin_4314_project.toString(7)
        )
        ...
        length_meter_mapunits, point_meter_result = da_4805.measureLineProjected(
            point_berlin_4805, 1.0, (math.pi / 2)
        )
        print(
            "-I-> Berlin 4805 length_meter_mapunits[{}] point_meter_result[{}]".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_4805.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
            )
        )
        ...
        self.assertEqual(
            point_meter_result.toString(7), point_berlin_4805_project.toString(7)
        )
        ...
        length_meter_mapunits, point_meter_result = da_25833.measureLineProjected(
            point_berlin_25833, 1.0, (math.pi / 2)
        )
        print(
            "-I-> Berlin 25833 length_meter_mapunits[{}] point_meter_result[{}]".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_25833.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
            )
        )
        ...
        self.assertEqual(
            point_meter_result.toString(7), point_berlin_25833_project.toString(7)
        )
        if da_5665.sourceCrs().authid() != "":
            ...
            length_meter_mapunits, point_meter_result = da_5665.measureLineProjected(
                point_berlin_5665, 1.0, (math.pi / 2)
            )
            print(
                "-I-> Berlin 5665 length_meter_mapunits[{}] point_meter_result[{}]".format(
                    QgsDistanceArea.formatDistance(
                        length_meter_mapunits, 7, da_5665.lengthUnits(), True
                    ),
                    point_meter_result.asWkt(),
                )
            )
            self.assertEqual(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 1, da_5665.lengthUnits(), True
                ),
                "1.0 m",
            )
            self.assertEqual(
        ...
        length_meter_mapunits, point_meter_result = da_wsg84.measureLineProjected(
            point_wsg84, 1.0, (math.pi / 2)
        )
        print(
            "-I-> Nordkap, Norway - Wsg84 - length_meter_mapunits[{}] point_meter_result[{}] ".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
            )
        )
        ...
        print(
            "-I-> Helsinki, Finnland - Wsg84 - length_meter_mapunits[{}] point_meter_result[{}] ".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
        ...
        print(
            "-I-> Copenhagen, Denmark - Wsg84 - length_meter_mapunits[{}] point_meter_result[{}] ".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
        ...
        print(
            "-I-> Basel, Switzerland - Wsg84 - length_meter_mapunits[{}] point_meter_result[{}] ".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
        ...
        print(
            "-I-> Florenz, Italy - Wsg84 - length_meter_mapunits[{}] point_meter_result[{}] ".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
        ...
        print(
            "-I-> Valletta, Malta - Wsg84 - length_meter_mapunits[{}] point_meter_result[{}] ".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
        ...
        print(
            "-I-> Charlston, South Carolina - Wsg84 - length_meter_mapunits[{}] point_meter_result[{}] ".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
        ...
        print(
            "-I-> Ferro, Spain - Wsg84 - length_meter_mapunits[{}] point_meter_result[{}] ".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
        ...
        print(
            "-I-> Mexico City, Mexico - Wsg84 - length_meter_mapunits[{}] point_meter_result[{}] ".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
        ...
        print(
            "-I-> Colón, Panama - Wsg84 - length_meter_mapunits[{}] point_meter_result[{}] ".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
        ...
        print(
            "-I-> Bogotá, Colombia - Wsg84 - length_meter_mapunits[{}] point_meter_result[{}] ".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
        ...
        print(
            "-I-> Equator, Atlantic Ocean - Wsg84 - length_meter_mapunits[{}] point_meter_result[{}] ".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
        ...
        print(
            "-I-> Quito, Ecuador - Wsg84 - length_meter_mapunits[{}] point_meter_result[{}] ".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
        ...
        print(
            "-I-> Jakarta, Indonesia - Wsg84 - length_meter_mapunits[{}] point_meter_result[{}] ".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
        ...
        print(
            "-I-> Lima, Peru - Wsg84 - length_meter_mapunits[{}] point_meter_result[{}] ".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
        ...
        print(
            "-I-> Kolwezi, Congo - Wsg84 - length_meter_mapunits[{}] point_meter_result[{}] ".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
        ...
        print(
            "-I-> Arica, Chile - Wsg84 - length_meter_mapunits[{}] point_meter_result[{}] ".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
        ...
        print(
            "-I-> Santiago, Chile - Wsg84 - length_meter_mapunits[{}] point_meter_result[{}] ".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
        ...
        print(
            "-I-> Melbourne, Australia - Wsg84 - length_meter_mapunits[{}] point_meter_result[{}] ".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 8, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
            )
        )
        ...
        print(
            "-I-> Hobart City,Tasmania, Australia - Wsg84 - length_meter_mapunits[{}] point_meter_result[{}] ".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
        ...
        print(
            "-I-> Ryan"
            "s Creek Aerodrome, New Zealand - Wsg84 - length_meter_mapunits[{}] point_meter_result[{}] ".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
        ...
        print(
            "-I-> Río Gallegos, Argentina - Wsg84 - length_meter_mapunits[{}] point_meter_result[{}] ".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
        ...
        print(
            "-I-> Port Lockroy, Antarctica - Wsg84 - length_meter_mapunits[{}] point_meter_result[{}] ".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
        ...
        print(
            "-I-> Someware, Antarctica - Wsg84 - length_meter_mapunits[{}] point_meter_result[{}] ".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
        ...
        print(
            "-W-> Mercator"
            "s Last Stop, Antarctica - Wsg84 - length_meter_mapunits[{}] point_meter_result[{}] ".format(
                QgsDistanceArea.formatDistance(
                    length_meter_mapunits, 7, da_wsg84.lengthUnits(), True
                ),
                point_meter_result.asWkt(),
    ...
    def testLengthMeasureAndUnits(self):
        ...
        da = QgsDistanceArea()
        da.setSourceCrs(
            QgsCoordinateReferenceSystem.fromSrsId(3452),
            QgsProject.instance().transformContext(),
        )
        da.setEllipsoid("NONE")
        ...
        assert (
            abs(distance - 2.23606797) < 0.00000001
            and units == QgsUnitTypes.DistanceUnit.DistanceDegrees
        ) or (
            abs(distance - 248.52) < 0.01
            and units == QgsUnitTypes.DistanceUnit.DistanceMeters
        )
        ...
        distance = da.convertLengthMeasurement(
            distance, QgsUnitTypes.DistanceUnit.DistanceNauticalMiles
        )
        self.assertAlmostEqual(distance, 133.669, delta=0.01)

        # now try with a source CRS which is in feet
        da.setSourceCrs(
            QgsCoordinateReferenceSystem.fromSrsId(27469),
            QgsProject.instance().transformContext(),
        )
        da.setEllipsoid("NONE")
        ...
        # test converting the resultant length
        distance = da.convertLengthMeasurement(
            distance, QgsUnitTypes.DistanceUnit.DistanceMeters
        )
    ...
    def testAreaMeasureAndUnits(self):
        ...
        assert (
            abs(area - 3.0) < 0.00000001
            and units == QgsUnitTypes.AreaUnit.AreaSquareDegrees
        ) or (
            abs(area - 37176087091.5) < 0.1
            and units == QgsUnitTypes.AreaUnit.AreaSquareMeters
        )
    ...
    def testFormatDistance(self):
        ...
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                45, 3, QgsUnitTypes.DistanceUnit.DistanceMeters
            ),
            "45.000 m",
        )
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                1300, 1, QgsUnitTypes.DistanceUnit.DistanceMeters, False
            ),
            "1.3 km",
        )
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                0.005, 1, QgsUnitTypes.DistanceUnit.DistanceMeters, False
            ),
            "5.0 mm",
        )
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                0.05, 1, QgsUnitTypes.DistanceUnit.DistanceMeters, False
            ),
            "5.0 cm",
        )
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                1.5, 3, QgsUnitTypes.DistanceUnit.DistanceKilometers, True
            ),
            "1.500 km",
        )
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                1.5, 3, QgsUnitTypes.DistanceUnit.DistanceKilometers, False
            ),
            "1.500 km",
        )
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                0.5, 3, QgsUnitTypes.DistanceUnit.DistanceKilometers, True
            ),
            "0.500 km",
        )
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                0.5, 3, QgsUnitTypes.DistanceUnit.DistanceKilometers, False
            ),
            "500.000 m",
        )
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                6000, 0, QgsUnitTypes.DistanceUnit.DistanceFeet, True
            ),
            "6000 ft",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                300, 0, QgsUnitTypes.DistanceUnit.DistanceFeet, True
            ),
            "300 ft",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                3000, 0, QgsUnitTypes.DistanceUnit.DistanceYards, True
            ),
            "3000 yd",
        )
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                3000, 3, QgsUnitTypes.DistanceUnit.DistanceYards, False
            ),
            "1.705 mi",
        )
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                300, 0, QgsUnitTypes.DistanceUnit.DistanceYards, True
            ),
            "300 yd",
        )
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                300, 0, QgsUnitTypes.DistanceUnit.DistanceYards, False
            ),
            "300 yd",
        )
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                1.5, 3, QgsUnitTypes.DistanceUnit.DistanceMiles, True
            ),
            "1.500 mi",
        )
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                1.5, 3, QgsUnitTypes.DistanceUnit.DistanceMiles, False
            ),
            "1.500 mi",
        )
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                0.5, 3, QgsUnitTypes.DistanceUnit.DistanceMiles, True
            ),
            "0.500 mi",
        )
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                0.5, 0, QgsUnitTypes.DistanceUnit.DistanceMiles, False
            ),
            "2640 ft",
        )
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                0.5, 1, QgsUnitTypes.DistanceUnit.DistanceNauticalMiles, True
            ),
            "0.5 NM",
        )
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                0.5, 1, QgsUnitTypes.DistanceUnit.DistanceNauticalMiles, False
            ),
            "0.5 NM",
        )
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                1.5, 1, QgsUnitTypes.DistanceUnit.DistanceNauticalMiles, True
            ),
            "1.5 NM",
        )
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                1.5, 1, QgsUnitTypes.DistanceUnit.DistanceNauticalMiles, False
            ),
            "1.5 NM",
        )
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                1.5, 1, QgsUnitTypes.DistanceUnit.DistanceDegrees, True
            ),
            "1.5 deg",
        )
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                1.0, 1, QgsUnitTypes.DistanceUnit.DistanceDegrees, False
            ),
            "1.0 deg",
        )
        self.assertEqual(
            QgsDistanceArea.formatDistance(
                1.0, 1, QgsUnitTypes.DistanceUnit.DistanceUnknownUnit, False
            ),
            "1.0",
        )
    ...
    def testGeodesicIntersectionAtAntimeridian(self):
        ...
        lat, fract = da.latitudeGeodesicCrossesAntimeridian(
            QgsPointXY(0, 0), QgsPointXY(-170, 0)
        )
        self.assertAlmostEqual(lat, 0, 5)
        self.assertAlmostEqual(fract, 0, 5)
        lat, fract = da.latitudeGeodesicCrossesAntimeridian(
            QgsPointXY(-170, 0), QgsPointXY(170, 0)
        )
        self.assertAlmostEqual(lat, 0, 5)
        self.assertAlmostEqual(fract, 0.5, 5)
        lat, fract = da.latitudeGeodesicCrossesAntimeridian(
            QgsPointXY(179, 0), QgsPointXY(181, 0)
        )
        self.assertAlmostEqual(lat, 0, 5)
        self.assertAlmostEqual(fract, 0.5, 5)
        lat, fract = da.latitudeGeodesicCrossesAntimeridian(
        ...
        self.assertAlmostEqual(fract, 0.5, 5)
        lat, fract = da.latitudeGeodesicCrossesAntimeridian(
            QgsPointXY(180, 0), QgsPointXY(180, 0)
        )
        self.assertAlmostEqual(lat, 0, 5)
        lat, fract = da.latitudeGeodesicCrossesAntimeridian(
            QgsPointXY(180, -10), QgsPointXY(180, -10)
        )
        self.assertAlmostEqual(lat, -10, 5)
        lat, fract = da.latitudeGeodesicCrossesAntimeridian(
            QgsPointXY(171, 0), QgsPointXY(181, 0)
        )
        self.assertAlmostEqual(lat, 0, 5)
        self.assertAlmostEqual(fract, 0.9, 5)
        lat, fract = da.latitudeGeodesicCrossesAntimeridian(
            QgsPointXY(181, 0), QgsPointXY(171, 0)
        )
        self.assertAlmostEqual(lat, 0, 5)
        self.assertAlmostEqual(fract, 0.1, 5)

        lat, fract = da.latitudeGeodesicCrossesAntimeridian(
            QgsPointXY(138.26237, -20.314687), QgsPointXY(-151.6, -77.8)
        )
        self.assertAlmostEqual(lat, -73.89148222666744914, 5)
        self.assertAlmostEqual(fract, 0.007113545719515548, 5)
        lat, fract = da.latitudeGeodesicCrossesAntimeridian(
            QgsPointXY(138.26237, -20.314687), QgsPointXY(-151.6 + 360, -77.8)
        )
        self.assertAlmostEqual(lat, -73.89148222666744914, 5)
        self.assertAlmostEqual(fract, 0.007113545719515548, 5)
        lat, fract = da.latitudeGeodesicCrossesAntimeridian(
            QgsPointXY(-151.6, -77.8), QgsPointXY(138.26237, -20.314687)
        )
        self.assertAlmostEqual(lat, -73.89148222666744914, 5)
        self.assertAlmostEqual(fract, 0.9928864542804845, 5)
        lat, fract = da.latitudeGeodesicCrossesAntimeridian(
            QgsPointXY(170.60188754234980024, -70.81368329001529105),
        ...
        lat, fract = da.latitudeGeodesicCrossesAntimeridian(
            QgsPointXY(178.44469761238570982, -73.47820480021761114),
        ...
        lat, fract = da.latitudeGeodesicCrossesAntimeridian(
            QgsPointXY(175.76717768974583578, 8.93749416467257873),
    ...
    def testGeodesicLine(self):
        ...
        g = QgsGeometry.fromMultiPolylineXY(
            da.geodesicLine(
                QgsPointXY(105.4, 66.4), QgsPointXY(208.4, -77.8), 1000000, True
            )
        )
        self.assertEqual(
            g.asWkt(5),
        ...
        g = QgsGeometry.fromMultiPolylineXY(
            da.geodesicLine(
                QgsPointXY(105.4, 66.4), QgsPointXY(208.4, -77.8), 1000000, False
            )
        )
        self.assertEqual(
            g.asWkt(5),
        ...
        g = QgsGeometry.fromMultiPolylineXY(
            da.geodesicLine(
                QgsPointXY(105.4, 66.4), QgsPointXY(208.4, -77.8), 100000, True
            )
        )
        self.assertEqual(
            g.asWkt(5),
        ...
        g = QgsGeometry.fromMultiPolylineXY(
            da.geodesicLine(
                QgsPointXY(105.4, 66.4), QgsPointXY(208.4, -77.8), 100000, False
            )
        )
        self.assertEqual(
            g.asWkt(5),
        ...
        g = QgsGeometry.fromMultiPolylineXY(
            da.geodesicLine(
                QgsPointXY(121.4, -76.4), QgsPointXY(-121.6, 76.8), 1000000, True
            )
        )
        self.assertEqual(
            g.asWkt(5),
        ...
        g = QgsGeometry.fromMultiPolylineXY(
            da.geodesicLine(
                QgsPointXY(121.4, -76.4), QgsPointXY(-121.6, 76.8), 1000000, False
            )
        )
        self.assertEqual(
            g.asWkt(5),
        ...
        g = QgsGeometry.fromMultiPolylineXY(
            da.geodesicLine(
                QgsPointXY(121.4, 6.4), QgsPointXY(-121.6, 2.8), 1000000, True
            )
        )
        self.assertEqual(
            g.asWkt(5),
        ...
        g = QgsGeometry.fromMultiPolylineXY(
            da.geodesicLine(
                QgsPointXY(121.4, 6.4), QgsPointXY(-121.6, 2.8), 1000000, False
            )
        )
        self.assertEqual(
            g.asWkt(5),
        ...
        g = QgsGeometry.fromMultiPolylineXY(
            da.geodesicLine(
                QgsPointXY(-13536427, 14138932),
                QgsPointXY(13760912, -13248201),
                1000000,
                False,
            )
        )
        ...
        g = QgsGeometry.fromMultiPolylineXY(
            da.geodesicLine(
                QgsPointXY(18933544, -5448034),
                QgsPointXY(-11638480, 3962206),
                1000000,
                True,
            )
        )
    ...
    def testSplitGeometryAtAntimeridian(self):
        ...
        g = da.splitGeometryAtAntimeridian(
            QgsGeometry.fromWkt("LineString(0 0, -170 0)")
        )
        self.assertEqual(g.asWkt(), "MultiLineString ((0 0, -170 0))")
        g = da.splitGeometryAtAntimeridian(
            QgsGeometry.fromWkt("LineString(-170 0, 0 0)")
        )
        self.assertEqual(g.asWkt(), "MultiLineString ((-170 0, 0 0))")
        g = da.splitGeometryAtAntimeridian(
            QgsGeometry.fromWkt("LineString(179 0, -179 0)")
        )
        self.assertEqual(g.asWkt(), "MultiLineString ((179 0, 180 0),(-180 0, -179 0))")
        g = da.splitGeometryAtAntimeridian(
            QgsGeometry.fromWkt("LineString(179 0, 181 0)")
        )
        self.assertEqual(g.asWkt(), "MultiLineString ((179 0, 180 0),(-180 0, -179 0))")
        g = da.splitGeometryAtAntimeridian(
            QgsGeometry.fromWkt("LineString(-179 0, 179 0)")
        ...
        self.assertEqual(g.asWkt(), "MultiLineString ((-179 0, -180 0),(180 0, 179 0))")
        g = da.splitGeometryAtAntimeridian(
            QgsGeometry.fromWkt("LineString(181 0, 179 0)")
        )
        self.assertEqual(g.asWkt(), "MultiLineString ((-179 0, -180 0),(180 0, 179 0))")
        g = da.splitGeometryAtAntimeridian(
            QgsGeometry.fromWkt("LineString(179 10, -179 -20)")
        )
        self.assertEqual(
            g.asWkt(3), "MultiLineString ((179 10, 180 -5.362),(-180 -5.362, -179 -20))"
        )
        g = da.splitGeometryAtAntimeridian(
            QgsGeometry.fromWkt("LineString(179 -80, -179 70)")
        )
        self.assertEqual(
            g.asWkt(3),
            "MultiLineString ((179 -80, 180 -55.685),(-180 -55.685, -179 70))",
        )

        # multiline input
        g = da.splitGeometryAtAntimeridian(
            QgsGeometry.fromWkt("MultiLineString((1 10, 50 30),(179 -80, -179 70))")
        )
        self.assertEqual(
            g.asWkt(3),
            "MultiLineString ((1 10, 50 30),(179 -80, 180 -55.685),(-180 -55.685, -179 70))",
        )
        g = da.splitGeometryAtAntimeridian(
            QgsGeometry.fromWkt("MultiLineString((1 10, 50 30),(179 -80, 179.99 70))")
        )
        self.assertEqual(
            g.asWkt(3), "MultiLineString ((1 10, 50 30),(179 -80, 179.99 70))"
        )

        # with z/m
        g = da.splitGeometryAtAntimeridian(
            QgsGeometry.fromWkt("LineString Z(179 -80 1, -179 70 10)")
        )
        self.assertEqual(
            g.asWkt(3),
        ...
        g = da.splitGeometryAtAntimeridian(
            QgsGeometry.fromWkt("LineStringM(179 -80 1, -179 70 10)")
        )
        self.assertEqual(
            g.asWkt(3),
        ...
        g = da.splitGeometryAtAntimeridian(
            QgsGeometry.fromWkt("LineStringZM(179 -80 1 -4, -179 70 10 -30)")
        )
        self.assertEqual(
            g.asWkt(3),
        ...
        g = da.splitGeometryAtAntimeridian(
            QgsGeometry.fromWkt(
                "MultiLineString Z((179 -80 1, -179 70 10),(-170 -5 1, -181 10 5))"
            )
        )
        self.assertEqual(
            g.asWkt(3),
        ...
        self.assertEqual(
            g.asWkt(3), "MultiLineString ((179 10, 180 -5.361),(-180 -5.361, -179 -20))"
        )
        ...
        g = da.splitGeometryAtAntimeridian(
            QgsGeometry.fromWkt("LineString( -13536427 14138932, 13760912 -13248201)")
        )
        self.assertEqual(
            g.asWkt(1),
