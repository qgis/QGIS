...
class TestQgsDistanceArea(unittest.TestCase):
    ...
    def testMeasureLineProjected(self):
        ...
        length_1998_mapunits, point_soldner_1998_result = da_3068.measureLineProjected(point_soldner_1924, distance_soldner_meters, azimuth_qpoint, point_soldner_1998_result)
        ...
        length_meter_mapunits, point_soldner_1998_result = da_wsg84.measureLineProjected(point_wsg84_1924, 1.0, (math.pi / 2), point_wsg84_meter_result)
        ...
        length_1928_mapunits, point_soldner_1998_result = da_wsg84.measureLineProjected(point_wsg84_1924, distance_wsg84_meters, azimuth_wsg84_1924, point_wsg84_1998_result)
    ...
    def testMeasureLineProjectedWorldPoints(self):
        ...
        length_meter_mapunits, point_meter_result = da_3068.measureLineProjected(point_berlin_3068, 1.0, (math.pi / 2), point_meter_result)
        ...
        length_meter_mapunits, point_meter_result = da_wsg84.measureLineProjected(point_berlin_wsg84, 1.0, (math.pi / 2), point_meter_result)
        ...
        length_meter_mapunits, point_meter_result = da_4314.measureLineProjected(point_berlin_4314, 1.0, (math.pi / 2), point_meter_result)
        ...
        length_meter_mapunits, point_meter_result = da_4805.measureLineProjected(point_berlin_4805, 1.0, (math.pi / 2), point_meter_result)
        ...
        length_meter_mapunits, point_meter_result = da_25833.measureLineProjected(point_berlin_25833, 1.0, (math.pi / 2), point_meter_result)
        ...
        length_meter_mapunits, point_meter_result = da_5665.measureLineProjected(point_berlin_5665, 1.0, (math.pi / 2), point_meter_result)
        ...
        length_meter_mapunits, point_meter_result = da_wsg84.measureLineProjected(point_wsg84, 1.0, (math.pi / 2), point_meter_result)
