...
class TestPyQgsProviderConnectionPostgres(unittest.TestCase, TestPyQgsProviderConnectionBase):
    ...
    def test_postgis_connections(self):
        ...
        srids_and_types = [[t.crs.postgisSrid(), t.wkbType._value_]
                           for t in geometries_table.geometryColumnTypes()]
        srids_and_types.sort()
        self.assertEqual(
            srids_and_types,
            [[0, QgsWkbTypes.Type.Point._value_],
             [0, QgsWkbTypes.Type.LineString._value_],
             [0, QgsWkbTypes.Type.Polygon._value_],
             [0, QgsWkbTypes.Type.GeometryCollection._value_],
             [3857, QgsWkbTypes.Type.Point._value_],
             [4326, QgsWkbTypes.Type.Point._value_]]
        )
