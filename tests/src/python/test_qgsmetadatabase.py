...
class TestQgsMetadataBase(QgisTestCase):
    ...
    def testGettersSetters(self):
        ...
        m.setDateTime(
            ...
            QDateTime(QDate(2022, 1, 2), QTime(12, 13, 14)),
        )
        self.assertEqual(
    ...
    def testKeywords(self):
        ...
        m.setKeywords(
            {"vocab a": ["keyword a", "other a"], "vocab b": ["keyword b", "other b"]}
        )
        self.assertEqual(
            m.keywords(),
            {"vocab a": ["keyword a", "other a"], "vocab b": ["keyword b", "other b"]},
    ...
    def createTestMetadata(self):
        ...
        m.setDateTime(
            Qgis.MetadataDateType.Created,
            QDateTime(QDate(2020, 1, 2), QTime(11, 12, 13)),
        )
        m.setDateTime(
            Qgis.MetadataDateType.Published,
    ...
    def testCombine(self):
        ...
        m1.setContacts(
            [
                QgsAbstractMetadataBase.Contact("c1"),
                QgsAbstractMetadataBase.Contact("cc1"),
            ]
        )
        m2.setContacts([])
        m1.combine(m2)
        ...
        m2.setContacts(
            [
                QgsAbstractMetadataBase.Contact("c2"),
                QgsAbstractMetadataBase.Contact("cc2"),
            ]
        )
        m1.combine(m2)
        self.assertEqual(
        ...
        m1.setLinks(
            [QgsAbstractMetadataBase.Link("l1"), QgsAbstractMetadataBase.Link("ll1")]
        )
        m2.setLinks([])
        m1.combine(m2)
        self.assertEqual(
        ...
        m1.setLinks([])
        m2.setLinks(
            [QgsAbstractMetadataBase.Link("l2"), QgsAbstractMetadataBase.Link("ll2")]
        )
        m1.combine(m2)
        self.assertEqual(
            m1.links(),
        ...
        m1.setDateTime(
            Qgis.MetadataDateType.Created, QDateTime(QDate(2020, 1, 2), QTime(1, 2, 3))
        )
        m1.setDateTime(
            Qgis.MetadataDateType.Revised, QDateTime(QDate(2020, 1, 3), QTime(1, 2, 3))
        )

        m2.setDateTime(
            Qgis.MetadataDateType.Revised, QDateTime(QDate(2020, 1, 4), QTime(1, 2, 3))
        )
        m2.setDateTime(
            Qgis.MetadataDateType.Superseded,
        ...
        self.assertEqual(
            m1.dateTime(Qgis.MetadataDateType.Created),
            QDateTime(QDate(2020, 1, 2), QTime(1, 2, 3)),
        )
        self.assertEqual(
            m1.dateTime(Qgis.MetadataDateType.Revised),
            QDateTime(QDate(2020, 1, 4), QTime(1, 2, 3)),
        )
        self.assertEqual(
            m1.dateTime(Qgis.MetadataDateType.Superseded),
            QDateTime(QDate(2020, 1, 5), QTime(1, 2, 3)),
        )
