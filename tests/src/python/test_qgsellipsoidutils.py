...
class TestQgsEllipsoidUtils(QgisTestCase):
    ...
    def testDefinitions(self):
        ...
        self.assertEqual(gany_defs.parameters.semiMinor, 2632345.0)
        self.assertEqual(gany_defs.parameters.inverseFlattening, 0.0)
    ...
    def testCelestialBodies(self):
        ...
        ganymede = [
            body
            for body in bodies
            if body.name() == "Ganymede" and body.authority() == "ESRI"
        ][0]
        self.assertTrue(ganymede.isValid())

    def testMappingEllipsoidsToProj6(self):
        old_qgis_ellipsoids = {
            "Adrastea2000": "Adrastea2000",
            "airy": "Airy 1830",
            "Amalthea2000": "Amalthea2000",
            ...
            "Bianca2000": "Bianca2000",
            "Callisto2000": "Callisto2000",
            "Calypso2000": "Calypso2000",
            "Carme2000": "Carme2000",
            "Charon2000": "Charon2000",
            "clrk66": "Clarke 1866",
            "IGNF:ELG004": "Clarke 1866",
            "IGNF:ELG003": "Clarke 1880 Anglais",
            "IGNF:ELG010": "Clarke 1880 IGN",
            "clrk80": "Clarke 1880 mod.",
            "cape": "Clarke 1880 mod.",
            "CPM": "Comm. des Poids et Mesures 1799",  # spellok
            "Cordelia2000": "Cordelia2000",
            "Cressida2000": "Cressida2000",
            "Deimos2000": "Deimos2000",
            "delmbr": "Delambre 1810 (Belgium)",
            "Desdemona2000": "Desdemona2000",
            "Despina2000": "Despina2000",
            "Dione2000": "Dione2000",
            "Earth2000": "Earth2000",
            "Elara2000": "Elara2000",
            "Enceladus2000": "Enceladus2000",
            "engelis": "Engelis 1985",
            "Epimetheus2000": "Epimetheus2000",
            "Europa2000": "Europa2000",
            ...
            "Galatea2000": "Galatea2000",
            "Ganymede2000": "Ganymede2000",
            "Helene2000": "Helene2000",
            "helmert": "Helmert 1906",
            "Himalia2000": "Himalia2000",
            "hough": "Hough",
            "Hyperion2000": "Hyperion2000",
            "IGNF:ELG108": "IAG GRS 1967",
            "IGNF:ELG037": "IAG GRS 1980",
            "IAU76": "IAU 1976",
            "Iapetus2000": "Iapetus2000",
            "intl": "International 1909 (Hayford)",
            "IGNF:ELG001": "International-Hayford 1909",
            "Io2000": "Io2000",
            "Janus2000": "Janus2000",
            "Juliet2000": "Juliet2000",
            "Jupiter2000": "Jupiter2000",
            "kaula": "Kaula 1961",
            "krass": "Krassovsky, 1942",
            "Larissa2000": "Larissa2000",
            "Leda2000": "Leda2000",
            "lerch": "Lerch 1979",
            ...
            "Metis2000": "Metis2000",
            "Mimas2000": "Mimas2000",
            "Miranda2000": "Miranda2000",
            "mod_airy": "Modified Airy",
            "fschr60m": "Modified Fischer 1960",
            "Moon2000": "Moon2000",
            "Naiad2000": "Naiad2000",
            "NWL9D": "Naval Weapons Lab., 1965",
            "Neptune2000": "Neptune2000",
            "Nereid2000": "Nereid2000",
            "new_intl": "New International 1967",
            "sphere": "Normal Sphere (r=6370997)",
            "Oberon2000": "Oberon2000",
            "Ophelia2000": "Ophelia2000",
            "IGNF:ELG017": "PLESSIS 1817",
            "Pan2000": "Pan2000",
            "Pandora2000": "Pandora2000",
            "Pasiphae2000": "Pasiphae2000",
            "Phobos2000": "Phobos2000",
            "Phoebe2000": "Phoebe2000",
            "plessis": "Plessis 1817 (France)",
            "Pluto2000": "Pluto2000",
            "Portia2000": "Portia2000",
            "Prometheus2000": "Prometheus2000",
            "Proteus2000": "Proteus2000",
            "Puck2000": "Puck2000",
            "Rhea2000": "Rhea2000",
            "Rosalind2000": "Rosalind2000",
            "IGNF:ELG032": "SPHERE PICARD",
            "Saturn2000": "Saturn2000",
            "Sinope2000": "Sinope2000",
            "SEasia": "Southeast Asia",
            "SGS85": "Soviet Geodetic System 85",
            "Telesto2000": "Telesto2000",
            "Tethys2000": "Tethys2000",
            "Thalassa2000": "Thalassa2000",
            "Thebe2000": "Thebe2000",
            "Titan2000": "Titan2000",
            "Titania2000": "Titania2000",
            "Triton2000": "Triton2000",
            "Umbriel2000": "Umbriel2000",
            "Uranus2000": "Uranus2000",
            "Venus2000": "Venus2000",
            "WGS60": "WGS 60",
            "WGS66": "WGS 66",
            "WGS72": "WGS 72",
