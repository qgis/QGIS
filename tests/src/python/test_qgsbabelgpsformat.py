...
class TestQgsBabelGpsFormat(QgisTestCase):
    ...
    def test_gps_device_format(self):
        ...
        # depending on whether the corresponding commands are empty
        f = QgsBabelGpsDeviceFormat(
            "%babel -w -i garmin -o gpx %in %out", None, None, None, None, None
        )
        self.assertEqual(
            f.capabilities(),
            Qgis.BabelFormatCapabilities(
        ...
        f = QgsBabelGpsDeviceFormat(
            None, "%babel -w -i gpx -o garmin %in %out", None, None, None, None
        )
        self.assertEqual(
            f.capabilities(),
            Qgis.BabelFormatCapabilities(
        ...
        f = QgsBabelGpsDeviceFormat(
            None, None, "%babel -r -i garmin -o gpx %in %out", None, None, None
        )
        self.assertEqual(
            f.capabilities(),
            Qgis.BabelFormatCapabilities(
        ...
        f = QgsBabelGpsDeviceFormat(
            None, None, None, "%babel -r -i gpx -o garmin %in %out", None, None
        )
        self.assertEqual(
            f.capabilities(),
            Qgis.BabelFormatCapabilities(
        ...
        f = QgsBabelGpsDeviceFormat(
            None, None, None, None, "%babel -t -i garmin -o gpx %in %out", None
        )
        self.assertEqual(
            f.capabilities(),
            Qgis.BabelFormatCapabilities(
        ...
        f = QgsBabelGpsDeviceFormat(
            None, None, None, None, None, "%babel -t -i gpx -o garmin %in %out"
        )
        self.assertEqual(
            f.capabilities(),
            Qgis.BabelFormatCapabilities(
    ...
    def test_registry(self):
        ...
        self.assertEqual(
            registry.importFormat("dna").description(), "Navitrak DNA marker format"
        )
        self.assertEqual(registry.importFormat("dna").extensions(), ["dna"])

        self.assertIsNone(registry.importFormatByDescription("aaaaaa"))
        self.assertEqual(
            registry.importFormatByDescription("Navitrak DNA marker format").name(),
            "dna",
        )
        self.assertEqual(
            registry.importFormatByDescription("navitrak dna marker format").name(),
        ...
        self.assertEqual(
            registry.importFormatByDescription("PocketFMS flightplan (.xml)").name(),
            "pocketfms_fp",
        )
        ...
        self.assertIn(
            ";;PocketFMS flightplan [.xml] (*.xml);;", registry.importFileFilter()
        )
        ...
        self.assertEqual(
            registry.deviceFormat("Garmin serial").importCommand(
                "bb", Qgis.GpsFeatureType.Waypoint, "in_file.shp", "out_file.gpx"
            ),
