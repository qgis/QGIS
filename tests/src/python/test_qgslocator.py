...
class TestQgsLocator(QgisTestCase):
    ...
    def testModel(self):
        ...
        m.clear()
        self.assertEqual(p.rowCount(), 0)
        filter_b = test_filter('b', None, groupResult=True, groupScore=True)
        l.registerFilter(filter_b)
        l.fetchResults('c', context)
        for i in range(200):
            sleep(0.002)
        ...
        self.assertEqual(p.data(p.index(4, 0), QgsLocatorModel.CustomRole.ResultType), 0)
        self.assertEqual(p.data(p.index(4, 0), QgsLocatorModel.CustomRole.ResultFilterName), 'test_b')
        self.assertEqual(p.data(p.index(5, 0)).strip(), 'group b')
        self.assertEqual(p.data(p.index(5, 0), QgsLocatorModel.CustomRole.ResultType), 1)
        self.assertEqual(p.data(p.index(5, 0), QgsLocatorModel.CustomRole.ResultFilterGroupScore), 10)
        self.assertEqual(p.data(p.index(6, 0)), 'b4')
        self.assertEqual(p.data(p.index(6, 0), QgsLocatorModel.CustomRole.ResultType), 2)
        self.assertEqual(p.data(p.index(6, 0), QgsLocatorModel.CustomRole.ResultFilterGroupScore), 10)
        self.assertEqual(p.data(p.index(7, 0)), 'b8')
        self.assertEqual(p.data(p.index(7, 0), QgsLocatorModel.CustomRole.ResultType), 2)
        self.assertEqual(p.data(p.index(8, 0)).strip(), 'group a')
        self.assertEqual(p.data(p.index(8, 0), QgsLocatorModel.CustomRole.ResultType), 1)
        self.assertEqual(p.data(p.index(8, 0), QgsLocatorModel.CustomRole.ResultFilterGroupScore), 1)
        self.assertEqual(p.data(p.index(9, 0)), 'b0')
        self.assertEqual(p.data(p.index(9, 0), QgsLocatorModel.CustomRole.ResultType), 2)
        self.assertEqual(p.data(p.index(9, 0), QgsLocatorModel.CustomRole.ResultFilterGroupScore), 1)
        self.assertEqual(p.data(p.index(10, 0)), 'b1')
        self.assertEqual(p.data(p.index(10, 0), QgsLocatorModel.CustomRole.ResultType), 2)
        self.assertEqual(p.data(p.index(11, 0)), 'b3')
        self.assertEqual(p.data(p.index(11, 0), QgsLocatorModel.CustomRole.ResultType), 2)
        self.assertEqual(p.data(p.index(12, 0)), 'b5')
        self.assertEqual(p.data(p.index(12, 0), QgsLocatorModel.CustomRole.ResultType), 2)
