...
class TestQgsVirtualLayerProvider(unittest.TestCase, ProviderTestCase):
    ...
    def test_joined_layers_conversion(self):
        ...
        project.removeMapLayers([v1.id(), v2.id(), v3.id()])
