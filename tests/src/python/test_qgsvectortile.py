...
class TestVectorTile(unittest.TestCase):
    ...
    def testSelection(self):
        ...
        self.assertCountEqual({f.id() for f in layer.selectedFeatures()}, {3320043274240,
                                                                              3320026497024,
                                                                              2220498092032,
                                                                              2224826613760,
                                                                              3320043274243,
                                                                              ...
                                                                              3324338241541,
                                                                              3324338241536})
        self.assertCountEqual({f.geometry().asWkt(-3) for f in layer.selectedFeatures()}, {
        ...
        self.assertCountEqual({f.id() for f in layer.selectedFeatures()}, {2220498092032, 3320043274243})
        self.assertCountEqual({f.geometry().asWkt(-3) for f in layer.selectedFeatures()},
                              {'Point (-12714000 5220000)',
                               'Polygon ((-12563000 5105000, -12470000 5102000, -12411000 4990000, -12411000 4970000, -12563000 4970000, -12563000 5105000))'})
        ...
        self.assertCountEqual({f.id() for f in layer.selectedFeatures()},
        ...
        self.assertCountEqual({f.id() for f in layer.selectedFeatures()}, {2220498092032})
        self.assertCountEqual({f.geometry().asWkt(-3) for f in layer.selectedFeatures()},
                              {'Point (-12714000 5220000)'})
