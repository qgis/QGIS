...
class TestQgsFieldModel(QgisTestCase):
    ...
    def testTooltip(self):
        ...
        self.assertEqual(m.data(m.index(0, 0), Qt.ItemDataRole.ToolTipRole), "<b>x</b><br><font style='font-family:monospace; white-space: nowrap;'>Float</font>")
        self.assertEqual(m.data(m.index(1, 0), Qt.ItemDataRole.ToolTipRole), "<b>y</b><br><font style='font-family:monospace; white-space: nowrap;'>Float</font>")
        self.assertEqual(m.data(m.index(2, 0), Qt.ItemDataRole.ToolTipRole), "<b>z</b><br><font style='font-family:monospace; white-space: nowrap;'>Float</font>")
        self.assertEqual(m.data(m.index(3, 0), Qt.ItemDataRole.ToolTipRole), "<b>cat</b><br><font style='font-family:monospace; white-space: nowrap;'>Character</font>")
        self.assertEqual(m.data(m.index(4, 0), Qt.ItemDataRole.ToolTipRole), "<b>red</b><br><font style='font-family:monospace; white-space: nowrap;'>Integer</font>")
        ...
        self.assertEqual(m.data(m.index(1, 0), Qt.ItemDataRole.ToolTipRole), "<b>x</b><br><font style='font-family:monospace; white-space: nowrap;'>Float</font>")
        self.assertEqual(m.data(m.index(2, 0), Qt.ItemDataRole.ToolTipRole), "<b>y</b><br><font style='font-family:monospace; white-space: nowrap;'>Float</font>")
        self.assertEqual(m.data(m.index(5, 0), Qt.ItemDataRole.ToolTipRole), "<b>red</b><br><font style='font-family:monospace; white-space: nowrap;'>Integer</font>")
