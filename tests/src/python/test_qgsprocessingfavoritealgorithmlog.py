...
class TestQgsProcessingFavoriteAlgorithmLog(QgisTestCase):
    ...
    def test_log(self):
        ...
        log.add('test4')
        self.assertEqual(log.favoriteAlgorithmIds(), ['test2', 'test', 'test3', 'test4'])
        self.assertEqual(len(spy), 6)

        log.add('test5')
        self.assertEqual(log.favoriteAlgorithmIds(), ['test2', 'test', 'test3', 'test4', 'test5'])
        self.assertEqual(len(spy), 7)

        log.add('test6')
        self.assertEqual(log.favoriteAlgorithmIds(), ['test2', 'test', 'test3', 'test4', 'test5', 'test6'])
        self.assertEqual(len(spy), 8)

        log.add('test7')
        self.assertEqual(log.favoriteAlgorithmIds(), ['test2', 'test', 'test3', 'test4', 'test5', 'test6', 'test7'])
