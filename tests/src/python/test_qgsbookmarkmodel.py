...
class TestQgsBookmarkManagerModel(QgisTestCase):
    ...
    def testBookmarkModel(self):
        ...
        self.assertFalse(
            model.data(model.index(0, 0), QgsBookmarkManagerModel.CustomRoles.RoleName)
        )
        ...
        self.assertEqual(
            model.data(model.index(0, 8), Qt.ItemDataRole.CheckStateRole),
        ...
        self.assertEqual(
            model.data(
                model.index(0, 0), QgsBookmarkManagerModel.CustomRoles.RoleGroup
            ),
            "group 1",
        )
        ...
        self.assertEqual(
            model.data(
                model.index(0, 0), QgsBookmarkManagerModel.CustomRoles.RoleExtent
            ),
        ...
        self.assertEqual(
            model.data(model.index(1, 8), Qt.ItemDataRole.CheckStateRole),
            Qt.CheckState.Unchecked,
        )
        self.assertEqual(
            model.data(model.index(1, 0), QgsBookmarkManagerModel.CustomRoles.RoleName),
            "b2",
        )
        self.assertEqual(
            model.data(
                model.index(1, 0), QgsBookmarkManagerModel.CustomRoles.RoleGroup
            ),
            "group 2",
        )
        ...
        self.assertEqual(
            model.data(
                model.index(1, 0), QgsBookmarkManagerModel.CustomRoles.RoleExtent
            ),
            app_manager.bookmarkById(id).extent(),
        )
        ...
        self.assertFalse(model.setData(model.index(-1, 0), 4, Qt.ItemDataRole.EditRole))
        self.assertTrue(
            model.setData(model.index(0, 0), "new name", Qt.ItemDataRole.EditRole)
        )
        self.assertEqual(model.data(model.index(0, 0)), "new name")
        self.assertEqual(app_manager.bookmarks()[0].name(), "new name")
        self.assertTrue(
            model.setData(model.index(1, 1), "new group", Qt.ItemDataRole.EditRole)
        )
        ...
        self.assertTrue(
            model.setData(model.index(0, 6), -1.2, Qt.ItemDataRole.EditRole)
        )
        ...
        self.assertTrue(
            model.flags(model.index(0, 8)) & Qt.ItemFlag.ItemIsUserCheckable
        )
        self.assertTrue(
            model.flags(model.index(1, 8)) & Qt.ItemFlag.ItemIsUserCheckable
        )
        ...
        self.assertFalse(
            model.flags(model.index(2, 8)) & Qt.ItemFlag.ItemIsUserCheckable
        )
        ...
        b3.setExtent(
            QgsReferencedRectangle(
                QgsRectangle(32, 32, 33, 43), QgsCoordinateReferenceSystem("EPSG:28355")
            )
        )
        b3.setRotation(90)
        ...
        self.assertEqual(
            model.data(model.index(2, 8), Qt.ItemDataRole.CheckStateRole),
            Qt.CheckState.Checked,
        )
        self.assertEqual(
            model.data(model.index(2, 0), QgsBookmarkManagerModel.CustomRoles.RoleName),
            "b3",
        )
        self.assertEqual(
            model.data(
                model.index(2, 0), QgsBookmarkManagerModel.CustomRoles.RoleGroup
            ),
            "group 3",
        )
        ...
        self.assertEqual(
            model.data(
                model.index(2, 0), QgsBookmarkManagerModel.CustomRoles.RoleExtent
            ),
        ...
        self.assertTrue(
            model.setData(model.index(2, 0), "new name 2", Qt.ItemDataRole.EditRole)
        )
        self.assertEqual(model.data(model.index(2, 0)), "new name 2")
        self.assertEqual(project_manager.bookmarks()[0].name(), "new name 2")
        self.assertTrue(
            model.setData(model.index(2, 1), "new group", Qt.ItemDataRole.EditRole)
        )
        ...
        self.assertFalse(
            model.flags(model.index(3, 8)) & Qt.ItemFlag.ItemIsUserCheckable
        )

        # try transferring bookmark from app->project
        self.assertTrue(
            model.setData(
                model.index(1, 8), Qt.CheckState.Checked, Qt.ItemDataRole.CheckStateRole
            )
        )
        self.assertEqual(
            [b.name() for b in project_manager.bookmarks()], ["new name 2", "b2"]
        )
        ...
        self.assertEqual(
            [b.name() for b in app_manager.bookmarks()], ["new name", "new name 2"]
        )
        self.assertFalse(
            model.setData(
                model.index(1, 8),
