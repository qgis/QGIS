...
class TestQgsMapCanvas(QgisTestCase):
    ...
    def testZoomToFeatureExtent(self):
        ...
        c.setExtent(QgsRectangle(5, 45, 9, 47))
        self.assertAlmostEqual(c.extent().xMinimum(), 5.0, 5)
        self.assertAlmostEqual(c.extent().xMaximum(), 9.0, 5)
        self.assertAlmostEqual(c.extent().yMinimum(), 44.5, 5)
        self.assertAlmostEqual(c.extent().yMaximum(), 47.5, 5)
        ...
        self.assertAlmostEqual(c.extent().xMinimum(), 4.9, 5)
        self.assertAlmostEqual(c.extent().xMaximum(), 9.1, 5)
        self.assertAlmostEqual(c.extent().yMinimum(), 44.425, 5)
        self.assertAlmostEqual(c.extent().yMaximum(), 47.575, 5)
        self.assertAlmostEqual(c.magnificationFactor(), 1, 1)
        ...
        self.assertAlmostEqual(c.extent().xMinimum(), 12.9, 5)
        self.assertAlmostEqual(c.extent().xMaximum(), 17.1, 5)
        self.assertAlmostEqual(c.extent().yMinimum(), 33.425, 5)
        self.assertAlmostEqual(c.extent().yMaximum(), 36.575, 5)
        self.assertAlmostEqual(c.magnificationFactor(), 1, 1)
