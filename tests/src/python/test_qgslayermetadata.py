...
class TestQgsLayerMetadata(QgisTestCase):
    ...
    def testExtent(self):
        ...
        self.assertEqual(
            m.extent().temporalExtents()[0].end(),
            QDateTime(QDate(2018, 1, 3), QTime(12, 35, 57)),
        )
    ...
    def checkExpectedMetadata(self, m):
        ...
        self.assertEqual(
            m.extent().temporalExtents()[1].end(),
            QDateTime(QDate(2020, 12, 17), QTime(9, 30, 47)),
        )
    ...
    def testCombine(self):
        ...
        m1.setContacts(
            [QgsLayerMetadata.Contact("c1"), QgsLayerMetadata.Contact("cc1")]
        )
        m2.setContacts([])
        m1.combine(m2)
        self.assertEqual(
        ...
        m1.setContacts([])
        m2.setContacts(
            [QgsLayerMetadata.Contact("c2"), QgsLayerMetadata.Contact("cc2")]
        )
        m1.combine(m2)
        self.assertEqual(
            m1.contacts(),
        ...
        m1.combine(m2)
        self.assertEqual(
            m1.links(), [QgsLayerMetadata.Link("l1"), QgsLayerMetadata.Link("ll1")]
        )
        ...
        m1.combine(m2)
        self.assertEqual(
            m1.links(), [QgsLayerMetadata.Link("l2"), QgsLayerMetadata.Link("ll2")]
        )
        ...
        m1.setConstraints(
            [QgsLayerMetadata.Constraint("c1"), QgsLayerMetadata.Constraint("cc1")]
        )
        m2.setConstraints([])
        m1.combine(m2)
        self.assertEqual(
        ...
        m1.setConstraints([])
        m2.setConstraints(
            [QgsLayerMetadata.Constraint("c2"), QgsLayerMetadata.Constraint("cc2")]
        )
        m1.combine(m2)
        self.assertEqual(
            m1.constraints(),
        ...
        m1.combine(m2)
        self.assertEqual(
            m1.extent().spatialExtents()[0].bounds, QgsBox3d(1, 2, 3, 4, 5, 6)
        )
        ...
        m1.combine(m2)
        self.assertEqual(
            m1.extent().spatialExtents()[0].bounds, QgsBox3d(11, 12, 13, 14, 15, 16)
        )

        s = QgsDateTimeRange(
            QDateTime(2020, 1, 1, 0, 0, 0), QDateTime(2020, 2, 1, 0, 0, 0)
        )
        ...
        s = QgsDateTimeRange(
            QDateTime(2021, 1, 1, 0, 0, 0), QDateTime(2021, 2, 1, 0, 0, 0)
        )
