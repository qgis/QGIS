...
class TestQgsPolygon(QgisTestCase):
    ...
    def testFuzzyComparisons(self):
        ...
        epsilon = 0.001
        geom1 = QgsPolygon()
        geom1.setExteriorRing(QgsLineString([QgsPoint(0.0, 0.0), QgsPoint(0.001, 0.001), QgsPoint(0.003, 0.003), QgsPoint(0.0, 0.0)]))
        geom2 = QgsPolygon()
        ...
        epsilon = 0.001
        geom1 = QgsPolygon()
        geom1.setExteriorRing(QgsLineString([QgsPoint(0.0, 0.0, 0.0), QgsPoint(0.001, 0.001, 0.001), QgsPoint(0.003, 0.003, 0.003), QgsPoint(0.0, 0.0, 0.0)]))
        geom2 = QgsPolygon()
        ...
        epsilon = 0.001
        geom1 = QgsPolygon()
        geom1.setExteriorRing(QgsLineString([QgsPoint(0.0, 0.0, m=0.0), QgsPoint(0.001, 0.001, m=0.001), QgsPoint(0.003, 0.003, m=0.003), QgsPoint(0.0, 0.0, m=0.0)]))
        geom2 = QgsPolygon()
        ...
        epsilon = 0.001
        geom1 = QgsPolygon()
        geom1.setExteriorRing(QgsLineString([QgsPoint(0.0, 0.0, 0.0, 0.0), QgsPoint(0.001, 0.001, 0.001, 0.001), QgsPoint(0.003, 0.003, 0.003, 0.003), QgsPoint(0.0, 0.0, 0.0, 0.0)]))
        geom2 = QgsPolygon()
