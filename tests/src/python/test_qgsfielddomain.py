...
class TestPyQgsFieldDomain(unittest.TestCase):
    ...
    def testCodedFieldDomain(self):
        domain = QgsCodedFieldDomain(
            "name", "desc", QVariant.Int, [QgsCodedValue(5, "a"), QgsCodedValue(6, "b")]
        )
        ...
        self.assertEqual(
            domain.values(), [QgsCodedValue(5, "a"), QgsCodedValue(6, "b")]
        )
        domain.setValues([QgsCodedValue(51, "aa"), QgsCodedValue(61, "bb")])
        self.assertEqual(
            domain.values(), [QgsCodedValue(51, "aa"), QgsCodedValue(61, "bb")]
        )

        domain.setSplitPolicy(Qgis.FieldDomainSplitPolicy.GeometryRatio)
        self.assertEqual(
            domain.splitPolicy(), Qgis.FieldDomainSplitPolicy.GeometryRatio
        )

        domain.setMergePolicy(Qgis.FieldDomainMergePolicy.GeometryWeighted)
        self.assertEqual(
            domain.mergePolicy(), Qgis.FieldDomainMergePolicy.GeometryWeighted
        )
        ...
        self.assertEqual(
            d2.values(), [QgsCodedValue(51, "aa"), QgsCodedValue(61, "bb")]
        )
    ...
    def testRangeFieldDomain(self):
        domain = QgsRangeFieldDomain("name", "desc", QVariant.Int, 1, True, 5, True)
