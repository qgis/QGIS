...
class TestQgsPalettedRasterRenderer(QgisTestCase):
    def testPaletted(self):
        ...
        self.assertTrue(
            self.render_map_settings_check("paletted_renderer", "paletted_renderer", ms)
        )
    ...
    def testPalettedBand(self):
        ...
        self.assertTrue(
            self.render_map_settings_check(
                "paletted_renderer_band2", "paletted_renderer_band2", ms
            )
        )
        ...
        self.assertTrue(
            self.render_map_settings_check(
                "paletted_renderer_band3", "paletted_renderer_band3", ms
            )
        )

    def testPalettedColorTableToClassData(self):
        entries = [
            QgsColorRampShader.ColorRampItem(5, QColor(255, 0, 0), "item1"),
        ...
        classes = QgsPalettedRasterRenderer.colorTableToClassData(
            layer.dataProvider().colorTable(15)
        )
    ...
    def testLoadPalettedClassDataFromFile(self):
        ...
        # good file!
        path = os.path.join(unitTestDataPath("raster"), "test.clr")
    ...
    def testPalettedClassDataToString(self):
        ...
        self.assertEqual(
            QgsPalettedRasterRenderer.classDataToString(classes),
