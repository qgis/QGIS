...
"""
        for version in ["1.0.0", "1.1.0"]:
            ...
            tests.append(
                (f"nobbox_post{version_underscore}", template.format(version, ""))
            )
            tests.append(
                (
                    f"startindex2_post{version_underscore}",
                    template.format(version, 'startIndex="2"'),
                )
            )
            tests.append(
                (
                    f"limit2_post{version_underscore}",
                    template.format(version, 'maxFeatures="2"'),
                )
            )
            tests.append(
                (
                    f"start1_limit1_post{version_underscore}",
                    template.format(version, 'startIndex="1" maxFeatures="1"'),
                )
            )
...
"""
        tests.append(
            (
                "srsname_post_1_0_0",
                srsTemplate.format("1.0.0", "", 'srsName="EPSG:3857"'),
            )
        )
        tests.append(
            (
                "srsname_post_1_1_0",
                srsTemplate.format("1.1.0", "", 'srsName="EPSG:3857"'),
            )
        )
        tests.append(
            (
                "srsname_post_1_1_0_urn",
                srsTemplate.format("1.1.0", "", 'srsName="urn:ogc:def:crs:EPSG::3857"'),
            )
        )
...
"""
        tests.append(
            ("within4326FilterTemplate_post", within4326FilterTemplate.format(""))
        )
...
"""
        tests.append(
            ("within3857FilterTemplate_post", within3857FilterTemplate.format(""))
        )
...
"""
    ...
    def test_getFeatureBBOX(self):
        ...
        self.wfs_request_compare(
            "GetFeature",
            "1.0.0",
            "TYPENAME=testlayer&RESULTTYPE=hits&BBOX=8.20347,44.901471,8.2035354,44.901493",
            "wfs_getFeature_1_0_0_bbox_1_feature",
        )
        self.wfs_request_compare(
            "GetFeature",
            "1.0.0",
            "TYPENAME=testlayer&RESULTTYPE=hits&BBOX=8.203127,44.9012765,8.204138,44.901632",
            "wfs_getFeature_1_0_0_bbox_3_feature",
        )
        ...
        self.wfs_request_compare(
            "GetFeature",
            "1.0.0",
            "SRSNAME=EPSG:4326&TYPENAME=testlayer&RESULTTYPE=hits&BBOX=8.20347,44.901471,8.2035354,44.901493,EPSG:4326",
            "wfs_getFeature_1_0_0_epsgbbox_1_feature",
        )
        self.wfs_request_compare(
            "GetFeature",
            "1.0.0",
            "SRSNAME=EPSG:4326&TYPENAME=testlayer&RESULTTYPE=hits&BBOX=8.203127,44.9012765,8.204138,44.901632,EPSG:4326",
            "wfs_getFeature_1_0_0_epsgbbox_3_feature",
        )
        self.wfs_request_compare(
            "GetFeature",
            "1.1.0",
            "SRSNAME=EPSG:4326&TYPENAME=testlayer&RESULTTYPE=hits&BBOX=8.20347,44.901471,8.2035354,44.901493,EPSG:4326",
            "wfs_getFeature_1_1_0_epsgbbox_1_feature",
        )
        self.wfs_request_compare(
            "GetFeature",
            "1.1.0",
            "SRSNAME=EPSG:4326&TYPENAME=testlayer&RESULTTYPE=hits&BBOX=8.203127,44.9012765,8.204138,44.901632,EPSG:4326",
            "wfs_getFeature_1_1_0_epsgbbox_3_feature",
        )

        self.wfs_request_compare(
            "GetFeature",
            "1.0.0",
            "SRSNAME=EPSG:4326&TYPENAME=testlayer&RESULTTYPE=hits&BBOX=913144,5605992,913303,5606048,EPSG:3857",
            "wfs_getFeature_1_0_0_epsgbbox_3_feature_3857",
        )
        self.wfs_request_compare(
            "GetFeature",
            "1.0.0",
            "SRSNAME=EPSG:4326&TYPENAME=testlayer&RESULTTYPE=hits&BBOX=913206,5606024,913213,5606026,EPSG:3857",
        ...
        self.wfs_request_compare(
            "GetFeature",
            "1.0.0",
            "SRSNAME=EPSG:3857&TYPENAME=testlayer&RESULTTYPE=hits&BBOX=913144,5605992,913303,5606048,EPSG:3857",
            "wfs_getFeature_1_0_0_epsgbbox_3_feature_3857",
        )
        self.wfs_request_compare(
            "GetFeature",
            "1.0.0",
            "SRSNAME=EPSG:3857&TYPENAME=testlayer&RESULTTYPE=hits&BBOX=913206,5606024,913213,5606026,EPSG:3857",
            "wfs_getFeature_1_0_0_epsgbbox_1_feature_3857",
        )
        self.wfs_request_compare(
            "GetFeature",
    ...
    def test_getFeatureFeatureId(self):
        ...
        self.wfs_request_compare(
            ...
            "wfs_getFeature_1_0_0_featureid_0",
        )
        ...
        self.wfs_request_compare(
            "GetFeature",
            "1.0.0",
            "SRSNAME=EPSG:4326&TYPENAME=testlayer&FEATUREID=testlayer.0,testlayer.2",
            "wfs_getFeature_1_0_0_featureid_02",
        )
        ...
        self.wfs_request_compare(
            "GetFeature",
            "1.0.0",
            "SRSNAME=EPSG:4326&TYPENAME=Testing_Layer_(copy)&FEATUREID=Testing_Layer_(copy).0",
            "wfs_getFeature_1_0_0_featureid_0_testing",
        )
        ...
        self.wfs_request_compare(
            "GetFeature",
            "1.0.0",
            "SRSNAME=EPSG:4326&TYPENAME=testlayer&FEATUREID=testlayer.0&PROPERTYNAME=*",
            "wfs_getFeature_1_0_0_featureid_0",
        )
    ...
    def test_getFeatureFeature11urn(self):
        ...
        self.wfs_request_compare(
            "GetFeature",
            "1.1.0",
            "SRSNAME=urn:ogc:def:crs:EPSG::4326&TYPENAME=testlayer&FEATUREID=testlayer.0",
            "wfs_getFeature_1_1_0_featureid_0_1_1_0",
        )
        ...
        self.wfs_request_compare(
            "GetFeature",
            "1.1.0",
            "SRSNAME=urn:ogc:def:crs:EPSG::3857&TYPENAME=testlayer&FEATUREID=testlayer.0",
            "wfs_getFeature_1_1_0_featureid_0_1_1_0_epsg3857",
        )
    ...
    def test_get_feature_srsname_empty(self):
        ...
        self.wfs_request_compare(
            "GetFeature",
            "1.1.0",
            "TYPENAME=testlayer&FEATUREID=testlayer.0",
            "wfs_getFeature_1_1_0_featureid_0_1_1_0_srsname",
        )
    ...
    def test_getFeature_EXP_FILTER_regression_20927(self):
        ...
        self.wfs_request_compare(
            "GetFeature",
            "1.0.0",
            "SRSNAME=EPSG:4326&TYPENAME=testlayer&FEATUREID=testlayer.0&EXP_FILTER=\"name\"='one'",
            "wfs_getFeature_1_0_0_EXP_FILTER_FID_one",
        )
        # Note that FEATUREID takes precedence over EXP_FILTER and the filter is completely ignored when FEATUREID is set
        self.wfs_request_compare(
            "GetFeature",
            "1.0.0",
            "SRSNAME=EPSG:4326&TYPENAME=testlayer&FEATUREID=testlayer.0&EXP_FILTER=\"name\"='two'",
            "wfs_getFeature_1_0_0_EXP_FILTER_FID_one",
        )
        self.wfs_request_compare(
            "GetFeature",
            "1.0.0",
            "SRSNAME=EPSG:4326&TYPENAME=testlayer&EXP_FILTER=\"name\"='two'",
            "wfs_getFeature_1_0_0_EXP_FILTER_two",
        )
        self.wfs_request_compare(
            "GetFeature",
            "1.0.0",
            "SRSNAME=EPSG:4326&TYPENAME=testlayer&EXP_FILTER=\"name\"=concat('tw', 'o')",
            "wfs_getFeature_1_0_0_EXP_FILTER_two",
        )
        ...
        self.wfs_request_compare(
            "GetFeature",
            "1.0.0",
            "SRSNAME=EPSG:4326&TYPENAME=testlayer&EXP_FILTER=\"name\"=invalid_expression('tw', 'o')",
        ...
        self.wfs_request_compare(
            "GetFeature",
            "1.0.0",
            'SRSNAME=EPSG:4326&TYPENAME=testlayer&EXP_FILTER=intersects($geometry, geom_from_gml(\'<gml:Box> <gml:coordinates cs="," ts=" ">8.20344750430995617,44.9013881888184514 8.20347909100379269,44.90140004005827024</gml:coordinates></gml:Box>\'))',
            "wfs_getFeature_1_0_0_EXP_FILTER_gml_bbox_three",
        )
        self.wfs_request_compare(
            "GetFeature",
            "1.0.0",
            'SRSNAME=EPSG:4326&TYPENAME=testlayer&EXP_FILTER=intersects($geometry, geom_from_gml(\'<gml:Box> <gml:coordinates cs="," ts=" ">8.20348458304175665,44.90147459621791626 8.20351616973559317,44.9014864474577351</gml:coordinates></gml:Box>\'))',
            "wfs_getFeature_1_0_0_EXP_FILTER_gml_bbox_one",
        )
    ...
    def test_describeFeatureType(self):
        ...
        self.wfs_request_compare(
            ...
            "1.0.0",
            "TYPENAME=as_areas&",
            "wfs_describeFeatureType_1_0_0_typename_as_areas",
            project_file=project_file,
        )
        self.wfs_request_compare(
            "DescribeFeatureType",
            "1.0.0",
            "TYPENAME=as_areas&OUTPUTFORMAT=XMLSCHEMA&",
            "wfs_describeFeatureType_1_0_0_typename_as_areas",
            project_file=project_file,
        )
        ...
        self.wfs_request_compare(
            ...
            "1.1.0",
            "TYPENAME=as_areas&",
            "wfs_describeFeatureType_1_1_0_typename_as_areas",
            project_file=project_file,
        )
        self.wfs_request_compare(
            "DescribeFeatureType",
        ...
        self.wfs_request_compare(
            "DescribeFeatureType",
            "1.1.0",
            "TYPENAME=as_areas&OUTPUTFORMAT=text/xml; subtype=gml/3.1.1&",
            "wfs_describeFeatureType_1_1_0_typename_as_areas",
            project_file=project_file,
        )
        ...
        self.wfs_request_compare(
            ...
            "1.0.0",
            "",
            "wfs_describeFeatureType_1_0_0_typename_empty",
            project_file=project_file,
        )
        self.wfs_request_compare(
            "DescribeFeatureType",
            "1.1.0",
            "",
            "wfs_describeFeatureType_1_1_0_typename_empty",
            project_file=project_file,
        )
        ...
        self.wfs_request_compare(
            ...
            "wfs_describeFeatureType_1_0_0_typename_wrong",
            project_file=project_file,
        )
        self.wfs_request_compare(
            "DescribeFeatureType",
            "1.1.0",
            "TYPENAME=does_not_exist&",
            "wfs_describeFeatureType_1_1_0_typename_wrong",
            project_file=project_file,
        )
    ...
    def test_describeFeatureTypeGeoJson(self):
        ...
        self.wfs_request_compare(
            "DescribeFeatureType",
            "1.1.0",
            "TYPENAME=as_areas&OUTPUTFORMAT=GEOJSON",
            "wfs_describeFeatureType_1_1_0_typename_as_areas_geojson",
            project_file=project_file,
        )
    ...
    def test_describeFeatureTypeVirtualFields(self):
        ...
        self.wfs_request_compare(
            ...
            "1.1.0",
            "",
            "wfs_describeFeatureType_1_1_0_virtual_fields",
            project_file=project_file,
        )
   ...
   <wfs:Update typeName="cdb_lines">
      ...
      <fes:Filter>
        ...
        def _round_trip(value, field, version="1.1.0"):
            ...
            encoded_data = post_data.format(
                field=field, value=value, version=version
            ).encode("utf8")
            ...
            header, body = self._execute_request(
                "?MAP={}&SERVICE=WFS&VERSION={}".format(
                    self.testdata_path + "test_project_wms_grouped_layers.qgs", version
                ),
            ...
            header, body = self._execute_request(
                "?MAP=%s&SERVICE=WFS&REQUEST=GetFeature&TYPENAME=cdb_lines&FEATUREID=cdb_lines.22"
            ...
            vl = QgsVectorLayer(
                self.testdata_path
                + "test_project_wms_grouped_layers.gpkg|layername=cdb_lines",
                "vl",
                "ogr",
            )
        ...
        for version in ("1.0.0", "1.1.0"):
            ...
            # Then NULL
            data = post_data.format(field="name", value="", version=version).encode(
                "utf8"
            )
            ...
            self.assertIn(
                b"<Message>NOT NULL constraint error on layer 'cdb_lines', field 'name'</Message>",
                body,
            )
    ...
    def test_getFeatureFeatureJsonCrs(self):
        ...
        layer = QgsVectorLayer(
            "Point?crs=epsg:3857&field=fldint:integer", "layer", "memory"
        )
        ...
        self.assertEqual(
            jdata["features"][0]["geometry"]["coordinates"], [807305, 5592878]
        )
        self.assertEqual(
            jdata["crs"]["properties"]["name"], "urn:ogc:def:crs:EPSG::3857"
        )
        ...
        jdata["features"][0]["geometry"]["coordinates"]
        self.assertEqual(
            [int(i) for i in jdata["features"][0]["geometry"]["coordinates"]], [7, 44]
        )
        ...
        jdata["features"][0]["geometry"]["coordinates"]
        self.assertEqual(
            [int(i) for i in jdata["features"][0]["geometry"]["coordinates"]],
            [361806, 4964192],
        )
        self.assertEqual(
            jdata["crs"]["properties"]["name"], "urn:ogc:def:crs:EPSG::32632"
        )
    ...
    def test_insert_srsName(self):
        ...
        project = self.testdata_path + "test_project_wms_grouped_layers.qgs"
        assert os.path.exists(project), "Project file not found: " + project
        ...
        self.assertTrue(vl.isValid())
        feature = next(
            vl.getFeatures(QgsFeatureRequest(QgsExpression("\"name\" = '4326-test1'")))
        )
        ...
        feature = next(
            vl.getFeatures(QgsFeatureRequest(QgsExpression("\"name\" = '25832-test1'")))
        )
        geom = feature.geometry()
        self.assertEqual(geom.asWkt(0), geom_4326.asWkt(0))
        ...
        def _test(version, srsName, lat_lon=False):
            ...
            feature = next(
                vl.getFeatures(QgsFeatureRequest(QgsExpression(f"\"name\" = '{name}'")))
            )
            geom = feature.geometry()
            self.assertEqual(
                geom.asWkt(0),
                geom_4326.asWkt(0),
                f"Transaction Failed: {version} , {srsName}, lat_lon={lat_lon}",
            )
        ...
        def _test_getFeature(version, srsName, lat_lon=False):
            ...
            self.assertTrue(
                b"gid>7" in body,
                f"GetFeature Failed: {version} , {srsName}, lat_lon={lat_lon}",
            )
    ...
    def test_getFeatureFeatureEnvelopeCrs(self):
        ...
        self.assertEqual(
            [c[:4] for c in e.findall(".//")[0].text.split(" ")], ["7.25", "44.7"]
        )
        self.assertEqual(
        ...
        self.assertEqual(e.attrib, {"srsName": "EPSG:4326"})
        self.assertEqual(
            [c[:4] for c in e.findall(".//")[0].text.split(" ")], ["7.2", "44.5"]
        )
        self.assertEqual(
    ...
    def test_describeFeatureTypeDateTime(self):
        ...
        self.wfs_request_compare(
            ...
            "wfs_describeFeatureType_1_0_0_typename_datetime_dim",
            project_file=project_file,
        )
        self.wfs_request_compare(
            "DescribeFeatureType",
            "1.1.0",
            "TYPENAME=Datetime_dim&",
            "wfs_describeFeatureType_1_1_0_typename_datetime_dim",
            project_file=project_file,
        )
        ...
        self.wfs_request_compare(
            ...
            "wfs_describeFeatureType_1_1_0_typename_datetime_str",
            project_file=project_file,
        )
