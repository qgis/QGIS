...
class TestQgsVectorLayerUtils(QgisTestCase):
    ...
    def testDuplicateFeature(self):
        ...
        layer1.setFieldDuplicatePolicy(2, Qgis.FieldDomainDuplicatePolicy.Duplicate)
        layer1.setFieldDuplicatePolicy(3, Qgis.FieldDomainDuplicatePolicy.DefaultValue)
        layer1.setFieldDuplicatePolicy(4, Qgis.FieldDomainDuplicatePolicy.UnsetField)
        # > check first layer (parent)
        self.assertTrue(layer1.isValid())
        ...
        layer2.setFieldDuplicatePolicy(3, Qgis.FieldDomainDuplicatePolicy.Duplicate)
        layer2.setFieldDuplicatePolicy(4, Qgis.FieldDomainDuplicatePolicy.DefaultValue)
        layer2.setFieldDuplicatePolicy(5, Qgis.FieldDomainDuplicatePolicy.UnsetField)
        # > check second layer (child)
        self.assertTrue(layer2.isValid())
        ...
        layer3.setFieldDuplicatePolicy(3, Qgis.FieldDomainDuplicatePolicy.Duplicate)
        layer3.setFieldDuplicatePolicy(4, Qgis.FieldDomainDuplicatePolicy.DefaultValue)
        layer3.setFieldDuplicatePolicy(5, Qgis.FieldDomainDuplicatePolicy.UnsetField)
        # > check third layer (child)
        self.assertTrue(layer3.isValid())
        # - add layers
