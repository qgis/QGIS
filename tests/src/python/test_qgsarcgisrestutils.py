...
class TestQgsArcGisRestUtils(unittest.TestCase):
    ...
    def test_json_to_geometry(self):
        tests = [('esriGeometryPolyline',
                  ...
                  'MultiCurve (CompoundCurve (CircularString (148.38318 -17.13902, 150.46568 -15.97606, 150.99307 -16.73334),CircularString (150.99307 -16.73334, 153.02147 -17.85572, 153.67056 -16.31413),(153.67056 -16.31413, 155.13101 -14.55618, 150.53329 -13.63664),CircularString (150.53329 -13.63664, 147.99103 -12.8388, 147.63944 -14.35334),(147.63944 -14.35334)))')]
