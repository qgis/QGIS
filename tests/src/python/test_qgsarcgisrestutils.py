...
class TestQgsArcGisRestUtils(QgisTestCase):
    ...
    def test_json_to_geometry(self):
        tests = [
            (
                "esriGeometryPolyline",
                {
                    "curvePaths": [
                        [
                            [148.38318344186538, -17.139016173514584],
                            {
                                "c": [
                                    [150.99306515432036, -16.733335282152847],
                                    [150.46567981044387, -15.976063814628597],
                                ]
                            },
                            {
                                "c": [
                                    [153.67056039605595, -16.314131721058928],
                                    [153.02147048339893, -17.855719902399045],
                                ]
                            },
                            [155.13101252753447, -14.556180364908652],
                            [150.533293548165, -13.636636042108115],
                            {
                                "c": [
                                    [147.6394350119692, -14.353339106615321],
                                    [147.99102541902195, -12.83879629512887],
                                ]
                            },
                        ]
                    ],
        ...
        for type_string, json, expected in tests:
            geometry, _ = QgsArcGisRestUtils.convertGeometry(
                json, type_string, json.get("hasM"), json.get("hasZ")
            )
        ...
        tests = [
            ...
            (
                "MultiPoint(1 1, 10 1, 3 4)",
                {
                    "hasM": False,
                    "hasZ": False,
                    "points": [[1.0, 1.0], [10.0, 1.0], [3.0, 4.0]],
                },
            ),
            (
                "MultiPointZ(1 1 3, 10 1 8, 3 4 9)",
                {
                    "hasM": False,
                    "hasZ": True,
                    "points": [[1.0, 1.0, 3.0], [10.0, 1.0, 8.0], [3.0, 4.0, 9.0]],
                },
            ),
            (
                "MultiPointM(1 1 22, 10 1 23, 3 4 24)",
                {
                    "hasM": True,
                    "hasZ": False,
                    "points": [[1.0, 1.0, 22.0], [10.0, 1.0, 23.0], [3.0, 4.0, 24.0]],
                },
            ),
            (
            ...
            (
                "LineStringZ(1 2 11, 3 4 12)",
                {
                    "hasM": False,
                    "hasZ": True,
                    "paths": [[[1.0, 2.0, 11.0], [3.0, 4.0, 12.0]]],
                },
            ),
            (
                "LineStringM(1 2 21, 3 4 22)",
                {
                    "hasM": True,
                    "hasZ": False,
                    "paths": [[[1.0, 2.0, 21.0], [3.0, 4.0, 22.0]]],
                },
            ),
            (
                "LineStringZM(1 2 21 22, 3 4 31 33)",
                {
                    "hasM": True,
                    "hasZ": True,
                    "paths": [[[1.0, 2.0, 21.0, 22.0], [3.0, 4.0, 31.0, 33.0]]],
                },
            ),
            (
                "CircularString (0 0, 1 4, 3 3)",
                {
                    "hasM": False,
                    "hasZ": False,
                    "curvePaths": [[[0.0, 0.0], {"c": [[3.0, 3.0], [1.0, 4.0]]}]],
                },
            ),
            (
            ...
            (
                "CircularStringZ (1 2 3, 5 4 4, 7 2.2 5)",
                {
                    ...
                    "hasZ": True,
                    "curvePaths": [
                        [[1.0, 2.0, 3.0], {"c": [[7.0, 2.2, 5.0], [5.0, 4.0, 4.0]]}]
                    ],
                },
            ),
            (
            ...
            (
                "MultiLineStringZ((1 2 11, 3 4 12, 3 6 13), (11 12 21, 13 16 22, 18 19 23, 21 3 24))",
                {
                    ...
                    "hasZ": True,
                    "paths": [
                        [[1.0, 2.0, 11.0], [3.0, 4.0, 12.0], [3.0, 6.0, 13.0]],
                        [
                            [11.0, 12.0, 21.0],
                            [13.0, 16.0, 22.0],
                            [18.0, 19.0, 23.0],
            ...
            (
                "Polygon((1 2, 10 2, 10 12, 1 12, 1 2))",
                {
                    ...
                    "hasZ": False,
                    "rings": [
                        [[1.0, 2.0], [1.0, 12.0], [10.0, 12.0], [10.0, 2.0], [1.0, 2.0]]
                    ],
                },
            ),
            (
            ...
            (
                "CurvePolygon (CompoundCurve ((0 -23.43778, 0 -15.43778, 0 23.43778),CircularString (0 23.43778, -45 100, -90 23.43778),(-90 23.43778, -90 -23.43778),CircularString (-90 -23.43778, -45 -16.43778, 0 -23.43778)),CompoundCurve (CircularString (-30 0, -48 -12, -60 0, -48 -6, -30 0)))",
                {
                    ...
                    "curveRings": [
                        [
                            [0.0, -23.43778],
                            {"c": [[-90.0, -23.43778], [-45.0, -16.43778]]},
                            [-90.0, 23.43778],
                            {"c": [[0.0, 23.43778], [-45.0, 100.0]]},
                            [0.0, -15.43778],
                            [0.0, -23.43778],
                        ],
                        [
    ...
    def test_crs_conversion(self):
        self.assertEqual(
            QgsArcGisRestUtils.crsToJson(QgsCoordinateReferenceSystem()), {}
        )
        self.assertEqual(
            QgsArcGisRestUtils.crsToJson(QgsCoordinateReferenceSystem("EPSG:4326")),
            {"wkid": "4326"},
        )
        self.assertEqual(
            QgsArcGisRestUtils.crsToJson(QgsCoordinateReferenceSystem("EPSG:3857")),
            {"wkid": "3857"},
        )
        self.assertEqual(
            QgsArcGisRestUtils.crsToJson(QgsCoordinateReferenceSystem("ESRI:53079")),
            {"wkid": "53079"},
        )

        # should be represented via wkt
        self.assertTrue(
            QgsArcGisRestUtils.crsToJson(QgsCoordinateReferenceSystem("IGNF:WGS84"))[
                "wkt"
            ]
        )
    ...
    def test_geometry_with_crs(self):
        ...
        self.assertEqual(
            QgsArcGisRestUtils.geometryToJson(
                geom, context, QgsCoordinateReferenceSystem("EPSG:4326")
            ),
            {"spatialReference": {"wkid": "4326"}, "x": 1.0, "y": 2.0},
        )
        self.assertEqual(
            QgsArcGisRestUtils.geometryToJson(
                geom, context, QgsCoordinateReferenceSystem("EPSG:3857")
            ),
    ...
    def test_feature_to_json(self):
        ...
        attributes.append(
            QDateTime(QDate(2022, 3, 4), QTime(12, 13, 14), Qt.TimeSpec.UTC)
        )
        ...
        self.assertEqual(
            res, {"attributes": {"a_int_field": 5}, "geometry": {"x": 1.0, "y": 2.0}}
        )
