...
class TestQgsVectorLayerTemporalProperties(QgisTestCase):
    ...
    def testReadWrite(self):
        ...
        props.setDurationUnits(QgsUnitTypes.TemporalUnit.TemporalWeeks)
    ...
    def testModeFromProvider(self):
        ...
        caps.setAvailableTemporalRange(
            QgsDateTimeRange(
                QDateTime(2006, 3, 11, 0, 13, 20), QDateTime(2017, 2, 14, 1, 33, 20)
            )
        )
        props.setDefaultsFromDataProviderTemporalCapabilities(caps)
        ...
        self.assertEqual(
            props.fixedTemporalRange().begin(), QDateTime(2006, 3, 11, 0, 13, 20)
        )
        self.assertEqual(
            props.fixedTemporalRange().end(), QDateTime(2017, 2, 14, 1, 33, 20)
        )
    ...
    def testGuessDefaultsFromFields(self):
        layer = QgsVectorLayer(
            "Point?field=start_date:string&field=end_date:integer", "test", "memory"
        )
        ...
        layer = QgsVectorLayer(
            "Point?field=date_created:date&field=date_modified:date", "test", "memory"
        )
        self.assertTrue(layer.isValid())
        props = layer.temporalProperties()
        self.assertFalse(props.isActive())
        ...
        layer = QgsVectorLayer(
            "Point?field=event_id:integer&field=event_date:date", "test", "memory"
        )
        self.assertTrue(layer.isValid())
        props = layer.temporalProperties()
        self.assertFalse(props.isActive())
        ...
        layer = QgsVectorLayer(
            "Point?field=event_id:integer&field=start_date:datetime&field=end_date:datetime",
            "test",
            "memory",
        )
        self.assertTrue(layer.isValid())
    ...
    def testSingleFieldMode(self):
        ...
        date_layer = QgsVectorLayer(
            "Point?field=fldtxt:string&field=fldint:integer&field=start_field:date",
            "test",
            "memory",
        )
        ...
        self.assertEqual(
            props.createFilterString(datetime_context, filter_range),
            '("start_field" >= make_datetime(2019,3,4,11,12,13) AND "start_field" <= make_datetime(2020,5,6,8,9,10)) OR "start_field" IS NULL',
        )
        self.assertEqual(
            props.createFilterString(date_context, filter_range),
            '(to_datetime( "start_field" ) >= make_datetime(2019,3,4,11,12,13) AND to_datetime( "start_field" ) <= make_datetime(2020,5,6,8,9,10)) OR to_datetime( "start_field" ) IS NULL',
        )
        ...
        props.setDurationUnits(QgsUnitTypes.TemporalUnit.TemporalDays)
        filter_range = QgsDateTimeRange(
            QDateTime(QDate(2019, 3, 4), QTime(11, 12, 13)),
            QDateTime(QDate(2020, 5, 6), QTime(8, 9, 10)),
        )
        ...
        self.assertEqual(
            props.createFilterString(date_context, filter_range),
            '(to_datetime( "start_field" ) > make_datetime(2019,3,1,11,12,13) AND to_datetime( "start_field" ) <= make_datetime(2020,5,6,8,9,10)) OR to_datetime( "start_field" ) IS NULL',
        )
        ...
        props.setLimitMode(
            Qgis.VectorTemporalLimitMode.IncludeBeginExcludeEnd
        )  # back to default

        # different unit
        props.setDurationUnits(QgsUnitTypes.TemporalUnit.TemporalMinutes)
        filter_range = QgsDateTimeRange(
            QDateTime(QDate(2019, 3, 4), QTime(11, 12, 13)),
            QDateTime(QDate(2020, 5, 6), QTime(8, 9, 10)),
        )
        ...
        self.assertEqual(
            props.createFilterString(date_context, filter_range),
            '(to_datetime( "start_field" ) > make_datetime(2019,3,4,11,9,13) AND to_datetime( "start_field" ) <= make_datetime(2020,5,6,8,9,10)) OR to_datetime( "start_field" ) IS NULL',
        )
        ...
        self.assertEqual(
            props.createFilterString(date_context, filter_range),
            '(to_datetime( "start_field" ) <= make_datetime(2020,5,6,8,9,10)) OR to_datetime( "start_field" ) IS NULL',
        )
    ...
    def testDualFieldMode(self):
        ...
        date_layer = QgsVectorLayer(
            "Point?field=fldtxt:string&field=fldint:integer&field=start_field:date&field=end_field:date",
            "test",
            "memory",
        )
        self.assertTrue(date_layer.isValid())
        ...
        self.assertEqual(
            props.createFilterString(date_context, filter_range),
            '(to_datetime( "start_field" ) <= make_datetime(2020,5,6,8,9,10) OR to_datetime( "start_field" ) IS NULL) AND (to_datetime( "end_field" ) > make_datetime(2019,3,4,11,12,13) OR to_datetime( "end_field" ) IS NULL)',
        )
        ...
        self.assertEqual(
            props.createFilterString(date_context, filter_range),
            'to_datetime( "end_field" ) > make_datetime(2019,3,4,11,12,13) OR to_datetime( "end_field" ) IS NULL',
        )
    ...
    def testStartAndDurationMode(self):
        ...
        props = QgsVectorLayerTemporalProperties(enabled=False)
        props.setMode(
            QgsVectorLayerTemporalProperties.TemporalMode.ModeFeatureDateTimeStartAndDurationFromFields
        )
        props.setStartField("start_field")
        props.setDurationField("duration")
        props.setDurationUnits(QgsUnitTypes.TemporalUnit.TemporalMilliseconds)
        # createFilterString should return QString() (== '' in Python world) in case the QgsVectorLayerTemporalProperties is not yet active
        self.assertEqual("", props.createFilterString(datetime_context, filter_range))
        ...
        props.setDurationUnits(QgsUnitTypes.TemporalUnit.TemporalSeconds)
        self.assertEqual(
            props.createFilterString(datetime_context, filter_range),
        ...
        props.setDurationUnits(QgsUnitTypes.TemporalUnit.TemporalHours)
        self.assertEqual(
            props.createFilterString(datetime_context, filter_range),
        ...
        props.setDurationUnits(QgsUnitTypes.TemporalUnit.TemporalMonths)
        self.assertEqual(
            props.createFilterString(datetime_context, filter_range),
        ...
        props.setDurationUnits(QgsUnitTypes.TemporalUnit.TemporalYears)
        self.assertEqual(
            props.createFilterString(datetime_context, filter_range),
        ...
        props.setDurationUnits(QgsUnitTypes.TemporalUnit.TemporalDecades)
        self.assertEqual(
            props.createFilterString(datetime_context, filter_range),
        ...
        props.setDurationUnits(QgsUnitTypes.TemporalUnit.TemporalCenturies)
        self.assertEqual(
            props.createFilterString(datetime_context, filter_range),
    ...
    def testExpressionMode(self):
        ...
        props = QgsVectorLayerTemporalProperties(enabled=False)
        props.setMode(
            QgsVectorLayerTemporalProperties.TemporalMode.ModeFeatureDateTimeStartAndEndFromExpressions
        )
