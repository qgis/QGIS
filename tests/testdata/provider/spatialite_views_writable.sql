-- spatialite spatialite_views_writable.sqlite < spatialite_views_writable.sql
SELECT DateTime('now'),'spatialite_views_writable.sql [begin] - Testing SpatialViews INSERT,UPDATE and DELETE Functionality.';
...
SELECT '1999',name,notes,valid_since,valid_until, AsEWKT(wsg84_center)  FROM positions_1999;
--
SELECT DateTime('now'),'spatialite_views_writable.sql [finished] [Habe fertig!]';
--
