...
--
-- Data for Name: c_amgmt_amgmt_lot; Type: TABLE DATA; Schema: relations; Owner: -
--

COPY relations.c_amgmt_amgmt_lot (id, id_amgmt, id_amgmt_lot) FROM stdin;
\.


--
-- Data for Name: c_batiment_bat_lot; Type: TABLE DATA; Schema: relations; Owner: -
--

COPY relations.c_batiment_bat_lot (id, id_bat, id_bat_lot) FROM stdin;
\.


--
-- Data for Name: c_ens_immo_amgmt; Type: TABLE DATA; Schema: relations; Owner: -
--

COPY relations.c_ens_immo_amgmt (id, id_ens_immo, id_amgmt) FROM stdin;
\.


--
-- Data for Name: c_ens_immo_bat; Type: TABLE DATA; Schema: relations; Owner: -
--

COPY relations.c_ens_immo_bat (id, id_ens_immo, id_bat) FROM stdin;
\.


--
-- Data for Name: c_terrain_ens_immo; Type: TABLE DATA; Schema: relations; Owner: -
--

COPY relations.c_terrain_ens_immo (id, id_terrain, id_ens_immo) FROM stdin;
\.


--
-- Data for Name: t_actes; Type: TABLE DATA; Schema: relations; Owner: -
--

COPY relations.t_actes (cnumero, nature, numero_avenant, description, text_de_deliberation, text_signature, en_attente, amodiataire, tiers_ac_amodiataire, exploitant, tiers_ac_exploitant, bien, text_bien, bien_en_option, text_bien_option, periodicite_facture, base_, duree_annees, duree_mois, duree_jours, text_d_effet, text_fin_periode_ini, preavis_fin_initiale, nbre_de_renouvelle, duree_renouvellement, unite_renouvellement, preavis_en_mois_reno, redevance_variable, abattement_multiple, echeance_30_jours_fd, n_d_immeuble, regime_de_tva_, text_origine, operation_origine, explication_origine, acte_origine_, text_destination, operation_destinatio, explication_destinat, acte_destination, nombre_facturations, nombre_sous_locataire, presence_agenda, presence_particulari, numero_derniere_fact, text_derniere_factur, type_derniere_factur, utilisateur, text_acte, heure_acte, repertoires_des_anne, faculte_resiliation, nbannee_resiliation, nbmois_resiliation, nbjour_resiliation, text_faculte_resiliation, text_exercice_resiliation, renouvellement, rrr_redevance, rrr_traffic, remarque_renouvellement, text_fin_contrat_avec_renouv, id_udc, id_activite, observation, tacite_reconduction) FROM stdin;
\.


--
-- Data for Name: t_adresse; Type: TABLE DATA; Schema: relations; Owner: -
--

COPY relations.t_adresse (id, id_adresse, numero_rue, rue, code_postal, commune, code_insee_commune, code_fantoir) FROM stdin;
\.


--
-- Data for Name: t_amgmt; Type: TABLE DATA; Schema: relations; Owner: -
--

COPY relations.t_amgmt (id, id_amgmt, fk_adresse, description) FROM stdin;
\.


--
-- Data for Name: t_amgmt_lot; Type: TABLE DATA; Schema: relations; Owner: -
--

COPY relations.t_amgmt_lot (id, geom, id_amgmt_lot, fk_adresse, numero, type, etat, description, fk_acte, fk_invariant) FROM stdin;
\.


--
-- Data for Name: t_bat; Type: TABLE DATA; Schema: relations; Owner: -
--

COPY relations.t_bat (id, geom, id_bat, fk_adresse, descriptio, apercu, repertoire, date_couverture, date_ravalement) FROM stdin;
\.


--
-- Data for Name: t_bat_lot; Type: TABLE DATA; Schema: relations; Owner: -
--

COPY relations.t_bat_lot (id, id_bat_lot, fk_adresse, num_lot, type, etat, description, fk_acte, repertoire, fk_invariant) FROM stdin;
\.


--
-- Data for Name: t_ens_immo; Type: TABLE DATA; Schema: relations; Owner: -
--

COPY relations.t_ens_immo (id, id_ens_immo, fk_adresse, description) FROM stdin;
\.


--
-- Data for Name: t_terrain; Type: TABLE DATA; Schema: relations; Owner: -
--

COPY relations.t_terrain (id, geom, id_terrain, fk_adresse, fk_acte, nature, fk_invariant) FROM stdin;
\.
...
--
-- Name: c_amgmt_amgmt_lot_id_seq; Type: SEQUENCE SET; Schema: relations; Owner: -
--

SELECT pg_catalog.setval('relations.c_amgmt_amgmt_lot_id_seq', 162, true);


--
-- Name: c_batiment_bat_lot_id_seq; Type: SEQUENCE SET; Schema: relations; Owner: -
--

SELECT pg_catalog.setval('relations.c_batiment_bat_lot_id_seq', 261, true);


--
-- Name: c_ens_immo_amgmt_id_seq; Type: SEQUENCE SET; Schema: relations; Owner: -
--

SELECT pg_catalog.setval('relations.c_ens_immo_amgmt_id_seq', 1, false);


--
-- Name: c_ens_immo_bat_id_seq; Type: SEQUENCE SET; Schema: relations; Owner: -
--

SELECT pg_catalog.setval('relations.c_ens_immo_bat_id_seq', 1, false);


--
-- Name: c_terrain_ens_immo_id_seq; Type: SEQUENCE SET; Schema: relations; Owner: -
--

SELECT pg_catalog.setval('relations.c_terrain_ens_immo_id_seq', 1, false);


--
-- Name: t_adresse_id_seq; Type: SEQUENCE SET; Schema: relations; Owner: -
--

SELECT pg_catalog.setval('relations.t_adresse_id_seq', 1003, true);


--
-- Name: t_amgmt_id_seq; Type: SEQUENCE SET; Schema: relations; Owner: -
--

SELECT pg_catalog.setval('relations.t_amgmt_id_seq', 6, true);


--
-- Name: t_amgmt_lot_xy_id_seq; Type: SEQUENCE SET; Schema: relations; Owner: -
--

SELECT pg_catalog.setval('relations.t_amgmt_lot_xy_id_seq', 137, true);


--
-- Name: t_bat_id_seq; Type: SEQUENCE SET; Schema: relations; Owner: -
--

SELECT pg_catalog.setval('relations.t_bat_id_seq', 85, true);


--
-- Name: t_bat_lot_id_seq; Type: SEQUENCE SET; Schema: relations; Owner: -
--

SELECT pg_catalog.setval('relations.t_bat_lot_id_seq', 143, true);


--
-- Name: t_ens_immo_id_seq; Type: SEQUENCE SET; Schema: relations; Owner: -
--

SELECT pg_catalog.setval('relations.t_ens_immo_id_seq', 1, true);


--
-- Name: t_terrain_xy_id_seq; Type: SEQUENCE SET; Schema: relations; Owner: -
--

SELECT pg_catalog.setval('relations.t_terrain_xy_id_seq', 487, true);
