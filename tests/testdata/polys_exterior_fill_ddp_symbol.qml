    ...
    <symbols>
      <symbol alpha="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="color_border" v="11,124,195,255"/>
          <prop k="color_border_expression" v="color_rgb(255, 0, 0)"/>
          <prop k="color_expression" v="color_rgb(0, 255, 0)"/>
          <prop k="exterior_fill" v="1"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="style" v="diagonal_x"/>
          <prop k="style_border" v="dash"/>
          <prop k="width_border" v="0.8"/>
          <prop k="width_border_expression" v="toreal('3.0')"/>
        </layer>
      </symbol>
    </symbols>
    <rotation/>
