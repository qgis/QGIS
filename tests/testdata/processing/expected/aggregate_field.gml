...
<ogr:FeatureCollection
  ...
  <gml:featureMember>
    <ogr:aggregate_field fid="aggregate_field.0">
      ...
      <ogr:fids>polys.0,polys.4</ogr:fids>
      <ogr:name>aa</ogr:name>
      <ogr:intval>2</ogr:intval>
      <ogr:floatval>23.726728</ogr:floatval>
    </ogr:aggregate_field>
  </gml:featureMember>
  <gml:featureMember>
    <ogr:aggregate_field fid="aggregate_field.1">
  ...
  <gml:featureMember>
    <ogr:aggregate_field fid="aggregate_field.2">
      ...
      <ogr:fids>polys.2,polys.5,polys.6,polys.8</ogr:fids>
      <ogr:name>bb</ogr:name>
      <ogr:intval>5</ogr:intval>
      <ogr:floatval>0.123</ogr:floatval>
    </ogr:aggregate_field>
  </gml:featureMember>
  <gml:featureMember>
    <ogr:aggregate_field fid="aggregate_field.3">
      <ogr:fids>polys.3</ogr:fids>
      <ogr:intval>120</ogr:intval>
      <ogr:floatval>-100291.43213</ogr:floatval>
    </ogr:aggregate_field>
  </gml:featureMember>
  <gml:featureMember>
    <ogr:aggregate_field fid="aggregate_field.4">
