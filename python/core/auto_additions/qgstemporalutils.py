...
try:
    ...
    QgsTemporalUtils.AnimationExportSettings.__annotations__ = {'animationRange': 'QgsDateTimeRange', 'frameDuration': 'QgsInterval', 'outputDirectory': str, 'fileNameTemplate': str, 'decorations': 'List[QgsMapDecoration]', 'availableTemporalRanges': 'List[QgsDateTimeRange]', 'frameRate': float}
