...
try:
    ...
    QgsProcessingParameterCrs.__overridden_methods__ = ['getColor', 'getUserFriendlyValue', 'clone', 'type', 'checkValueIsAcceptable', 'valueAsPythonString', 'valueAsString', 'valueAsJsonObject']
...
try:
    ...
    QgsProcessingParameterDistance.__overridden_methods__ = ['getColor', 'getUserFriendlyValue', 'clone', 'type', 'dependsOnOtherParameters', 'asPythonString', 'toVariantMap', 'fromVariantMap']
...
try:
    ...
    QgsProcessingParameterEnum.__overridden_methods__ = ['getColor', 'getUserFriendlyValue', 'clone', 'type', 'checkValueIsAcceptable', 'valueAsPythonString', 'valueAsPythonComment', 'asScriptCode', 'asPythonString', 'toVariantMap', 'fromVariantMap']
...
try:
    ...
    pass
try:
    QgsProcessingParameterDefinition.__virtual_methods__ = ['getColor', 'getUserFriendlyValue', 'isDestination', 'checkValueIsAcceptable', 'valueAsPythonString', 'valueAsJsonObject', 'valueAsString', 'valueAsStringList', 'valueAsPythonComment', 'asScriptCode', 'asPythonString', 'toVariantMap', 'fromVariantMap', 'dependsOnOtherParameters', 'toolTip']
