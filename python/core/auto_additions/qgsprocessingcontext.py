...
try:
    ...
    __wrapped_QgsProcessingContext.LayerDetails_setPostProcessor = QgsProcessingContext.LayerDetails.setPostProcessor
    def __QgsProcessingContext.LayerDetails_setPostProcessor_wrapper(self, arg):
        __tracebackhide__ = True
        QgsSipUtils.verifyIsPyOwned(arg, 'you dont have ownership')
        return __wrapped_QgsProcessingContext.LayerDetails_setPostProcessor(self, arg)
    QgsProcessingContext.LayerDetails.setPostProcessor = _functools.update_wrapper(__QgsProcessingContext.LayerDetails_setPostProcessor_wrapper, QgsProcessingContext.LayerDetails.setPostProcessor)
