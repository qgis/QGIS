...
QgsMessageOutput.MessageText.__doc__ = "Plain text"
...
QgsMessageOutput.MessageHtml.__doc__ = "HTML formatted text"
Qgis.StringFormat.__doc__ = """Format of strings
...
Qgis.MapGridFrameSideFlag.__or__ = lambda flag1, flag2: Qgis.MapGridFrameSideFlags(_force_int(flag1) | _force_int(flag2))
try:
