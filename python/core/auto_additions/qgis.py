...
Qgis.MapLayerActionFlag.EnableOnlyIfHasGeometry.__doc__ = "Action should be shown only for layers with geometry, \n.. versionadded:: 3.42"
...
* ``EnableOnlyIfHasGeometry``: Action should be shown only for layers with geometry,
