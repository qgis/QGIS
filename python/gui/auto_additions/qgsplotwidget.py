...
try:
    ...
    QgsBarChartPlotWidget.__overridden_methods__ = ['setPlot', 'plot']
    QgsBarChartPlotWidget.__group__ = ['plot']
except (NameError, AttributeError):
    pass
try:
    QgsLineChartPlotWidget.create = staticmethod(QgsLineChartPlotWidget.create)
    QgsLineChartPlotWidget.__overridden_methods__ = ['setPlot', 'plot']
    QgsLineChartPlotWidget.__group__ = ['plot']
except (NameError, AttributeError):
    pass
try:
    QgsPlotWidget.__abstract_methods__ = ['setPlot', 'plot']
