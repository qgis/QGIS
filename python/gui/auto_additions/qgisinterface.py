...
try:
    ...
    __wrapped_QgisInterface_addToolBarWidget = QgisInterface.addToolBarWidget
    def __QgisInterface_addToolBarWidget_wrapper(self, arg):
        __tracebackhide__ = True
        QgsSipUtils.verifyIsPyOwned(arg, 'you dont have ownership')
        return __wrapped_QgisInterface_addToolBarWidget(self, arg)
    QgisInterface.addToolBarWidget = _functools.update_wrapper(__QgisInterface_addToolBarWidget_wrapper, QgisInterface.addToolBarWidget)

    import functools as _functools
    __wrapped_QgisInterface_addRasterToolBarWidget = QgisInterface.addRasterToolBarWidget
    def __QgisInterface_addRasterToolBarWidget_wrapper(self, arg):
        __tracebackhide__ = True
        QgsSipUtils.verifyIsPyOwned(arg, 'you dont have ownership')
        return __wrapped_QgisInterface_addRasterToolBarWidget(self, arg)
    QgisInterface.addRasterToolBarWidget = _functools.update_wrapper(__QgisInterface_addRasterToolBarWidget_wrapper, QgisInterface.addRasterToolBarWidget)

    import functools as _functools
    __wrapped_QgisInterface_addVectorToolBarWidget = QgisInterface.addVectorToolBarWidget
    def __QgisInterface_addVectorToolBarWidget_wrapper(self, arg):
        __tracebackhide__ = True
        QgsSipUtils.verifyIsPyOwned(arg, 'you dont have ownership')
        return __wrapped_QgisInterface_addVectorToolBarWidget(self, arg)
    QgisInterface.addVectorToolBarWidget = _functools.update_wrapper(__QgisInterface_addVectorToolBarWidget_wrapper, QgisInterface.addVectorToolBarWidget)

    import functools as _functools
    __wrapped_QgisInterface_addDatabaseToolBarWidget = QgisInterface.addDatabaseToolBarWidget
    def __QgisInterface_addDatabaseToolBarWidget_wrapper(self, arg):
        __tracebackhide__ = True
        QgsSipUtils.verifyIsPyOwned(arg, 'you dont have ownership')
        return __wrapped_QgisInterface_addDatabaseToolBarWidget(self, arg)
    QgisInterface.addDatabaseToolBarWidget = _functools.update_wrapper(__QgisInterface_addDatabaseToolBarWidget_wrapper, QgisInterface.addDatabaseToolBarWidget)

    import functools as _functools
    __wrapped_QgisInterface_addWebToolBarWidget = QgisInterface.addWebToolBarWidget
    def __QgisInterface_addWebToolBarWidget_wrapper(self, arg):
        __tracebackhide__ = True
        QgsSipUtils.verifyIsPyOwned(arg, 'you dont have ownership')
        return __wrapped_QgisInterface_addWebToolBarWidget(self, arg)
    QgisInterface.addWebToolBarWidget = _functools.update_wrapper(__QgisInterface_addWebToolBarWidget_wrapper, QgisInterface.addWebToolBarWidget)

    import functools as _functools
    __wrapped_QgisInterface_registerLocatorFilter = QgisInterface.registerLocatorFilter
    def __QgisInterface_registerLocatorFilter_wrapper(self, arg):
        __tracebackhide__ = True
        QgsSipUtils.verifyIsPyOwned(arg, 'you dont have ownership')
        return __wrapped_QgisInterface_registerLocatorFilter(self, arg)
    QgisInterface.registerLocatorFilter = _functools.update_wrapper(__QgisInterface_registerLocatorFilter_wrapper, QgisInterface.registerLocatorFilter)

    import functools as _functools
    __wrapped_QgisInterface_setGpsPanelConnection = QgisInterface.setGpsPanelConnection
    def __QgisInterface_setGpsPanelConnection_wrapper(self, arg):
        __tracebackhide__ = True
        QgsSipUtils.verifyIsPyOwned(arg, 'you dont have ownership')
        return __wrapped_QgisInterface_setGpsPanelConnection(self, arg)
    QgisInterface.setGpsPanelConnection = _functools.update_wrapper(__QgisInterface_setGpsPanelConnection_wrapper, QgisInterface.setGpsPanelConnection)
