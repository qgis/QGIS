# The following has been generated automatically from src/gui/symbology/qgssymbollayerwidgets.h
try:
...
try:
    ...
    QgsHashedLineSymbolLayerWidget.__overridden_methods__ = ['setSymbolLayer']
