...
class PythonConsoleWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.actionClass.setIcon(QgsApplication.getThemeIcon("console/iconClassConsole.svg"))
        ...
        self.runButton.setIcon(QgsApplication.getThemeIcon("console/iconRunConsole.svg"))
