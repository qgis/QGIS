...
class LAStoolsAlgorithm(GeoAlgorithm):
    ...
    FILTERS_RETURN_CLASS_FLAGS = ["---", "keep_last", "keep_first", "keep_middle", "keep_single", "drop_single", "keep_double", "keep_class 2", "keep_class 2 8", "keep_class 8", "keep_class 6", "keep_class 9", "keep_class 3 4 5", "keep_class 2 6", "drop_class 7", "drop_withheld"]
    ...
    FILTERS_COORDS_INTENSITY = ["---", "clip_x_above", "clip_x_below", "clip_y_above", "clip_y_below", "clip_z_above", "clip_z_below", "drop_intensity_above", "drop_intensity_below", "drop_gps_time_above", "drop_gps_time_below", "drop_scan_angle_above", "drop_scan_angle_below", "keep_point_source", "drop_point_source", "drop_point_source_above", "drop_point_source_below", "keep_user_data", "drop_user_data", "drop_user_data_above", "drop_user_data_below", "keep_every_nth", "keep_random_fraction", "thin_with_grid" ]
    ...
    TRANSFORM_OTHERS = ["---", "scale_intensity", "translate_intensity",  "clamp_intensity_above", "clamp_intensity_below", "scale_scan_angle", "translate_scan_angle", "translate_gps_time", "set_classification", "set_user_data", "set_point_source", "scale_rgb_up", "scale_rgb_down", "repair_zero_returns" ]
    ...
    def addParametersVerboseGUI(self):
        self.addParameter(ParameterBoolean(LAStoolsAlgorithm.VERBOSE, "verbose", True))
    ...
    def addParametersFilesAreFlightlinesGUI(self):
        self.addParameter(ParameterBoolean(LAStoolsAlgorithm.FILES_ARE_FLIGHTLINES, "verbose", True))
    ...
    def addParametersPointOutputFileGUI(self):
        self.addOutput(OutputFile(LAStoolsAlgorithm.OUTPUT_LASLAZ, "Output LAS/LAZ file"))
    ...
    def addParametersPointOutputDirectoryGUI(self):
        self.addOutput(OutputFile(LAStoolsAlgorithm.OUTPUT_DIRECTORY, "Output directory"))
    ...
    def addParametersPointOutputAppendixGUI(self):
        self.addOutput(OutputFile(LAStoolsAlgorithm.OUTPUT_APPENDIX, "Output appendix"))
    ...
    def addParametersPointOutputFormatGUI(self):
        self.addOutput(OutputFile(LAStoolsAlgorithm.OUTPUT_POINT_FORMAT, "Output format"))

    def addParametersPointOutputFormatCommands(self, commands):
        commands.append("-o")
        commands.append(self.getParameterValue(LAStoolsAlgorithm.OUTPUT_POINT_FORMAT))
    ...
    def addParametersFilter1ReturnClassFlagsGUI(self):
        self.addParameter(ParameterSelection(LAStoolsAlgorithm.FILTER_RETURN_CLASS_FLAGS1, "filter (by return, classification, flags)", LAStoolsAlgorithm.FILTERS_RETURN_CLASS_FLAGS, 0))
    ...
    def addParametersFilter2ReturnClassFlagsGUI(self):
        self.addParameter(ParameterSelection(LAStoolsAlgorithm.FILTER_RETURN_CLASS_FLAGS2, "second filter (by return, classification, flags)", LAStoolsAlgorithm.FILTERS_RETURN_CLASS_FLAGS, 0))
    ...
    def addParametersFilter3ReturnClassFlagsGUI(self):
         self.addParameter(ParameterSelection(LAStoolsAlgorithm.FILTER_RETURN_CLASS_FLAGS3, "third filter (by return, classification, flags)", LAStoolsAlgorithm.FILTERS_RETURN_CLASS_FLAGS, 0))
    ...
    def addParametersFilter1CoordsIntensityGUI(self):
        self.addParameter(ParameterSelection(LAStoolsAlgorithm.FILTER_COORDS_INTENSITY1, "filter (by coordinate, intensity, GPS time, ...)", LAStoolsAlgorithm.FILTERS_COORDS_INTENSITY, 0))
    ...
    def addParametersTransform1CoordinateGUI(self):
        self.addParameter(ParameterSelection(LAStoolsAlgorithm.TRANSFORM_COORDINATE1, "transform (coordinates)", LAStoolsAlgorithm.TRANSFORM_COORDINATES, 0))
        self.addParameter(ParameterString(LAStoolsAlgorithm.TRANSFORM_COORDINATE1_ARG, "value for transform (coordinates)"))        
    ...
    def addParametersTransform2CoordinateGUI(self):
        self.addParameter(ParameterSelection(LAStoolsAlgorithm.TRANSFORM_COORDINATE2, "second transform (coordinates)", LAStoolsAlgorithm.TRANSFORM_COORDINATES, 0))
        self.addParameter(ParameterString(LAStoolsAlgorithm.TRANSFORM_COORDINATE2_ARG, "value for second transform (coordinates)"))        
    ...
    def addParametersTransform1OtherGUI(self):
        self.addParameter(ParameterSelection(LAStoolsAlgorithm.TRANSFORM_OTHER1, "transform (intensities, scan angles, GPS times, ...)", LAStoolsAlgorithm.TRANSFORM_OTHERS, 0))
        self.addParameter(ParameterString(LAStoolsAlgorithm.TRANSFORM_OTHER1_ARG, "value for transform (intensities, scan angles, GPS times, ...)"))        
    ...
    def addParametersTransform2OtherGUI(self):
        self.addParameter(ParameterSelection(LAStoolsAlgorithm.TRANSFORM_OTHER2, "second transform (intensities, scan angles, GPS times, ...)", LAStoolsAlgorithm.TRANSFORM_OTHERS, 0))
        self.addParameter(ParameterString(LAStoolsAlgorithm.TRANSFORM_OTHER2_ARG, "value for second transform (intensities, scan angles, GPS times, ...)"))        
