...
<head>
  ...
  <link rel="stylesheet" href="https://unpkg.com/leaflet.fullscreen@2.3.0/Control.FullScreen.css"
   integrity="sha512-Wm5w05vDvZK7tOIICMiJMnvltfzTvmHFWmBhIQ4Wx4MutP9paMzZmEmH6DlxSuemaOhu8DcOE8TehdBhnz1mkQ=="
   crossorigin="anonymous">
  <script src="https://unpkg.com/leaflet.fullscreen@2.3.0/Control.FullScreen.js"
   integrity="sha512-T89wHCapRHFBnPRxzjMtXe421pHXhCIlBEedj6BmTviGc6VPly4xlj78Q1hiZ4u2JVDIbDzHDrWoqBi0vHHahQ=="
   crossorigin="anonymous"></script>

  <!-- https://www.npmjs.com/package/leaflet-hash -->
...
<body>
  ...
  <script>
      ...
      // create fullscreen control & add to the map
      ...
      L.tileLayer({tilesource}, {{
        ...
        maxZoom: {maxzoom},
        tms: {tms},
        attribution: 'Generated by <a target="_blank" href="https://plugins.qgis.org/plugins/tiles_xyz/">Tiles XYZ</a>'
      }}).addTo(map);
  </script>
</body>
</html>
