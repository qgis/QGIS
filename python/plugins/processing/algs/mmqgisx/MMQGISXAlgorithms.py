...
class mmqgisx_grid_algorithm(GeoAlgorithm):
  ...
  def processAlgorithm(self, progress):
    ...
    if width < hspacing:
      raise GeoAlgorithmExecutionException("Horizontal spacing is too small for the covered area")
    if height < vspacing:
        raise GeoAlgorithmExecutionException("Vertical spacing is too small for the covered area")
