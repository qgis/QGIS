...
class QgisAlgsTest(unittest.TestCase):
    ...
    def test_qgisreprojectlayer(self):
        outputs=sextante.runalg("qgis:reprojectlayer",polygons(),"EPSG:4326",None)
        output=outputs['OUTPUT']
        layer=QGisLayers.getObjectFromUri(output, True)
        fields=layer.pendingFields()
    ...
    def test_qgispolygonfromlayerextent(self):
        outputs=sextante.runalg("qgis:polygonfromlayerextent",polygons(),False,None)
        output=outputs['OUTPUT']
        layer=QGisLayers.getObjectFromUri(output, True)
        fields=layer.pendingFields()
    ...
    def test_qgispolygonfromlayerextentindividual(self):
        outputs=sextante.runalg("qgis:polygonfromlayerextent",polygons(),True,None)
        output=outputs['OUTPUT']
        layer=QGisLayers.getObjectFromUri(output, True)
        fields=layer.pendingFields()
        expectednames=['MINX','MINY','MAXX','MAXY','CNTX','CNTY','AREA','PERIM','HEIGHT','WIDTH']
    ...
    def test_qgisconvexhull(self):
        outputs=sextante.runalg("qgis:convexhull",points(),"ID",0,None)
        output=outputs['OUTPUT']
        layer=QGisLayers.getObjectFromUri(output, True)
        fields=layer.pendingFields()
    ...
    def test_qgisconvexhullindividual(self):
        outputs=sextante.runalg("qgis:convexhull",points(),"PT_ST_A",1,None)
        output=outputs['OUTPUT']
        layer=QGisLayers.getObjectFromUri(output, True)
        fields=layer.pendingFields()
        expectednames=['id','value','area','perim']
    ...
    def test_qgisdelaunaytriangulation(self):
        outputs=sextante.runalg("qgis:delaunaytriangulation",points(),None)
        output=outputs['OUTPUT']
        layer=QGisLayers.getObjectFromUri(output, True)
        fields=layer.pendingFields()
    ...
    def test_qgisconvertgeometrytypepolyg(self):
        outputs=sextante.runalg("qgis:convertgeometrytype",lines(),4,None)
        output=outputs['SAVENAME']
        layer=QGisLayers.getObjectFromUri(output, True)
        fields=layer.pendingFields()
    ...
    def test_qgisconvertgeometrytypemultiline(self):
        outputs=sextante.runalg("qgis:convertgeometrytype",polygons(),3,None)
        output=outputs['SAVENAME']
        layer=QGisLayers.getObjectFromUri(output, True)
        fields=layer.pendingFields()
        expectednames=['ID','POLY_NUM_A','POLY_ST_A']
    ...
    def test_qgisconvertgeometrytypenodes(self):
        outputs=sextante.runalg("qgis:convertgeometrytype",polygons(),1,None)
        output=outputs['SAVENAME']
        layer=QGisLayers.getObjectFromUri(output, True)
        fields=layer.pendingFields()
        expectednames=['ID','POLY_NUM_A','POLY_ST_A']
    ...
    def test_qgissnappointstogrid(self):
        outputs=sextante.runalg("qgis:snappointstogrid",points(),5,5,None)
        output=outputs['SAVENAME']
        layer=QGisLayers.getObjectFromUri(output, True)
        fields=layer.pendingFields()
    ...
    def test_qgisdensifygeometriesgivenaninterval(self):
        outputs=sextante.runalg("qgis:densifygeometriesgivenaninterval",lines(),25,None)
        output=outputs['OUTPUT']
        layer=QGisLayers.getObjectFromUri(output, True)
        fields=layer.pendingFields()
        expectednames=['ID','LINE_NUM_A','LINE_ST_A']
    ...
    def test_qgisdensifygeometries(self):
        outputs=sextante.runalg("qgis:densifygeometries",lines(),5,None)
        output=outputs['OUTPUT']
        layer=QGisLayers.getObjectFromUri(output, True)
        fields=layer.pendingFields()
        expectednames=['ID','LINE_NUM_A','LINE_ST_A']
    ...
    def test_qgisexplodelines(self):
        outputs=sextante.runalg("qgis:explodelines",lines(),None)
        output=outputs['OUTPUT']
        layer=QGisLayers.getObjectFromUri(output, True)
        fields=layer.pendingFields()
        expectednames=['ID','LINE_NUM_A','LINE_ST_A']
    ...
    def test_qgisextractnodes(self):
        outputs=sextante.runalg("qgis:extractnodes",lines(),None)
        output=outputs['OUTPUT']
        layer=QGisLayers.getObjectFromUri(output, True)
        fields=layer.pendingFields()
        expectednames=['ID','LINE_NUM_A','LINE_ST_A']
    ...
    def test_qgisfixeddistancebuffer(self):
        outputs=sextante.runalg("qgis:fixeddistancebuffer",points(),10,5,False,None)
        output=outputs['OUTPUT']
        layer=QGisLayers.getObjectFromUri(output, True)
        fields=layer.pendingFields()
        expectednames=['ID','PT_NUM_A','PT_ST_A']
    ...
    def test_qgisfixeddistancebufferdissolve(self):
        outputs=sextante.runalg("qgis:fixeddistancebuffer",points(),10,5,True,None)
        output=outputs['OUTPUT']
        layer=QGisLayers.getObjectFromUri(output, True)
        fields=layer.pendingFields()
        expectednames=['ID','PT_NUM_A','PT_ST_A']
    ...
    def test_qgisvoronoipolygons(self):
        outputs=sextante.runalg("qgis:voronoipolygons",points(),None)
        output=outputs['OUTPUT']
        layer=QGisLayers.getObjectFromUri(output, True)
        fields=layer.pendingFields()
        expectednames=['ID','PT_NUM_A','PT_ST_A']
    ...
    def test_qgisvariabledistancebufferdissolve(self):
        outputs=sextante.runalg("qgis:variabledistancebuffer",lines(),"LINE_NUM_A",5,True,None)
        output=outputs['OUTPUT']
        layer=QGisLayers.getObjectFromUri(output, True)
        fields=layer.pendingFields()
        expectednames=['ID','LINE_NUM_A','LINE_ST_A']
    ...
    def test_qgisvariabledistancebuffer(self):
        outputs=sextante.runalg("qgis:variabledistancebuffer",lines(),"LINE_NUM_A",5,False,None)
        output=outputs['OUTPUT']
        layer=QGisLayers.getObjectFromUri(output, True)
        fields=layer.pendingFields()
        expectednames=['ID','LINE_NUM_A','LINE_ST_A']
    ...
    def test_qgissimplifygeometries(self):
        outputs=sextante.runalg("qgis:simplifygeometries",polygons(),5,None)
        output=outputs['OUTPUT']
        layer=QGisLayers.getObjectFromUri(output, True)
        fields=layer.pendingFields()
        expectednames=['ID','POLY_NUM_A','POLY_ST_A']
    ...
    def test_qgispolygonstolines(self):
        outputs=sextante.runalg("qgis:polygonstolines",polygons(),None)
        output=outputs['OUTPUT']
        layer=QGisLayers.getObjectFromUri(output, True)
        fields=layer.pendingFields()
        expectednames=['ID','POLY_NUM_A','POLY_ST_A']
    ...
    def test_qgispolygoncentroids(self):
        outputs=sextante.runalg("qgis:polygoncentroids",polygons(),None)
    ...
    def test_qgislinestopolygons(self):
        outputs=sextante.runalg("qgis:linestopolygons",lines(),None)
        output=outputs['OUTPUT']
        layer=QGisLayers.getObjectFromUri(output, True)
        fields=layer.pendingFields()
        expectednames=['ID','LINE_NUM_A','LINE_ST_A']
    ...
    def test_qgisdifference(self):
        outputs=sextante.runalg("qgis:difference",polygons(),polygons2(),None)
        output=outputs['OUTPUT']
        layer=QGisLayers.getObjectFromUri(output, True)
        fields=layer.pendingFields()
        expectednames=['ID','POLY_NUM_A','POLY_ST_A']
    ...
    def test_qgisintersection(self):
        outputs=sextante.runalg("qgis:intersection",polygons(),polygons2(),None)
        output=outputs['OUTPUT']
        layer=QGisLayers.getObjectFromUri(output, True)
        fields=layer.pendingFields()
        expectednames=['ID','POLY_NUM_A','POLY_ST_A','id_2','POLY_NUM_B','POLY_ST_B']
