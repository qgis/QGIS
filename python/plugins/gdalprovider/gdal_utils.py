...
def mark_source(func):
    ...
    This is only needed if that function is not the getConsoleCommands
    function.
    """
...
def get_implementation_source_uri(self) -> str:
    ...
    def _default_implementation_source() -> tuple[str, int]:
        ...
        # else just default to getConsoleCommands function, or class
        # itself if none
        target = cls.__dict__.get("getConsoleCommands", cls)
