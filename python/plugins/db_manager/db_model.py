...
from PyQt.QtCore import Qt, QObject, qDebug, QByteArray, QMimeData, QDataStream, QIODevice, QFileInfo, QAbstractItemModel, QModelIndex, QSettings
...
class DBModel(QAbstractItemModel):
    ...
    def __init__(self, parent=None):
        ...
        if self.isImportVectorAvail:
            self.importVector.connect(self.importVector)
