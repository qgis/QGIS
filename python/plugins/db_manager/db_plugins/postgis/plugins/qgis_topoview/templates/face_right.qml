...
<qgis version="2.1.0-Master" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
    ...
    <symbols>
      <symbol alpha="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="color" v="195,102,231,255"/>
  ...
  <edittypes>
    <edittype labelontop="0" editable="1" type="0" name="abs_next_left_edge"/>
    <edittype labelontop="0" editable="1" type="0" name="abs_next_right_edge"/>
    <edittype labelontop="0" editable="1" type="0" name="edge_id"/>
    <edittype labelontop="0" editable="1" type="0" name="end_node"/>
    <edittype labelontop="0" editable="1" type="0" name="left_face"/>
    <edittype labelontop="0" editable="1" type="0" name="next_left_edge"/>
    <edittype labelontop="0" editable="1" type="0" name="next_right_edge"/>
    <edittype labelontop="0" editable="1" type="0" name="right_face"/>
    <edittype labelontop="0" editable="1" type="0" name="start_node"/>
  </edittypes>
