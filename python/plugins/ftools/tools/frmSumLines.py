...
# Form implementation generated from reading ui file 'frmSumLines.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(QtCore.QSize(QtCore.QRect(0,0,382,303).size()).expandedTo(Dialog.minimumSizeHint()))
        ...
        self.gridlayout.addLayout(self.vboxlayout,4,0,1,2)
        ...
        self.vboxlayout1.addWidget(self.inPolygon)
        self.gridlayout.addLayout(self.vboxlayout1,0,0,1,2)
        ...
        self.vboxlayout2.addWidget(self.inPoint)
        self.gridlayout.addLayout(self.vboxlayout2,1,0,1,2)
