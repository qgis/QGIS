...
class Dialog(QtGui.QDialog, Ui_Dialog):
    ...
    def update(self, inputLayer):
        ...
        self.selected.setText(QtGui.QApplication.translate("Dialog", "Selected features: " + str(selFeatures),
    ...
    def eliminate(self, inLayer, boundary, progressBar, outFileName = None):
        ...
        if outFileName: # user wants a new shape file to be created as result
            ...
            error = QgsVectorFileWriter.writeAsVectorFormat(inLayer, outFileName, provider.encoding(), None, "ESRI Shapefile")
