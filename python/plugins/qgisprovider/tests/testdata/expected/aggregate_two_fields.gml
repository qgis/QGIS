...
<ogr:FeatureCollection
  ...
  <gml:featureMember>
    <ogr:aggregate_two_fields fid="aggregate_two_fields.0">
    ...
    </ogr:aggregate_two_fields>
  </gml:featureMember>
  <gml:featureMember>
    <ogr:aggregate_two_fields fid="aggregate_two_fields.1">
  ...
  <gml:featureMember>
    <ogr:aggregate_two_fields fid="aggregate_two_fields.2">
      ...
      <ogr:fids>polys.2,polys.5,polys.6</ogr:fids>
  ...
  <gml:featureMember>
    <ogr:aggregate_two_fields fid="aggregate_two_fields.3">
  ...
  <gml:featureMember>
    <ogr:aggregate_two_fields fid="aggregate_two_fields.4">
  ...
  <gml:featureMember>
    <ogr:aggregate_two_fields fid="aggregate_two_fields.5">
