...
try:
    ...
    __wrapped_QgsRuleBased3DRenderer_Rule_setSymbol = QgsRuleBased3DRenderer.Rule.setSymbol
    def __QgsRuleBased3DRenderer_Rule_setSymbol_wrapper(self, arg):
        __tracebackhide__ = True
        QgsSipUtils.verifyIsPyOwned(arg, 'you dont have ownership')
        return __wrapped_QgsRuleBased3DRenderer_Rule_setSymbol(self, arg)
    QgsRuleBased3DRenderer.Rule.setSymbol = _functools.update_wrapper(__QgsRuleBased3DRenderer_Rule_setSymbol_wrapper, QgsRuleBased3DRenderer.Rule.setSymbol)

    import functools as _functools
    __wrapped_QgsRuleBased3DRenderer_Rule_appendChild = QgsRuleBased3DRenderer.Rule.appendChild
    def __QgsRuleBased3DRenderer_Rule_appendChild_wrapper(self, arg):
        __tracebackhide__ = True
        QgsSipUtils.verifyIsPyOwned(arg, 'you dont have ownership')
        return __wrapped_QgsRuleBased3DRenderer_Rule_appendChild(self, arg)
    QgsRuleBased3DRenderer.Rule.appendChild = _functools.update_wrapper(__QgsRuleBased3DRenderer_Rule_appendChild_wrapper, QgsRuleBased3DRenderer.Rule.appendChild)
