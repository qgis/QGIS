...
try:
    ...
    QgsAbstractVectorLayerLabeling.__abstract_methods__ = ['type', 'clone', 'save', 'settings', 'setSettings', 'requiresAdvancedEffects']
...
try:
    ...
    QgsVectorLayerSimpleLabeling.__overridden_methods__ = ['type', 'clone', 'save', 'settings', 'accept', 'setSettings', 'requiresAdvancedEffects', 'toSld', 'multiplyOpacity']
