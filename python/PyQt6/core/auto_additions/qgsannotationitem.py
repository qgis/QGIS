...
try:
    QgsAnnotationItem.__virtual_methods__ = ['flags', 'snapGeometry', 'applyEdit', 'applyEditV2', 'transientEditResults', 'transientEditResultsV2', 'nodes', 'nodesV2', 'copyCommonProperties', 'writeCommonProperties', 'readCommonProperties']
