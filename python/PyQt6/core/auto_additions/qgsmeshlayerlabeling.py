...
try:
    ...
    QgsAbstractMeshLayerLabeling.__abstract_methods__ = ['type', 'clone', 'save', 'settings', 'setSettings', 'requiresAdvancedEffects']
...
try:
    ...
    QgsMeshLayerSimpleLabeling.__overridden_methods__ = ['type', 'clone', 'save', 'settings', 'accept', 'setSettings', 'requiresAdvancedEffects', 'multiplyOpacity']
