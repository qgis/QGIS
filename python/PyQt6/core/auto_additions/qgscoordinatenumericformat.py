...
QgsGeographicCoordinateNumericFormat.DegreesMinutesSeconds = QgsGeographicCoordinateNumericFormat.AngleFormat.DegreesMinutesSeconds
QgsGeographicCoordinateNumericFormat.AngleFormat.DegreesMinutes.__doc__ = "Degrees and decimal minutes, eg 30 degrees 45.55'"
QgsGeographicCoordinateNumericFormat.DegreesMinutes = QgsGeographicCoordinateNumericFormat.AngleFormat.DegreesMinutes
QgsGeographicCoordinateNumericFormat.AngleFormat.DecimalDegrees.__doc__ = "Decimal degrees, eg 30.7555 degrees"
QgsGeographicCoordinateNumericFormat.DecimalDegrees = QgsGeographicCoordinateNumericFormat.AngleFormat.DecimalDegrees
