...
try:
    QgsProcessing.__attribute_docs__ = {'TEMPORARY_OUTPUT': 'Constant used to indicate that a Processing algorithm output should be a temporary layer/file.\n\n.. versionadded:: 3.6', 'MODEL_PROVIDER_ID': "Constant used for the model provider's ID.\n\n.. versionadded:: 4.4", 'PROJECT_PROVIDER_ID': "Constant used for the project model provider's ID.\n\n.. versionadded:: 4.4"}
    QgsProcessing.__annotations__ = {'TEMPORARY_OUTPUT': str, 'MODEL_PROVIDER_ID': str, 'PROJECT_PROVIDER_ID': str}
