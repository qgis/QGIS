...
QgsAbstract3DSymbol.Property.Height.__doc__ = "Height (altitude)"
...
QgsAbstract3DSymbol.Property.ExtrusionHeight.__doc__ = "Extrusion height (zero means no extrusion)"
