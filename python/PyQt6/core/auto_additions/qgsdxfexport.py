...
QgsDxfExport.Success = QgsDxfExport.ExportResult.Success
QgsDxfExport.ExportResult.InvalidDeviceError.__doc__ = "Invalid device error"
QgsDxfExport.InvalidDeviceError = QgsDxfExport.ExportResult.InvalidDeviceError
QgsDxfExport.ExportResult.DeviceNotWritableError.__doc__ = "Device not writable error"
QgsDxfExport.DeviceNotWritableError = QgsDxfExport.ExportResult.DeviceNotWritableError
...
QgsDxfExport.EmptyExtentError = QgsDxfExport.ExportResult.EmptyExtentError
...
QgsDxfExport.VBaseLine = QgsDxfExport.VAlign.VBaseLine
QgsDxfExport.VAlign.VBottom.__doc__ = "Bottom (1)"
QgsDxfExport.VBottom = QgsDxfExport.VAlign.VBottom
QgsDxfExport.VAlign.VMiddle.__doc__ = "Middle (2)"
QgsDxfExport.VMiddle = QgsDxfExport.VAlign.VMiddle
QgsDxfExport.VAlign.VTop.__doc__ = "Top (3)"
QgsDxfExport.VTop = QgsDxfExport.VAlign.VTop
QgsDxfExport.VAlign.Undefined.__doc__ = "Undefined"
QgsDxfExport.Undefined = QgsDxfExport.VAlign.Undefined
...
QgsDxfExport.HLeft = QgsDxfExport.HAlign.HLeft
QgsDxfExport.HAlign.HCenter.__doc__ = "Centered (1)"
QgsDxfExport.HCenter = QgsDxfExport.HAlign.HCenter
QgsDxfExport.HAlign.HRight.__doc__ = "Right (2)"
QgsDxfExport.HRight = QgsDxfExport.HAlign.HRight
QgsDxfExport.HAlign.HAligned.__doc__ = "Aligned = (3) (if VAlign==0)"
QgsDxfExport.HAligned = QgsDxfExport.HAlign.HAligned
QgsDxfExport.HAlign.HMiddle.__doc__ = "Middle = (4) (if VAlign==0)"
QgsDxfExport.HMiddle = QgsDxfExport.HAlign.HMiddle
QgsDxfExport.HAlign.HFit.__doc__ = "Fit into point = (5) (if VAlign==0)"
QgsDxfExport.HFit = QgsDxfExport.HAlign.HFit
QgsDxfExport.HAlign.Undefined.__doc__ = "Undefined"
QgsDxfExport.Undefined = QgsDxfExport.HAlign.Undefined
