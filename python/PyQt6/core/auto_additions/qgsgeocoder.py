...
QgsGeocoderInterface.GeocodesStrings = QgsGeocoderInterface.Flag.GeocodesStrings
QgsGeocoderInterface.Flag.GeocodesFeatures.__doc__ = "Can geocode QgsFeature input values"
QgsGeocoderInterface.GeocodesFeatures = QgsGeocoderInterface.Flag.GeocodesFeatures
