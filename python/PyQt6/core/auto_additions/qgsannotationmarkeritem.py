...
try:
    ...
    QgsAnnotationMarkerItem.__overridden_methods__ = ['type', 'render', 'writeXml', 'flags', 'nodesV2', 'applyEditV2', 'transientEditResultsV2', 'readXml', 'clone', 'boundingBox', 'snapGeometry']
