...
QgsMapBoxGlStyleConverter.Color = QgsMapBoxGlStyleConverter.PropertyType.Color
QgsMapBoxGlStyleConverter.PropertyType.Numeric.__doc__ = "Numeric property (e.g. line width, text size)"
QgsMapBoxGlStyleConverter.Numeric = QgsMapBoxGlStyleConverter.PropertyType.Numeric
QgsMapBoxGlStyleConverter.PropertyType.Opacity.__doc__ = "Opacity property"
QgsMapBoxGlStyleConverter.Opacity = QgsMapBoxGlStyleConverter.PropertyType.Opacity
QgsMapBoxGlStyleConverter.PropertyType.Point.__doc__ = "Point/offset property"
QgsMapBoxGlStyleConverter.Point = QgsMapBoxGlStyleConverter.PropertyType.Point
