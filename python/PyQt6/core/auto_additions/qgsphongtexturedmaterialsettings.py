...
try:
    ...
    QgsPhongTexturedMaterialSettings.__overridden_methods__ = ['type', 'clone', 'equals', 'textureScale', 'textureRotation', 'requiresTextureCoordinates', 'averageColor', 'setColorsFromBase', 'readXml', 'writeXml']
