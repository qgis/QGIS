...
try:
    ...
    QgsPhongTexturedMaterialSettings.__overridden_methods__ = ['type', 'clone', 'equals', 'supportedProperties', 'textureScale', 'textureRotation', 'textureOffset', 'requiresTextureCoordinates', 'averageColor', 'setColorsFromBase', 'readXml', 'writeXml']
