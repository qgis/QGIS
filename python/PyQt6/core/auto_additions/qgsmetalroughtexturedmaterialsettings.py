...
try:
    ...
    QgsMetalRoughTexturedMaterialSettings.__overridden_methods__ = ['type', 'clone', 'equals', 'supportedProperties', 'textureScale', 'textureRotation', 'textureOffset', 'requiresTextureCoordinates', 'requiresTangents', 'readXml', 'writeXml', 'averageColor', 'setColorsFromBase']
