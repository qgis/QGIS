...
try:
    ...
    QgsAnnotationLineItem.__overridden_methods__ = ['type', 'render', 'writeXml', 'nodesV2', 'applyEditV2', 'transientEditResultsV2', 'flags', 'readXml', 'boundingBox', 'snapGeometry', 'clone']
