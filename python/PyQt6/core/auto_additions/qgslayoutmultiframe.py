...
try:
    ...
    QgsLayoutMultiFrame.__virtual_methods__ = ['recalculateFrameSizes', 'refreshDataDefinedProperty', 'writePropertiesToElement', 'readPropertiesFromElement']
    QgsLayoutMultiFrame.__overridden_methods__ = ['refresh']
