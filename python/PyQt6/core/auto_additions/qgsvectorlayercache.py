...
try:
    ...
    __wrapped_QgsVectorLayerCache_addCacheIndex = QgsVectorLayerCache.addCacheIndex
    def __QgsVectorLayerCache_addCacheIndex_wrapper(self, arg):
        __tracebackhide__ = True
        _QgsSipUtils.verifyIsPyOwned(arg, 'you dont have ownership')
        return __wrapped_QgsVectorLayerCache_addCacheIndex(self, arg)
    QgsVectorLayerCache.addCacheIndex = _functools.update_wrapper(__QgsVectorLayerCache_addCacheIndex_wrapper, QgsVectorLayerCache.addCacheIndex)
