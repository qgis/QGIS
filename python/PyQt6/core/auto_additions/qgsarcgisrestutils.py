...
QgsArcGisRestUtils.IncludeGeometry = QgsArcGisRestUtils.FeatureToJsonFlag.IncludeGeometry
QgsArcGisRestUtils.FeatureToJsonFlag.IncludeNonObjectIdAttributes.__doc__ = "Whether to include any non-objectId attributes"
QgsArcGisRestUtils.IncludeNonObjectIdAttributes = QgsArcGisRestUtils.FeatureToJsonFlag.IncludeNonObjectIdAttributes
