...
# --
try:
    QgsAbstractMaterialSettings.__virtual_methods__ = ['readXml', 'writeXml', 'requiresTextureCoordinates', 'requiresTangents', 'textureScale', 'textureRotation', 'textureOffset']
