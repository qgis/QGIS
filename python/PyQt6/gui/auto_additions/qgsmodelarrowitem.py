...
try:
    QgsModelArrowItem.__attribute_docs__ = {'showDataViewerDock': 'Emitted when the user opts to view the previous log from the child\nalgorithm with matching ID and paramName.\n\n.. versionadded:: 4.4\n'}
    QgsModelArrowItem.__overridden_methods__ = ['paint']
    QgsModelArrowItem.__signal_arguments__ = {'showDataViewerDock': ['childId: str', 'paramName: str']}
