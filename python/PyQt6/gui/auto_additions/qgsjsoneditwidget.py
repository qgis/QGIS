...
QgsJsonEditWidget.Indented = QgsJsonEditWidget.FormatJson.Indented
QgsJsonEditWidget.FormatJson.Compact.__doc__ = "JSON data formatted as a compact one line string"
QgsJsonEditWidget.Compact = QgsJsonEditWidget.FormatJson.Compact
QgsJsonEditWidget.FormatJson.Disabled.__doc__ = "JSON data is not formatted"
QgsJsonEditWidget.Disabled = QgsJsonEditWidget.FormatJson.Disabled
