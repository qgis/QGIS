...
QgsProcessingAlgorithmDialogBase.Single = QgsProcessingAlgorithmDialogBase.DialogMode.Single
QgsProcessingAlgorithmDialogBase.DialogMode.Batch.__doc__ = "Batch processing mode"
QgsProcessingAlgorithmDialogBase.Batch = QgsProcessingAlgorithmDialogBase.DialogMode.Batch
