...
try:
    ...
    QgsModelGraphicsScene.__signal_arguments__ = {'componentAboutToChange': ['text: str', 'id: Optional[str] = None'], 'runFromChild': ['childId: str'], 'childAlgorithmDeleted': ['childId: str'], 'showChildAlgorithmOutputs': ['childId: str'], 'showChildAlgorithmLog': ['childId: str'], 'showDataViewerDock': ['childId: str', 'paramName: str']}
