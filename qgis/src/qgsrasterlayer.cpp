...
void QgsRasterLayer::draw(QPainter * theQPainter, QgsRect * theViewExtent, QgsCoordinateTransform * theQgsCoordinateTransform)
{
    ...
    //{ "myRectXOffsetInt", "int", "0" }
    //{ "myRectYOffsetInt", "int", "0" }
    //{ "myClippedXMinDouble", "double", "0" }
    //{ "myClippedXMaxDouble", "double", "7532" }
    //{ "myClippedYMinDouble", "double", "1" }
    //{ "myClippedWidthInt", "int", "7532" }
    //{ "myClippedHeightInt", "int", "6285" }
    ...
    // Layer Variables:
    //{ "myDrawableAreaXDimInt", "int", "393" }
    //{ "myDrawableAreaYDimInt", "int", "327" }
    ...
    int myDrawableAreaXDimInt = myBottomRightPoint.xToInt() - myTopLeftPoint.xToInt();
    int myDrawableAreaYDimInt = myBottomRightPoint.yToInt() - myTopLeftPoint.yToInt();
    //
    ...
    for (int i = 1; i <= gdalDataset->GetRasterCount(); i++)
    {
        ...
        uint *myGdalScanData = (uint*) CPLMalloc(sizeof(uint)*myDrawableAreaXDimInt * sizeof(uint)*myDrawableAreaYDimInt);
        CPLErr myResultCPLerr = myGdalBand->RasterIO(
                                    GF_Read, myRectXOffsetInt, myRectYOffsetInt, myClippedWidthInt, myClippedHeightInt, myGdalScanData, myDrawableAreaXDimInt, myDrawableAreaYDimInt, GDT_UInt32, 0, 0 );
        ...
        if ( myColorInterpretation == "Palette")
        {
            ...
            QImage myQImage=QImage(myDrawableAreaXDimInt,myDrawableAreaYDimInt,32);
            myQImage.setAlphaBuffer(true);
            for (int myColumnInt = 0; myColumnInt < myDrawableAreaYDimInt; myColumnInt++)
            {
                for (int myRowInt =0; myRowInt < myDrawableAreaXDimInt; myRowInt++)
                {
                    const GDALColorEntry *colorEntry = GDALGetColorEntry(colorTable, myGdalScanData[myColumnInt*myDrawableAreaXDimInt + myRowInt]);
                    //dont draw this point if it is no data !
                    if (myNoDataDouble != myGdalScanData[myColumnInt*myDrawableAreaXDimInt + myRowInt])
                    {
        ...
        {
            // print each point in myGdalScanData as the red part of an rgb value
            ...
            for (int myColumnInt = 0; myColumnInt < myDrawableAreaYDimInt; myColumnInt++)
            {
                for (int myRowInt =0; myRowInt < myDrawableAreaXDimInt; myRowInt++)
                {
                    ...
                    if (myNoDataDouble != myGdalScanData[myColumnInt*myDrawableAreaXDimInt + myRowInt])
                    {
                        theQPainter->setPen(QColor(myGdalScanData[myColumnInt*myDrawableAreaXDimInt + myRowInt], 0, 0));
                        theQPainter->drawPoint(myTopLeftPoint.xToInt() + myRowInt, myTopLeftPoint.yToInt() + myColumnInt);
                    }
                }
            }
        ...
        {
            // print each point in myGdalScanData as the green part of an rgb value
            ...
            for (int myColumnInt = 0; myColumnInt < myDrawableAreaYDimInt; myColumnInt++)
            {
                for (int myRowInt =0; myRowInt < myDrawableAreaXDimInt; myRowInt++)
                {
                    ...
                    if (myNoDataDouble != myGdalScanData[myColumnInt*myDrawableAreaXDimInt + myRowInt])
                    {
                        theQPainter->setPen(QColor(0, myGdalScanData[myColumnInt*myDrawableAreaXDimInt + myRowInt], 0));
                        theQPainter->drawPoint(myTopLeftPoint.xToInt() + myRowInt, myTopLeftPoint.yToInt() + myColumnInt);
                    }
                }
            }
        ...
        {
            // print each point in myGdalScanData as the blue part of an rgb value
            theQPainter->setRasterOp(Qt::XorROP);
            for (int myColumnInt = 0; myColumnInt < myDrawableAreaYDimInt; myColumnInt++)
            {
                for (int myRowInt =0; myRowInt < myDrawableAreaXDimInt; myRowInt++)
                {
                    ...
                    if (myNoDataDouble != myGdalScanData[myColumnInt*myDrawableAreaXDimInt + myRowInt])
                    {
                        theQPainter->setPen(QColor(0, 0, myGdalScanData[myColumnInt*myDrawableAreaXDimInt + myRowInt]));
                        theQPainter->drawPoint(myTopLeftPoint.xToInt() + myRowInt, myTopLeftPoint.yToInt() + myColumnInt);
                    }
                }
            }
        ...
        else if ( myColorInterpretation == "Gray" || myColorInterpretation == "Undefined" )
        {
            if (!showGrayAsColorFlag)
            {
                ...
                for (int myColumnInt = 0; myColumnInt < myDrawableAreaYDimInt; myColumnInt++)
                {
                    for (int myRowInt =0; myRowInt < myDrawableAreaXDimInt; myRowInt++)
                    {
                        int myGrayValInt=myGdalScanData[myColumnInt*myDrawableAreaXDimInt + myRowInt];
                        //dont draw this point if it is no data !
            ...
            { //show the gray layer as pseudocolor
                //ensure we are not still xoring
                ...
                for (int myColumnInt = 0; myColumnInt < myDrawableAreaYDimInt; myColumnInt++)
                {
                    for (int myRowInt =0; myRowInt < myDrawableAreaXDimInt; myRowInt++)
                    {
                        int myInt=myGdalScanData[myColumnInt*myDrawableAreaXDimInt + myRowInt];
                        //dont draw this point if it is no data !
    ...
    if (showDebugOverlayFlag)
    {
      ...
      theQPainter->drawText(10,32,"Raster Extent: "
                          + QString::number(myRasterExtent.xMin())
                          + ","  + QString::number(myRasterExtent.yMin())
                          + " - " + QString::number(myRasterExtent.xMax())
                          + "," + QString::number(myRasterExtent.yMax()));
      theQPainter->drawText(10,44,"Clipped area: "
                          + QString::number(myClippedXMinDouble)
                          + ","  + QString::number(myClippedYMinDouble)
                          + " - " + QString::number(myClippedXMaxDouble)
                          + "," + QString::number(myClippedYMinDouble));
      theQPainter->drawText(10,56,"Draw Loop x,y: "
                          + QString::number(myDrawableAreaXDimInt)
                          + ","  + QString::number(myDrawableAreaYDimInt));
    }//end of debug overlay flag check
}
