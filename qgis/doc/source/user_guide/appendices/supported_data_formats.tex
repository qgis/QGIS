...
\subsection{Supported OGR Formats}\label{appdx_ogr} \index{ogr!supported formats}
...
\end{compactitem}
\subsection{GDAL Raster Formats}\label{appdx_gdal}\index{rasters!supported formats}
