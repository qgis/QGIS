...
\begin{figure}[h]
   ...
   \smallskip
   \includegraphics[scale=0.5]{qgis_user_guide_images/plugins_delimited_text/plugin_manager}
   \end{center}  
\end{figure}


A new toolbar icon is now present:
\includegraphics{qgis_user_guide_images/plugins_delimited_text/toolbar_icon}
...
\begin{figure}[h]
   ...
   \includegraphics[scale=0.5]{qgis_user_guide_images/plugins_delimited_text/dialog}            
   \end{center}  
\end{figure}

  
First select the file to import by clicking on the ellipsis button: 
\includegraphics{qgis_user_guide_images/plugins_delimited_text/ellipsis}
...
\begin{figure}[h]
   ...
   \includegraphics[scale=0.5]{qgis_user_guide_images/plugins_delimited_text/file_selected}   
   \end{center}  
\end{figure}
...
To properly parse the file, change the delimiter to tab using \mbox{$\backslash$}t (this is a regular expression for the tab character). After changing the delimiter, click {\em Parse}
The drop down boxes now contain the fields properly parsed:
\begin{figure}[h]
   \begin{center}
   \caption{Plugin Manager Dialog}\label{fig:delim_text_file_selected2}\smallskip
   \includegraphics[scale=0.5]{qgis_user_guide_images/plugins_delimited_text/file_selected2}
   \end{center}  
\end{figure}
...
\begin{figure}[h]
   \begin{center}
   \caption{Plugin Manager Dialog}\label{fig:delim_text_file_selected3}\smallskip
   \includegraphics[scale=0.5]{qgis_user_guide_images/plugins_delimited_text/file_se
   \end{center}  
\end{figure}lected3}
\item Click {\em Add Layer}
The layer is added to the map: 
\includegraphics[scale=0.5]{qgis_user_guide_images/plugins_delimited_text/layer_added}
