...
static const char * const sName = "Community Register";
static const char * const sDescription = "This plugin will submit your details to community.qgis.org so that you appear on the map of QGIS users";
