...
void OpenModellerGui::parseAndRun(QString theParametersFileNameQString)
{
  ...
  txtbLogs->append(   "(c) T.Sutton 2003,P.W.Brewer 2004 & Renato De Giovanni 2005\n");
  ...
  try 
  {
    ...
    txtbLogs->append("<img src=\""+outputFileNameQString+".png\">");
    // Confusion matrix
...
QString OpenModellerGui::makeConfigReport()
{
  ...
  myString+= tr("<h2>Coordinate system and projection in WKT format</h2>\n");
  ...
  myString+= tr("<p><b>Output file name (should end in .tif)</b></p>\n");
