...
void OpenModellerGuiBase::pbnSelectOutputDirectory_clicked()
{
...
void OpenModellerGuiBase::cboModelAlgorithm_highlighted( const QString & )
{

}


void OpenModellerGuiBase::leOutputDirectory_textChanged( const QString & )
{
