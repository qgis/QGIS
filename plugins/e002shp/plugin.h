...
#ifndef QGSE002SHPPLUGIN
#define QGSE002SHPPLUGIN
...
/**
* \class QgsE002shpPlugin
* \brief [name] plugin for QGIS
* [description]
*/
class QgsE002shpPlugin:public QObject, public QgisPlugin
{
  Q_OBJECT public:
  ...
  * @param Pointer to the QgisIface object. 
   */
  QgsE002shpPlugin(QgisApp * , QgisIface * );
  //! Destructor
  virtual ~ QgsE002shpPlugin();
