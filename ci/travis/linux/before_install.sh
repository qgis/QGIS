...
sudo apt-get install --force-yes --no-install-recommends --no-install-suggests \
                         ...
                         libqscintilla2-dev libqwt-dev libspatialindex-dev \
                         libspatialite-dev libsqlite3-dev lighttpd pkg-config \
                         poppler-utils python python-dev python-sip \
                         python-sip-dev spawn-fcgi txt2tags xauth \
...
if [ ${QT} == 5 ]; then
  sudo apt-get install --force-yes --no-install-recommends --no-install-suggests \
    ...
    qttools5-dev-tools libqt5svg5-dev libqt5gui5 libqt5widgets5 libqt5network5 \
    libqt5xml5 libqt5-qtconcurrent5 libqt5printsupport5 libqt5positioning5
  ...
  sudo apt-get install --force-yes --no-install-recommends --no-install-suggests \
    ...
    pyqt4-dev-tools python-qt4 python-qt4-dev
fi
