  ...
  else
  {
    ...
    switch ( tileMode )
    {
      case WMSC:
      {
        ...
        int i = 0;
        int retry = 0; // Retry counter to manage Tile request fails. Faile bounded by option defaultTileMaxRetry
...
// manage retry in case of tile fail
// feature added with founding of Regione Toscana - SITA
