...
bool QgsAfsSourceSelect::connectToService( const QgsOwsConnection &connection )
{
  ...
  visitItemsRecursive = [this, &visitItemsRecursive, baseUrl, authcfg, headers, &errorTitle, &errorMessage]( const QString & baseItemUrl, QStandardItem * parentItem ) -> bool
  {
    ...
    QgsArcGisRestQueryUtils::addLayerItems( [ =, &layerItems, &parents]( const QString & parentLayerId, QgsArcGisRestQueryUtils::ServiceTypeFilter, QgsWkbTypes::GeometryType, const QString & layerId, const QString & name, const QString & description, const QString & url, bool isParentLayer, const QString & authid, const QString & )
    {
