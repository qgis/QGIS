...
class QgsPostgresProviderConnection : public QgsAbstractDatabaseProviderConnection
{
  ...
  public:
    ...
    QList<QgsLayerMetadataProviderResult> searchLayerMetadata(
  ...
  private:
    ...
    QgsAbstractDatabaseProviderConnection::QueryResult execSqlPrivate(
      const QString &sql, bool resolveTypes = true, QgsFeedback *feedback = nullptr, std::shared_ptr<class QgsPoolPostgresConn> pgconn = nullptr
    ) const;
