...
class QgsPostgresExpressionCompiler : public QgsSqlExpressionCompiler
{
  ...
  protected:
    ...
    [[nodiscard]] QString castToReal( const QString &value ) const override;
    [[nodiscard]] QString castToInt( const QString &value ) const override;
    [[nodiscard]] QString castToText( const QString &value ) const override;
