 ...
 *
 ***************************************************************************/
#ifndef QGSREDSHIFTSOURCESELECT_H
#define QGSREDSHIFTSOURCESELECT_H
...
class QgisApp;
class QgsRedshiftSourceSelect;
class QgsProxyProgressTask;

class QgsRedshiftSourceSelectDelegate : public QItemDelegate
{
    Q_OBJECT

  public:
    explicit QgsRedshiftSourceSelectDelegate( QObject *parent = nullptr ) : QItemDelegate( parent )
    {
    }
...
/**
 * \class QgsRedshiftSourceSelect
 * \brief Dialog to create connections and add tables from Redshift.
 *
 * This dialog allows the user to define and save connection information
 * for Redshift databases. The user can then connect and add
 * tables from the database to the map canvas.
 */
class QgsRedshiftSourceSelect : public QgsAbstractDbSourceSelect
{
    Q_OBJECT

  public:
    //! Constructor
    QgsRedshiftSourceSelect( QWidget *parent = nullptr, Qt::WindowFlags fl = QgsGuiUtils::ModalDialogFlags,
                             QgsProviderRegistry::WidgetMode widgetMode = QgsProviderRegistry::WidgetMode::None );

    ~QgsRedshiftSourceSelect() override;
  ...
  private:
    ...
    void addSearchGeometryColumn( const QgsRedshiftLayerProperty &layerProperty );
    ...
    QgsRedshiftTableModel *mTableModel = nullptr;
...
#endif // QGSREDSHIFTSOURCESELECT_H
