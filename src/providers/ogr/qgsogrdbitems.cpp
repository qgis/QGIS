/***************************************************************************
  qgsogrdbitems.cpp - QgsOgrDbItems
 ...
 *                                                                         *
 ***************************************************************************/
#include "qgsogrdbitems.h"


QgsOgrDbCollectionItem::QgsGeoPackageCollectionItem( QgsDataItem *parent, const QString &name, const QString &path )
