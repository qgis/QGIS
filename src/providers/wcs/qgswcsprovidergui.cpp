...
{
  public:
    [[nodiscard]] QString providerKey() const override { return QStringLiteral( "wcs" ); }
    [[nodiscard]] QString text() const override { return QObject::tr( "WCS" ); }
    [[nodiscard]] int ordering() const override { return QgsSourceSelectProvider::OrderRemoteProvider + 30; }
    [[nodiscard]] QIcon icon() const override { return QgsApplication::getThemeIcon( QStringLiteral( "/mActionAddWcsLayer.svg" ) ); }
