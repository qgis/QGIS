    ...
    QString &errorMsg )
{
  ...
  for ( int i = 0; i < attributeNodeList.size(); ++i )
  {
    ...
    else if ( ! foundGeometryAttribute && ( type.indexOf( gmlPT, 0, &match ) == 0 || type == QLatin1String( "gml:GeometryAssociationType" ) ) )
    {
      foundGeometryAttribute = true;
      geometryAttribute = name;
    ...
    else if ( ! foundGeometryAttribute &&  ref.indexOf( gmlRefProperty, 0, &match ) == 0 )
    {
      foundGeometryAttribute = true;
