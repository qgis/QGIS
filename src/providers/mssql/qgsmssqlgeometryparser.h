...
class QgsMssqlGeometryParser
{
  ...
  protected:
    [[nodiscard]] QgsPoint readCoordinates( int iPoint ) const;
    void readCoordinates( int iPoint, int iNextPoint, double *x, double *y, double *z, double *m ) const;
    [[nodiscard]] const QgsPointSequence readPointSequence( int iPoint, int iNextPoint ) const;
  ...
  public:
    ...
    [[nodiscard]] int GetSRSId() const { return mSRSId; }
