...
{
  public:
    [[nodiscard]] QString providerKey() const override { return QStringLiteral( "mssql" ); }
    [[nodiscard]] QString text() const override { return QObject::tr( "MS SQL Server" ); }
    [[nodiscard]] int ordering() const override { return QgsSourceSelectProvider::OrderDatabaseProvider + 30; }
    [[nodiscard]] QIcon icon() const override { return QgsApplication::getThemeIcon( QStringLiteral( "/mActionAddMssqlLayer.svg" ) ); }
