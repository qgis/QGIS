...
class ModelerParameterDefinitionDialog(QtGui.QDialog):
    ...
    paramTypes = [PARAMETER_BOOLEAN,PARAMETER_MULTIPLE,PARAMETER_NUMBER, PARAMETER_RASTER,
                  PARAMETER_STRING, PARAMETER_VECTOR, PARAMETER_TABLE]
    ...
    def okPressed(self):
        ...
        if description.strip() == "":
            ...
            return
        name = self.paramType + "_" + description
        if self.paramType == ModelerParameterDefinitionDialog.PARAMETER_BOOLEAN:
            ...
            #try:
                ...
                if vmax == "":
                    ...
                    vmax = float(vmax)
                self.param = ParameterNumber(name, description, vmin, vmax, float(self.defaultTextBox.text()))
            #===================================================================
            # except:
            ...
            self.param = ParameterString(name, description, self.defaultTextBox.text)
