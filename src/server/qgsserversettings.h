...
class SERVER_EXPORT QgsServerSettingsEnv : public QObject
{
  ...
  public:
    ...
    enum EnvVar
    {
      ...
      QGIS_SERVER_LANDING_PAGE_PROJECTS_RECURSIVE,      //!< Recursively scan QGIS_SERVER_LANDING_PAGE_PROJECTS_DIRECTORIES for .qgs and .qgz projects \since QGIS 4.4
...
class SERVER_EXPORT QgsServerSettings
{
  public:
    ...
    /**
     * Returns TRUE if landingPageProjectsDirectories() should be scanned
     * recursively for .qgs and .qgz projects in subdirectories, default to FALSE.
     * \since QGIS 4.4
     */
    bool landingPageProjectsRecursive() const;
