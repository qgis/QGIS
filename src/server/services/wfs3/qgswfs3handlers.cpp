...
QList<QgsServerQueryStringParameter> QgsWfs3CollectionsItemsHandler::parameters( const QgsServerApiContext &context ) const
{
  ...
  // filter
  QgsServerQueryStringParameter filter { u"filter"_s, false, QgsServerQueryStringParameter::Type::String, u"The filter expression"_s, u""_s };
  params.push_back( filter );

  // filter-lang
  QgsServerQueryStringParameter filterLang { u"filter-lang"_s, false, QgsServerQueryStringParameter::Type::String, u"The language of the filter expression"_s, u"qgis"_s };
