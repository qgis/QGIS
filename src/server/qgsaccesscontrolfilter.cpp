...
{
  QgsMessageLog::logMessage( QStringLiteral( "QgsAccessControlFilter plugin default layerFilterSQL called" ), QStringLiteral( "AccessControlFilter" ), Qgis::MessageLevel::Info );
  Q_UNUSED( layer )
  return QString();
}
