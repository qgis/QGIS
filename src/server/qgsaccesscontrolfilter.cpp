...
{
  QgsMessageLog::logMessage( u"QgsAccessControlFilter plugin default layerFilterExpression called"_s, u"AccessControlFilter"_s, Qgis::MessageLevel::Info );
  Q_UNUSED( layer )
  return QString();
}
...
{
  QgsMessageLog::logMessage( u"QgsAccessControlFilter plugin default layerFilterSubsetString called"_s, u"AccessControlFilter"_s, Qgis::MessageLevel::Info );
  Q_UNUSED( layer )
  return QString();
}
...
{
  QgsMessageLog::logMessage( u"QgsAccessControlFilter plugin default layerPermissions called"_s, u"AccessControlFilter"_s, Qgis::MessageLevel::Info );
  Q_UNUSED( layer )
...
{
  Q_UNUSED( layer )
  QgsMessageLog::logMessage( u"QgsAccessControlFilter plugin default authorizedLayerAttributes called"_s, u"AccessControlFilter"_s, Qgis::MessageLevel::Info );
  return attributes;
}
...
{
  QgsMessageLog::logMessage( u"QgsAccessControlFilter plugin default allowToEdit called"_s, u"AccessControlFilter"_s, Qgis::MessageLevel::Info );
  Q_UNUSED( layer )
  Q_UNUSED( feature )
  return true;
}
