...
class QgsSocketMonitoringThread: public QThread
{
  ...
  public:
     ...
     * \param  isResponseFinished will be used to know when to stop the monitor thread
     * \param  feedback will be used to send cancel if socket is closed prematurely
     */
