...
class QgsWmsServer: public QgsOWSServer
{
  public:
    ...
    QDomDocument getCapabilities( const QString &version = QStringLiteral( "1.3.0" ), bool fullProjectInformation = false );
    ...
    int getFeatureInfo( QDomDocument& result, const QString& version = QStringLiteral( "1.3.0" ) );
