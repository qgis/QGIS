...
void QgsFrameGraph::constructForwardRenderPass()
{
  ...
  registerRenderView( std::shared_ptr<QgsAbstractRenderView>( forwardRenderView ), FORWARD_RENDERVIEW );
}
...
void QgsFrameGraph::constructShadowRenderPass()
{
  ...
  registerRenderView( std::shared_ptr<QgsAbstractRenderView>( shadowRenderView ), SHADOW_RENDERVIEW );
}
...
bool QgsFrameGraph::registerRenderView( std::shared_ptr<QgsAbstractRenderView> renderView, const QString &name )
{
  bool out;
  if ( mRenderViewMap.find( name ) == mRenderViewMap.end() )
  {
    mRenderViewMap.insert( name, renderView );
