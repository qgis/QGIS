...
#ifndef QGSUNLITMATERIAL3DHANDLER_H
#define QGSUNLITMATERIAL3DHANDLER_H
...
/**
 * \ingroup qgis_3d
 * \brief 3D handler for the unlit shading material.
 *
 * \warning Not available in Python bindings
 * \since QGIS 4.4
 */
class _3D_EXPORT QgsUnlitMaterial3DHandler : public QgsAbstractMaterial3DHandler
{
  public:
    QgsUnlitMaterial3DHandler() = default;
...
#endif // QGSUNLITMATERIAL3DHANDLER_H
