/***************************************************************************
  qgsmaskeddiffusespecularmaterial.h
  --------------------------------------
  Date                 : March 2024
...
#ifndef QGSMASKEDDIFFUSESPECULARMATERIAL_H
#define QGSMASKEDDIFFUSESPECULARMATERIAL_H
 ...
 * \since QGIS 3.40
 */
class _3D_EXPORT QgsMaskedDiffuseSpecularMaterial : public Qt3DRender::QMaterial
{
    Q_OBJECT
  ...
  public:
    ...
    /**
     * Constructor for QgsMaskedDiffuseSpecularMaterial, with the specified \a parent node.
     */
    explicit QgsMaskedDiffuseSpecularMaterial( Qt3DCore::QNode *parent = nullptr );
    ~QgsMaskedDiffuseSpecularMaterial() override;
...
#endif // QGSMASKEDDIFFUSESPECULARMATERIAL_H
