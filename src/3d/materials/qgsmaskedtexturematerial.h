...
#ifndef QGSMASKEDTEXTUREMATERIAL_H
#define QGSMASKEDTEXTUREMATERIAL_H
 ...
 * \since QGIS 3.40
 */
class _3D_EXPORT QgsMaskedTextureMaterial : public Qt3DRender::QMaterial
{
    Q_OBJECT
  ...
  public:
    ...
    /**
     * Constructor for QgsMaskedTextureMaterial, with the specified \a parent node.
     */
    explicit QgsMaskedTextureMaterial( Qt3DCore::QNode *parent = nullptr );
    ~QgsMaskedTextureMaterial() override;
...
#endif // QGSMASKEDTEXTUREMATERIAL_H
