...
void QgsDemTerrainGenerator::heightAndQualityAt( double x, double y, float &height, int &quality ) const
{
  if ( mRootNode != nullptr )
  {
    ...
    // qDebug() << "QgsDemTerrainGenerator::heightAndQualityAt" << "foundKey:" << foundKey;
    ...
    if ( heightMapData )
    {
      ...
      // qDebug() << "QgsDemTerrainGenerator::heightAndQualityAt" << "in cache";
  ...
  {
    // qDebug() << "QgsDemTerrainGenerator::heightAndQualityAt" << "in coarse";
    quality = 0;
    height = mHeightMapGenerator->heightAt( x, y );
  }
  else
  {
    // qDebug() << "QgsDemTerrainGenerator::heightAndQualityAt" << "in nothing";
    quality = -1;
    height = 0;
  }
}
