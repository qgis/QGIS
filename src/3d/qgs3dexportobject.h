...
class _3D_EXPORT Qgs3DExportObject
{
  public:
     ...
     */
    void saveTo(
      QTextStream &out, float scale, const QVector3D &center, const Qgis::Export3DSceneFormat &exportFormat = Qgis::Export3DSceneFormat::Obj, int precision = 6, QString materialName = QString()
    ) const;
