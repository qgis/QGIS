...
class QgsBufferedLine3DSymbolHandler : public QgsFeature3DHandler
{
  ...
  private:
    ...
    void processPolygon( std::unique_ptr<QgsPolygon> &polyBuffered, QgsFeatureId fid, float height, float extrusionHeight, const Qgs3DRenderContext &context, LineData &lineData );
...
void QgsBufferedLine3DSymbolHandler::processPolygon( std::unique_ptr<QgsPolygon> &polyBuffered, QgsFeatureId fid, float height, float extrusionHeight, const Qgs3DRenderContext &context, LineData &lineData )
{
