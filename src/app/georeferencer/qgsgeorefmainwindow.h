...
class QgsGeoreferencerMainWindow : public QMainWindow, private Ui::QgsGeorefPluginGuiBase
{
  ...
  public:
    ...
    static const inline QgsSettingsEntryBool settingUseZeroForTransparent = QgsSettingsEntryBool( QStringLiteral( "/georeferencer/use-zero-for-transparent" ), QgsSettings::App, false, QObject::tr( "Last used georeferencer use-zero-as-tranparent option" ) );
