...
QMenu *QgsLayoutAppMenuProvider::createContextMenu( QWidget *parent, QgsLayout *layout, QPointF layoutPoint ) const
{
  ...
  if ( !selectedItems.empty() )
  {
    ...
    if ( addedGroupAction )
      menu->addSeparator()->setText( QLatin1String( "AddedGroupSeparator" ) );
    ...
    menu->addSeparator()->setText( QLatin1String( "CopyCutSeparator" ) );
  }
  else if ( mDesigner->view()->hasItemsInClipboard() )
  {
    ...
    menu->addSeparator()->setText( QLatin1String( "PasteSeparator" ) );
  }
  ...
  if ( page )
  {
    ...
    menu->addSeparator()->setText( QLatin1String( "ManagePageSeparator" ) );
  }
