...
class APP_EXPORT QgsPointCloudProfileTool : public QgsMapTool
{
	Q_OBJECT

public:

	QgsPointCloudProfileTool(QgsMapCanvas *canvas, bool measureArea, View3D* window_3d);

	~QgsPointCloudProfileTool() override;
	...
	std::vector<Imath::V3f> m_V2FPoints;
...
signals:
	void passPoint(double x, double y);
