  ...
  if ( mTempRubberBand )
  {
    switch ( mPoints.size() )
    {
      ...
      case 2:
      {
        ...
        {
          case DistanceMode:
            mRectangle = QgsQuadix::rectangleFrom3points( mPoints.at( 0 ), mPoints.at( 1 ), point, QgsQuadix::Distance );
            break;
          case ProjectedMode:
            mRectangle = QgsQuadix::rectangleFrom3points( mPoints.at( 0 ), mPoints.at( 1 ), point, QgsQuadix::Projected );
            break;
        }
