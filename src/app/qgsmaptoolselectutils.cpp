...
void QgsMapToolSelectUtils::selectSingleFeature( QgsMapCanvas *canvas, const QgsGeometry &selectGeometry, Qt::KeyboardModifiers modifiers )
{
  ...
  switch ( layer->type() )
  {
    ...
    case QgsMapLayerType::VectorTileLayer:
    {
      ...
      vtLayer->selectByGeometry( selectGeomTrans, context, behavior );
      break;
    }
...
static bool QgsMapToolSelectUtils::transformSelectGeometry( const QgsGeometry &selectGeometry,  QgsGeometry &selectGeomTrans, const QgsCoordinateTransform &ct )
{
