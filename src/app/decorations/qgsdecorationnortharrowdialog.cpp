...
void QgsDecorationNorthArrowDialog::drawNorthArrow()
{
  ...
  if ( svg.isValid() )
  {
    ...
    const int xShift = static_cast<int>( (
                                           ( centerXDouble * std::cos( myRadiansDouble ) ) + ( centerYDouble * std::sin( myRadiansDouble ) ) )
                                         - centerXDouble );
    const int yShift = static_cast<int>( (
                                           ( -centerXDouble * std::sin( myRadiansDouble ) ) + ( centerYDouble * std::cos( myRadiansDouble ) ) )
                                         - centerYDouble );
