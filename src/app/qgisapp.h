...
class APP_EXPORT QgisApp : public QMainWindow, private Ui::MainWindow
{
  ...
  public:
    ...
    //! Constructor
    QgisApp( QSplashScreen *splash, AppOptions options = AppOptions( RestorePlugins | EnablePython ), const QString &rootProfileLocation = QString(), const QString &activeProfile = QString(), QWidget *parent = nullptr, Qt::WindowFlags fl = Qt::Window );
