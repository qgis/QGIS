...
void QgsPluginManager::showPluginDetails( QStandardItem *item )
{
  ...
  if ( !metadata->value( QStringLiteral( "version_installed" ) ).isEmpty() )
  {
    ...
    html += QStringLiteral( "<tr><td class='key'>%1 </td><td title='%2'><a href='%3'>%4</a></td></tr>" ).arg( tr( "Installed version" ), QDir::toNativeSeparators( localDir ), QUrl::fromLocalFile( localDir ).toString(), ver );
  }
  ...
  if ( !metadata->value( QStringLiteral( "version_available_stable" ) ).isEmpty() )
  {
    ...
    html += QStringLiteral( "<tr><td class='key'>%1 </td><td title='%2'><a href='%2'>%3</a> %4</td></tr>" ).arg( tr( "Available version (stable)" ), downloadUrl, metadata->value( QStringLiteral( "version_available_stable" ) ), dateUpdatedStr );
  }
  ...
  if ( !metadata->value( QStringLiteral( "version_available_experimental" ) ).isEmpty() )
  {
    ...
    html += QStringLiteral( "<tr><td class='key'>%1 </td><td title='%2'><a href='%2'>%3</a> %4</td></tr>" ).arg( tr( "Available version (experimental)" ), downloadUrl, metadata->value( QStringLiteral( "version_available_experimental" ) ), dateUpdatedStr );
  }
