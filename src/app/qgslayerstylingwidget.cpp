...
void QgsLayerStylingWidget::updateCurrentWidgetLayer()
{
  ...
  {
    QgsMapLayerConfigWidget* panel = mUserPages[row]->createPanel( mCurrentLayer, mMapCanvas, mWidgetStack );
    if ( panel )
    {
...
QgsMapLayerConfigWidget *QgsLayerStyleManagerWidgetFactory::createPanel( QgsMapLayer *layer, QgsMapCanvas *canvas, QWidget *parent ) const
{
