from core.GeoAlgorithm import GeoAlgorithm
from saga.SagaBlackList import SagaBlackList
from saga.UnwrappableSagaAlgorithmException import UnwrappableSagaAlgorithmException
from parameters.ParameterTable import ParameterTable
from parameters.ParameterFixedTable import ParameterFixedTable
from parameters.ParameterTableField import ParameterTableField
from outputs.OutputTable import OutputTable
from parameters.ParameterMultipleInput import ParameterMultipleInput
from parameters.ParameterRaster import ParameterRaster
from outputs.OutputRaster import OutputRaster
from parameters.ParameterVector import ParameterVector
from parameters.ParameterNumber import ParameterNumber
from parameters.ParameterBoolean import ParameterBoolean
from parameters.ParameterString import ParameterString
from parameters.ParameterSelection import ParameterSelection
from core.SextanteUtils import SextanteUtils
from saga.SagaExecutionException import SagaExecutionException
import os
from outputs.OutputVector import OutputVector
...
class SagaAlgorithm(GeoAlgorithm):
    ...
    def defineCharacteristicsFromFile(self):
        ...
        while line != "":
            ...
            if line.startswith("-"):
                ...
                except Exception: #for some reason boolean params have a different syntax
                    paramName = line[1:line.index("\t")]
                    paramDescription = line[:line.index("\t") + 1].strip()
    ...
    def commandLineName(self):
        return "saga:" + self.name.lower.replace(" ", "")
