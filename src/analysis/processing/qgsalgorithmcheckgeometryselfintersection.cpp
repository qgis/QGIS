...
{
  return QObject::tr( "This algorithm checks the self intersections of geometry." );
}
...
QgsFeaturePool *QgsGeometryCheckSelfIntersectionAlgorithm::createFeaturePool( QgsVectorLayer *layer, bool selectedOnly ) const
{
