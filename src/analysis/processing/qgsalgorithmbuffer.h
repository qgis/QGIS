...
class QgsBufferAlgorithm : public QgsProcessingAlgorithm
{
  public:
    ...
    [[nodiscard]] QIcon icon() const override { return QgsApplication::getThemeIcon( QStringLiteral( "/algorithms/mAlgorithmBuffer.svg" ) ); }
    [[nodiscard]] QString svgIconPath() const override { return QgsApplication::iconPath( QStringLiteral( "/algorithms/mAlgorithmBuffer.svg" ) ); }
    ...
    [[nodiscard]] QgsBufferAlgorithm *createInstance() const override SIP_FACTORY;
