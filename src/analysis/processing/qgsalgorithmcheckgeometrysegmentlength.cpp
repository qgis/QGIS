...
QVariantMap QgsGeometryCheckSegmentLengthAlgorithm::processAlgorithm( const QVariantMap &parameters, QgsProcessingContext &context, QgsProcessingFeedback *feedback )
{
  ...
  const std::unique_ptr<QgsGeometryCheckContext> checkContext = std::make_unique<QgsGeometryCheckContext>(
  ...
  const double segmentLength = parameterAsDouble( parameters, QStringLiteral( "MIN_SEGMENT_LENGTH" ), context );
