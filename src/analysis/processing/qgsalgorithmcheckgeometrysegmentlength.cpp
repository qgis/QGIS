...
{
  return QObject::tr( "This algorithm checks the min segment length of geometry." );
}
...
void QgsGeometryCheckSegmentLengthAlgorithm::initAlgorithm( const QVariantMap &configuration )
{
  ...
  addParameter( new QgsProcessingParameterNumber(
    QStringLiteral( "MIN_SEGMENT_LENGTH" ), QObject::tr( "min segment length" ), Qgis::ProcessingNumberParameterType::Double, 0, false, 0.0
  ) );
...
QgsFeaturePool *QgsGeometryCheckSegmentLengthAlgorithm::createFeaturePool( QgsVectorLayer *layer, bool selectedOnly ) const
{
