...
#ifndef QGSALGORITHMFIXGEOMETRYANGLE_H
#define QGSALGORITHMFIXGEOMETRYANGLE_H
...
class QgsFixGeometryAngleAlgorithm : public QgsProcessingAlgorithm
{
  public:
    ...
    [[nodiscard]] QgsFixGeometryAngleAlgorithm *createInstance() const override SIP_FACTORY;
...
#endif // QGSALGORITHMFIXGEOMETRYANGLE_H
