...
class QgsRandomPointsExtentAlgorithm : public QgsProcessingAlgorithm
{
  public:
    ...
    [[nodiscard]] QIcon icon() const override { return QgsApplication::getThemeIcon( QStringLiteral( "/algorithms/mAlgorithmRandomPointsWithinExtent.svg" ) ); }
    [[nodiscard]] QString svgIconPath() const override { return QgsApplication::iconPath( QStringLiteral( "/algorithms/mAlgorithmRandomPointsWithinExtent.svg" ) ); }
    ...
    [[nodiscard]] QgsRandomPointsExtentAlgorithm *createInstance() const override SIP_FACTORY;
