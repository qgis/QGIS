...
{
  return QObject::tr( "This algorithm checks if the geometry is multipart." );
}
...
QgsFeaturePool *QgsGeometryCheckMultipartAlgorithm::createFeaturePool( QgsVectorLayer *layer, bool selectedOnly ) const
{
