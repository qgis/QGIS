...
class ANALYSIS_EXPORT QgsConvertGpxFeatureTypeAlgorithm : public QgsProcessingAlgorithm
{
  public:
    ...
    [[nodiscard]] QgsConvertGpxFeatureTypeAlgorithm *createInstance() const override SIP_FACTORY;
...
class ANALYSIS_EXPORT QgsConvertGpsDataAlgorithm : public QgsProcessingAlgorithm
{
  public:
    ...
    [[nodiscard]] QString shortHelpString() const override;
    [[nodiscard]] QString shortDescription() const override;
    [[nodiscard]] QgsConvertGpsDataAlgorithm *createInstance() const override SIP_FACTORY;
...
class ANALYSIS_EXPORT QgsDownloadGpsDataAlgorithm : public QgsProcessingAlgorithm
{
  public:
    ...
    [[nodiscard]] QString shortHelpString() const override;
    [[nodiscard]] QString shortDescription() const override;
    [[nodiscard]] QgsDownloadGpsDataAlgorithm *createInstance() const override SIP_FACTORY;
...
class ANALYSIS_EXPORT QgsUploadGpsDataAlgorithm : public QgsProcessingAlgorithm
{
  public:
    ...
    [[nodiscard]] QString shortHelpString() const override;
    [[nodiscard]] QString shortDescription() const override;
    [[nodiscard]] QgsUploadGpsDataAlgorithm *createInstance() const override SIP_FACTORY;
