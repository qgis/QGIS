...
void QgsConvertGpsDataAlgorithm::initAlgorithm( const QVariantMap & )
{
  ...
  formatParam->setMetadata( { { QStringLiteral( "widget_wrapper" ), QVariantMap(
...
void QgsDownloadGpsDataAlgorithm::initAlgorithm( const QVariantMap & )
{
  ...
  deviceParam->setMetadata( { { QStringLiteral( "widget_wrapper" ), QVariantMap(
  ...
  portParam->setMetadata( { { QStringLiteral( "widget_wrapper" ), QVariantMap(
