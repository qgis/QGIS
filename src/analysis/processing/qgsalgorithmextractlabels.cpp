...
QVariantMap QgsExtractLabelsAlgorithm::processAlgorithm( const QVariantMap &parameters, QgsProcessingContext &context, QgsProcessingFeedback *feedback )
{
  ...
  if ( QgsVectorLayer *vl = qobject_cast< QgsVectorLayer * >( QgsProcessingUtils::mapLayerFromString( dest, context ) ) )
  {
    ...
    if ( vl->renderer() )
    {
      ...
      settingsProperties.setProperty( static_cast<int>( QgsPalLayerSettings::Property::Color ), QgsProperty::fromExpression( QStringLiteral( "if(\"LabelUnplaced\",'255,0,0',\"Color\")" ) ) );
      settingsProperties.setProperty( static_cast<int>( QgsPalLayerSettings::Property::FontOpacity ), QgsProperty::fromField( QStringLiteral( "FontOpacity" ) ) );
      settingsProperties.setProperty( static_cast<int>( QgsPalLayerSettings::Property::Family ), QgsProperty::fromField( QStringLiteral( "Family" ) ) );
      settingsProperties.setProperty( static_cast<int>( QgsPalLayerSettings::Property::Italic ), QgsProperty::fromField( QStringLiteral( "Italic" ) ) );
      settingsProperties.setProperty( static_cast<int>( QgsPalLayerSettings::Property::Bold ), QgsProperty::fromField( QStringLiteral( "Bold" ) ) );
      settingsProperties.setProperty( static_cast<int>( QgsPalLayerSettings::Property::Underline ), QgsProperty::fromField( QStringLiteral( "Underline" ) ) );
      settingsProperties.setProperty( static_cast<int>( QgsPalLayerSettings::Property::Size ), QgsProperty::fromField( QStringLiteral( "Size" ) ) );
      settingsProperties.setProperty( static_cast<int>( QgsPalLayerSettings::Property::FontLetterSpacing ), QgsProperty::fromField( QStringLiteral( "FontLetterSpacing" ) ) );
      settingsProperties.setProperty( static_cast<int>( QgsPalLayerSettings::Property::FontWordSpacing ), QgsProperty::fromField( QStringLiteral( "FontWordSpacing" ) ) );
      settingsProperties.setProperty( static_cast<int>( QgsPalLayerSettings::Property::MultiLineAlignment ), QgsProperty::fromField( QStringLiteral( "MultiLineAlignment" ) ) );
      settingsProperties.setProperty( static_cast<int>( QgsPalLayerSettings::Property::MultiLineHeight ), QgsProperty::fromField( QStringLiteral( "MultiLineHeight" ) ) );
      settingsProperties.setProperty( static_cast<int>( QgsPalLayerSettings::Property::LabelRotation ), QgsProperty::fromField( QStringLiteral( "LabelRotation" ) ) );
      settingsProperties.setProperty( static_cast<int>( QgsPalLayerSettings::Property::BufferDraw ), QgsProperty::fromField( QStringLiteral( "BufferDraw" ) ) );
      settingsProperties.setProperty( static_cast<int>( QgsPalLayerSettings::Property::BufferSize ), QgsProperty::fromField( QStringLiteral( "BufferSize" ) ) );
      settingsProperties.setProperty( static_cast<int>( QgsPalLayerSettings::Property::BufferColor ), QgsProperty::fromField( QStringLiteral( "BufferColor" ) ) );
      settingsProperties.setProperty( static_cast<int>( QgsPalLayerSettings::Property::BufferOpacity ), QgsProperty::fromField( QStringLiteral( "BufferOpacity" ) ) );
      settingsProperties.setProperty( static_cast<int>( QgsPalLayerSettings::Property::Show ), QgsProperty::fromExpression( QStringLiteral( "\"LabelUnplaced\"=false" ) ) );
