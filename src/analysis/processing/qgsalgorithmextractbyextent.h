...
#ifndef QGSALGORITHMEXTRACTBYEXTENT_H
#define QGSALGORITHMEXTRACTBYEXTENT_H
...
class QgsExtractByExtentAlgorithm : public QgsProcessingAlgorithm
{
  public:
    ...
    [[nodiscard]] QgsExtractByExtentAlgorithm *createInstance() const override SIP_FACTORY;
