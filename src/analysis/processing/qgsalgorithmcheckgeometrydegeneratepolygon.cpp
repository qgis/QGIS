...
{
  return QObject::tr( "This algorithm checks the degenerate polygons of a layer." );
}
...
QgsFeaturePool *QgsGeometryCheckDegeneratePolygonAlgorithm::createFeaturePool( QgsVectorLayer *layer, bool selectedOnly ) const
{
