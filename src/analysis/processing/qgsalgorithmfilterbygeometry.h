...
class QgsFilterByGeometryAlgorithm : public QgsProcessingAlgorithm
{
  public:
    ...
    [[nodiscard]] QgsFilterByGeometryAlgorithm *createInstance() const override SIP_FACTORY;
...
class QgsFilterByLayerTypeAlgorithm : public QgsProcessingAlgorithm
{
  public:
    ...
    [[nodiscard]] QString shortHelpString() const override;
    [[nodiscard]] QString shortDescription() const override;
    [[nodiscard]] QgsFilterByLayerTypeAlgorithm *createInstance() const override SIP_FACTORY;
