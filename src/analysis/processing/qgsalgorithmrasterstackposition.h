...
class QgsRasterStackLowestPositionAlgorithm : public QgsRasterStackPositionAlgorithmBase
{
  public:
    ...
    [[nodiscard]] QgsRasterStackLowestPositionAlgorithm *createInstance() const override SIP_FACTORY;
...
class QgsRasterStackHighestPositionAlgorithm : public QgsRasterStackPositionAlgorithmBase
{
  public:
    ...
    [[nodiscard]] QString shortHelpString() const override;
    [[nodiscard]] QString shortDescription() const override;
    [[nodiscard]] QgsRasterStackHighestPositionAlgorithm *createInstance() const override SIP_FACTORY;
