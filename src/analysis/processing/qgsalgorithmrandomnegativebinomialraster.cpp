/***************************************************************************
                         qgsalgorithmrandomnegativebinomialraster.cpp
                         ---------------------
    begin                : April 2020
...
QString QgsRandomNegativeBinomialRasterAlgorithm::group() const
{
  return QObject::tr( "Raster creation" );
}

QString QgsRandomNegativeBinomialRasterAlgorithm::groupId() const
{
...
void QgsRandomNegativeBinomialRasterAlgorithm::initAlgorithm( const QVariantMap & )
{
  ...
  std::unique_ptr< QgsProcessingParameterNumber > kParameter = qgis::make_unique< QgsProcessingParameterNumber >( QStringLiteral( "K_PARAMETER" ), QStringLiteral( "Distribution parameter k" ), QgsProcessingParameterNumber::Double, 10.0, true, 0.00001 );
...
bool QgsRandomNegativeBinomialRasterAlgorithm::prepareAlgorithm( const QVariantMap &parameters, QgsProcessingContext &context, QgsProcessingFeedback *feedback )
{
  Q_UNUSED( feedback );
  ...
  mK = parameterAsDouble( parameters, QStringLiteral( "K_PARAMETER" ), context );
...
QVariantMap QgsRandomNegativeBinomialRasterAlgorithm::processAlgorithm( const QVariantMap &parameters, QgsProcessingContext &context, QgsProcessingFeedback *feedback )
{
  std::random_device rd {};
  std::mt19937 mersenneTwister{rd()};

  std::negative_binomial_distribution<long> randomNegativeBinomialDistribution( mK, mProbability );
  ...
  for ( int row = 0; row < rows ; row++ )
  {
    ...
    switch ( mTypeId )
    {
      case 0:
      {
        ...
        {
          int16Row[col] = static_cast<qint16>( randomNegativeBinomialDistribution( mersenneTwister ) );
        }
      ...
      case 1:
      {
        ...
        for ( int col = 0; col < cols; col++ )
        {
          uInt16Row[col] = static_cast<quint16>( randomNegativeBinomialDistribution( mersenneTwister ) );
        }
      ...
      case 2:
      {
        ...
        for ( int col = 0; col < cols; col++ )
        {
          int32Row[col] = static_cast<qint32>( randomNegativeBinomialDistribution( mersenneTwister ) );
        }
      ...
      case 3:
      {
        ...
        for ( int col = 0; col < cols; col++ )
        {
          uInt32Row[col] = static_cast<quint32>( randomNegativeBinomialDistribution( mersenneTwister ) );
        }
      ...
      case 4:
      {
        ...
        for ( int col = 0; col < cols; col++ )
        {
          float32Row[col] = static_cast<float>( randomNegativeBinomialDistribution( mersenneTwister ) );
        }
      ...
      case 5:
      {
        ...
        for ( int col = 0; col < cols; col++ )
        {
          float64Row[col] = static_cast<double>( randomNegativeBinomialDistribution( mersenneTwister ) );
        }
