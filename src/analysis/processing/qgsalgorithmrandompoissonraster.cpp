/***************************************************************************
                         qgsalgorithmrandompoissonraster.cpp
                         ---------------------
    begin                : April 2020
...
QString QgsRandomPoissonRasterAlgorithm::group() const
{
  return QObject::tr( "Raster creation" );
}

QString QgsRandomPoissonRasterAlgorithm::groupId() const
{
...
void QgsRandomPoissonRasterAlgorithm::initAlgorithm( const QVariantMap & )
{
...
bool QgsRandomPoissonRasterAlgorithm::prepareAlgorithm( const QVariantMap &parameters, QgsProcessingContext &context, QgsProcessingFeedback *feedback )
{
  Q_UNUSED( feedback );
...
QVariantMap QgsRandomPoissonRasterAlgorithm::processAlgorithm( const QVariantMap &parameters, QgsProcessingContext &context, QgsProcessingFeedback *feedback )
{
  std::random_device rd {};
  std::mt19937 mersenneTwister{rd()};

  std::poisson_distribution<long> randomPoissonDistribution( mMean );
  ...
  for ( int row = 0; row < rows ; row++ )
  {
    ...
    switch ( mTypeId )
    {
      case 0:
      {
        ...
        {
          int16Row[col] = static_cast<qint16>( randomPoissonDistribution( mersenneTwister ) );
        }
      ...
      case 1:
      {
        ...
        for ( int col = 0; col < cols; col++ )
        {
          uInt16Row[col] = static_cast<quint16>( randomPoissonDistribution( mersenneTwister ) );
        }
      ...
      case 2:
      {
        ...
        for ( int col = 0; col < cols; col++ )
        {
          int32Row[col] = static_cast<qint32>( randomPoissonDistribution( mersenneTwister ) );
        }
      ...
      case 3:
      {
        ...
        for ( int col = 0; col < cols; col++ )
        {
          uInt32Row[col] = static_cast<quint32>( randomPoissonDistribution( mersenneTwister ) );
        }
      ...
      case 4:
      {
        ...
        for ( int col = 0; col < cols; col++ )
        {
          float32Row[col] = static_cast<float>( randomPoissonDistribution( mersenneTwister ) );
        }
      ...
      case 5:
      {
        ...
        for ( int col = 0; col < cols; col++ )
        {
          float64Row[col] = static_cast<double>( randomPoissonDistribution( mersenneTwister ) );
        }
