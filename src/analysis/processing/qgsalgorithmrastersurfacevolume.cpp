...
void QgsRasterSurfaceVolumeAlgorithm::initAlgorithm( const QVariantMap & )
{
  ...
  addParameter( new QgsProcessingParameterEnum( QStringLiteral( "METHOD" ),
                                                QObject::tr( "Method" ), QStringList() << QObject::tr( "Count Only Above Base Level" ) << QObject::tr( "Count Only Below Base Level" ) << QObject::tr( "Subtract Volumes Below Base Level" ) << QObject::tr( "Add Volumes Below Base Level" ) ) );
