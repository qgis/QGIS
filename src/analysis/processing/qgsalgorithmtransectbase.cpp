...
void QgsTransectAlgorithmBase::initAlgorithm( const QVariantMap & )
{
  ...
  auto direction = std::make_unique<QgsProcessingParameterEnum>( QStringLiteral( "DIRECTION" ), QObject::tr( "Direction" ), QStringList() << QObject::tr( "Left to Right" ) << QObject::tr( "Right to Left" ), false, 0, true );
