...
QString QgsGeometryCheckSelfContactAlgorithm::name() const
{
  return u"checkgeometryselfcontact"_s;
}

QString QgsGeometryCheckSelfContactAlgorithm::displayName() const
{
  return QObject::tr( "Self-contacts" );
}
...
{
  return QObject::tr( "check,geometry,contact" ).split( ',' );
}

QString QgsGeometryCheckSelfContactAlgorithm::group() const
{
  return QObject::tr( "Check geometry" );
}

QString QgsGeometryCheckSelfContactAlgorithm::groupId() const
{
  return u"checkgeometry"_s;
}

QString QgsGeometryCheckSelfContactAlgorithm::shortHelpString() const
{
  return QObject::tr(
...
{
  return new QgsGeometryCheckSelfContactAlgorithm();
}

void QgsGeometryCheckSelfContactAlgorithm::initAlgorithm( const QVariantMap &configuration )
{
  ...
  addParameter( new QgsProcessingParameterFeatureSink( u"ERRORS"_s, QObject::tr( "Self contact error points" ), Qgis::ProcessingSourceType::VectorPoint ) );
  addParameter( new QgsProcessingParameterFeatureSink( u"OUTPUT"_s, QObject::tr( "Self contact features" ), Qgis::ProcessingSourceType::VectorAnyGeometry, QVariant(), true, false ) );
...
bool QgsGeometryCheckSelfContactAlgorithm::prepareAlgorithm( const QVariantMap &parameters, QgsProcessingContext &context, QgsProcessingFeedback * )
{
...
QgsFields QgsGeometryCheckSelfContactAlgorithm::outputFields()
{
  QgsFields fields;
...
QVariantMap QgsGeometryCheckSelfContactAlgorithm::processAlgorithm( const QVariantMap &parameters, QgsProcessingContext &context, QgsProcessingFeedback *feedback )
{
  ...
  const QgsGeometrySelfContactCheck check( &checkContext, QVariantMap() );
