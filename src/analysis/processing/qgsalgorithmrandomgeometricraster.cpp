/***************************************************************************
                         qgsalgorithmrandomgeometricraster.cpp
                         ---------------------
    begin                : April 2020
...
QString QgsRandomGeometricRasterAlgorithm::group() const
{
  return QObject::tr( "Raster creation" );
}

QString QgsRandomGeometricRasterAlgorithm::groupId() const
{
...
void QgsRandomGeometricRasterAlgorithm::initAlgorithm( const QVariantMap & )
{
...
bool QgsRandomGeometricRasterAlgorithm::prepareAlgorithm( const QVariantMap &parameters, QgsProcessingContext &context, QgsProcessingFeedback *feedback )
{
  Q_UNUSED( feedback );
...
QVariantMap QgsRandomGeometricRasterAlgorithm::processAlgorithm( const QVariantMap &parameters, QgsProcessingContext &context, QgsProcessingFeedback *feedback )
{
  std::random_device rd {};
  std::mt19937 mersenneTwister{rd()};

  std::geometric_distribution<long> randomGeometricDistribution( mProbability );
  ...
  for ( int row = 0; row < rows ; row++ )
  {
    ...
    switch ( mTypeId )
    {
      case 0:
      {
        ...
        {
          int16Row[col] = static_cast<qint16>( randomGeometricDistribution( mersenneTwister ) );
        }
      ...
      case 1:
      {
        ...
        for ( int col = 0; col < cols; col++ )
        {
          uInt16Row[col] = static_cast<quint16>( randomGeometricDistribution( mersenneTwister ) );
        }
      ...
      case 2:
      {
        ...
        for ( int col = 0; col < cols; col++ )
        {
          int32Row[col] = static_cast<qint32>( randomGeometricDistribution( mersenneTwister ) );
        }
      ...
      case 3:
      {
        ...
        for ( int col = 0; col < cols; col++ )
        {
          uInt32Row[col] = static_cast<quint32>( randomGeometricDistribution( mersenneTwister ) );
        }
      ...
      case 4:
      {
        ...
        for ( int col = 0; col < cols; col++ )
        {
          float32Row[col] = static_cast<float>( randomGeometricDistribution( mersenneTwister ) );
        }
      ...
      case 5:
      {
        ...
        for ( int col = 0; col < cols; col++ )
        {
          float64Row[col] = static_cast<double>( randomGeometricDistribution( mersenneTwister ) );
        }
