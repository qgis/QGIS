...
class QgsRaiseExceptionAlgorithm : public QgsProcessingAlgorithm
{
  public:
    ...
    [[nodiscard]] QgsRaiseExceptionAlgorithm *createInstance() const override SIP_FACTORY;
...
class QgsRaiseWarningAlgorithm : public QgsProcessingAlgorithm
{
  public:
    ...
    [[nodiscard]] QString shortHelpString() const override;
    [[nodiscard]] QString shortDescription() const override;
    [[nodiscard]] QgsRaiseWarningAlgorithm *createInstance() const override SIP_FACTORY;
...
class QgsRaiseMessageAlgorithm : public QgsProcessingAlgorithm
{
  public:
    ...
    [[nodiscard]] QString shortHelpString() const override;
    [[nodiscard]] QString shortDescription() const override;
    [[nodiscard]] QgsRaiseMessageAlgorithm *createInstance() const override SIP_FACTORY;
