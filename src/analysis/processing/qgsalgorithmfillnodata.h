...
class QgsFillNoDataAlgorithm : public QgsProcessingAlgorithm
{
  public:
    ...
    [[nodiscard]] QIcon icon() const override { return QgsApplication::getThemeIcon( QStringLiteral( "/algorithms/mAlgorithmFillNoData.svg" ) ); }
    [[nodiscard]] QString svgIconPath() const override { return QgsApplication::iconPath( QStringLiteral( "/algorithms/mAlgorithmFillNoData.svg" ) ); }
    ...
    [[nodiscard]] QgsFillNoDataAlgorithm *createInstance() const override SIP_FACTORY;
