...
class QgsRasterCalculatorAlgorithm : public QgsProcessingAlgorithm
{
  public:
    ...
    [[nodiscard]] QgsRasterCalculatorAlgorithm *createInstance() const override SIP_FACTORY;
...
class QgsRasterCalculatorModelerAlgorithm : public QgsRasterCalculatorAlgorithm
{
  public:
    ...
    [[nodiscard]] QString group() const override;
    [[nodiscard]] QString groupId() const override;
    [[nodiscard]] QgsRasterCalculatorModelerAlgorithm *createInstance() const override SIP_FACTORY;
