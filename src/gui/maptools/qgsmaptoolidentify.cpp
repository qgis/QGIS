...
)
{
  ...
  mCoordinatePrecision
    = QgsCoordinateUtils::calculateCoordinatePrecision( mLastMapUnitsPerPixel, mCanvas->mapSettings().destinationCrs(), mCanvas->project() ? *mCanvas->project() : *QgsProject::instance() );
