...
{
  QgsHelp::openHelp( u"working_with_vector/vector_properties.html#rule-based-labeling"_s );
}
...
{
  const QString filter = mElseRadio->isChecked() ? u"ELSE"_s : editFilter->text().trimmed();
