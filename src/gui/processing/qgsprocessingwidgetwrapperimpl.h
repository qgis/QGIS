...
class GUI_EXPORT QgsProcessingVectorTileWriterLayersPanelWidget : public QWidget
{
    Q_OBJECT

  public:

    QgsProcessingVectorTileWriterLayersPanelWidget( QWidget *parent = nullptr ); //, const QgsProcessingParameterMultipleLayers *param = nullptr );
...
class GUI_EXPORT QgsProcessingVectorTileWriterLayersWidgetWrapper : public QgsAbstractProcessingParameterWidgetWrapper, public QgsProcessingParameterWidgetFactoryInterface
{
    Q_OBJECT
...
//    QString modelerExpressionFormatString() const override;
  ...
  private:
    ...
    QgsProcessingVectorTileWriterLayersPanelWidget *mPanel = nullptr;
