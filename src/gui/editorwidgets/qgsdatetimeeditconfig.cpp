  ...
  : QgsEditorConfigWidget( vl, fieldIdx, parent )
{
  ...
  mHelpLabel->setText(
    ...
    + u"</a> "_s
    + tr(
      "extended format: either <code>yyyy-MM-dd</code> for dates or <code>yyyy-MM-ddTHH:mm:ss</code> (e.g. 2017-07-24T15:46:29), or with a time-zone suffix (Z for UTC otherwise an offset as "
      "[+|-]HH:mm) where appropriate for combined dates and times."
    )
    + QStringLiteral(
      "</span></p>"
      "</td>"
    ...
    + QStringLiteral(
      "</span><a href=\"http://qt-project.org/doc/qt-5/qlocale.html#system\"><span style=\"font-family:'Arial,Open Sans,sans-serif'; font-size:12px; font-weight:600; text-decoration: underline; "
      "color:#00732f;\">QLocale</span></a><span style=\"font-family:'Open Sans,sans-serif'; font-size:11px; color:#66666e;\">().</span></p>"
      "</td>"
      "</tr>"
      "<tr>"
      "<td bgcolor=\"#ffffff\" style=\"vertical-align:top; padding-left:10; padding-right:10; padding-top:3; padding-bottom:3;\">"
