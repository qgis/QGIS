...
void QgsDateTimeEditWrapper::initWidget( QWidget *editor )
{
  ...
  const QString displayFormat = config( "display_format", QgsDateTimeEditFactory::DateFormat ).toString();
...
QVariant QgsDateTimeEditWrapper::value()
{
  ...
  const QString fieldFormat = config( "field_format", QgsDateTimeEditFactory::DateFormat ).toString();
