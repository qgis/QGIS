  ...
  , mLayer( layer )
{
  ...
  mSymbolUnitWidget->setUnits( QgsUnitTypes::RenderUnitList() << QgsUnitTypes::RenderMillimeters << QgsUnitTypes::RenderMeters << QgsUnitTypes::RenderMapUnits << QgsUnitTypes::RenderPixels
