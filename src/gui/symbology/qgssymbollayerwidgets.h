/***************************************************************************
 qgssymbollayerwidgets.h - symbol layer widgets
...
#ifndef QGSSYMBOLLAYERWIDGETS_H
#define QGSSYMBOLLAYERWIDGETS_H
...
#include "qgstemplatedlinesymbollayerwidget_p.h"
 ...
 */
class GUI_EXPORT QgsMarkerLineSymbolLayerWidget : public QgsTemplatedLineSymbolLayerWidget<Ui::WidgetMarkerLine, QgsMarkerLineSymbolLayer>
{
    Q_OBJECT
 ...
 * \since QGIS 3.8
 */
class GUI_EXPORT QgsHashedLineSymbolLayerWidget : public QgsTemplatedLineSymbolLayerWidget<Ui::WidgetHashedLine, QgsHashedLineSymbolLayer>
{
    Q_OBJECT
