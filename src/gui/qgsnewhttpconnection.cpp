...
void QgsNewHttpConnection::accept()
{
  ...
  {
    QgsOwsConnection::sTreeConnectionServices->deleteItem( mOriginalConnName, {mServiceName.toLower()} );
    settings.sync();
  }
  ...
  QgsOwsConnection::sTreeConnectionServices->setSelectedItem( newConnectionName, {mServiceName.toLower()} );
