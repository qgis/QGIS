    ...
    , mResolutionState( OriginalResolution )
{
  ...
  myFormats << "GTiff";
  foreach ( const QString& myFormat, myFormats )
  {
...
void QgsRasterLayerSaveAsDialog::on_mLoadTransparentNoDataToolButton_clicked()
{
  ...
  foreach ( const QgsRasterTransparency::TransparentSingleValuePixel& transparencyPixel, rasterTransparency->transparentSingleValuePixelList() )
  {
