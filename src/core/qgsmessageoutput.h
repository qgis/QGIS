...
class CORE_EXPORT QgsMessageOutput
{
  public:
    ...
    virtual void setMessage( const QString &message, Qgis::StringFormat msgType ) = 0;
     ...
     */
    static void showMessage( const QString &title, const QString &message, Qgis::StringFormat msgType );
...
class CORE_EXPORT QgsMessageOutputConsole : public QObject, public QgsMessageOutput
{
  ...
  private:
    ...
    Qgis::StringFormat mMsgType = Qgis::StringFormat::PlainText;
};
