...
class CORE_EXPORT QgsBearingUtils
{
  ...
  public:
     ...
     */
    Q_INVOKABLE static double bearingTrueNorth( const QgsCoordinateReferenceSystem &crs, const QgsCoordinateTransformContext &transformContext, const QgsPointXY &point );
};
