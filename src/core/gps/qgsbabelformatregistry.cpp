...
QgsBabelFormatRegistry::QgsBabelFormatRegistry()
{
  ...
  mImporters[u"alanwpr"_s]
    = new QgsBabelSimpleImportFormat( u"alanwpr"_s, u"Alan Map500 waypoints and routes (.wpr)"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes, { u"wpr"_s } );
  ...
  mImporters[u"compegps"_s]
    = new QgsBabelSimpleImportFormat( u"compegps"_s, u"CompeGPS data files (.wpt/.trk/.rte)"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes | Qgis::BabelFormatCapability::Tracks, {} );
  mImporters[u"cst"_s]
    = new QgsBabelSimpleImportFormat( u"cst"_s, u"CarteSurTable data file"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes | Qgis::BabelFormatCapability::Tracks, { u"cst"_s } );
  ...
  mImporters[u"g7towin"_s]
    = new QgsBabelSimpleImportFormat( u"g7towin"_s, u"G7ToWin data files (.g7t)"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes | Qgis::BabelFormatCapability::Tracks, { u"g7t"_s } );
  ...
  mImporters[u"garmin_txt"_s]
    = new QgsBabelSimpleImportFormat( u"garmin_txt"_s, u"Garmin MapSource - txt (tab delimited)"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes | Qgis::BabelFormatCapability::Tracks, { u"txt"_s } );
  ...
  mImporters[u"gdb"_s]
    = new QgsBabelSimpleImportFormat( u"gdb"_s, u"Garmin MapSource - gdb"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes | Qgis::BabelFormatCapability::Tracks, { u"gdb"_s } );
  ...
  mImporters[u"geojson"_s]
    = new QgsBabelSimpleImportFormat( u"geojson"_s, u"GeoJson"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes | Qgis::BabelFormatCapability::Tracks, { u"json"_s } );
  ...
  mImporters[u"ggv_ovl"_s]
    = new QgsBabelSimpleImportFormat( u"ggv_ovl"_s, u"Geogrid-Viewer ascii overlay file (.ovl)"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes | Qgis::BabelFormatCapability::Tracks, { u"ovl"_s } );
  ...
  mImporters[u"gpx"_s]
    = new QgsBabelSimpleImportFormat( u"gpx"_s, u"GPX XML"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes | Qgis::BabelFormatCapability::Tracks, { u"gpx"_s } );
  mImporters[u"gtm"_s]
    = new QgsBabelSimpleImportFormat( u"gtm"_s, u"GPS TrackMaker"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes | Qgis::BabelFormatCapability::Tracks, { u"gtm"_s } );
  mImporters[u"gtrnctr"_s]
    = new QgsBabelSimpleImportFormat( u"gtrnctr"_s, u"Garmin Training Center (.tcx/.crs/.hst/.xml)"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Tracks, { u"tcx"_s, u"crs"_s, u"hst"_s, u"xml"_s } );
  ...
  mImporters[u"humminbird"_s]
    = new QgsBabelSimpleImportFormat( u"humminbird"_s, u"Humminbird waypoints and routes (.hwr)"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes | Qgis::BabelFormatCapability::Tracks, { u"hwr"_s } );
  mImporters[u"humminbird_ht"_s]
    = new QgsBabelSimpleImportFormat( u"humminbird_ht"_s, u"Humminbird tracks (.ht)"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes | Qgis::BabelFormatCapability::Tracks, { u"ht"_s } );
  ...
  mImporters[u"itracku-bin"_s]
    = new QgsBabelSimpleImportFormat( u"itracku-bin"_s, u"XAiOX iTrackU Logger Binary File Format"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Tracks, { u"bin"_s } );
  ...
  mImporters[u"kml"_s]
    = new QgsBabelSimpleImportFormat( u"kml"_s, u"Google Earth (Keyhole) Markup Language"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes | Qgis::BabelFormatCapability::Tracks, { u"kml"_s } );
  ...
  mImporters[u"lowranceusr"_s]
    = new QgsBabelSimpleImportFormat( u"lowranceusr"_s, u"Lowrance USR"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes | Qgis::BabelFormatCapability::Tracks, { u"usr"_s } );
  mImporters[u"m241-bin"_s]
    = new QgsBabelSimpleImportFormat( u"m241-bin"_s, u"Holux M-241 (MTK based) Binary File Format"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Tracks, { u"bin"_s } );
  mImporters[u"magellan"_s]
    = new QgsBabelSimpleImportFormat( u"magellan"_s, u"Magellan SD files (as for Meridian)"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes | Qgis::BabelFormatCapability::Tracks, {} );
  mImporters[u"magellanx"_s]
    = new QgsBabelSimpleImportFormat( u"magellanx"_s, u"Magellan SD files (as for eXplorist)"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes | Qgis::BabelFormatCapability::Tracks, { u"upt"_s } );
  ...
  mImporters[u"mapsend"_s]
    = new QgsBabelSimpleImportFormat( u"mapsend"_s, u"Magellan Mapsend"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes | Qgis::BabelFormatCapability::Tracks, {} );
  mImporters[u"mmo"_s]
    = new QgsBabelSimpleImportFormat( u"mmo"_s, u"Memory-Map Navigator overlay files (.mmo)"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes | Qgis::BabelFormatCapability::Tracks, { u"mmo"_s } );
  ...
  mImporters[u"mtk-bin"_s]
    = new QgsBabelSimpleImportFormat( u"mtk-bin"_s, u"MTK Logger (iBlue 747,...) Binary File Format"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Tracks, { u"bin"_s } );
  ...
  mImporters[u"pcx"_s]
    = new QgsBabelSimpleImportFormat( u"pcx"_s, u"Garmin PCX5"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes | Qgis::BabelFormatCapability::Tracks, { u"pcx"_s } );
  ...
  mImporters[u"pocketfms_fp"_s]
    = new QgsBabelSimpleImportFormat( u"pocketfms_fp"_s, u"PocketFMS flightplan (.xml)"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes, { u"xml"_s } );
  ...
  mImporters[u"raymarine"_s]
    = new QgsBabelSimpleImportFormat( u"raymarine"_s, u"Raymarine Waypoint File (.rwf)"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes, { u"rwf"_s } );
  ...
  mImporters[u"shape"_s]
    = new QgsBabelSimpleImportFormat( u"shape"_s, u"ESRI shapefile"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes | Qgis::BabelFormatCapability::Tracks, { u"shp"_s } );
  mImporters[u"skyforce"_s]
    = new QgsBabelSimpleImportFormat( u"skyforce"_s, u"Skymap / KMD150 ascii files"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes | Qgis::BabelFormatCapability::Tracks, {} );
  mImporters[u"skytraq-bin"_s]
    = new QgsBabelSimpleImportFormat( u"skytraq-bin"_s, u"SkyTraq Venus based loggers Binary File Format"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Tracks, { u"bin"_s } );
  ...
  mImporters[u"stmwpp"_s]
    = new QgsBabelSimpleImportFormat( u"stmwpp"_s, u"Suunto Trek Manager (STM) WaypointPlus files"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes | Qgis::BabelFormatCapability::Tracks, { u"txt"_s } );
  ...
  mImporters[u"tpo3"_s]
    = new QgsBabelSimpleImportFormat( u"tpo3"_s, u"National Geographic Topo 3.x/4.x .tpo"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes | Qgis::BabelFormatCapability::Tracks, { u"tpo"_s } );
  mImporters[u"unicsv"_s]
    = new QgsBabelSimpleImportFormat( u"unicsv"_s, u"Universal csv with field structure in first line"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes | Qgis::BabelFormatCapability::Tracks, {} );
  ...
  mImporters[u"vitosmt"_s]
    = new QgsBabelSimpleImportFormat( u"vitosmt"_s, u"Vito Navigator II tracks"_s, Qgis::BabelFormatCapability::Waypoints | Qgis::BabelFormatCapability::Routes | Qgis::BabelFormatCapability::Tracks, { u"smt"_s } );
...
void QgsBabelFormatRegistry::reloadFromSettings()
{
  ...
  mDevices[u"Garmin serial"_s]
    = new QgsBabelGpsDeviceFormat( u"%babel -w -i garmin -o gpx %in %out"_s, u"%babel -w -i gpx -o garmin %in %out"_s, u"%babel -r -i garmin -o gpx %in %out"_s, u"%babel -r -i gpx -o garmin %in %out"_s, u"%babel -t -i garmin -o gpx %in %out"_s, u"%babel -t -i gpx -o garmin %in %out"_s );
