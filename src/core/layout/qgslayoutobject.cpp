...
void QgsLayoutObject::initPropertyDefinitions()
{
  ...
  sPropertyDefinitions = QgsPropertiesDefinition {
    ...
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::PaperOrientation ),
      QgsPropertyDefinition( "dataDefinedPaperOrientation", QgsPropertyDefinition::DataTypeString, QObject::tr( "Symbol size" ), QObject::tr( "string " ) + "[<b>portrait</b>|<b>landscape</b>]"_L1 ) },
    ...
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::ExcludeFromExports ),
      QgsPropertyDefinition( "dataDefinedExcludeExports", QObject::tr( "Exclude item from exports" ), QgsPropertyDefinition::Boolean ) },
    ...
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::BackgroundColor ),
      QgsPropertyDefinition( "dataDefinedBackgroundColor", QObject::tr( "Background color" ), QgsPropertyDefinition::ColorWithAlpha ) },
    ...
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::MarginBottom ),
      QgsPropertyDefinition( "dataDefinedMarginBottom", QObject::tr( "Bottom margin" ), QgsPropertyDefinition::DoublePositive ) },
    ...
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapLabelMargin ),
      QgsPropertyDefinition( "dataDefinedMapLabelMargin", QObject::tr( "Label margin" ), QgsPropertyDefinition::DoublePositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapAtlasMargin ),
      QgsPropertyDefinition( "dataDefinedMapAtlasMargin", QObject::tr( "Atlas margin" ), QgsPropertyDefinition::DoublePositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapLayers ),
      QgsPropertyDefinition( "dataDefinedMapLayers", QgsPropertyDefinition::DataTypeString, QObject::tr( "Map Layers" ), tr( "list of map layer names separated by | characters" ) ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapStylePreset ),
      QgsPropertyDefinition( "dataDefinedMapStylePreset", QgsPropertyDefinition::DataTypeString, QObject::tr( "Map theme" ), tr( "name of an existing map theme (case-sensitive)" ) ) },
    ...
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapGridIntervalX ),
      QgsPropertyDefinition( "dataDefinedMapGridIntervalX", QObject::tr( "Grid interval X" ), QgsPropertyDefinition::DoublePositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapGridIntervalY ),
      QgsPropertyDefinition( "dataDefinedMapGridIntervalY", QObject::tr( "Grid interval Y" ), QgsPropertyDefinition::DoublePositive ) },
    ...
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapGridFrameSize ),
      QgsPropertyDefinition( "dataDefinedMapGridFrameSize", QObject::tr( "Grid frame size" ), QgsPropertyDefinition::DoublePositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapGridFrameLineThickness ),
      QgsPropertyDefinition( "dataDefinedMapGridFrameLineThickness", QObject::tr( "Grid frame line thickness" ), QgsPropertyDefinition::DoublePositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapGridCrossSize ),
      QgsPropertyDefinition( "dataDefinedMapGridCrossSize", QObject::tr( "Grid cross size" ), QgsPropertyDefinition::DoublePositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapGridFrameMargin ),
      QgsPropertyDefinition( "dataDefinedMapGridFrameMargin", QObject::tr( "Grid frame margin" ), QgsPropertyDefinition::DoublePositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapGridLabelDistance ),
      QgsPropertyDefinition( "dataDefinedMapGridLabelDistance", QObject::tr( "Grid label distance" ), QgsPropertyDefinition::DoublePositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapGridAnnotationDisplayLeft ),
      QgsPropertyDefinition( "dataDefinedMapGridAnnotationDisplayLeft", QgsPropertyDefinition::DataTypeString, QObject::tr( "Map grid annotation display left" ), QObject::tr( "string " ) + "[<b>all</b>|<b>x_only</b>|<b>y_only</b>|<b>disabled</b>]"_L1 ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapGridAnnotationDisplayRight ),
      QgsPropertyDefinition( "dataDefinedMapGridAnnotationDisplayRight", QgsPropertyDefinition::DataTypeString, QObject::tr( "Map grid annotation display right" ), QObject::tr( "string " ) + "[<b>all</b>|<b>x_only</b>|<b>y_only</b>|<b>disabled</b>]"_L1 ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapGridAnnotationDisplayTop ),
      QgsPropertyDefinition( "dataDefinedMapGridAnnotationDisplayTop", QgsPropertyDefinition::DataTypeString, QObject::tr( "Map grid annotation display top" ), QObject::tr( "string " ) + "[<b>all</b>|<b>x_only</b>|<b>y_only</b>|<b>disabled</b>]"_L1 ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapGridAnnotationDisplayBottom ),
      QgsPropertyDefinition( "dataDefinedMapGridAnnotationDisplayBottom", QgsPropertyDefinition::DataTypeString, QObject::tr( "Map grid annotation display bottom" ), QObject::tr( "string " ) + "[<b>all</b>|<b>x_only</b>|<b>y_only</b>|<b>disabled</b>]"_L1 ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapGridFrameDivisionsLeft ),
      QgsPropertyDefinition( "dataDefinedMapGridFrameDivisionsLeft", QgsPropertyDefinition::DataTypeString, QObject::tr( "Map grid frame divisions display left" ), QObject::tr( "string " ) + "[<b>all</b>|<b>x_only</b>|<b>y_only</b>|<b>disabled</b>]"_L1 ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapGridFrameDivisionsRight ),
      QgsPropertyDefinition( "dataDefinedMapGridFrameDivisionsRight", QgsPropertyDefinition::DataTypeString, QObject::tr( "Map grid frame divisions display right" ), QObject::tr( "string " ) + "[<b>all</b>|<b>x_only</b>|<b>y_only</b>|<b>disabled</b>]"_L1 ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapGridFrameDivisionsTop ),
      QgsPropertyDefinition( "dataDefinedMapGridFrameDivisionsTop", QgsPropertyDefinition::DataTypeString, QObject::tr( "Map grid frame divisions display top" ), QObject::tr( "string " ) + "[<b>all</b>|<b>x_only</b>|<b>y_only</b>|<b>disabled</b>]"_L1 ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapGridFrameDivisionsBottom ),
      QgsPropertyDefinition( "dataDefinedMapGridFrameDivisionsBottom", QgsPropertyDefinition::DataTypeString, QObject::tr( "Map grid frame divisions display bottom" ), QObject::tr( "string " ) + "[<b>all</b>|<b>x_only</b>|<b>y_only</b>|<b>disabled</b>]"_L1 ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::MapGridDrawAnnotation ),
    ...
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::StartDateTime ),
      QgsPropertyDefinition( "dataDefinedStartDateTime", QObject::tr( "Temporal range start date / time" ), QgsPropertyDefinition::DateTime ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::EndDateTime ),
      QgsPropertyDefinition( "dataDefinedEndDateTime", QObject::tr( "Temporal range end date / time" ), QgsPropertyDefinition::DateTime ) },
    ...
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::PictureSvgBackgroundColor ),
      QgsPropertyDefinition( "dataDefinedSvgBackgroundColor", QObject::tr( "SVG background color" ), QgsPropertyDefinition::ColorWithAlpha ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::PictureSvgStrokeColor ),
      QgsPropertyDefinition( "dataDefinedSvgStrokeColor", QObject::tr( "SVG stroke color" ), QgsPropertyDefinition::ColorWithAlpha ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::PictureSvgStrokeWidth ),
      QgsPropertyDefinition( "dataDefinedSvgStrokeWidth", QObject::tr( "SVG stroke width" ), QgsPropertyDefinition::StrokeWidth ) },
    ...
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::LegendColumnCount ),
      QgsPropertyDefinition( "dataDefinedLegendColumns", QObject::tr( "Number of columns" ), QgsPropertyDefinition::IntegerPositiveGreaterZero ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::LegendAutoWrapWidth ),
      QgsPropertyDefinition( "dataDefinedLegendAutoWrapWidth", QObject::tr( "Text wrapping width in mm" ), QgsPropertyDefinition::DoublePositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarFillColor ),
      QgsPropertyDefinition( "dataDefinedScalebarFill", QObject::tr( "Fill color" ), QgsPropertyDefinition::ColorWithAlpha ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarFillColor2 ),
      QgsPropertyDefinition( "dataDefinedScalebarFill2", QObject::tr( "Secondary fill color" ), QgsPropertyDefinition::ColorWithAlpha ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarLineColor ),
      QgsPropertyDefinition( "dataDefinedScalebarLineColor", QObject::tr( "Line color" ), QgsPropertyDefinition::ColorWithAlpha ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarLineWidth ),
      QgsPropertyDefinition( "dataDefinedScalebarLineWidth", QObject::tr( "Line width" ), QgsPropertyDefinition::StrokeWidth ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::AttributeTableSourceLayer ),
      QgsPropertyDefinition( "dataDefinedAttributeTableSourceLayer", QObject::tr( "Table source layer" ), QgsPropertyDefinition::String ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarLeftSegments ),
      QgsPropertyDefinition( "dataDefinedScaleBarLeftSegments", QObject::tr( "Segments to the left of 0" ), QgsPropertyDefinition::IntegerPositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarRightSegments ),
      QgsPropertyDefinition( "dataDefinedScaleBarRightSegments", QObject::tr( "Segments to the right of 0" ), QgsPropertyDefinition::IntegerPositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarSegmentWidth ),
      QgsPropertyDefinition( "dataDefinedScalebarSegmentWidth", QObject::tr( "Length of a segment in map units" ), QgsPropertyDefinition::DoublePositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarMinimumWidth ),
      QgsPropertyDefinition( "dataDefinedScalebarMinWidth", QObject::tr( "Minimum length of a segment in mm" ), QgsPropertyDefinition::DoublePositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarMaximumWidth ),
      QgsPropertyDefinition( "dataDefinedScalebarMaxWidth", QObject::tr( "Maximum length of a segment in mm" ), QgsPropertyDefinition::DoublePositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarHeight ),
      QgsPropertyDefinition( "dataDefinedScalebarHeight", QObject::tr( "Scalebar height in mm" ), QgsPropertyDefinition::DoublePositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarSubdivisionHeight ),
      QgsPropertyDefinition( "dataDefinedScalebarSubdivisionHeight", QObject::tr( "Subdivision height in mm" ), QgsPropertyDefinition::DoublePositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::ScalebarRightSegmentSubdivisions ),
      QgsPropertyDefinition( "dataDefinedScalebarRightSegmentSubdivisions", QObject::tr( "Number of subdivisions in segments to the right of 0" ), QgsPropertyDefinition::IntegerPositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::ElevationProfileTolerance ),
      QgsPropertyDefinition( "dataDefinedElevationProfileTolerance", QObject::tr( "Tolerance" ), QgsPropertyDefinition::DoublePositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::ElevationProfileDistanceMajorInterval ),
      QgsPropertyDefinition( "dataDefinedElevationProfileDistanceMajorInterval", QObject::tr( "Major grid line interval for elevation axis" ), QgsPropertyDefinition::DoublePositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::ElevationProfileDistanceMinorInterval ),
      QgsPropertyDefinition( "dataDefinedElevationProfileDistanceMinorInterval", QObject::tr( "Minor grid line interval for elevation axis" ), QgsPropertyDefinition::DoublePositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::ElevationProfileDistanceLabelInterval ),
      QgsPropertyDefinition( "dataDefinedElevationProfileDistanceLabelInterval", QObject::tr( "Label interval for elevation axis" ), QgsPropertyDefinition::DoublePositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::ElevationProfileElevationMajorInterval ),
      QgsPropertyDefinition( "dataDefinedElevationProfileElevationMajorInterval", QObject::tr( "Major grid line interval for distance axis" ), QgsPropertyDefinition::DoublePositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::ElevationProfileElevationMinorInterval ),
      QgsPropertyDefinition( "dataDefinedElevationProfileElevationMinorInterval", QObject::tr( "Minor grid line interval for distance axis" ), QgsPropertyDefinition::DoublePositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::ElevationProfileElevationLabelInterval ),
      QgsPropertyDefinition( "dataDefinedElevationProfileElevationLabelInterval", QObject::tr( "Label interval for distance axis" ), QgsPropertyDefinition::DoublePositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::ElevationProfileMinimumDistance ),
      QgsPropertyDefinition( "dataDefinedElevationProfileMinimumDistance", QObject::tr( "Minimum distance" ), QgsPropertyDefinition::DoublePositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::ElevationProfileMaximumDistance ),
      QgsPropertyDefinition( "dataDefinedElevationProfileMaximumDistance", QObject::tr( "Maximum distance" ), QgsPropertyDefinition::DoublePositive ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::ElevationProfileMinimumElevation ),
      QgsPropertyDefinition( "dataDefinedElevationProfileMinimumElevation", QObject::tr( "Minimum elevation" ), QgsPropertyDefinition::Double ) },
    { static_cast< int >( QgsLayoutObject::DataDefinedProperty::ElevationProfileMaximumElevation ),
      QgsPropertyDefinition( "dataDefinedElevationProfileMaximumElevation", QObject::tr( "Maximum elevation" ), QgsPropertyDefinition::Double ) },
  };
}
