...
class CORE_EXPORT QgsComposerMapGrid : public QgsComposerMapItem
{
  ...
  public:
    ...
    {
      mGridAnnotationFontColor = color;
    }
    ...
    {
      return mGridAnnotationFontColor;
    }
    ...
    {
      mGridAnnotationPrecision = precision;
    }
    ...
    {
      return mGridAnnotationExpressionString;
    }
