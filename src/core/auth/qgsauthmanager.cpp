...
const QgsSettingsEntryBool *QgsAuthManager::settingsPasswordHelperInsecureFallback = new QgsSettingsEntryBool( u"password-helper-insecure-fallback"_s, QgsSettingsTree::sTreeAuthentication, false );
const QgsSettingsEntryBool *QgsAuthManager::settingsUsePasswordHelper = new QgsSettingsEntryBool( u"use-password-helper"_s, QgsSettingsTree::sTreeAuthentication, true );
const QgsSettingsEntryBool *QgsAuthManager::settingsPasswordHelperLogging = new QgsSettingsEntryBool( u"password-helper-logging"_s, QgsSettingsTree::sTreeAuthentication, false );
