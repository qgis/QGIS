...
class CORE_EXPORT QgsReadWriteContext
{
  public:
    ...
    struct ReadWriteMessage
    {
        ...
        ReadWriteMessage( const QString &message, Qgis::MessageLevel level = Qgis::MessageLevel::Warning, const QStringList &categories = QStringList() )
          : mMessage( message )
          , mLevel( level )
     ...
     * \since QGIS 3.2
     */
    void pushMessage( const QString &message, Qgis::MessageLevel level = Qgis::MessageLevel::Warning );
