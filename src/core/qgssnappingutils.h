...
class CORE_EXPORT QgsSnappingUtils : public QObject
{
  ...
  public:
    ...
    struct LayerConfig
    {
       ...
       *
       * snapping_layer1 = QgsSnappingUtils.LayerConfig(layer1, QgsPointLocator.Vertex, 10, Qgis::MapUnitType::Pixels)
       * snapping_layer2 = QgsSnappingUtils.LayerConfig(layer2, QgsPointLocator.Vertex and QgsPointLocator.Edge, 10, Qgis::MapUnitType::Pixels)
       *
       ...
       */
      LayerConfig( QgsVectorLayer *l, QgsPointLocator::Types t, double tol, Qgis::MapUnitType u )
        : layer( l )
        , type( t )
        , tolerance( tol )
        , unit( u )
