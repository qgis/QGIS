...
QgsRectangle QgsArcGisRestQueryUtils::getExtent(const QString &layerurl, const QString &whereClause, const QString &authcfg, const QgsHttpHeaders &requestHeaders , const QString &urlPrefix)
{
  ...
  QString errorTitle;
  QString errorText;
  const QVariantMap res = queryServiceJSON( queryUrl, authcfg, errorTitle, errorText, requestHeaders, urlPrefix );
  if ( res.isEmpty() )
  {
...
QVariantMap QgsArcGisRestQueryUtils::getObjects(const QString &layerurl, const QString &authcfg, const QList<quint32> &objectIds, const QString &crs,
    ...
    QString &errorTitle, QString &errorText, const QgsHttpHeaders &requestHeaders, const QString &urlPrefix, QgsFeedback *feedback )
{
  QStringList ids;
...
QList<quint32> QgsArcGisRestQueryUtils::getObjectIdsByExtent(const QString &layerurl, const QgsRectangle &filterRect, QString &errorTitle, QString &errorText, const QString &authcfg, const QgsHttpHeaders &requestHeaders, const QString &urlPrefix, QgsFeedback *feedback, const QString &whereClause )
{
  ...
  query.addQueryItem( QStringLiteral( "spatialRel" ), QStringLiteral( "esriSpatialRelEnvelopeIntersects" ) );
  queryUrl.setQuery( query );
  const QVariantMap objectIdData = queryServiceJSON( queryUrl, authcfg, errorTitle, errorText, requestHeaders, urlPrefix, feedback );
...
QByteArray QgsArcGisRestQueryUtils::queryService( const QUrl &u, const QString &authcfg, QString &errorTitle, QString &errorText, const QgsHttpHeaders &requestHeaders, const QString &urlPrefix, QgsFeedback *feedback, QString *contentType )
{
  QUrl url = parseUrl( u );
...
QVariantMap QgsArcGisRestQueryUtils::queryServiceJSON( const QUrl &url, const QString &authcfg, QString &errorTitle, QString &errorText, const QgsHttpHeaders &requestHeaders, const QString &urlPrefix, QgsFeedback *feedback )
{
  const QByteArray reply = queryService( url, authcfg, errorTitle, errorText, requestHeaders, urlPrefix, feedback );
