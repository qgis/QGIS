...
QgsPdalProvider::QgsPdalProvider(const QString &uri, const QgsDataProvider::ProviderOptions &options)
...
QString QgsPdalProvider::filePointCloudFilters() const
{
...
void QgsPdalProvider::filePointCloudExtensions(QStringList &filePointCloudExtensions)
{
...
QString QgsPdalProvider::providerKey()
{
	return TEXT_PROVIDER_KEY;
}

QString QgsPdalProvider::providerDescription()
{
	return TEXT_PROVIDER_DESCRIPTION;
}

/*QgsPdalProvider *QgsPdalProvider::createProvider(const QString &uri, const ProviderOptions &options)
{
	return new QgsPdalProvider(geom, uri, options);
}*/

void QgsPdalProvider::setattribute()
{
	if (m_geom)
	{
...
QgsAbstractFeatureSource *QgsPdalProvider::featureSource() const
{
	return new QgsPdalFeatureSource(this);
}

QString QgsPdalProvider::dataSourceUri(bool expandAuthConfig) const
{
	return QgsDataProvider::dataSourceUri();
}

QString QgsPdalProvider::storageType() const
{
	return QStringLiteral("Memory storage");
}

QgsFeatureIterator QgsPdalProvider::getFeatures(const QgsFeatureRequest &request) const
{
	return QgsFeatureIterator(new QgsPdalFeatureIterator(new QgsPdalFeatureSource(this), true, request));
}
...
QgsWkbTypes::Type QgsPdalProvider::wkbType() const
{
	return QgsWkbTypes::Type::MultiPointZ;
}

long QgsPdalProvider::featureCount() const
{
	
	return m_geom->pointCount();
}

QgsFields QgsPdalProvider::fields() const
{
	return mFields;
}
...
bool QgsPdalProvider::addAttributes(const QList<QgsField> &attributes)
{
...
bool QgsPdalProvider::renameAttributes(const QgsFieldNameMap &renamedAttributes)
{
...
bool QgsPdalProvider::deleteAttributes(const QgsAttributeIds &attributes)
{
...
bool QgsPdalProvider::changeAttributeValues(const QgsChangedAttributesMap &attr_map)
{
	/*
...
bool QgsPdalProvider::changeGeometryValues(const QgsGeometryMap &geometry_map)
{
	/*
...
QString QgsPdalProvider::subsetString() const
{
	return mSubsetString;
}

bool QgsPdalProvider::setSubsetString(const QString &theSQL, bool updateFeatureCount)
{
...
bool QgsPdalProvider::createSpatialIndex()
{

	return false;
}

QgsFeatureSource::SpatialIndexPresence QgsPdalProvider::hasSpatialIndex() const
{
	return SpatialIndexNotPresent;
}

QgsVectorDataProvider::Capabilities QgsPdalProvider::capabilities() const
{
...
void QgsPdalProvider::updateExtents()
{
	//mExtent.setMinimal();
}
...
*/
/*
QGISEXTERN QgsPdalProvider *classFactory(const QString *uri, const QgsDataProvider::ProviderOptions &options)
{
	return new QgsPdalProvider(*uri, options);
}
*/
/**
...
/*
QgsPdalFeatureSource::QgsPdalFeatureSource(const QgsPdalProvider * p)
{
...
* /
QgsPdalFeatureSource::~QgsPdalFeatureSource()
{
}
/*
QgsFeatureIterator QgsPdalFeatureSource::getFeatures(const QgsFeatureRequest & request)
{
...
*/
 ...
 QgsPdalProvider *QgsPdalProviderMetadata::createProvider(const QString &uri, const QgsDataProvider::ProviderOptions &options)
 {
	 return new QgsPdalProvider(uri, options);
 }
 ...
 QString QgsPdalProviderMetadata::filters(FilterType type)
 {
