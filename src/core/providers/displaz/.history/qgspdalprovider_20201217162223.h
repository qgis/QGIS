...
class QgsDisplazProvider :public QgsVectorDataProvider//public QgsDataProvider, public QgsFeatureSink, public QgsFeatureSource
{
	Q_OBJECT
...
public:
	...
	QgsDisplazProvider *createProvider(const QString &uri, const QgsDataProvider::ProviderOptions &options) override;
