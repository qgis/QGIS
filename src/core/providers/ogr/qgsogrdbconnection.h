...
class CORE_EXPORT QgsOgrDbConnection : public QObject
{
  ...
  public:
    static const inline QgsSettingsEntryString *settingsOgrConnectionPath = new QgsSettingsEntryString( QStringLiteral( "providers/ogr/%1/connections/%2/path" ), QString(), QString() );
    static const inline QgsSettingsEntryString *settingsOgrConnectionSelected = new QgsSettingsEntryString( QStringLiteral( "providers/ogr/%1/connections/selected" ), QString() );
