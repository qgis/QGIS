...
{
  if ( properties.isActive( static_cast< int >( QgsPalLayerSettings::Property::ShadowDraw ) ) )
  {
    context.expressionContext().setOriginalValueVariable( d->enabled );
    d->enabled = properties.valueAsBool( static_cast< int >( QgsPalLayerSettings::Property::ShadowDraw ), context.expressionContext(), d->enabled );
  }

  // data defined shadow under type?
  QVariant exprVal = properties.value( static_cast< int >( QgsPalLayerSettings::Property::ShadowUnder ), context.expressionContext() );
  ...
  if ( properties.isActive( static_cast< int >( QgsPalLayerSettings::Property::ShadowOffsetAngle ) ) )
  {
    context.expressionContext().setOriginalValueVariable( d->offsetAngle );
    d->offsetAngle = properties.valueAsInt( static_cast< int >( QgsPalLayerSettings::Property::ShadowOffsetAngle ), context.expressionContext(), d->offsetAngle );
  }
  if ( properties.isActive( static_cast< int >( QgsPalLayerSettings::Property::ShadowOffsetDist ) ) )
  {
    context.expressionContext().setOriginalValueVariable( d->offsetDist );
    d->offsetDist = properties.valueAsDouble( static_cast< int >( QgsPalLayerSettings::Property::ShadowOffsetDist ), context.expressionContext(), d->offsetDist );
  }

  exprVal = properties.value( static_cast< int >( QgsPalLayerSettings::Property::ShadowOffsetUnits ), context.expressionContext() );
  if ( !QgsVariantUtils::isNull( exprVal ) )
  {
  ...
  if ( properties.isActive( static_cast< int >( QgsPalLayerSettings::Property::ShadowRadius ) ) )
  {
    context.expressionContext().setOriginalValueVariable( d->radius );
    d->radius = properties.valueAsDouble( static_cast< int >( QgsPalLayerSettings::Property::ShadowRadius ), context.expressionContext(), d->radius );
  }

  exprVal = properties.value( static_cast< int >( QgsPalLayerSettings::Property::ShadowRadiusUnits ), context.expressionContext() );
  if ( !QgsVariantUtils::isNull( exprVal ) )
  {
    const QString units = exprVal.toString();
    if ( !units.isEmpty() )
  ...
  if ( properties.isActive( static_cast< int >( QgsPalLayerSettings::Property::ShadowOpacity ) ) )
  {
    context.expressionContext().setOriginalValueVariable( d->opacity * 100 );
    const QVariant val = properties.value( static_cast< int >( QgsPalLayerSettings::Property::ShadowOpacity ), context.expressionContext(), d->opacity * 100 );
  ...
  if ( properties.isActive( static_cast< int >( QgsPalLayerSettings::Property::ShadowScale ) ) )
  {
    context.expressionContext().setOriginalValueVariable( d->scale );
    d->scale = properties.valueAsInt( static_cast< int >( QgsPalLayerSettings::Property::ShadowScale ), context.expressionContext(), d->scale );
  }

  if ( properties.isActive( static_cast< int >( QgsPalLayerSettings::Property::ShadowColor ) ) )
  {
    context.expressionContext().setOriginalValueVariable( QgsSymbolLayerUtils::encodeColor( d->color ) );
    d->color = properties.valueAsColor( static_cast< int >( QgsPalLayerSettings::Property::ShadowColor ), context.expressionContext(), d->color );
  }

  if ( properties.isActive( static_cast< int >( QgsPalLayerSettings::Property::ShadowBlendMode ) ) )
  {
    exprVal = properties.value( static_cast< int >( QgsPalLayerSettings::Property::ShadowBlendMode ), context.expressionContext() );
