...
class CORE_EXPORT QgsFontManager : public QObject
{
  ...
  public:
    ...
    static const inline QgsSettingsEntryStringList *settingsFontFamilyReplacements = new QgsSettingsEntryStringList( QStringLiteral( "fontFamilyReplacements" ), QgsSettings::sTreeFonts, QStringList(), QStringLiteral( "Automatic font family replacements" ) );

    //! Settings entry for font family replacements
    static const inline QgsSettingsEntryBool *settingsDownloadMissingFonts = new QgsSettingsEntryBool( QStringLiteral( "downloadMissingFonts" ), QgsSettings::sTreeFonts, true, QStringLiteral( "Automatically download missing fonts whenever possible" ) );
#endif
