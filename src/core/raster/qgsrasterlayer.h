...
class CORE_EXPORT QgsRasterLayer : public QgsMapLayer
{
  ...
  protected:
    ...
    bool readSymbology( const QDomNode &node, QString &errorMessage, const QgsPathResolver &pathResolver ) override;
    ...
    bool readXml( const QDomNode &layer_node, const QgsPathResolver &pathResolver ) override;

    //! \brief Write the symbology for the layer into the docment provided
    bool writeSymbology( QDomNode &, QDomDocument &doc, QString &errorMessage, const QgsPathResolver &pathResolver ) const override;
    ...
    bool writeXml( QDomNode &layer_node, QDomDocument &doc, const QgsPathResolver &pathResolver ) const override;
