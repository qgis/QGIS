...
class CORE_EXPORT QgsSnappingConfig
{
  ...
  public:
    ...
    class CORE_EXPORT IndividualLayerSettings
    {
      public:
         ...
         */
        Q_DECL_DEPRECATED IndividualLayerSettings( bool enabled, SnappingType type, double tolerance, Qgis::MapUnitType units ) SIP_DEPRECATED;
         ...
         * \since QGIS 3.12
         */
        IndividualLayerSettings( bool enabled, Qgis::SnappingTypes type, double tolerance, Qgis::MapUnitType units, double minScale = 0.0, double maxScale = 0.0 );
        ...
        */
        ...
        Qgis::MapUnitType units() const;

        //! Sets the type of units
        void setUnits( Qgis::MapUnitType units );
      ...
      private:
        ...
        double mTolerance = 0;
        Qgis::MapUnitType mUnits = Qgis::MapUnitType::Pixels;
  ...
  private:
    ...
    double mMinimumScale = 0.0;
    double mMaximumScale = 0.0;
    Qgis::MapUnitType mUnits = Qgis::MapUnitType::Project;
