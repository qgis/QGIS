  ...
  for ( const QVariant &layer : layers )
  {
    ...
    if ( layerType.compare( QLatin1String( "raster" ), Qt::CaseInsensitive ) == 0 )
    {
      ...
      if ( jsonPaint.contains( QStringLiteral( "raster-opacity" ) ) )
      {
        ...
        raster.dataDefinedProperties().setProperty( static_cast< int >( QgsRasterPipe::Property::RendererOpacity ), parseInterpolateByZoom( jsonRasterOpacity.toMap(), *context, 100, &defaultOpacity ) );
      }
...
bool QgsMapBoxGlStyleConverter::parseFillLayer( const QVariantMap &jsonLayer, QgsVectorTileBasicRendererStyle &style, QgsMapBoxGlStyleConversionContext &context, bool isBackgroundStyle )
{
  ...
  if ( jsonPaint.contains( isBackgroundStyle ? QStringLiteral( "background-color" ) : QStringLiteral( "fill-color" ) ) )
  {
    ...
    {
      case QVariant::Map:
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::FillColor ), parseInterpolateColorByZoom( jsonFillColor.toMap(), context, &fillColor ) );
        break;

      case QVariant::List:
      case QVariant::StringList:
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::FillColor ), parseValueList( jsonFillColor.toList(), PropertyType::Color, context, 1, 255, &fillColor ) );
        break;
  ...
  if ( !isBackgroundStyle )
  {
    if ( !jsonPaint.contains( QStringLiteral( "fill-outline-color" ) ) )
    {
      ...
      if ( ddProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::FillColor ) ) )
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ),  ddProperties.property( static_cast< int >( QgsSymbolLayer::Property::FillColor ) ) );
    }
    else
    {
      ...
      {
        case QVariant::Map:
          ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ), parseInterpolateColorByZoom( jsonFillOutlineColor.toMap(), context, &fillOutlineColor ) );
          break;

        case QVariant::List:
        case QVariant::StringList:
          ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ), parseValueList( jsonFillOutlineColor.toList(), PropertyType::Color, context, 1, 255, &fillOutlineColor ) );
          break;
  ...
  if ( jsonPaint.contains( isBackgroundStyle ? QStringLiteral( "background-opacity" ) : QStringLiteral( "fill-opacity" ) ) )
  {
    ...
    switch ( jsonFillOpacity.type() )
    {
      ...
      case QVariant::Map:
        ...
        {
          ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::FillColor ), parseInterpolateOpacityByZoom( jsonFillOpacity.toMap(), fillColor.isValid() ? fillColor.alpha() : 255, &context ) );
          ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ), parseInterpolateOpacityByZoom( jsonFillOpacity.toMap(), fillOutlineColor.isValid() ? fillOutlineColor.alpha() : 255, &context ) );
          ddRasterProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::Opacity ), parseInterpolateByZoom( jsonFillOpacity.toMap(), context, 100, &rasterOpacity ) );
        }
        break;
      ...
      case QVariant::StringList:
        ...
        {
          ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::FillColor ), parseValueList( jsonFillOpacity.toList(), PropertyType::Opacity, context, 1, fillColor.isValid() ? fillColor.alpha() : 255 ) );
          ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ), parseValueList( jsonFillOpacity.toList(), PropertyType::Opacity, context, 1, fillOutlineColor.isValid() ? fillOutlineColor.alpha() : 255 ) );
          ddRasterProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::Opacity ), parseValueList( jsonFillOpacity.toList(), PropertyType::Numeric, context, 100, 255, nullptr, &rasterOpacity ) );
        }
        break;
  ...
  if ( jsonPaint.contains( QStringLiteral( "fill-translate" ) ) )
  {
    ...
    switch ( jsonFillTranslate.type() )
    {
      ...
      case QVariant::Map:
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::Offset ), parseInterpolatePointByZoom( jsonFillTranslate.toMap(), context, context.pixelSizeConversionFactor(), &fillTranslate ) );
        break;
  ...
  if ( jsonPaint.contains( isBackgroundStyle ? QStringLiteral( "background-pattern" ) : QStringLiteral( "fill-pattern" ) ) )
  {
    ...
    if ( !sprite.isEmpty() )
    {
      ...
      {
        ddRasterProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::File ), QgsProperty::fromExpression( spriteProperty ) );
        ddRasterProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::Width ), QgsProperty::fromExpression( spriteSizeProperty ) );
      }
...
bool QgsMapBoxGlStyleConverter::parseLineLayer( const QVariantMap &jsonLayer, QgsVectorTileBasicRendererStyle &style, QgsMapBoxGlStyleConversionContext &context )
{
  ...
  if ( jsonPaint.contains( QStringLiteral( "line-pattern" ) ) )
  {
    ...
    switch ( jsonLinePattern.type() )
    {
      ...
      case QVariant::String:
      {
        ...
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::File ), QgsProperty::fromExpression( spriteProperty ) );
        break;
      }
  ...
  if ( jsonPaint.contains( QStringLiteral( "line-color" ) ) )
  {
    ...
    {
      case QVariant::Map:
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::FillColor ), parseInterpolateColorByZoom( jsonLineColor.toMap(), context, &lineColor ) );
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ), ddProperties.property( static_cast< int >( QgsSymbolLayer::Property::FillColor ) ) );
        break;

      case QVariant::List:
      case QVariant::StringList:
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::FillColor ), parseValueList( jsonLineColor.toList(), PropertyType::Color, context, 1, 255, &lineColor ) );
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ), ddProperties.property( static_cast< int >( QgsSymbolLayer::Property::FillColor ) ) );
        break;
  ...
  if ( jsonPaint.contains( QStringLiteral( "line-width" ) ) )
  {
    ...
    switch ( jsonLineWidth.type() )
    {
      ...
      case QVariant::Map:
        ...
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::StrokeWidth ), lineWidthProperty );
        break;
  ...
  if ( jsonPaint.contains( QStringLiteral( "line-offset" ) ) )
  {
    ...
    switch ( jsonLineOffset.type() )
    {
      ...
      case QVariant::Map:
        lineWidth = -1;
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::Offset ), parseInterpolateByZoom( jsonLineOffset.toMap(), context, context.pixelSizeConversionFactor() * -1, &lineOffset ) );
        break;

      case QVariant::List:
      case QVariant::StringList:
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::Offset ), parseValueList( jsonLineOffset.toList(), PropertyType::Numeric, context, context.pixelSizeConversionFactor() * -1, 255, nullptr, &lineOffset ) );
        break;
  ...
  if ( jsonPaint.contains( QStringLiteral( "line-opacity" ) ) )
  {
    ...
    switch ( jsonLineOpacity.type() )
    {
      ...
      case QVariant::Map:
        if ( ddProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ) ) )
        {
        ...
        {
          ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ), parseInterpolateOpacityByZoom( jsonLineOpacity.toMap(), lineColor.isValid() ? lineColor.alpha() : 255, &context ) );
        }
        break;
      ...
      case QVariant::StringList:
        ...
        {
          ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ), parseValueList( jsonLineOpacity.toList(), PropertyType::Opacity, context, 1, lineColor.isValid() ? lineColor.alpha() : 255 ) );
        }
        break;
  ...
  if ( jsonPaint.contains( QStringLiteral( "line-dasharray" ) ) )
  {
    ...
    switch ( jsonLineDashArray.type() )
    {
      case QVariant::Map:
      {
        ...
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::CustomDash ), QgsProperty::fromExpression( arrayExpression ) );
...
bool QgsMapBoxGlStyleConverter::parseCircleLayer( const QVariantMap &jsonLayer, QgsVectorTileBasicRendererStyle &style, QgsMapBoxGlStyleConversionContext &context )
{
  ...
  if ( jsonPaint.contains( QStringLiteral( "circle-color" ) ) )
  {
    ...
    {
      case QVariant::Map:
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::FillColor ), parseInterpolateColorByZoom( jsonCircleColor.toMap(), context, &circleFillColor ) );
        break;

      case QVariant::List:
      case QVariant::StringList:
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::FillColor ), parseValueList( jsonCircleColor.toList(), PropertyType::Color, context, 1, 255, &circleFillColor ) );
        break;
  ...
  if ( jsonPaint.contains( QStringLiteral( "circle-radius" ) ) )
  {
    ...
    switch ( jsonCircleRadius.type() )
    {
      ...
      case QVariant::Map:
        circleDiameter = -1;
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::Width ), parseInterpolateByZoom( jsonCircleRadius.toMap(), context, context.pixelSizeConversionFactor() * 2, &circleDiameter ) );
        break;

      case QVariant::List:
      case QVariant::StringList:
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::Width ), parseValueList( jsonCircleRadius.toList(), PropertyType::Numeric, context, context.pixelSizeConversionFactor() * 2, 255, nullptr, &circleDiameter ) );
        break;
  ...
  if ( jsonPaint.contains( QStringLiteral( "circle-opacity" ) ) )
  {
    ...
    switch ( jsonCircleOpacity.type() )
    {
      ...
      case QVariant::Map:
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::FillColor ), parseInterpolateOpacityByZoom( jsonCircleOpacity.toMap(), circleFillColor.isValid() ? circleFillColor.alpha() : 255, &context ) );
        break;

      case QVariant::List:
      case QVariant::StringList:
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::FillColor ), parseValueList( jsonCircleOpacity.toList(), PropertyType::Opacity, context, 1, circleFillColor.isValid() ? circleFillColor.alpha() : 255 ) );
        break;
  ...
  if ( jsonPaint.contains( QStringLiteral( "circle-stroke-color" ) ) )
  {
    ...
    {
      case QVariant::Map:
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ), parseInterpolateColorByZoom( jsonCircleStrokeColor.toMap(), context, &circleStrokeColor ) );
        break;

      case QVariant::List:
      case QVariant::StringList:
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ), parseValueList( jsonCircleStrokeColor.toList(), PropertyType::Color, context, 1, 255, &circleStrokeColor ) );
        break;
  ...
  if ( jsonPaint.contains( QStringLiteral( "circle-stroke-width" ) ) )
  {
    ...
    switch ( circleStrokeWidthJson.type() )
    {
      ...
      case QVariant::Map:
        ...
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::StrokeWidth ), parseInterpolateByZoom( circleStrokeWidthJson.toMap(), context, context.pixelSizeConversionFactor(), &circleStrokeWidth ) );
        break;

      case QVariant::List:
      case QVariant::StringList:
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::StrokeWidth ), parseValueList( circleStrokeWidthJson.toList(), PropertyType::Numeric, context, context.pixelSizeConversionFactor(), 255, nullptr, &circleStrokeWidth ) );
        break;
  ...
  if ( jsonPaint.contains( QStringLiteral( "circle-stroke-opacity" ) ) )
  {
    ...
    switch ( jsonCircleStrokeOpacity.type() )
    {
      ...
      case QVariant::Map:
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ), parseInterpolateOpacityByZoom( jsonCircleStrokeOpacity.toMap(), circleStrokeColor.isValid() ? circleStrokeColor.alpha() : 255, &context ) );
        break;

      case QVariant::List:
      case QVariant::StringList:
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ), parseValueList( jsonCircleStrokeOpacity.toList(), PropertyType::Opacity, context, 1, circleStrokeColor.isValid() ? circleStrokeColor.alpha() : 255 ) );
        break;
  ...
  if ( jsonPaint.contains( QStringLiteral( "circle-translate" ) ) )
  {
    ...
    switch ( jsonCircleTranslate.type() )
    {
      ...
      case QVariant::Map:
        ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::Offset ), parseInterpolatePointByZoom( jsonCircleTranslate.toMap(), context, context.pixelSizeConversionFactor(), &circleTranslate ) );
        break;
...
void QgsMapBoxGlStyleConverter::parseSymbolLayer( const QVariantMap &jsonLayer, QgsVectorTileBasicRendererStyle &renderer, bool &hasRenderer, QgsVectorTileBasicLabelingStyle &labelingStyle, bool &hasLabeling, QgsMapBoxGlStyleConversionContext &context )
{
  ...
  if ( jsonLayout.contains( QStringLiteral( "text-size" ) ) )
  {
    ...
    if ( textSizeProperty )
    {
      ddLabelProperties.setProperty( static_cast< int >( QgsPalLayerSettings::Property::Size ), textSizeProperty );
    }
  }
  ...
  if ( jsonLayout.contains( QStringLiteral( "text-max-width" ) ) )
  {
    ...
    switch ( jsonTextMaxWidth.type() )
    {
      ...
      case QVariant::Map:
        ddLabelProperties.setProperty( static_cast< int >( QgsPalLayerSettings::Property::AutoWrapLength ), parseInterpolateByZoom( jsonTextMaxWidth.toMap(), context, EM_TO_CHARS, &textMaxWidth ) );
        break;

      case QVariant::List:
      case QVariant::StringList:
        ddLabelProperties.setProperty( static_cast< int >( QgsPalLayerSettings::Property::AutoWrapLength ), parseValueList( jsonTextMaxWidth.toList(), PropertyType::Numeric, context, EM_TO_CHARS, 255, nullptr, &textMaxWidth ) );
        break;
  ...
  if ( jsonLayout.contains( QStringLiteral( "text-letter-spacing" ) ) )
  {
    ...
    switch ( jsonTextLetterSpacing.type() )
    {
      ...
      case QVariant::Map:
        ddLabelProperties.setProperty( static_cast< int >( QgsPalLayerSettings::Property::FontLetterSpacing ), parseInterpolateByZoom( jsonTextLetterSpacing.toMap(), context, 1, &textLetterSpacing ) );
        break;

      case QVariant::List:
      case QVariant::StringList:
        ddLabelProperties.setProperty( static_cast< int >( QgsPalLayerSettings::Property::FontLetterSpacing ), parseValueList( jsonTextLetterSpacing.toList(), PropertyType::Numeric, context, 1, 255, nullptr, &textLetterSpacing ) );
        break;
    ...
    else
    {
      switch ( jsonTextFont.type() )
      {
        ...
        case QVariant::Map:
        {
          ...
          ddLabelProperties.setProperty( static_cast< int >( QgsPalLayerSettings::Property::Family ), QgsProperty::fromExpression( familyCaseString ) );
          ddLabelProperties.setProperty( static_cast< int >( QgsPalLayerSettings::Property::FontStyle ), QgsProperty::fromExpression( styleCaseString ) );
  ...
  if ( jsonPaint.contains( QStringLiteral( "text-color" ) ) )
  {
    ...
    {
      case QVariant::Map:
        ddLabelProperties.setProperty( static_cast< int >( QgsPalLayerSettings::Property::Color ), parseInterpolateColorByZoom( jsonTextColor.toMap(), context, &textColor ) );
        break;

      case QVariant::List:
      case QVariant::StringList:
        ddLabelProperties.setProperty( static_cast< int >( QgsPalLayerSettings::Property::Color ), parseValueList( jsonTextColor.toList(), PropertyType::Color, context, 1, 255, &textColor ) );
        break;
  ...
  if ( jsonPaint.contains( QStringLiteral( "text-halo-color" ) ) )
  {
    ...
    {
      case QVariant::Map:
        ddLabelProperties.setProperty( static_cast< int >( QgsPalLayerSettings::Property::BufferColor ), parseInterpolateColorByZoom( jsonBufferColor.toMap(), context, &bufferColor ) );
        break;

      case QVariant::List:
      case QVariant::StringList:
        ddLabelProperties.setProperty( static_cast< int >( QgsPalLayerSettings::Property::BufferColor ), parseValueList( jsonBufferColor.toList(), PropertyType::Color, context, 1, 255, &bufferColor ) );
        break;
  ...
  if ( jsonPaint.contains( QStringLiteral( "text-halo-width" ) ) )
  {
    ...
    switch ( jsonHaloWidth.type() )
    {
      ...
      case QVariant::Map:
        bufferSize = 1;
        ddLabelProperties.setProperty( static_cast< int >( QgsPalLayerSettings::Property::BufferSize ), parseInterpolateByZoom( jsonHaloWidth.toMap(), context, context.pixelSizeConversionFactor() * BUFFER_SIZE_SCALE, &bufferSize ) );
        break;

      case QVariant::List:
      case QVariant::StringList:
        bufferSize = 1;
        ddLabelProperties.setProperty( static_cast< int >( QgsPalLayerSettings::Property::BufferSize ), parseValueList( jsonHaloWidth.toList(), PropertyType::Numeric, context, context.pixelSizeConversionFactor() * BUFFER_SIZE_SCALE, 255, nullptr, &bufferSize ) );
        break;
        ...
        if ( jsonLayout.contains( QStringLiteral( "text-offset" ) ) )
        {
          ...
          switch ( jsonTextOffset.type() )
          {
            case QVariant::Map:
              ...
              if ( !textSizeProperty )
              {
                ddLabelProperties.setProperty( static_cast< int >( QgsPalLayerSettings::Property::LabelDistance ), QStringLiteral( "abs(array_get(%1,1))-%2" ).arg( textOffsetProperty ).arg( textSize ) );
              }
              else
              {
                ddLabelProperties.setProperty( static_cast< int >( QgsPalLayerSettings::Property::LabelDistance ), QStringLiteral( "with_variable('text_size',%2,abs(array_get(%1,1))*@text_size-@text_size)" ).arg( textOffsetProperty.asExpression(), textSizeProperty.asExpression() ) );
              }
              ddLabelProperties.setProperty( static_cast< int >( QgsPalLayerSettings::Property::LinePlacementOptions ), QStringLiteral( "if(array_get(%1,1)>0,'BL','AL')" ).arg( textOffsetProperty ) );
              break;
          ...
          if ( !textOffset.isNull() )
          {
            ...
            {
              ddLabelProperties.setProperty( static_cast< int >( QgsPalLayerSettings::Property::LabelDistance ), QStringLiteral( "with_variable('text_size',%2,%1*@text_size-@text_size)" ).arg( std::abs( textOffset.y() / textSize ) ).arg( textSizeProperty.asExpression() ) );
            }
          }
        }
  ...
  if ( jsonLayout.contains( QStringLiteral( "text-justify" ) ) )
  {
    ...
    switch ( jsonTextJustify.type() )
    {
      ...
      case QVariant::List:
        ddLabelProperties.setProperty( static_cast< int >( QgsPalLayerSettings::Property::OffsetQuad ), QgsProperty::fromExpression( parseStringStops( jsonTextJustify.toList(), context, conversionMap, &textAlign ) ) );
        break;

      case QVariant::Map:
        ddLabelProperties.setProperty( static_cast< int >( QgsPalLayerSettings::Property::OffsetQuad ), parseInterpolateStringByZoom( jsonTextJustify.toMap(), context, conversionMap, &textAlign ) );
        break;
  ...
  if ( labelSettings.placement == Qgis::LabelPlacement::OverPoint )
  {
    if ( jsonLayout.contains( QStringLiteral( "text-anchor" ) ) )
    {
      ...
      switch ( jsonTextAnchor.type() )
      {
        ...
        case QVariant::List:
          ddLabelProperties.setProperty( static_cast< int >( QgsPalLayerSettings::Property::OffsetQuad ), QgsProperty::fromExpression( parseStringStops( jsonTextAnchor.toList(), context, conversionMap, &textAnchor ) ) );
          break;

        case QVariant::Map:
          ddLabelProperties.setProperty( static_cast< int >( QgsPalLayerSettings::Property::OffsetQuad ), parseInterpolateStringByZoom( jsonTextAnchor.toMap(), context, conversionMap, &textAnchor ) );
          break;
    ...
    if ( jsonLayout.contains( QStringLiteral( "text-offset" ) ) )
    {
      ...
      {
        case QVariant::Map:
          ddLabelProperties.setProperty( static_cast< int >( QgsPalLayerSettings::Property::OffsetXY ), parseInterpolatePointByZoom( jsonTextOffset.toMap(), context, textSize, &textOffset ) );
          break;
       ...
       ( labelSettings.placement == Qgis::LabelPlacement::Horizontal || labelSettings.placement == Qgis::LabelPlacement::Curved ) )
  {
    ...
    if ( !sprite.isEmpty() )
    {
      ...
      if ( !spriteProperty.isEmpty() )
      {
        ...
        markerDdProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::Name ), QgsProperty::fromExpression( spriteProperty ) );
        markerLayer->setDataDefinedProperties( markerDdProperties );

        ddLabelProperties.setProperty( static_cast< int >( QgsPalLayerSettings::Property::ShapeSizeX ), QgsProperty::fromExpression( spriteSizeProperty ) );
      }
  ...
  if ( jsonLayout.value( QStringLiteral( "symbol-placement" ) ).toString() == QLatin1String( "line" ) && !jsonLayout.contains( QStringLiteral( "text-field" ) ) )
  {
    ...
    if ( jsonLayout.contains( QStringLiteral( "symbol-spacing" ) ) )
    {
      ...
      switch ( jsonSpacing.type() )
      {
        ...
        case QVariant::Map:
          ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::Interval ), parseInterpolateByZoom( jsonSpacing.toMap(), context, context.pixelSizeConversionFactor(), &spacing ) );
          break;

        case QVariant::List:
        case QVariant::StringList:
          ddProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::Interval ), parseValueList( jsonSpacing.toList(), PropertyType::Numeric, context, context.pixelSizeConversionFactor(), 255, nullptr, &spacing ) );
          break;
    ...
    if ( jsonLayout.contains( QStringLiteral( "icon-rotate" ) ) )
    {
      ...
      switch ( jsonIconRotate.type() )
      {
        ...
        case QVariant::Map:
          markerDdProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::Angle ), parseInterpolateByZoom( jsonIconRotate.toMap(), context, context.pixelSizeConversionFactor(), &rotation ) );
          break;

        case QVariant::List:
        case QVariant::StringList:
          markerDdProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::Angle ), parseValueList( jsonIconRotate.toList(), PropertyType::Numeric, context, context.pixelSizeConversionFactor(), 255, nullptr, &rotation ) );
          break;
    ...
    if ( !sprite.isNull() )
    {
      ...
      {
        markerDdProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::Name ), QgsProperty::fromExpression( spriteProperty ) );
        markerDdProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::Width ), QgsProperty::fromExpression( spriteSizeProperty ) );
      }
    }
    ...
    if ( jsonLayout.contains( QStringLiteral( "icon-size" ) ) )
    {
      ...
      switch ( jsonIconSize.type() )
      {
        ...
        case QVariant::Double:
        {
          ...
          {
            markerDdProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::Width ),
    ...
    if ( !sprite.isEmpty() )
    {
      ...
      if ( jsonPaint.contains( QStringLiteral( "icon-opacity" ) ) )
      {
        ...
        switch ( jsonIconOpacity.type() )
        {
          ...
          case QVariant::Map:
            markerDdProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::Opacity ), parseInterpolateByZoom( jsonIconOpacity.toMap(), context, 100, &iconOpacity ) );
            break;

          case QVariant::List:
          case QVariant::StringList:
            markerDdProperties.setProperty( static_cast< int >( QgsSymbolLayer::Property::Opacity ), parseValueList( jsonIconOpacity.toList(), PropertyType::Numeric, context, 100, 255, nullptr, &iconOpacity ) );
            break;
