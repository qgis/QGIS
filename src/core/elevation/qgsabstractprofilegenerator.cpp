...
const QTransform &QgsProfileRenderContext::worldTransform() const { return mWorldTransform; }

void QgsProfileRenderContext::setWorldTransform( const QTransform &transform ) { mWorldTransform = transform; }

QgsDoubleRange QgsProfileRenderContext::distanceRange() const { return mDistanceRange; }

void QgsProfileRenderContext::setDistanceRange( const QgsDoubleRange &range ) { mDistanceRange = range; }

QgsDoubleRange QgsProfileRenderContext::elevationRange() const { return mElevationRange; }

void QgsProfileRenderContext::setElevationRange( const QgsDoubleRange &range ) { mElevationRange = range; }
...
QVector< QgsAbstractProfileResults::Feature > QgsAbstractProfileResults::asFeatures( Qgis::ProfileExportType, QgsFeedback * ) const { return {}; }

QgsProfileSnapResult QgsAbstractProfileResults::snapPoint( const QgsProfilePoint &, const QgsProfileSnapContext & ) { return QgsProfileSnapResult(); }

QVector<QgsProfileIdentifyResults> QgsAbstractProfileResults::identify( const QgsProfilePoint &, const QgsProfileIdentifyContext & ) { return {}; }

QVector<QgsProfileIdentifyResults> QgsAbstractProfileResults::identify( const QgsDoubleRange &, const QgsDoubleRange &, const QgsProfileIdentifyContext & ) { return {}; }
...
bool QgsProfileGenerationContext::operator!=( const QgsProfileGenerationContext &other ) const { return !( *this == other ); }

Qgis::ProfileGeneratorFlags QgsAbstractProfileGenerator::flags() const { return Qgis::ProfileGeneratorFlags(); }
