...
class CORE_EXPORT QgsProcessingFeedback : public QgsFeedback
{
  ...
  public:
     ...
     * \since QGIS 3.14
     */
    [[nodiscard]] virtual QString htmlLog() const;
     ...
     * \since QGIS 3.14
     */
    [[nodiscard]] virtual QString textLog() const;
...
class CORE_EXPORT QgsProcessingMultiStepFeedback : public QgsProcessingFeedback
{
  ...
  public:
    ...
    [[nodiscard]] QString htmlLog() const override;
    [[nodiscard]] QString textLog() const override;
  private slots:
