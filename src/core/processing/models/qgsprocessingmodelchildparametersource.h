...
class CORE_EXPORT QgsProcessingModelChildParameterSource
{
  public:
     ...
     */
    [[nodiscard]] Qgis::ProcessingModelChildParameterSource source() const;
     ...
     * \see setStaticValue()
     */
    [[nodiscard]] QVariant staticValue() const { return mStaticValue; }
     ...
     * \see outputName()
     */
    [[nodiscard]] QString outputChildId() const { return mChildId; }
     ...
     * \see outputChildId()
     */
    [[nodiscard]] QString outputName() const { return mOutputName; }
     ...
     * \see setExpression()
     */
    [[nodiscard]] QString expression() const { return mExpression; }
     ...
     * \since QGIS 3.2
     */
    [[nodiscard]] QString expressionText() const { return mExpressionText; }
