...
#include "qgscolorramplegendnode.h"
  ...
  public:
    ...
    */
    ...
    % MethodCode
        QString str
      = QStringLiteral( "<QgsLayerTreeModelLegendNode: \"%1\">" ).arg( sipCpp->data( Qt::DisplayRole ).toString() );
...
class CORE_EXPORT QgsSymbolLegendNode : public QgsLayerTreeModelLegendNode
{
  ...
  public:
    ...
    % MethodCode
        QString str
      = QStringLiteral( "<QgsSymbolLegendNode: %1 \"%2\"" ).arg( sipCpp->data( static_cast<int>( QgsLayerTreeModelLegendNode::CustomRole::RuleKey ) ).toString(), sipCpp->data( Qt::DisplayRole ).toString() );
    sipRes = PyUnicode_FromString( str.toUtf8().constData() );
    % End
#endif
...
class CORE_EXPORT QgsSimpleLegendNode : public QgsLayerTreeModelLegendNode
{
  ...
  public:
    ...
    % MethodCode
        QString str
      = QStringLiteral( "<QgsSimpleLegendNode: \"%1\">" ).arg( sipCpp->data( Qt::DisplayRole ).toString() );
    sipRes = PyUnicode_FromString( str.toUtf8().constData() );
    % End
#endif
...
class CORE_EXPORT QgsImageLegendNode : public QgsLayerTreeModelLegendNode
{
  ...
  public:
    ...
    % MethodCode
        QString str
      = QStringLiteral( "<QgsImageLegendNode: \"%1\">" ).arg( sipCpp->data( Qt::DisplayRole ).toString() );
    sipRes = PyUnicode_FromString( str.toUtf8().constData() );
    % End
#endif
...
class CORE_EXPORT QgsRasterSymbolLegendNode : public QgsLayerTreeModelLegendNode
{
  ...
  public:
    ...
    % MethodCode
        QString str
      = QStringLiteral( "<QgsRasterSymbolLegendNode: \"%1\">" ).arg( sipCpp->data( Qt::DisplayRole ).toString() );
    sipRes = PyUnicode_FromString( str.toUtf8().constData() );
    % End
#endif
...
class CORE_EXPORT QgsWmsLegendNode : public QgsLayerTreeModelLegendNode
{
  ...
  public:
    ...
    % MethodCode
        QString str
      = QStringLiteral( "<QgsWmsLegendNode: \"%1\">" ).arg( sipCpp->data( Qt::DisplayRole ).toString() );
    sipRes = PyUnicode_FromString( str.toUtf8().constData() );
    % End
#endif
      ...
      void
      getLegendGraphicFinished( const QImage & );
...
class CORE_EXPORT QgsDataDefinedSizeLegendNode : public QgsLayerTreeModelLegendNode
{
  ...
  public:
    ...
    % MethodCode
        QString str
      = QStringLiteral( "<QgsDataDefinedSizeLegendNode: \"%1\">" ).arg( sipCpp->data( Qt::DisplayRole ).toString() );
    sipRes = PyUnicode_FromString( str.toUtf8().constData() );
    % End
#endif
...
class CORE_EXPORT QgsVectorLabelLegendNode : public QgsLayerTreeModelLegendNode
{
  ...
  public:
    ...
    % MethodCode
        QString str
      = QStringLiteral( "<QgsVectorLabelLegendNode: \"%1\">" ).arg( sipCpp->data( Qt::DisplayRole ).toString() );
    sipRes = PyUnicode_FromString( str.toUtf8().constData() );
    % End
#endif
