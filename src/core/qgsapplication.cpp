...
const char *QgsApplication::QGIS_ORGANIZATION_NAME = "MilSvy";
const char *QgsApplication::QGIS_ORGANIZATION_DOMAIN = "surveykshak.org";
const char *QgsApplication::QGIS_APPLICATION_NAME = "SURVEYKSHAK3_30";
