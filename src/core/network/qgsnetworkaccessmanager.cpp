...
const QgsSettingsEntryString *QgsNetworkAccessManager::settingsProxyType = new QgsSettingsEntryString( u"proxy-type"_s, QgsSettingsTree::sTreeProxy, u"DefaultProxy"_s, u"Proxy type"_s );
