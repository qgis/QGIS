...
class CORE_EXPORT QgsNetworkAccessManager : public QNetworkAccessManager
{
  ...
  public:
    ...
    static const inline QgsSettingsEntryInteger *settingsNetworkTimeout = new QgsSettingsEntryInteger( QStringLiteral( "network-timeout" ), QgsSettings::sTreeNetwork, 60000, QObject::tr( "Network timeout" ) );
#endif
