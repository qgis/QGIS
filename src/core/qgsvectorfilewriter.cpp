...
namespace
{
  struct ArcInfoCoverageMetaData: public QgsVectorFileWriter::MetaData
  {
    ArcInfoCoverageMetaData(): MetaData( QT_TR_NOOP( "Arc/Info ASCII Coverage" ), "e00" )
    {}
  };

  struct BNAMetaData: public QgsVectorFileWriter::MetaData
  {
    BNAMetaData(): MetaData( QT_TR_NOOP( "Atlas BNA" ), "bna" )
    {
      driverOptions.insert( "LINEFORMAT", new QgsVectorFileWriter::SetOption(
      ...
      driverOptions.insert( "MULTILINE", new QgsVectorFileWriter::BoolOption(
      ...
      driverOptions.insert( "NB_IDS", new QgsVectorFileWriter::SetOption(
                              ...
                              QStringList() << "2" << "3" << "4" << "NB_SOURCE_FIELDS",
                              "2" // Default value
                            ) );

      driverOptions.insert( "ELLIPSES_AS_ELLIPSES", new QgsVectorFileWriter::BoolOption(
      ...
      driverOptions.insert( "NB_PAIRS_PER_LINE", new QgsVectorFileWriter::IntOption(
                              QObject::tr( "Limit the number of coordinate pairs per line in multiline format." ),
                              2 // Default value
                            ) );

      driverOptions.insert( "COORDINATE_PRECISION", new QgsVectorFileWriter::IntOption(
  ...
  struct CSVMetaData: public QgsVectorFileWriter::MetaData
  {
    CSVMetaData(): MetaData( QT_TR_NOOP( "Comma Separated Value [CSV]" ), "csv" )
    {
      layerOptions.insert( "LINEFORMAT", new QgsVectorFileWriter::SetOption(
      ...
      layerOptions.insert( "GEOMETRY", new QgsVectorFileWriter::SetOption(
                             QObject::tr( "By default, the geometry of a feature written to a .csv file is discarded. "
                                          ...
                                          "or GEOMETRY=AS_YX." ),
                             QStringList() << "AS_WKT" << "AS_XYZ" << "AS_XY" << "AS_YX",
                             "AS_XY", // Default value
                             true // Allow None
                           ) );

      layerOptions.insert( "CREATE_CSVT", new QgsVectorFileWriter::BoolOption(
      ...
      layerOptions.insert( "SEPARATOR", new QgsVectorFileWriter::SetOption(
                             QObject::tr( "Field separator character." ),
                             QStringList() << "COMMA" << "SEMICOLON" << "TAB",
                             "COMMA" // Default value
                           ) );

      layerOptions.insert( "WRITE_BOM", new QgsVectorFileWriter::BoolOption(
  ...
  struct ShapefileMetaData: public QgsVectorFileWriter::MetaData
  {
    ShapefileMetaData(): MetaData( QT_TR_NOOP( "ESRI Shapefile" ), "shp" )
    {
      layerOptions.insert( "SHPT", new QgsVectorFileWriter::SetOption(
                             ...
                             QStringList() << "NULL" << "POINT" << "ARC" << "POLYGON" << "MULTIPOINT"
      ...
      layerOptions.insert( "RESIZE", new QgsVectorFileWriter::BoolOption(
  ...
  struct DBFMetaData: public QgsVectorFileWriter::MetaData
  {
    DBFMetaData(): MetaData( QT_TR_NOOP( "DBF File" ), "dbf" )
    {

    }
  };

  struct FMEMetaData: public QgsVectorFileWriter::MetaData
  {
    FMEMetaData(): MetaData( QT_TR_NOOP( "FMEObjects Gateway" ), "fdd" )
    {}
  };

  struct GeoJSONMetaData: public QgsVectorFileWriter::MetaData
  {
    GeoJSONMetaData(): MetaData( QT_TR_NOOP( "GeoJSON" ), "geojson" )
    {
      compulsoryEncoding = "UTF-8";
      layerOptions.insert( "WRITE_BBOX", new QgsVectorFileWriter::BoolOption(
      ...
      layerOptions.insert( "COORDINATE_PRECISION", new QgsVectorFileWriter::IntOption(
  ...
  struct GeoRSSMetaData: public QgsVectorFileWriter::MetaData
  {
    GeoRSSMetaData(): MetaData( QT_TR_NOOP( "GeoRSS" ), "xml" )
    {
      compulsoryEncoding = "UTF-8";
      driverOptions.insert( "FORMAT", new QgsVectorFileWriter::SetOption(
                              QObject::tr( "whether the document must be in RSS 2.0 or Atom 1.0 format. "
                                           "Default value : RSS" ),
                              QStringList() << "RSS" << "ATOM",
                              "RSS" // Default value
                            ) );

      driverOptions.insert( "GEOM_DIALECT", new QgsVectorFileWriter::SetOption(
                              ...
                              QStringList() << "SIMPLE" << "GML" << "W3C_GEO",
                              "SIMPLE" // Default value
                            ) );

      driverOptions.insert( "USE_EXTENSIONS", new QgsVectorFileWriter::BoolOption(
      ...
      driverOptions.insert( "WRITE_HEADER_AND_FOOTER", new QgsVectorFileWriter::BoolOption(
      ...
      driverOptions.insert( "HEADER", new QgsVectorFileWriter::StringOption(
      ...
      driverOptions.insert( "TITLE", new QgsVectorFileWriter::StringOption(
      ...
      driverOptions.insert( "DESCRIPTION", new QgsVectorFileWriter::StringOption(
                              QObject::tr( "Value put inside the <description> element in the header. "
                                           "If not provided, a dummy value will be used as that element is compulsory." ),
                              ""  // Default value
                            ) );

      driverOptions.insert( "LINK", new QgsVectorFileWriter::StringOption(
                              QObject::tr( "Value put inside the <link> element in the header. "
                                           "If not provided, a dummy value will be used as that element is compulsory." ),
                              ""  // Default value
                            ) );

      driverOptions.insert( "UPDATED", new QgsVectorFileWriter::StringOption(
      ...
      driverOptions.insert( "AUTHOR_NAME", new QgsVectorFileWriter::StringOption(
                              QObject::tr( "Value put inside the <author><name> element in the header. "
                                           "If not provided, a dummy value will be used as that element is compulsory." ),
                              ""  // Default value
                            ) );

      driverOptions.insert( "ID", new QgsVectorFileWriter::StringOption(
  ...
  struct GMLMetaData: public QgsVectorFileWriter::MetaData
  {
    GMLMetaData(): MetaData( QT_TR_NOOP( "Geography Markup Language [GML]" ), "gml" )
    {
      compulsoryEncoding = "UTF-8";
      driverOptions.insert( "XSISCHEMAURI", new QgsVectorFileWriter::StringOption(
      ...
      driverOptions.insert( "XSISCHEMA", new QgsVectorFileWriter::SetOption(
                              ...
                              QStringList() << "EXTERNAL" << "INTERNAL" << "OFF",
                              "EXTERNAL" // Default value
                            ) );

      driverOptions.insert( "PREFIX", new QgsVectorFileWriter::StringOption(
                              QObject::tr( "This is the prefix for the application target namespace." ),
                              "ogr"  // Default value
                            ) );

      driverOptions.insert( "STRIP_PREFIX", new QgsVectorFileWriter::BoolOption(
                              QObject::tr( "Can be set to TRUE to avoid writing the prefix of the "
                                           "application target namespace in the GML file." ),
                              false  // Default value
                            ) );

      driverOptions.insert( "TARGET_NAMESPACE", new QgsVectorFileWriter::StringOption(
      ...
      driverOptions.insert( "FORMAT", new QgsVectorFileWriter::SetOption(
                              ...
                              QStringList() << "GML3" << "GML3Deegree" << "GML3.2",
                              "", // Default value
                              true // Allow None
                            ) );

      driverOptions.insert( "GML3_LONGSRS", new QgsVectorFileWriter::BoolOption(
      ...
      driverOptions.insert( "WRITE_FEATURE_BOUNDED_BY", new QgsVectorFileWriter::BoolOption(
                              QObject::tr( "only valid when FORMAT=GML3/GML3Degree/GML3.2) Default to YES. "
      ...
      driverOptions.insert( "SPACE_INDENTATION", new QgsVectorFileWriter::BoolOption(
  ...
  struct GeoPackageMetaData: public QgsVectorFileWriter::MetaData
  {
    GeoPackageMetaData(): MetaData( QT_TR_NOOP( "GeoPackage" ), "gpkp" )
    {
      compulsoryEncoding = "UTF-8";
      layerOptions.insert( "IDENTIFIER", new QgsVectorFileWriter::StringOption(
                             QObject::tr( "Human-readable identifier (e.g. short name) for the layer content" ),
                             ""  // Default value
                           ) );

      layerOptions.insert( "DESCRIPTION", new QgsVectorFileWriter::StringOption(
                             QObject::tr( "Human-readable description for the layer content" ),
                             ""  // Default value
                           ) );

      layerOptions.insert( "FID", new QgsVectorFileWriter::StringOption(
                             QObject::tr( "Name for the feature identifier column" ),
                             "fid"  // Default value
                           ) );

      layerOptions.insert( "GEOMETRY_NAME", new QgsVectorFileWriter::StringOption(
                             QObject::tr( "Name for the geometry column" ),
                             "geometry"  // Default value
                           ) );

#if defined(GDAL_COMPUTE_VERSION) && GDAL_VERSION_NUM >= GDAL_COMPUTE_VERSION(2,0,0)
      layerOptions.insert( "SPATIAL_INDEX", new QgsVectorFileWriter::BoolOption(
  ...
  struct GMTMetaData: public QgsVectorFileWriter::MetaData
  {
    GMTMetaData(): MetaData( QT_TR_NOOP( "Generic Mapping Tools [GMT]" ), "gmt" )
    {}
  };

  struct GPXMetaData: public QgsVectorFileWriter::MetaData
  {
    GPXMetaData(): MetaData( QT_TR_NOOP( "GPS eXchange Format [GPX]" ), "gpx" )
    {
      compulsoryEncoding = "UTF-8";
      layerOptions.insert( "FORCE_GPX_TRACK", new QgsVectorFileWriter::BoolOption(
      ...
      layerOptions.insert( "FORCE_GPX_ROUTE", new QgsVectorFileWriter::BoolOption(
                             QObject::tr( "By default when writing a layer whose features are of "
      ...
      driverOptions.insert( "GPX_USE_EXTENSIONS", new QgsVectorFileWriter::BoolOption(
                              QObject::tr( "If GPX_USE_EXTENSIONS=YES is specified, "
                                           "extra fields will be written inside the <extensions> tag." ),
                              true  // Default value
                            ) );

      driverOptions.insert( "GPX_EXTENSIONS_NS", new QgsVectorFileWriter::StringOption(
      ...
      driverOptions.insert( "GPX_EXTENSIONS_NS_URL", new QgsVectorFileWriter::StringOption(
  ...
  struct Interlis1MetaData: public QgsVectorFileWriter::MetaData
  {
    Interlis1MetaData(): MetaData( QT_TR_NOOP( "INTERLIS 1" ), "ili" )
    {
      glob = "*.itf *.xml *.ili";
    }
  };

  struct Interlis2MetaData: public QgsVectorFileWriter::MetaData
  {
    Interlis2MetaData(): MetaData( QT_TR_NOOP( "INTERLIS 2" ), "ili" )
    {
      glob = "*.itf *.xml *.ili";
    }
  };

  struct KMLMetaData: public QgsVectorFileWriter::MetaData
  {
    KMLMetaData(): MetaData( QT_TR_NOOP( "Keyhole Markup Language [KML]" ), "kml" )
    {
      compulsoryEncoding = "UTF-8";
      driverOptions.insert( "NameField", new QgsVectorFileWriter::StringOption(
                              QObject::tr( "Allows you to specify the field to use for the KML <name> element. " ),
                              "Name"  // Default value
                            ) );

      driverOptions.insert( "DescriptionField", new QgsVectorFileWriter::StringOption(
                              QObject::tr( "Allows you to specify the field to use for the KML <description> element." ),
                              "Description"  // Default value
                            ) );

      driverOptions.insert( "AltitudeMode", new QgsVectorFileWriter::SetOption(
                              ...
                              QStringList() << "clampToGround" << "relativeToGround" << "absolute",
  ...
  struct MapInfoFileMetaData: public QgsVectorFileWriter::MetaData
  {
    MapInfoFileMetaData(): MetaData( QT_TR_NOOP( "Mapinfo TAB" ), "tab" )
    {
      layerOptions.insert( "SPATIAL_INDEX_MODE", new QgsVectorFileWriter::SetOption(
  ...
  struct MapInfoMIFMetaData: public QgsVectorFileWriter::MetaData
  {
    MapInfoMIFMetaData(): MetaData( QT_TR_NOOP( "Mapinfo MIF" ), "mif" )
    {
      layerOptions.insert( "SPATIAL_INDEX_MODE", new QgsVectorFileWriter::SetOption(
                             QObject::tr( "Use this to turn on 'quick spatial index mode'. "
                                          "In this mode writing files can be about 5 times faster, "
  ...
  struct DGNMetaData: public QgsVectorFileWriter::MetaData
  {
    DGNMetaData(): MetaData( QT_TR_NOOP( "Microstation DGN" ), "dgn" )
    {
      driverOptions.insert( "3D", new QgsVectorFileWriter::BoolOption(
  ...
  struct S57MetaData: public QgsVectorFileWriter::MetaData
  {
    S57MetaData(): MetaData( QT_TR_NOOP( "S-57 Base file" ), "000" )
    {
      driverOptions.insert( "UPDATES", new QgsVectorFileWriter::SetOption(
                              QObject::tr( "Should update files be incorporated into the base data on the fly. " ),
                              QStringList() << "APPLY" << "IGNORE",
                              "APPLY" // Default value
                            ) );

      driverOptions.insert( "SPLIT_MULTIPOINT", new QgsVectorFileWriter::BoolOption(
      ...
      driverOptions.insert( "ADD_SOUNDG_DEPTH", new QgsVectorFileWriter::BoolOption(
      ...
      driverOptions.insert( "RETURN_PRIMITIVES", new QgsVectorFileWriter::BoolOption(
      ...
      driverOptions.insert( "PRESERVE_EMPTY_NUMBERS", new QgsVectorFileWriter::BoolOption(
      ...
      driverOptions.insert( "LNAM_REFS", new QgsVectorFileWriter::BoolOption(
      ...
      driverOptions.insert( "RETURN_LINKAGES", new QgsVectorFileWriter::BoolOption(
      ...
      driverOptions.insert( "RECODE_BY_DSSI", new QgsVectorFileWriter::BoolOption(
  ...
  struct SDTSMetaData: public QgsVectorFileWriter::MetaData
  {
    SDTSMetaData(): MetaData( QT_TR_NOOP( "Spatial Data Transfer Standard [SDTS]" ), "ddf" )
    {
      glob = "*catd.ddf";
    }
  };

  struct SQLiteMetaData: public QgsVectorFileWriter::MetaData
  {
    SQLiteMetaData(): MetaData( QT_TR_NOOP( "SQLite" ), "sqlite" )
    {
      compulsoryEncoding = "UTF-8";
      driverOptions.insert( "METADATA", new QgsVectorFileWriter::BoolOption(
      ...
      driverOptions.insert( "SPATIALITE", new QgsVectorFileWriter::HiddenOption(
                              "NO"
                            ) );


      driverOptions.insert( "INIT_WITH_EPSG", new QgsVectorFileWriter::HiddenOption(
                              "NO"
                            ) );

      layerOptions.insert( "FORMAT", new QgsVectorFileWriter::SetOption(
      ...
      layerOptions.insert( "LAUNDER", new QgsVectorFileWriter::BoolOption(
      ...
      layerOptions.insert( "SPATIAL_INDEX", new QgsVectorFileWriter::HiddenOption(
                             "NO"
                           ) );

      layerOptions.insert( "COMPRESS_GEOM", new QgsVectorFileWriter::HiddenOption(
                             "NO"
                           ) );

      layerOptions.insert( "SRID", new QgsVectorFileWriter::HiddenOption(
                             ""
                           ) );

      layerOptions.insert( "COMPRESS_COLUMNS", new QgsVectorFileWriter::StringOption(
  ...
  struct SpatiaLiteMetaData: public QgsVectorFileWriter::MetaData
  {
    SpatiaLiteMetaData(): MetaData( QT_TR_NOOP( "SpatiaLite" ), "sqlite" )
    {
      compulsoryEncoding = "UTF-8";
      driverOptions.insert( "METADATA", new QgsVectorFileWriter::BoolOption(
                              QObject::tr( "Can be used to avoid creating the geometry_columns and spatial_ref_sys "
      ...
      driverOptions.insert( "INIT_WITH_EPSG", new QgsVectorFileWriter::BoolOption(
                              QObject::tr( "Insert the content of the EPSG CSV files into the spatial_ref_sys table. "
                                           "Set to NO for regular SQLite databases." ),
                              true  // Default value
                            ) );

      layerOptions.insert( "FORMAT", new QgsVectorFileWriter::HiddenOption(
                             "SPATIALITE"
                           ) );
      ...
      layerOptions.insert( "COMPRESS_GEOM", new QgsVectorFileWriter::BoolOption(
      ...
      layerOptions.insert( "SRID", new QgsVectorFileWriter::StringOption(
  ...
  struct DXFMetaData: public QgsVectorFileWriter::MetaData
  {
    DXFMetaData(): MetaData( QT_TR_NOOP( "AutoCAD DXF" ), "dxf" )
    {
#if 0
      driverOptions.insert( "HEADER", new QgsVectorFileWriter::StringOption(
      ...
      driverOptions.insert( "TRAILER", new QgsVectorFileWriter::StringOption(
  ...
  struct GeoconceptMetaData: public QgsVectorFileWriter::MetaData
  {
    GeoconceptMetaData(): MetaData( QT_TR_NOOP( "Geoconcept" ), "gxt" )
    {
      glob = "*.gxt *.txt";
      driverOptions.insert( "EXTENSION", new QgsVectorFileWriter::SetOption(
...
#if 0
      driverOptions.insert( "CONFIG", new QgsVectorFileWriter::StringOption(
  ...
  struct FileGDBMetaData: public QgsVectorFileWriter::MetaData
  {
    FileGDBMetaData(): MetaData( QT_TR_NOOP( "ESRI FileGDB" ), "gdb" )
    {
      compulsoryEncoding = "UTF-8";
      layerOptions.insert( "FEATURE_DATASET", new QgsVectorFileWriter::StringOption(
      ...
      layerOptions.insert( "OID_NAME", new QgsVectorFileWriter::StringOption(
  ...
  struct XSLXMetaData: public QgsVectorFileWriter::MetaData
  {
    XSLXMetaData(): MetaData( QT_TR_NOOP( "MS Office Open XML spreadsheet" ), "xslx" )
    {
      compulsoryEncoding = "UTF-8";
      layerOptions.insert( "OGR_XLSX_FIELD_TYPES", new QgsVectorFileWriter::SetOption(
  ...
  struct ODSMetaData: public QgsVectorFileWriter::MetaData
  {
    ODSMetaData(): MetaData( QT_TR_NOOP( "Open Document Spreadsheet" ), "ods" )
    {
      compulsoryEncoding = "UTF-8";
      layerOptions.insert( "OGR_ODS_FIELD_TYPES", new QgsVectorFileWriter::SetOption(
                             QObject::tr( "By default, the driver will try to detect the data type of fields. If set "
                                          "to STRING, all fields will be of String type." ),
                             QStringList() << "AUTO" << "STRING",
                             "AUTO", // Default value
...
const QMap<QString, QgsVectorFileWriter::MetaData> QgsVectorFileWriter::initMetaData()
{
  ...
  driverMetadata.insert( "AVCE00", ArcInfoCoverageMetaData() );
  driverMetadata.insert( "BNA", BNAMetaData() );
  driverMetadata.insert( "CSV", CSVMetaData() );
  driverMetadata.insert( "ESRI", ShapefileMetaData() );
  driverMetadata.insert( "DBF File", DBFMetaData() );
  driverMetadata.insert( "FMEObjects Gateway", FMEMetaData() );
  driverMetadata.insert( "GeoJSON", GeoJSONMetaData() );
  driverMetadata.insert( "GeoRSS", GeoRSSMetaData() );
  driverMetadata.insert( "GML", GMLMetaData() );
  driverMetadata.insert( "GPKG", GeoPackageMetaData() );
  driverMetadata.insert( "GMT", GMTMetaData() );
  driverMetadata.insert( "GPX", GPXMetaData() );
  driverMetadata.insert( "Interlis 1", Interlis1MetaData() );
  driverMetadata.insert( "Interlis 2", Interlis2MetaData() );
  driverMetadata.insert( "KML", KMLMetaData() );
  driverMetadata.insert( "MapInfo File", MapInfoFileMetaData() );
  driverMetadata.insert( "MapInfo MIF", MapInfoMIFMetaData() );
  driverMetadata.insert( "DGN", DGNMetaData() );
  driverMetadata.insert( "S57", S57MetaData() );
  driverMetadata.insert( "SDTS", SDTSMetaData() );
  driverMetadata.insert( "SQLite", SQLiteMetaData() );
  driverMetadata.insert( "SpatiaLite", SpatiaLiteMetaData() );
  driverMetadata.insert( "DXF", DXFMetaData() );
  driverMetadata.insert( "Geoconcept", GeoconceptMetaData() );
  driverMetadata.insert( "FileGDB", FileGDBMetaData() );
  driverMetadata.insert( "XLSX", XSLXMetaData() );
  driverMetadata.insert( "ODS", ODSMetaData() );
