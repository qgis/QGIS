...
class CORE_EXPORT QgsAbstractSensor : public QObject
{
  ...
  public:
     ...
     */
    [[nodiscard]] virtual QString type() const { return QString(); }
     ...
     */
    [[nodiscard]] Qgis::DeviceConnectionStatus status() const;
     ...
     */
    [[nodiscard]] QgsAbstractSensor::SensorData data() const;
