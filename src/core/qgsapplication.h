...
class CORE_EXPORT QgsApplication : public QApplication
{
  ...
  public:
    ...
    */
    ...
    /**
     * Register gdal drivers, excluding the ones mentionned in "gdal/skipList" setting.
     * \since QGIS 3.10
     */
     ...
     * \since QGIS 3.10
     */
    static QStringList deferredSkippedGdalDrivers() { return mDeferredSkippedGdalDrivers; }
  ...
  private:
     ...
     * and thus, for safety, should not be disabled right now, but at the
     * next application restart */
    static QStringList mDeferredSkippedGdalDrivers;
