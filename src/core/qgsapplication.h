...
// clang-format on
   ...
   * will be added to the stylesheet on load.
   ...
   * or "external" (for external CLI scripts).
   * \see osName()
   */
   ...
   * point cloud layer 2D renderers.
   * \since QGIS 3.18
   */
   ...
   * tiled scene layer 2D renderers.
   * \since QGIS 3.34
   */
  ...
  /**
   * Sets the list of projects and folders that have been temporarily determined
   * as trusted by the user.
   *
   * \since QGIS 4.0
   */
  static void setTemporarilyTrustedProjectsFolders(
