...
{
  QString levelStr = QMetaEnum::fromType<Qgis::MessageLevel>().valueToKey( static_cast<int>( level ) );
  QgsDebugMsg( QStringLiteral( "%1 %2[%3] %4" ).arg( QDateTime::currentDateTime().toString( Qt::ISODate ), tag ).arg( levelStr ).arg( message ) );
