                                            ...
                                            const QString &fieldOrExpression, QgsExpressionContext *context, bool *ok, QgsFeedback *feedback ) const
{
  ...
  request.setFlags( expressionNeedsGeometry ? Qgis::FeatureRequestFlag::NoFlags : Qgis::FeatureRequestFlag::NoGeometry )
...
QList<QgsAggregateCalculator::AggregateInfo> QgsAggregateCalculator::aggregates()
{
  ...
  aggregates
    ...
    << AggregateInfo { QStringLiteral( "count_distinct" ), QCoreApplication::tr( "Count Distinct" ), QSet<QMetaType::Type>() << QMetaType::Type::QDateTime << QMetaType::Type::QDate << QMetaType::Type::UInt << QMetaType::Type::Int << QMetaType::Type::LongLong << QMetaType::Type::ULongLong << QMetaType::Type::QString } << AggregateInfo { QStringLiteral( "count_missing" ), QCoreApplication::tr( "Count Missing" ), QSet<QMetaType::Type>() << QMetaType::Type::QDateTime << QMetaType::Type::QDate << QMetaType::Type::Int << QMetaType::Type::UInt << QMetaType::Type::LongLong << QMetaType::Type::QString } << AggregateInfo { QStringLiteral( "min" ), QCoreApplication::tr( "Min" ), QSet<QMetaType::Type>() << QMetaType::Type::QDateTime << QMetaType::Type::QDate << QMetaType::Type::Int << QMetaType::Type::UInt << QMetaType::Type::LongLong << QMetaType::Type::ULongLong << QMetaType::Type::Double << QMetaType::Type::QString } << AggregateInfo { QStringLiteral( "max" ), QCoreApplication::tr( "Max" ), QSet<QMetaType::Type>() << QMetaType::Type::QDateTime << QMetaType::Type::QDate << QMetaType::Type::Int << QMetaType::Type::UInt << QMetaType::Type::LongLong << QMetaType::Type::ULongLong << QMetaType::Type::Double << QMetaType::Type::QString } << AggregateInfo { QStringLiteral( "sum" ), QCoreApplication::tr( "Sum" ), QSet<QMetaType::Type>() << QMetaType::Type::Int << QMetaType::Type::UInt << QMetaType::Type::LongLong << QMetaType::Type::ULongLong << QMetaType::Type::Double } << AggregateInfo { QStringLiteral( "mean" ), QCoreApplication::tr( "Mean" ), QSet<QMetaType::Type>() << QMetaType::Type::Int << QMetaType::Type::UInt << QMetaType::Type::LongLong << QMetaType::Type::ULongLong << QMetaType::Type::Double } << AggregateInfo { QStringLiteral( "median" ), QCoreApplication::tr( "Median" ), QSet<QMetaType::Type>() << QMetaType::Type::Int << QMetaType::Type::UInt << QMetaType::Type::Double } << AggregateInfo { QStringLiteral( "stdev" ), QCoreApplication::tr( "Stdev" ), QSet<QMetaType::Type>() << QMetaType::Type::Int << QMetaType::Type::UInt << QMetaType::Type::LongLong << QMetaType::Type::ULongLong << QMetaType::Type::Double } << AggregateInfo { QStringLiteral( "stdevsample" ), QCoreApplication::tr( "Stdev Sample" ), QSet<QMetaType::Type>() << QMetaType::Type::Int << QMetaType::Type::UInt << QMetaType::Type::LongLong << QMetaType::Type::ULongLong << QMetaType::Type::Double } << AggregateInfo { QStringLiteral( "range" ), QCoreApplication::tr( "Range" ), QSet<QMetaType::Type>() << QMetaType::Type::QDate << QMetaType::Type::QDateTime << QMetaType::Type::Int << QMetaType::Type::UInt << QMetaType::Type::LongLong << QMetaType::Type::ULongLong << QMetaType::Type::Double } << AggregateInfo { QStringLiteral( "minority" ), QCoreApplication::tr( "Minority" ), QSet<QMetaType::Type>() << QMetaType::Type::Int << QMetaType::Type::UInt << QMetaType::Type::LongLong << QMetaType::Type::ULongLong << QMetaType::Type::Double << QMetaType::Type::QString } << AggregateInfo { QStringLiteral( "majority" ), QCoreApplication::tr( "Majority" ), QSet<QMetaType::Type>() << QMetaType::Type::Int << QMetaType::Type::UInt << QMetaType::Type::LongLong << QMetaType::Type::ULongLong << QMetaType::Type::Double << QMetaType::Type::QString } << AggregateInfo { QStringLiteral( "q1" ), QCoreApplication::tr( "Q1" ), QSet<QMetaType::Type>() << QMetaType::Type::Int << QMetaType::Type::UInt << QMetaType::Type::LongLong << QMetaType::Type::ULongLong << QMetaType::Type::Double } << AggregateInfo { QStringLiteral( "q3" ), QCoreApplication::tr( "Q3" ), QSet<QMetaType::Type>() << QMetaType::Type::Int << QMetaType::Type::UInt << QMetaType::Type::LongLong << QMetaType::Type::ULongLong << QMetaType::Type::Double } << AggregateInfo { QStringLiteral( "iqr" ), QCoreApplication::tr( "InterQuartileRange" ), QSet<QMetaType::Type>() << QMetaType::Type::Int << QMetaType::Type::UInt << QMetaType::Type::LongLong << QMetaType::Type::ULongLong << QMetaType::Type::Double } << AggregateInfo { QStringLiteral( "min_length" ), QCoreApplication::tr( "Min Length" ), QSet<QMetaType::Type>() << QMetaType::Type::QString } << AggregateInfo { QStringLiteral( "max_length" ), QCoreApplication::tr( "Max Length" ), QSet<QMetaType::Type>() << QMetaType::Type::QString } << AggregateInfo { QStringLiteral( "concatenate" ), QCoreApplication::tr( "Concatenate" ), QSet<QMetaType::Type>() << QMetaType::Type::QString } << AggregateInfo { QStringLiteral( "collect" ), QCoreApplication::tr( "Collect" ), QSet<QMetaType::Type>() } << AggregateInfo { QStringLiteral( "array_agg" ), QCoreApplication::tr( "Array Aggregate" ), QSet<QMetaType::Type>() };
                                            ...
                                            int attr, QgsExpression *expression, const QString &delimiter, QgsExpressionContext *context, bool *ok, QString *error )
{
  ...
  switch ( resultType )
  {
    ...
    case QMetaType::Type::QDateTime:
    {
      ...
      {
        if ( error )
          *error = ( expression ? QObject::tr( "Cannot calculate %1 on %2 values" ).arg( displayName( aggregate ) ) : QObject::tr( "Cannot calculate %1 on %2 fields" ).arg( displayName( aggregate ) ) ).arg( resultType == QMetaType::Type::QDate ? QObject::tr( "date" ) : QObject::tr( "datetime" ) );
        return QVariant();
      }
