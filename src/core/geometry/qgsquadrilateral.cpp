...
bool QgsQuadrilateral::equals( const QgsQuadrilateral &other, double epsilon ) const
{
  ...
  return ( ( equalPoint( mPoint1, other.mPoint1, epsilon ) ) && ( equalPoint( mPoint2, other.mPoint2, epsilon ) ) && ( equalPoint( mPoint3, other.mPoint3, epsilon ) ) && ( equalPoint( mPoint4, other.mPoint4, epsilon ) ) );
}
...
{
  const bool isCollinear = ( ( QgsGeometryUtils::segmentSide( p1, p2, p3 ) == 0 ) || ( QgsGeometryUtils::segmentSide( p1, p2, p4 ) == 0 ) || ( QgsGeometryUtils::segmentSide( p1, p3, p4 ) == 0 ) || ( QgsGeometryUtils::segmentSide( p2, p3, p4 ) == 0 ) );
...
{
  const bool doublePoints = ( ( p1 == p2 ) || ( p1 == p3 ) || ( p1 == p4 ) || ( p2 == p3 ) || ( p2 == p4 ) || ( p3 == p4 ) );
...
{
  return (
    haveSameType( p1, p2, p3, p4 ) && notHaveDoublePoints( p1, p2, p3, p4 ) && isNotAntiParallelogram( p1, p2, p3, p4 ) && isNotCollinear( p1, p2, p3, p4 ) );
}
