...
class CORE_EXPORT QgsGeometryUtils
{
  public:
     ...
     * \since QGIS 4.0
     */
    static bool has3DPlane( const QgsAbstractGeometry *geom, QgsPoint &pt1 SIP_OUT, QgsPoint &pt2 SIP_OUT, QgsPoint &pt3 SIP_OUT, double epsilon = std::numeric_limits<double>::epsilon() );
