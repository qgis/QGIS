 ...
 *
 * The methods are available directly via QgsGeometry::[geometryfunction]
...
class QgsInternalGeometryEngine
{
  public:
    /**
     * You are responsible that the geometry is available for the whole lifetime of this object.
     * @param geometry
     */
