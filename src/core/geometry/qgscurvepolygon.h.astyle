...
class CORE_EXPORT QgsCurvePolygon: public QgsSurface
{
  public:
    ...
    virtual QgsCurvePolygon *newSameGeometry() const override SIP_FACTORY;
    ...
    virtual QgsCurvePolygon *asGridified( double hSpacing, double vSpacing, double dSpacing = 0, double mSpacing = 0,
