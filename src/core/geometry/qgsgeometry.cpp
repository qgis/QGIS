...
QgsGeometry::OperationResult QgsGeometry::addRing( const QList<QgsPoint> &ring )
{
  detach( true );
...
QgsGeometry::OperationResult QgsGeometry::addPart( const QList<QgsPoint> &points, QgsWkbTypes::GeometryType geomType )
{
  QgsPointSequence l;
