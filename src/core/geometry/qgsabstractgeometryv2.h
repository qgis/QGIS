...
class CORE_EXPORT QgsAbstractGeometryV2
{
  public:
     ...
     * the z coordinates in the geometry represent height in metres relative to the
     * source ellipsoid. If false, then z coordinates will not be changed by the transform.
     */
