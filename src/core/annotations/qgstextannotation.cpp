...
void QgsTextAnnotation::writeXml( QDomElement &elem, QDomDocument &doc, const QgsPathResolver &pathResolver ) const
{
  ...
  _writeXml( annotationElem, doc, pathResolver );
  elem.appendChild( annotationElem );
}

void QgsTextAnnotation::readXml( const QDomElement &itemElem, const QDomDocument &doc, const QgsPathResolver &pathResolver )
{
