...
#ifndef QGSPOINTCLOUDEXPRESSIONUTILS_H
#define QGSPOINTCLOUDEXPRESSIONUTILS_H
...
/**
 * \ingroup core
 * \class QgsPointcloudExpressionUtils
 * \brief A set of expression-related functions
 * \since QGIS 3.22
 */

class CORE_EXPORT QgsPointcloudExpressionUtils
{
  public:
/// @cond PRIVATE
///////////////////////////////////////////////
...
// this handles also NULL values
    static TVL getTVLValue( const QVariant &value, QgsPointcloudExpression *parent )
    {
...
// implicit conversion to string
    static QString getStringValue( const QVariant &value, QgsPointcloudExpression * )
    {
     ...
     * \since QGIS 3.12
     */
    static QByteArray getBinaryValue( const QVariant &value, QgsPointcloudExpression *parent )
    {
    ...
    static double getDoubleValue( const QVariant &value, QgsPointcloudExpression *parent )
    {
      bool ok;
      const double x = value.toDouble( &ok );
    ...
    static qlonglong getIntValue( const QVariant &value, QgsPointcloudExpression *parent )
    {
      bool ok;
    ...
    static int getNativeIntValue( const QVariant &value, QgsPointcloudExpression *parent )
    {
      bool ok;
      const qlonglong x = value.toLongLong( &ok );
    ...
    static QDateTime getDateTimeValue( const QVariant &value, QgsPointcloudExpression *parent )
    {
    ...
    static QDate getDateValue( const QVariant &value, QgsPointcloudExpression *parent )
    {
    ...
    static QTime getTimeValue( const QVariant &value, QgsPointcloudExpression *parent )
    {
    ...
    static QgsInterval getInterval( const QVariant &value, QgsPointcloudExpression *parent, bool report_error = false )
    {
    ...
    static QgsGradientColorRamp getRamp( const QVariant &value, QgsPointcloudExpression *parent, bool report_error = false );

    static QgsGeometry getGeometry( const QVariant &value, QgsPointcloudExpression *parent )
    {
      if ( value.canConvert<QgsGeometry>() )
    ...
    static QgsFeature getFeature( const QVariant &value, QgsPointcloudExpression *parent )
    {
    ...
    static QgsPointcloudExpressionNode *getNode( const QVariant &value, QgsPointcloudExpression *parent )
    {
      if ( value.canConvert<QgsPointcloudExpressionNode *>() )
        return value.value<QgsPointcloudExpressionNode *>();

      parent->setEvalErrorString( QStringLiteral( "Cannot convert to node" ) );
      return nullptr;
    }

    static QgsMapLayer *getMapLayer( const QVariant &value, QgsPointcloudExpression * )
    {
    ...
    static std::unique_ptr<QgsVectorLayerFeatureSource> getFeatureSource( const QVariant &value, QgsPointcloudExpression *e )
    {
    ...
    static QgsVectorLayer *getVectorLayer( const QVariant &value, QgsPointcloudExpression *e )
    {
      return qobject_cast<QgsVectorLayer *>( getMapLayer( value, e ) );
    }

    static QgsRasterLayer *getRasterLayer( const QVariant &value, QgsPointcloudExpression *e )
    {
      return qobject_cast<QgsRasterLayer *>( getMapLayer( value, e ) );
    }

    static QgsMeshLayer *getMeshLayer( const QVariant &value, QgsPointcloudExpression *e )
    {
      return qobject_cast<QgsMeshLayer *>( getMapLayer( value, e ) );
    }

    static QVariantList getListValue( const QVariant &value, QgsPointcloudExpression *parent )
    {
    ...
    static QVariantMap getMapValue( const QVariant &value, QgsPointcloudExpression *parent )
    {
...
#endif // QGSPOINTCLOUDEXPRESSIONUTILS_H
