...
void QgsEllipseSymbolLayer::renderPoint( QPointF point, QgsSymbolRenderContext &context )
{
  ...
  bool ok;
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::StrokeWidth ) ) )
  {
    context.setOriginalValueVariable( mStrokeWidth );
    const QVariant exprVal = mDataDefinedProperties.value( static_cast< int >( QgsSymbolLayer::Property::StrokeWidth ), context.renderContext().expressionContext() );
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::StrokeStyle ) ) )
  {
    context.setOriginalValueVariable( QgsSymbolLayerUtils::encodePenStyle( mStrokeStyle ) );
    const QVariant exprVal = mDataDefinedProperties.value( static_cast< int >( QgsSymbolLayer::Property::StrokeStyle ), context.renderContext().expressionContext() );
    if ( !QgsVariantUtils::isNull( exprVal ) )
    {
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::JoinStyle ) ) )
  {
    context.setOriginalValueVariable( QgsSymbolLayerUtils::encodePenJoinStyle( mPenJoinStyle ) );
    const QVariant exprVal = mDataDefinedProperties.value( static_cast< int >( QgsSymbolLayer::Property::JoinStyle ), context.renderContext().expressionContext() );
    if ( !QgsVariantUtils::isNull( exprVal ) )
    {
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::CapStyle ) ) )
  {
    context.setOriginalValueVariable( QgsSymbolLayerUtils::encodePenCapStyle( mPenCapStyle ) );
    const QString style = mDataDefinedProperties.valueAsString( static_cast< int >( QgsSymbolLayer::Property::CapStyle ), context.renderContext().expressionContext(), QString(), &ok );
    if ( ok )
    {
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::FillColor ) ) )
  {
    context.setOriginalValueVariable( QgsSymbolLayerUtils::encodeColor( mColor ) );
    QColor brushColor = mDataDefinedProperties.valueAsColor( static_cast< int >( QgsSymbolLayer::Property::FillColor ), context.renderContext().expressionContext(), mColor );
    brushColor.setAlphaF( brushColor.alphaF() * context.opacity() );
    mBrush.setColor( brushColor );
  }

  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ) ) )
  {
    context.setOriginalValueVariable( QgsSymbolLayerUtils::encodeColor( mStrokeColor ) );
    QColor penColor = mDataDefinedProperties.valueAsColor( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ), context.renderContext().expressionContext(), mStrokeColor );
    penColor.setAlphaF( penColor.alphaF() * context.opacity() );
    mPen.setColor( penColor );
  }

  QgsEllipseSymbolLayer::Shape shape = mShape;
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Width ) ) || mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Height ) ) || mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Name ) ) )
  {
    context.setOriginalValueVariable( encodeShape( shape ) );
    const QVariant exprVal = mDataDefinedProperties.value( static_cast< int >( QgsSymbolLayer::Property::Name ), context.renderContext().expressionContext() );
    if ( !QgsVariantUtils::isNull( exprVal ) )
    {
...
//priority for rotation: 1. data defined symbol level, 2. symbol layer rotation (mAngle)
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Angle ) ) )
  {
    ...
    angle = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::Angle ), context.renderContext().expressionContext(), 0 ) + mLineAngle;
...
void QgsEllipseSymbolLayer::writeSldMarker( QDomDocument &doc, QDomElement &element, const QVariantMap &props ) const
{
  ...
  // <Rotation>
  const QgsProperty ddRotation = mDataDefinedProperties.property( static_cast< int >( QgsSymbolLayer::Property::Angle ) );
...
QSizeF QgsEllipseSymbolLayer::calculateSize( QgsSymbolRenderContext &context, double *scaledWidth, double *scaledHeight )
{
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Width ) ) ) //1. priority: data defined setting on symbol layer le
  {
    context.setOriginalValueVariable( mSymbolWidth );
    width = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::Width ), context.renderContext().expressionContext(), mSymbolWidth );
  }
  ...
  double height = 0;
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Height ) ) ) //1. priority: data defined setting on symbol layer level
  {
    context.setOriginalValueVariable( mSymbolHeight );
    height = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::Height ), context.renderContext().expressionContext(), mSymbolHeight );
  }
...
bool QgsEllipseSymbolLayer::writeDxf( QgsDxfExport &e, double mmMapUnitScaleFactor, const QString &layerName, QgsSymbolRenderContext &context, QPointF shift ) const
{
  ...
  {
    context.setOriginalValueVariable( mSymbolWidth );
    symbolWidth = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::Width ), context.renderContext().expressionContext(), mSymbolWidth );
  }
  ...
  {
    context.setOriginalValueVariable( mSymbolHeight );
    symbolWidth = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::Height ), context.renderContext().expressionContext(), mSymbolHeight );
  }
  ...
  {
    context.setOriginalValueVariable( mStrokeWidth );
    strokeWidth = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::StrokeWidth ), context.renderContext().expressionContext(), mStrokeWidth );
  }
  ...
  {
    context.setOriginalValueVariable( QgsSymbolLayerUtils::encodeColor( mColor ) );
    fc = mDataDefinedProperties.valueAsColor( static_cast< int >( QgsSymbolLayer::Property::FillColor ), context.renderContext().expressionContext(), mColor );
  }
  ...
  {
    context.setOriginalValueVariable( QgsSymbolLayerUtils::encodeColor( mStrokeColor ) );
    oc = mDataDefinedProperties.valueAsColor( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ), context.renderContext().expressionContext(), mStrokeColor );
  }

  //symbol name
  QgsEllipseSymbolLayer::Shape shape = mShape;
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Name ) ) )
  {
    context.setOriginalValueVariable( encodeShape( shape ) );
    shape = decodeShape( mDataDefinedProperties.valueAsString( static_cast< int >( QgsSymbolLayer::Property::Name ), context.renderContext().expressionContext(), encodeShape( shape ) ) );
  }
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Angle ) ) )
  {
    ...
    rotation = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::Angle ), context.renderContext().expressionContext(), mAngle ) + mLineAngle;
  }
