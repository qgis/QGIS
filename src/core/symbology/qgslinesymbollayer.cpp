...
void QgsSimpleLineSymbolLayer::renderPolyline( const QPolygonF &pts, QgsSymbolRenderContext &context )
{
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::TrimStart ) ) )
  {
    context.setOriginalValueVariable( startTrim );
    startTrim = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::TrimStart ), context.renderContext().expressionContext(), mTrimDistanceStart );
  }
  double endTrim = mTrimDistanceEnd;
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::TrimEnd ) ) )
  {
    context.setOriginalValueVariable( endTrim );
    endTrim = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::TrimEnd ), context.renderContext().expressionContext(), mTrimDistanceEnd );
  }
...
void QgsSimpleLineSymbolLayer::applyDataDefinedSymbology( QgsSymbolRenderContext &context, QPen &pen, QPen &selPen, double &offset )
{
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::StrokeWidth ) ) )
  {
    ...
    double scaledWidth = context.renderContext().convertToPainterUnits(
                           mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::StrokeWidth ), context.renderContext().expressionContext(), mWidth ),
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ) ) )
  {
    ...
    QColor penColor = mDataDefinedProperties.valueAsColor( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ), context.renderContext().expressionContext(), mColor );
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Offset ) ) )
  {
    ...
    offset = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::Offset ), context.renderContext().expressionContext(), offset );
  }
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::CustomDash ) ) )
  {
    QVector<qreal> dashVector;
    QVariant exprVal = mDataDefinedProperties.value( static_cast< int >( QgsSymbolLayer::Property::CustomDash ), context.renderContext().expressionContext() );
  ...
  else if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::StrokeWidth ) ) && mUseCustomDashPattern )
  {
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::DashPatternOffset ) ) && pen.style() != Qt::SolidLine )
  {
    context.setOriginalValueVariable( patternOffset );
    patternOffset = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::DashPatternOffset ), context.renderContext().expressionContext(), mDashPatternOffset );
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::StrokeStyle ) ) )
  {
    ...
    QVariant exprVal = mDataDefinedProperties.value( static_cast< int >( QgsSymbolLayer::Property::StrokeStyle ), context.renderContext().expressionContext() );
    if ( !QgsVariantUtils::isNull( exprVal ) )
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::JoinStyle ) ) )
  {
    ...
    QVariant exprVal = mDataDefinedProperties.value( static_cast< int >( QgsSymbolLayer::Property::JoinStyle ), context.renderContext().expressionContext() );
    if ( !QgsVariantUtils::isNull( exprVal ) )
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::CapStyle ) ) )
  {
    ...
    QVariant exprVal = mDataDefinedProperties.value( static_cast< int >( QgsSymbolLayer::Property::CapStyle ), context.renderContext().expressionContext() );
    if ( !QgsVariantUtils::isNull( exprVal ) )
...
double QgsSimpleLineSymbolLayer::dxfWidth( const QgsDxfExport &e, QgsSymbolRenderContext &context ) const
{
  ...
  {
    context.setOriginalValueVariable( mWidth );
    width = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::StrokeWidth ), context.renderContext().expressionContext(), mWidth );
  }
...
QColor QgsSimpleLineSymbolLayer::dxfColor( QgsSymbolRenderContext &context ) const
{
  ...
  {
    context.setOriginalValueVariable( QgsSymbolLayerUtils::encodeColor( mColor ) );
    return mDataDefinedProperties.valueAsColor( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ), context.renderContext().expressionContext(), mColor );
  }
  return mColor;
}
...
double QgsSimpleLineSymbolLayer::dxfOffset( const QgsDxfExport &e, QgsSymbolRenderContext &context ) const
{
  ...
  {
    context.setOriginalValueVariable( mOffset );
    offset = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::Offset ), context.renderContext().expressionContext(), mOffset );
  }
...
void QgsTemplatedLineSymbolLayerBase::renderPolyline( const QPolygonF &points, QgsSymbolRenderContext &context )
{
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Placement ) ) )
  {
    QVariant exprVal = mDataDefinedProperties.value( static_cast< int >( QgsSymbolLayer::Property::Placement ), context.renderContext().expressionContext() );
    if ( !QgsVariantUtils::isNull( exprVal ) )
    {
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::AverageAngleLength ) ) )
  {
    context.setOriginalValueVariable( mAverageAngleLength );
    averageOver = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::AverageAngleLength ), context.renderContext().expressionContext(), mAverageAngleLength );
  }
...
void QgsTemplatedLineSymbolLayerBase::renderPolylineInterval( const QPolygonF &points, QgsSymbolRenderContext &context, double averageOver )
{
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Interval ) ) )
  {
    context.setOriginalValueVariable( mInterval );
    interval = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::Interval ), context.renderContext().expressionContext(), mInterval );
  }
  if ( interval <= 0 )
  {
    interval = 0.1;
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::OffsetAlongLine ) ) )
  {
    context.setOriginalValueVariable( mOffsetAlongLine );
    offsetAlongLine = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::OffsetAlongLine ), context.renderContext().expressionContext(), mOffsetAlongLine );
  }
...
void QgsHashedLineSymbolLayer::renderSymbol( const QPointF &point, const QgsFeature *feature, QgsRenderContext &context, int layer, bool selected )
{
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::LineDistance ) ) )
  {
    ...
    lineLength = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::LineDistance ), context.expressionContext(), lineLength );
  }
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::LineAngle ) ) )
  {
    ...
    hashAngle = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::LineAngle ), context.expressionContext(), hashAngle );
  }
...
void QgsRasterLineSymbolLayer::renderPolyline( const QPolygonF &points, QgsSymbolRenderContext &context )
{
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::StrokeWidth ) )
       || mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::File ) )
       || mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Opacity ) ) )
  {
    QString path = mPath;
    if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::File ) ) )
    {
      context.setOriginalValueVariable( path );
      path = mDataDefinedProperties.valueAsString( static_cast< int >( QgsSymbolLayer::Property::File ), context.renderContext().expressionContext(), path );
    }
    ...
    if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::StrokeWidth ) ) )
    {
      ...
      strokeWidth = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::StrokeWidth ), context.renderContext().expressionContext(), strokeWidth );
    }
    ...
    if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Opacity ) ) )
    {
...
void QgsLineburstSymbolLayer::renderPolyline( const QPolygonF &points, QgsSymbolRenderContext &context )
{
  ...
  {
    context.setOriginalValueVariable( QgsSymbolLayerUtils::encodeColor( mColor ) );
    color1 = mDataDefinedProperties.valueAsColor( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ), context.renderContext().expressionContext(), mColor );
  }
  const bool useSelectedColor = shouldRenderUsingSelectionColor( context );
  if ( useSelectedColor )
  {
