...
QVariant QgsCombinedStyleModel::headerData( int section, Qt::Orientation orientation, int role ) const { return QgsStyleModel::headerDataStatic( section, orientation, role ); }
...
QList< QgsStyle * > QgsCombinedStyleModel::styles() const { return mStyles; }
