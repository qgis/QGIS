...
void QgsSimpleMarkerSymbolLayerBase::startRender( QgsSymbolRenderContext &context )
{
  ...
  const bool hasDataDefinedSize = mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Size ) );
...
double QgsSimpleMarkerSymbolLayerBase::calculateSize( QgsSymbolRenderContext &context, bool &hasDataDefinedSize ) const
{
  ...
  hasDataDefinedSize = mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Size ) );
  bool ok = true;
  if ( hasDataDefinedSize )
  {
    context.setOriginalValueVariable( mSize );
    scaledSize = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::Size ), context.renderContext().expressionContext(),
                 mSize, &ok );
  }
...
void QgsSimpleMarkerSymbolLayerBase::calculateOffsetAndRotation( QgsSymbolRenderContext &context, double scaledSize, bool &hasDataDefinedRotation, QPointF &offset, double &angle ) const
{
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Angle ) ) )
  {
    ...
    angle = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::Angle ), context.renderContext().expressionContext(), 0, &ok ) + mLineAngle;
...
void QgsSimpleMarkerSymbolLayer::startRender( QgsSymbolRenderContext &context )
{
  ...
  const bool hasDataDefinedRotation = context.renderHints() & Qgis::SymbolRenderHint::DynamicRotation || mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Angle ) );
  const bool hasDataDefinedSize = mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Size ) );
  ...
  mUsingCache = !hasDataDefinedRotation && !hasDataDefinedSize && !context.renderContext().forceVectorOutput()
                && !mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Name ) ) && !mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::FillColor ) ) && !mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ) )
                && !mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::StrokeWidth ) ) && !mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::StrokeStyle ) )
                && !mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::JoinStyle ) );
...
void QgsSimpleMarkerSymbolLayer::draw( QgsSymbolRenderContext &context, Qgis::MarkerShape shape, const QPolygonF &polygon, const QPainterPath &path )
{
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::FillColor ) ) )
  {
    ...
    QColor c = mDataDefinedProperties.valueAsColor( static_cast< int >( QgsSymbolLayer::Property::FillColor ), context.renderContext().expressionContext(), mColor, &ok );
    if ( ok )
    {
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ) ) )
  {
    ...
    QColor c = mDataDefinedProperties.valueAsColor( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ), context.renderContext().expressionContext(), mStrokeColor, &ok );
    if ( ok )
    {
      c.setAlphaF( c.alphaF() * context.opacity() );
      mPen.setColor( c );
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::StrokeWidth ) ) )
  {
    ...
    const double strokeWidth = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::StrokeWidth ), context.renderContext().expressionContext(), 0, &ok );
    if ( ok )
    {
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::StrokeStyle ) ) )
  {
    ...
    const QString strokeStyle = mDataDefinedProperties.valueAsString( static_cast< int >( QgsSymbolLayer::Property::StrokeStyle ), context.renderContext().expressionContext(), QString(), &ok );
    if ( ok )
    {
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::JoinStyle ) ) )
  {
    ...
    const QString style = mDataDefinedProperties.valueAsString( static_cast< int >( QgsSymbolLayer::Property::JoinStyle ), context.renderContext().expressionContext(), QString(), &ok );
    if ( ok )
    {
...
void QgsSimpleMarkerSymbolLayer::writeSldMarker( QDomDocument &doc, QDomElement &element, const QVariantMap &props ) const
{
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Angle ) ) )
  {
    angleFunc = mDataDefinedProperties.property( static_cast< int >( QgsSymbolLayer::Property::Angle ) ).asExpression();
  }
  else
  {
    bool ok;
...
bool QgsSimpleMarkerSymbolLayer::writeDxf( QgsDxfExport &e, double mmMapUnitScaleFactor, const QString &layerName, QgsSymbolRenderContext &context, QPointF shift ) const
{
  ...
  {
    context.setOriginalValueVariable( QgsSymbolLayerUtils::encodeColor( mColor ) );
    bc = mDataDefinedProperties.valueAsColor( static_cast< int >( QgsSymbolLayer::Property::FillColor ), context.renderContext().expressionContext(), bc );
  }
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ) ) )
  {
    context.setOriginalValueVariable( QgsSymbolLayerUtils::encodeColor( mStrokeColor ) );
    pc = mDataDefinedProperties.valueAsColor( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ), context.renderContext().expressionContext(), pc );
  }
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Angle ) ) )
  {
    ...
    angle = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::Angle ), context.renderContext().expressionContext(), mAngle ) + mLineAngle;
  }
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Name ) ) )
  {
    ...
    const QString shapeName = mDataDefinedProperties.valueAsString( static_cast< int >( QgsSymbolLayer::Property::Name ), context.renderContext().expressionContext(), QString(), &ok );
    if ( ok )
    {
...
QRectF QgsSimpleMarkerSymbolLayer::bounds( QPointF point, QgsSymbolRenderContext &context )
{
  ...
  {
    context.setOriginalValueVariable( mStrokeWidth );
    const double strokeWidth = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::StrokeWidth ), context.renderContext().expressionContext(), mStrokeWidth, &ok );
    if ( ok )
    {
...
void QgsSvgMarkerSymbolLayer::renderPoint( QPointF point, QgsSymbolRenderContext &context )
{
  ...
  else if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::FillColor ) ) )
  {
    context.setOriginalValueVariable( QgsSymbolLayerUtils::encodeColor( mColor ) );
    fillColor = mDataDefinedProperties.valueAsColor( static_cast< int >( QgsSymbolLayer::Property::FillColor ), context.renderContext().expressionContext(), mColor );
  }
  ...
  {
    context.setOriginalValueVariable( QgsSymbolLayerUtils::encodeColor( mStrokeColor ) );
    strokeColor = mDataDefinedProperties.valueAsColor( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ), context.renderContext().expressionContext(), mStrokeColor );
  }
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Name ) ) )
  {
    ...
    path = QgsSymbolLayerUtils::svgSymbolNameToPath( mDataDefinedProperties.valueAsString( static_cast< int >( QgsSymbolLayer::Property::Name ), context.renderContext().expressionContext(), mPath ),
           context.renderContext().pathResolver() );
    if ( path != mPath && qgsDoubleNear( aspectRatio, 0.0 ) && !mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Height ) ) )
    {
  ...
  bool usePict = true;
  const bool rasterizeSelected = !mHasFillParam || mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Name ) );
...
double QgsSvgMarkerSymbolLayer::calculateSize( QgsSymbolRenderContext &context, bool &hasDataDefinedSize ) const
{
  ...
  {
    context.setOriginalValueVariable( mSize );
    scaledSize = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::Size ), context.renderContext().expressionContext(), mSize, &ok );
  }
  else
  {
    hasDataDefinedSize = mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Width ) );
    if ( hasDataDefinedSize )
    {
      context.setOriginalValueVariable( mSize );
      scaledSize = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::Width ), context.renderContext().expressionContext(), mSize, &ok );
    }
  }
...
{
  hasDataDefinedAspectRatio = mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Width ) ) || mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Height ) );
  if ( !hasDataDefinedAspectRatio )
    return mFixedAspectRatio;

  if ( !mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Height ) ) && mFixedAspectRatio <= 0.0 )
    return 0.0;
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Height ) ) )
  {
    context.setOriginalValueVariable( defaultHeight );
    scaledHeight = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::Height ), context.renderContext().expressionContext(), defaultHeight, &ok );
  }
...
QRectF QgsSvgMarkerSymbolLayer::bounds( QPointF point, QgsSymbolRenderContext &context )
{
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Name ) ) )
  {
    ...
    if ( path != mPath && qgsDoubleNear( aspectRatio, 0.0 ) && !mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Height ) ) )
    {
      ...
      {
        context.setOriginalValueVariable( QgsSymbolLayerUtils::encodeColor( mStrokeColor ) );
        fillColor = mDataDefinedProperties.valueAsColor( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ), context.renderContext().expressionContext(), mStrokeColor );
      }
...
void QgsRasterMarkerSymbolLayer::renderPoint( QPointF point, QgsSymbolRenderContext &context )
{
  ...
  {
    context.setOriginalValueVariable( mPath );
    path = mDataDefinedProperties.valueAsString( static_cast< int >( QgsSymbolLayer::Property::Name ), context.renderContext().expressionContext(), mPath );
  }
...
void QgsFontMarkerSymbolLayer::startRender( QgsSymbolRenderContext &context )
{
  ...
  mUseCachedPath = !mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::FontFamily ) ) &&
                   !mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::FontStyle ) ) &&
                   !mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Character ) );
  if ( mUseCachedPath )
  {
...
QString QgsFontMarkerSymbolLayer::characterToRender( QgsSymbolRenderContext &context, QPointF &charOffset, double &charWidth )
{
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Character ) ) )
  {
    context.setOriginalValueVariable( mString );
    stringToRender = mDataDefinedProperties.valueAsString( static_cast< int >( QgsSymbolLayer::Property::Character ), context.renderContext().expressionContext(), mString );
    ...
    double &angle ) const
{
  ...
  {
    context.setOriginalValueVariable( angle );
    angle = mDataDefinedProperties.valueAsDouble( static_cast< int >( QgsSymbolLayer::Property::Angle ), context.renderContext().expressionContext(), mAngle, &ok ) + mLineAngle;
...
void QgsFontMarkerSymbolLayer::renderPoint( QPointF point, QgsSymbolRenderContext &context )
{
  ...
  {
    context.setOriginalValueVariable( QgsSymbolLayerUtils::encodeColor( mColor ) );
    brushColor = mDataDefinedProperties.valueAsColor( static_cast< int >( QgsSymbolLayer::Property::FillColor ), context.renderContext().expressionContext(), brushColor );
  }
  const bool useSelectedColor = shouldRenderUsingSelectionColor( context );
  ...
  {
    context.setOriginalValueVariable( QgsSymbolLayerUtils::encodeColor( mStrokeColor ) );
    penColor = mDataDefinedProperties.valueAsColor( static_cast< int >( QgsSymbolLayer::Property::StrokeColor ), context.renderContext().expressionContext(), penColor );
  }
  penColor.setAlphaF( penColor.alphaF() * context.opacity() );
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::FontFamily ) ) )
  {
    context.setOriginalValueVariable( mFontFamily );
    const QString fontFamily = mDataDefinedProperties.valueAsString( static_cast< int >( QgsSymbolLayer::Property::FontFamily ), context.renderContext().expressionContext(), mFontFamily, &ok );
  ...
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::FontStyle ) ) )
  {
    context.setOriginalValueVariable( mFontStyle );
    const QString fontStyle = mDataDefinedProperties.valueAsString( static_cast< int >( QgsSymbolLayer::Property::FontStyle ), context.renderContext().expressionContext(), mFontStyle, &ok );
    QgsFontUtils::updateFontViaStyle( mFont, QgsFontUtils::translateNamedStyle( ok ? fontStyle : mFontStyle ) );
  }
  if ( mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::FontFamily ) ) || mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::FontStyle ) ) )
  {
    mFontMetrics.reset( new QFontMetrics( mFont ) );
  }
...
void QgsAnimatedMarkerSymbolLayer::startRender( QgsSymbolRenderContext &context )
{
  ...
  if ( !mDataDefinedProperties.isActive( static_cast< int >( QgsSymbolLayer::Property::Name ) ) && !mPath.isEmpty() )
  {
