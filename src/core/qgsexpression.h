    ...
    */
    ...
    class StaticFunction : public Function
    {
      public:
        ...
        StaticFunction( QString fnname, int params, FcnEvalContext fcn, QString group, QString helpText = QString(), bool usesGeometry = false, QStringList referencedColumns = QStringList(), bool lazyEval = false, const QStringList& aliases = QStringList() )
            : Function( fnname, params, group, helpText, usesGeometry, referencedColumns, lazyEval ), mContextFnc( fcn ), mAliases( aliases ) {}
