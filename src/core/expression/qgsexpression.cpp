...
void QgsExpression::initVariableHelp()
{
  ...
  sVariableHelpTexts.insert( QStringLiteral( "map_crs_description" ), QCoreApplication::translate( "variable_help", "Name of theCoordinate reference system of the map." ) );
  ...
  sVariableHelpTexts.insert( QStringLiteral( "map_crs_Wkt" ), QCoreApplication::translate( "variable_help", "Wkt description of the Coordinate reference system." ) );
