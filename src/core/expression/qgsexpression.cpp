...
void QgsExpression::initVariableHelp()
{
  ...
  sVariableHelpTexts.insert( QStringLiteral( "symbol_label" ), QCoreApplication::translate( "variable_help", "Label of this symbol." ) );
  sVariableHelpTexts.insert( QStringLiteral( "symbol_id" ), QCoreApplication::translate( "variable_help", "Id of this symbol." ) );
  ...
  sVariableHelpTexts.insert( QStringLiteral( "symbol_feature_ids" ), QCoreApplication::translate( "variable_help", "List of Ids (QgsFeatureId/qint64) of features defined by this symbol." ) );
