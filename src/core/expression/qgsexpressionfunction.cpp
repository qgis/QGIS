...
const QList<QgsExpressionFunction *> &QgsExpression::Functions()
{
  ...
  if ( sFunctions.isEmpty() )
  {
    ...
    sFunctions
        ...
        << new QgsStaticExpressionFunction( QStringLiteral( "simplify_by_area" ), QgsExpressionFunction::ParameterList() << QgsExpressionFunction::Parameter( QStringLiteral( "geometry" ) ) << QgsExpressionFunction::Parameter( QStringLiteral( "tolerance" ) ), fcnSimplifyVW, QStringLiteral( "GeometryGroup" ) )
