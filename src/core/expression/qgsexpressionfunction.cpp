...
const QList<QgsExpressionFunction *> &QgsExpression::Functions()
{
  ...
  if ( functions.isEmpty() )
  {
    ...
    true
        ...
        << new QgsStaticExpressionFunction( QStringLiteral( "ascii" ), QgsExpressionFunction::ParameterList() << QgsExpressionFunction::Parameter( QStringLiteral( "code" ) ), fcnAscii, QStringLiteral( "String" ) )
