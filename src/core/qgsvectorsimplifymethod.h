...
class CORE_EXPORT QgsVectorSimplifyMethod
{
  ...
  public:
    ...
    [[nodiscard]] inline Qgis::VectorRenderingSimplificationFlags simplifyHints() const { return mSimplifyHints; }
    ...
    [[nodiscard]] inline Qgis::VectorSimplificationAlgorithm simplifyAlgorithm() const { return mSimplifyAlgorithm; }
    ...
    [[nodiscard]] inline bool forceLocalOptimization() const { return mLocalOptimization; }

    //! Sets the maximum scale at which the layer should be simplified
    void setMaximumScale( float maximumScale ) { mMaximumScale = maximumScale; }
    //! Gets the maximum scale at which the layer should be simplified
    [[nodiscard]] inline float maximumScale() const { return mMaximumScale; }
