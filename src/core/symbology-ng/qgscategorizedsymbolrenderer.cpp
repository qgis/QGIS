...
QgsFeatureRenderer *QgsCategorizedSymbolRenderer::create( QDomElement &element, const QgsPathResolver &pathResolver )
{
...
QDomElement QgsCategorizedSymbolRenderer::save( QDomDocument &doc, const QgsPathResolver &pathResolver )
{
