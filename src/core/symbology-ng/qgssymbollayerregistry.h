...
class CORE_EXPORT QgsSymbolLayerMetadata : public QgsSymbolLayerAbstractMetadata
{
  public:
    ...
    virtual QgsSymbolLayer* createSymbolLayer( const QgsStringMap& map ) override
    {
      return mCreateFunc ? mCreateFunc( map ) : nullptr;
    }
    virtual QgsSymbolLayerWidget* createSymbolLayerWidget( const QgsVectorLayer* vl ) override
    {
      return mWidgetFunc ? mWidgetFunc( vl ) : nullptr;
    }
    virtual QgsSymbolLayer* createSymbolLayerFromSld( QDomElement& elem ) override
    {
      return mCreateFromSldFunc ? mCreateFromSldFunc( elem ) : nullptr;
    }
