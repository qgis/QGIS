...
QgsFeatureRenderer *QgsSingleSymbolRenderer::create( QDomElement &element, const QgsPathResolver &pathResolver )
{
...
QDomElement QgsSingleSymbolRenderer::save( QDomDocument &doc, const QgsPathResolver &pathResolver )
{
