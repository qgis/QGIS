...
QDomElement QgsRuleBasedRenderer::save( QDomDocument &doc, const QgsPathResolver &pathResolver )
{
...
QgsFeatureRenderer *QgsRuleBasedRenderer::create( QDomElement &element, const QgsPathResolver &pathResolver )
{
  // load symbols
