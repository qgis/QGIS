...
class CORE_EXPORT QgsStringUtils
{
  public:
    ...
    /**
    * Generates the unaccent mapping (auto-generated by script).
    * \since QGIS 4.0
    */
    static QHash<QString, QString> createUnaccentMap();

    /**
    * Lookup table used by unaccent(). Generated at build time.
    */
    static QHash<QString, QString> UNACCENT_MAP;

    /**
    * Removes accents and compatibility characters using the
    * PostgreSQL-style generated UNACCENT_MAP.
    *
    * \since QGIS 4.0
    */
