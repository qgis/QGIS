...
class CORE_EXPORT QgsVectorLayerUtils
{
  public:
    ...
    * \since QGIS 4.0
    */
    static QList< QVariant > getUniqueValues( const QgsVectorLayer *layer, const QString &fieldOrExpression, bool &ok, bool selectedOnly = false, QgsFeedback *feedback = nullptr );
