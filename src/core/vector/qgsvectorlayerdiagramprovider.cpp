...
QgsLabelFeature *QgsVectorLayerDiagramProvider::registerDiagram( const QgsFeature &feat, QgsRenderContext &context, const QgsGeometry &obstacleGeometry )
{
  ...
  if ( !mSettings.dataDefinedProperties().valueAsBool( static_cast< int >( QgsDiagramLayerSettings::Property::Show ), context.expressionContext(), true ) )
    return nullptr;

  // data defined obstacle?
  bool isObstacle = mSettings.dataDefinedProperties().valueAsBool( static_cast< int >( QgsDiagramLayerSettings::Property::IsObstacle ), context.expressionContext(), mSettings.isObstacle() );
  ...
  alwaysShow = mSettings.dataDefinedProperties().valueAsBool( static_cast< int >( QgsDiagramLayerSettings::Property::AlwaysShow ), context.expressionContext(), alwaysShow );

  // new style data defined position
  bool ddPos = false;
  double ddPosX = 0.0;
  double ddPosY = 0.0;
  if ( mSettings.dataDefinedProperties().hasProperty( static_cast< int >( QgsDiagramLayerSettings::Property::PositionX ) )
       && mSettings.dataDefinedProperties().property( static_cast< int >( QgsDiagramLayerSettings::Property::PositionX ) ).isActive()
       && mSettings.dataDefinedProperties().hasProperty( static_cast< int >( QgsDiagramLayerSettings::Property::PositionY ) )
       && mSettings.dataDefinedProperties().property( static_cast< int >( QgsDiagramLayerSettings::Property::PositionY ) ).isActive() )
  {
    ddPosX = mSettings.dataDefinedProperties().valueAsDouble( static_cast< int >( QgsDiagramLayerSettings::Property::PositionX ), context.expressionContext(), std::numeric_limits<double>::quiet_NaN() );
    ddPosY = mSettings.dataDefinedProperties().valueAsDouble( static_cast< int >( QgsDiagramLayerSettings::Property::PositionY ), context.expressionContext(), std::numeric_limits<double>::quiet_NaN() );
  ...
  if ( mSettings.dataDefinedProperties().hasProperty( static_cast< int >( QgsDiagramLayerSettings::Property::Priority ) )
       && mSettings.dataDefinedProperties().property( static_cast< int >( QgsDiagramLayerSettings::Property::Priority ) ).isActive() )
  {
    context.expressionContext().setOriginalValueVariable( mSettings.priority() );
    double priorityD = mSettings.dataDefinedProperties().valueAsDouble( static_cast< int >( QgsDiagramLayerSettings::Property::Priority ), context.expressionContext(), mSettings.priority() );
  ...
  if ( mSettings.dataDefinedProperties().hasProperty( static_cast< int >( QgsDiagramLayerSettings::Property::ZIndex ) )
       && mSettings.dataDefinedProperties().property( static_cast< int >( QgsDiagramLayerSettings::Property::ZIndex ) ).isActive() )
  {
    context.expressionContext().setOriginalValueVariable( zIndex );
    zIndex = mSettings.dataDefinedProperties().valueAsDouble( static_cast< int >( QgsDiagramLayerSettings::Property::ZIndex ), context.expressionContext(), zIndex );
  }
  lf->setZIndex( zIndex );
  ...
  if ( mSettings.dataDefinedProperties().hasProperty( static_cast< int >( QgsDiagramLayerSettings::Property::Distance ) )
       && mSettings.dataDefinedProperties().property( static_cast< int >( QgsDiagramLayerSettings::Property::Distance ) ).isActive() )
  {
    context.expressionContext().setOriginalValueVariable( dist );
    dist = mSettings.dataDefinedProperties().valueAsDouble( static_cast< int >( QgsDiagramLayerSettings::Property::Distance ), context.expressionContext(), dist );
  }
