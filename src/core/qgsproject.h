...
class CORE_EXPORT QgsProject : public QObject, public QgsExpressionContextGenerator, public QgsExpressionContextScopeGenerator, public QgsProjectTranslator
{
  ...
  public:
    ...
    */
     ...
     */
    QStringList readListEntry( const QString &scope, const QString &key, const QStringList &def = QStringList(), bool *ok = nullptr SIP_OUT ) const;
     ...
     */
    QString readEntry( const QString &scope, const QString &key, const QString &def = QString(), bool *ok = nullptr SIP_OUT ) const;
     ...
     */
    int readNumEntry( const QString &scope, const QString &key, int def = 0, bool *ok = nullptr SIP_OUT ) const;
     ...
     */
    double readDoubleEntry( const QString &scope, const QString &key, double def = 0, bool *ok = nullptr SIP_OUT ) const;
     ...
     */
    bool readBoolEntry( const QString &scope, const QString &key, bool def = false, bool *ok = nullptr SIP_OUT ) const;
