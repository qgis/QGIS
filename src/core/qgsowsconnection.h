...
class CORE_EXPORT QgsOwsConnection : public QObject
{
  ...
  public:
    ...
    static const inline QgsSettingsEntryEnumFlag<Qgis::TilePixelRatio> settingsConnectionTilePixelRatio = QgsSettingsEntryEnumFlag<Qgis::TilePixelRatio>( QStringLiteral( "connections-%1/%2/tilePixelRatio" ), QgsSettings::Prefix::QGIS, Qgis::TilePixelRatio::Unknown, QString(), Qgis::SettingsOption::SaveEnumFlagAsInt ) SIP_SKIP;
