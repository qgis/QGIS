...
void QgsLocator::registerFilter( QgsLocatorFilter *filter )
{
  ...
  {
    if ( filter->name() == QStringLiteral( "actions" ) ||
         filter->name() == QStringLiteral( "bookmarks" ) ||
         filter->name() == QStringLiteral( "calculator" ) ||
         filter->name() == QStringLiteral( "features" ) ||
         filter->name() == QStringLiteral( "goto" ) ||
         filter->name() == QStringLiteral( "layertree" ) ||
         filter->name() == QStringLiteral( "layouts" ) ||
         filter->name() == QStringLiteral( "processing_alg" ) )
    {
