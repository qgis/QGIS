...
class CORE_EXPORT QgsSettingsRegistryCore : public QgsSettingsRegistry
{
  ...
  public:
    ...
    static const QgsSettingsEntryEnumFlag<Qgis::MapUnitType> *settingsDigitizingDefaultSnappingToleranceUnit;
    ...
    static const QgsSettingsEntryEnumFlag<Qgis::MapUnitType> *settingsDigitizingSearchRadiusVertexEditUnit;
