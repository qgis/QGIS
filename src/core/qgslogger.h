...
class CORE_EXPORT QgsLogger
{
  public:
    ...
    *
    * Returns an empty string if the variable is not set, otherwise returns a file
    * name for writing log messages to.
    *
    ...
    * logFile() must be called before logMessageToFile() to ensure that messages
