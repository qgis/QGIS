...
#include "ui_qgslauncherpluginguibase.h"
#include <memory>
#include <QProcess>
class QTextEdit;
/**
...
@author Gary Sherman
*/
class QgsLauncherPluginGui : public QDialog, private Ui::QgsLauncherPluginGuiBase
{
Q_OBJECT
public:
  //! Default constructor
    //QgsLauncherPluginGui();
    QgsLauncherPluginGui( QWidget* parent = 0, const char* name = 0, bool modal = FALSE, Qt::WFlags fl = 0 );
    ~QgsLauncherPluginGui();
public slots:
...
private:
  ...
  bool firstRun;
  //! String to hold the program name for use in error reporting
  QString programName;
signals:
