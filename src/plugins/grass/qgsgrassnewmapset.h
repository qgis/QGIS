...
class QgsGrassNewMapset : public QWizard, private Ui::QgsGrassNewMapsetBase
{
  ...
  public slots:
    //! Browse database
    void on_mDatabaseButton_clicked()
    {
      browseDatabase();
    }
    void browseDatabase();
    ...
    //! Database changed
    void on_mDatabaseLineEdit_returnPressed()
    {
      databaseChanged();
    }
    void on_mDatabaseLineEdit_textChanged()
    {
      databaseChanged();
    }
    ...
    void on_mCreateLocationRadioButton_clicked()
    {
      locationRadioSwitched();
    }
    void on_mSelectLocationRadioButton_clicked()
    {
      locationRadioSwitched();
    }
    ...
    void on_mLocationLineEdit_returnPressed()
    {
      newLocationChanged();
    }
    void on_mLocationLineEdit_textChanged()
    {
      newLocationChanged();
    }
    ...
    //! Location radio switched
    void on_mNoProjRadioButton_clicked()
    {
      projRadioSwitched();
    }
    void on_mProjRadioButton_clicked()
    {
      projRadioSwitched();
    }
    ...
    //! Region Changed
    void on_mNorthLineEdit_returnPressed()
    {
      regionChanged();
    }
    void on_mNorthLineEdit_textChanged()
    {
      regionChanged();
    }
    void on_mSouthLineEdit_returnPressed()
    {
      regionChanged();
    }
    void on_mSouthLineEdit_textChanged()
    {
      regionChanged();
    }
    void on_mEastLineEdit_returnPressed()
    {
      regionChanged();
    }
    void on_mEastLineEdit_textChanged()
    {
      regionChanged();
    }
    void on_mWestLineEdit_returnPressed()
    {
      regionChanged();
    }
    void on_mWestLineEdit_textChanged()
    {
      regionChanged();
    }
    void regionChanged();
    ...
    void on_mCurrentRegionButton_clicked()
    {
      setCurrentRegion();
    }
    ...
    //! Mapset name changed
    void on_mMapsetLineEdit_returnPressed()
    {
      mapsetChanged();
    }
    void on_mMapsetLineEdit_textChanged()
    {
      mapsetChanged();
    }
    void mapsetChanged();
