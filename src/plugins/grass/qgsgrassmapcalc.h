  ...
  public QgsGrassModuleOptions
{
  ...
  public slots:
    ...
    //! Constant changed
    void on_mConstantLineEdit_textChanged()
    {
      constantChanged();
    }
    ...
    void on_mFunctionComboBox_activated()
    {
      functionChanged();
    }
...
class QgsGrassMapcalcObject: public QGraphicsRectItem, public QgsGrassMapcalcItem
{
  public:
    ...
    //! Function
    QgsGrassMapcalcFunction function()
    {
      return mFunction;
    }
...
class QgsGrassMapcalcConnector: public QGraphicsLineItem, public QgsGrassMapcalcItem
{
  public:
    ...
    int socketDirection( int end )
    {
      return mSocketDir[end];
    }
