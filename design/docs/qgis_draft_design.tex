...
\item [Layer:]A dataset that has a spatial context and can be drawn on
a map canvas. Layers may have associated attributes. 
...
by merely creating a data provider plug-in that supports agiven format.
