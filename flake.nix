{
  ...
  inputs = {
    # FIXME:
    # nixpkgs-unstable with:
    # https://github.com/NixOS/nixpkgs/pull/424012
    # https://github.com/NixOS/nixpkgs/pull/424399
    # https://github.com/NixOS/nixpkgs/pull/424421
    # nixpkgs.url = "github:NixOS/nixpkgs/nixpkgs-unstable";
    nixpkgs.url = "github:imincik/nixpkgs/qgis-qt6-deps";
  };
