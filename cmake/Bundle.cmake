...
set(CPACK_PACKAGE_NAME "GeoAI-Desktop")
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "GeoAI Desktop - independent unofficial fork based on QGIS")
set(CPACK_PACKAGE_VENDOR "Francesco Mazzi")
set(CPACK_RESOURCE_FILE_LICENSE "${CMAKE_CURRENT_SOURCE_DIR}/COPYING")
set(CPACK_PACKAGE_INSTALL_DIRECTORY "GeoAI Desktop ${COMPLETE_VERSION}")
set(CPACK_PACKAGE_EXECUTABLES "${QGIS_APP_NAME}" "GeoAI Desktop")
...
if(CREATE_NSIS)
  ...
  set(CPACK_NSIS_DISPLAY_NAME "GeoAI Desktop ${CPACK_PACKAGE_VERSION}")
  set(CPACK_NSIS_PACKAGE_NAME "GeoAI Desktop")
  set(CPACK_NSIS_HELP_LINK "https:\\\\\\\\github.com\\\\francemazzi\\\\GeoAI-Desktop")
  set(CPACK_NSIS_URL_INFO_ABOUT "https:\\\\\\\\github.com\\\\francemazzi\\\\GeoAI-Desktop")
...
if(CMAKE_SYSTEM_NAME STREQUAL "Darwin" AND QGIS_MAC_BUNDLE)
  ...
  install(FILES "${CMAKE_SOURCE_DIR}/images/icons/mac/geoai-desktop.icns" DESTINATION "${APP_RESOURCES_DIR}")

  set(CPACK_DMG_VOLUME_NAME "GeoAI Desktop")
