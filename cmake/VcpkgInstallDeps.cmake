...
if(MSVC)
  install(DIRECTORY "${VCPKG_BASE_DIR}/bin/Qca/crypto/" DESTINATION "${QGIS_BIN_SUBDIR}/${QT_VERSION_BASE}/plugins/crypto") # QCA plugins
else()
...
if(MSVC)
  if(BUILD_WITH_QT6)
    ...
    install(DIRECTORY "${VCPKG_BASE_DIR}/plugins/" DESTINATION "${QGIS_BIN_SUBDIR}/Qt5") # qt plugins (qml and others)
  endif()
else()
  if(BUILD_WITH_QT6)
    install(DIRECTORY "${VCPKG_BASE_DIR}/Qt6/plugins/" DESTINATION "${APP_PLUGINS_DIR}/") # qt plugins (qml and others)
  else()
    install(DIRECTORY "${VCPKG_BASE_DIR}/plugins/" DESTINATION "${APP_PLUGINS_DIR}/") # qt plugins (others)
    install(DIRECTORY "${VCPKG_BASE_DIR}/qml/" DESTINATION "${APP_PLUGINS_DIR}/../qml/") # qt plugins (qml)
  endif()
endif()
