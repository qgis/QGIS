  ...
  if(PYTHONINTERP_FOUND)
    ...
    if(python_config)
      ...
      if(CMAKE_LIBRARY_ARCHITECTURE)
        FIND_LIBRARY(PYTHON_LIBRARY NAMES ${PYTHON_LIBRARY_NAMES} PATHS ${PYTHON_PREFIX}/lib/${CMAKE_LIBRARY_ARCHITECTURE} ${PYTHON_PREFIX}/libs/${CMAKE_LIBRARY_ARCHITECTURE} NO_DEFAULT_PATH)
