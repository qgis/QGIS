...
MACRO(GENERATE_SIP_PYTHON_MODULE_CODE MODULE_NAME MODULE_SIP SIP_FILES CPP_FILES)
  ...
  IF (SIP_BUILD_EXECUTABLE)
    ...
    message(STATUS "RUNNING SIP COMMAND ${SIP_BUILD_EXECUTABLE}")
    execute_process(COMMAND ${SIP_BUILD_EXECUTABLE} ERROR_VARIABLE SIP_erorr RESULT_VARIABLE SIP_result OUTPUT_VARIABLE SIP_out )
    message(STATUS "SIP COMMAND ERROR (${SIP_erorr}) RESULT(${SIP_result}) OUT(${SIP_out})")
