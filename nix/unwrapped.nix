...
stdenv.mkDerivation
{
  ...
  # FIXME
  env.QCA_INCLUDE_DIR="${qca}/include/Qca-qt6/QtCrypto/";

  # FIXME: qt webkit can't be enabled with Qt6
  cmakeFlags = [
    # "-DCMAKE_BUILD_TYPE=Debug"  # FIXME: remove
    # See: https://github.com/qgis/QGIS/pull/61316
    "-DCMAKE_BUILD_TYPE=Debug" "-DCMAKE_CXX_FLAGS=-UGDAL_DEBUG"
