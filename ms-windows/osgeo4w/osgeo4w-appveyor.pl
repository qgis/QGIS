...
my @pkg = qw/fcgi gdal geos grass grass6 gsl-devel libspatialindex-devel oci openssl osg-dev osgearth-dev proj psycopg2 pyqt4 pyspatialite python python-qscintilla qca-devel qca-libs qscintilla qt4-devel setuptools sip spatialite sqlite3 zlib/;
